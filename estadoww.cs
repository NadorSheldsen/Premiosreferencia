...
namespace GeneXus.Programs {
   public class estadoww : GXDataArea
   {
      public estadoww( )
      {
      ...
      public estadoww( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV24TFEstadoDescripcion = GetPar( "TFEstadoDescripcion");
         AV25TFEstadoDescripcion_Sel = GetPar( "TFEstadoDescripcion_Sel");
         AV26TFEstadoActivo_Sel = (short)(Math.Round(NumberUtil.Val( GetPar( "TFEstadoActivo_Sel"), "."), 18, MidpointRounding.ToEven));
         AV33PaisID = (int)(Math.Round(NumberUtil.Val( GetPar( "PaisID"), "."), 18, MidpointRounding.ToEven));
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         {
            GxWebError = 1;
         ...
         gxgrGrid_refresh( subGrid_Rows, AV12OrderedBy, AV13OrderedDsc, AV15FilterFullText, AV23ManageFiltersExecutionStep, AV18ColumnsSelector, AV34Pgmname, AV24TFEstadoDescripcion, AV25TFEstadoDescripcion_Sel, AV26TFEstadoActivo_Sel, AV33PaisID) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("estadoww.aspx") +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV34Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "vPAISID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV33PaisID), 9, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vPAISID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV33PaisID), "ZZZZZZZZ9"), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV34Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV34Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "vTFESTADODESCRIPCION", AV24TFEstadoDescripcion);
         GxWebStd.gx_hidden_field( context, "vTFESTADODESCRIPCION_SEL", AV25TFEstadoDescripcion_Sel);
         GxWebStd.gx_hidden_field( context, "vTFESTADOACTIVO_SEL", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV26TFEstadoActivo_Sel), 1, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      {
         return formatLink("estadoww.aspx")  ;
      }
      ...
      protected void WB1B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavFilterfulltext_Internalname, AV15FilterFullText, StringUtil.RTrim( context.localUtil.Format( AV15FilterFullText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,28);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", context.GetMessage( "WWP_Search", ""), edtavFilterfulltext_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavFilterfulltext_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "WorkWithPlus_Web\\WWPFullTextFilter", "start", true, "", "HLP_EstadoWW.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       string AV34Pgmname ,
                                       string AV24TFEstadoDescripcion ,
                                       string AV25TFEstadoDescripcion_Sel ,
                                       short AV26TFEstadoActivo_Sel ,
                                       int AV33PaisID )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      protected void RF1B2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 AV35Estadowwds_1_filterfulltext ,
                                                 AV37Estadowwds_3_tfestadodescripcion_sel ,
                                                 AV36Estadowwds_2_tfestadodescripcion ,
                                                 AV38Estadowwds_4_tfestadoactivo_sel ,
                                                 A2EstadoDescripcion ,
                                                 A3EstadoActivo ,
                                                 AV12OrderedBy ,
                                                 AV13OrderedDsc } ,
            ...
            lV35Estadowwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV35Estadowwds_1_filterfulltext), "%", "");
            lV36Estadowwds_2_tfestadodescripcion = StringUtil.Concat( StringUtil.RTrim( AV36Estadowwds_2_tfestadodescripcion), "%", "");
            /* Using cursor H001B2 */
            pr_default.execute(0, new Object[] {lV35Estadowwds_1_filterfulltext, lV36Estadowwds_2_tfestadodescripcion, AV37Estadowwds_3_tfestadodescripcion_sel, GXPagingFrom2, GXPagingTo2});
            nGXsfl_37_idx = 1;
            sGXsfl_37_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_37_idx), 4, 0), 4, "0");
            SubsflControlProps_372( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A3EstadoActivo = H001B2_A3EstadoActivo[0];
               A2EstadoDescripcion = H001B2_A2EstadoDescripcion[0];
               A17PaisDescripcion = H001B2_A17PaisDescripcion[0];
               A16PaisID = H001B2_A16PaisID[0];
               A1EstadoID = H001B2_A1EstadoID[0];
               A17PaisDescripcion = H001B2_A17PaisDescripcion[0];
               /* Execute user event: Grid.Load */
               E191B2 ();
      ...
      {
         AV35Estadowwds_1_filterfulltext = AV15FilterFullText;
         AV36Estadowwds_2_tfestadodescripcion = AV24TFEstadoDescripcion;
         AV37Estadowwds_3_tfestadodescripcion_sel = AV25TFEstadoDescripcion_Sel;
         AV38Estadowwds_4_tfestadoactivo_sel = AV26TFEstadoActivo_Sel;
         ...
         lV36Estadowwds_2_tfestadodescripcion = StringUtil.Concat( StringUtil.RTrim( AV36Estadowwds_2_tfestadodescripcion), "%", "");
         /* Using cursor H001B3 */
         pr_default.execute(1, new Object[] {lV35Estadowwds_1_filterfulltext, lV36Estadowwds_2_tfestadodescripcion, AV37Estadowwds_3_tfestadodescripcion_sel});
      ...
      protected void E181B2( )
      {
         ...
         if ( StringUtil.StrCmp(AV20Session.Get("EstadoWWColumnsSelector"), "") != 0 )
         {
            AV16ColumnsSelectorXML = AV20Session.Get("EstadoWWColumnsSelector");
         ...
         new WorkWithPlus.workwithplus_web.wwp_getappliedfiltersdescription(context ).execute(  AV34Pgmname, out  GXt_char2) ;
      ...
      protected void E141B2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_grid_Activeeventkey, "<#Filter#>") == 0 )
         {
            ...
            {
               AV24TFEstadoDescripcion = Ddo_grid_Filteredtext_get;
               AssignAttri("", false, "AV24TFEstadoDescripcion", AV24TFEstadoDescripcion);
               AV25TFEstadoDescripcion_Sel = Ddo_grid_Selectedvalue_get;
               AssignAttri("", false, "AV25TFEstadoDescripcion_Sel", AV25TFEstadoDescripcion_Sel);
            }
            else if ( StringUtil.StrCmp(Ddo_grid_Selectedcolumn, "EstadoActivo") == 0 )
            {
               AV26TFEstadoActivo_Sel = (short)(Math.Round(NumberUtil.Val( Ddo_grid_Selectedvalue_get, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV26TFEstadoActivo_Sel", StringUtil.Str( (decimal)(AV26TFEstadoActivo_Sel), 1, 0));
            }
            subgrid_firstpage( ) ;
         }
         /*  Sending Event outputs  */
      ...
      private void E191B2( )
      {
         ...
         cmbavGridactions.addItem("1", context.GetMessage( "Modificar", ""), 0);
         cmbavGridactions.addItem("2", context.GetMessage( "Eliminar", ""), 0);
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 37;
      ...
      protected void E151B2( )
      {
         ...
         new WorkWithPlus.workwithplus_web.savecolumnsselectorstate(context ).execute(  "EstadoWWColumnsSelector",  (String.IsNullOrEmpty(StringUtil.RTrim( AV16ColumnsSelectorXML)) ? "" : AV18ColumnsSelector.ToXml(false, true, "", ""))) ;
      ...
      protected void E111B2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("EstadoWWFilters")) + "," + UrlEncode(StringUtil.RTrim(AV34Pgmname+"GridState"));
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Manage#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.managefilters.aspx"+UrlEncode(StringUtil.RTrim("EstadoWWFilters"));
         ...
         else
         {
            ...
            new WorkWithPlus.workwithplus_web.getfilterbyname(context ).execute(  "EstadoWWFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char2) ;
            ...
            else
            {
               ...
               new WorkWithPlus.workwithplus_web.savegridstate(context ).execute(  AV34Pgmname+"GridState",  AV22ManageFiltersXml) ;
      ...
      protected void E161B2( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wpagregarestado.aspx"+UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode(StringUtil.LTrimStr(0,1,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV33PaisID,9,0));
      ...
      protected void S162( )
      {
         ...
         new WorkWithPlus.workwithplus_web.loadcolumnsselectorstate(context ).execute(  "EstadoWWColumnsSelector", out  GXt_char2) ;
      ...
      protected void S112( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_managefiltersloadsavedfilters(context ).execute(  "EstadoWWFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item3) ;
      ...
      protected void S172( )
      {
         ...
         AV15FilterFullText = "";
         AssignAttri("", false, "AV15FilterFullText", AV15FilterFullText);
         AV24TFEstadoDescripcion = "";
         AssignAttri("", false, "AV24TFEstadoDescripcion", AV24TFEstadoDescripcion);
         AV25TFEstadoDescripcion_Sel = "";
         AssignAttri("", false, "AV25TFEstadoDescripcion_Sel", AV25TFEstadoDescripcion_Sel);
         AV26TFEstadoActivo_Sel = 0;
         AssignAttri("", false, "AV26TFEstadoActivo_Sel", StringUtil.Str( (decimal)(AV26TFEstadoActivo_Sel), 1, 0));
      ...
      protected void S192( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wpagregarestado.aspx"+UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode(StringUtil.LTrimStr(A1EstadoID,9,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV33PaisID,9,0));
         context.PopUp(formatLink("wpagregarestado.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey), new Object[] {});
         context.DoAjaxRefresh();
      }
      ...
      protected void S202( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wpagregarestado.aspx"+UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode(StringUtil.LTrimStr(A1EstadoID,9,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV33PaisID,9,0));
         context.PopUp(formatLink("wpagregarestado.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey), new Object[] {});
         context.DoAjaxRefresh();
      }
      ...
      protected void S132( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV20Session.Get(AV34Pgmname+"GridState"), "") == 0 )
         {
            AV10GridState.FromXml(new WorkWithPlus.workwithplus_web.loadgridstate(context).executeUdp(  AV34Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV10GridState.FromXml(AV20Session.Get(AV34Pgmname+"GridState"), null, "", "");
         }
         AV12OrderedBy = AV10GridState.gxTpr_Orderedby;
         AssignAttri("", false, "AV12OrderedBy", StringUtil.LTrimStr( (decimal)(AV12OrderedBy), 4, 0));
         AV13OrderedDsc = AV10GridState.gxTpr_Ordereddsc;
      ...
      protected void S182( )
      {
         ...
         {
            AV11GridStateFilterValue = ((WorkWithPlus.workwithplus_web.SdtWWPGridState_FilterValue)AV10GridState.gxTpr_Filtervalues.Item(AV39GXV1));
            ...
            {
               AV24TFEstadoDescripcion = AV11GridStateFilterValue.gxTpr_Value;
               AssignAttri("", false, "AV24TFEstadoDescripcion", AV24TFEstadoDescripcion);
            }
            else if ( StringUtil.StrCmp(AV11GridStateFilterValue.gxTpr_Name, "TFESTADODESCRIPCION_SEL") == 0 )
            {
               AV25TFEstadoDescripcion_Sel = AV11GridStateFilterValue.gxTpr_Value;
               AssignAttri("", false, "AV25TFEstadoDescripcion_Sel", AV25TFEstadoDescripcion_Sel);
            }
            else if ( StringUtil.StrCmp(AV11GridStateFilterValue.gxTpr_Name, "TFESTADOACTIVO_SEL") == 0 )
            {
               AV26TFEstadoActivo_Sel = (short)(Math.Round(NumberUtil.Val( AV11GridStateFilterValue.gxTpr_Value, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV26TFEstadoActivo_Sel", StringUtil.Str( (decimal)(AV26TFEstadoActivo_Sel), 1, 0));
            }
            AV39GXV1 = (int)(AV39GXV1+1);
         }
         GXt_char2 = "";
         new WorkWithPlus.workwithplus_web.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV25TFEstadoDescripcion_Sel)),  AV25TFEstadoDescripcion_Sel, out  GXt_char2) ;
         Ddo_grid_Selectedvalue_set = GXt_char2+"|"+((0==AV26TFEstadoActivo_Sel) ? "" : StringUtil.Str( (decimal)(AV26TFEstadoActivo_Sel), 1, 0));
         ucDdo_grid.SendProperty(context, "", false, Ddo_grid_Internalname, "SelectedValue_set", Ddo_grid_Selectedvalue_set);
         GXt_char2 = "";
         new WorkWithPlus.workwithplus_web.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV24TFEstadoDescripcion)),  AV24TFEstadoDescripcion, out  GXt_char2) ;
      ...
      protected void S152( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_gridstateaddfiltervalueandsel(context ).execute( ref  AV10GridState,  "TFESTADODESCRIPCION",  context.GetMessage( "Estado", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV24TFEstadoDescripcion)),  0,  AV24TFEstadoDescripcion,  AV24TFEstadoDescripcion,  false,  "",  "",  !String.IsNullOrEmpty(StringUtil.RTrim( AV25TFEstadoDescripcion_Sel)),  AV25TFEstadoDescripcion_Sel,  AV25TFEstadoDescripcion_Sel) ;
         new WorkWithPlus.workwithplus_web.wwp_gridstateaddfiltervalue(context ).execute( ref  AV10GridState,  "TFESTADOACTIVO_SEL",  context.GetMessage( "Activo", ""),  !(0==AV26TFEstadoActivo_Sel),  0,  StringUtil.Trim( StringUtil.Str( (decimal)(AV26TFEstadoActivo_Sel), 1, 0)),  ((AV26TFEstadoActivo_Sel==1) ? context.GetMessage( "WWP_TSChecked", "") : context.GetMessage( "WWP_TSUnChecked", "")),  false,  "",  "") ;
         AV10GridState.gxTpr_Pagesize = StringUtil.Str( (decimal)(subGrid_Rows), 10, 0);
         AV10GridState.gxTpr_Currentpage = (short)(subGrid_fnc_Currentpage( ));
         new WorkWithPlus.workwithplus_web.savegridstate(context ).execute(  AV34Pgmname+"GridState",  AV10GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20265111131181", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("estadoww.js", "?20265111131181", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "3:EstadoDescripcion|4:EstadoActivo";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E121B2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV12OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV34Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV24TFEstadoDescripcion","fld":"vTFESTADODESCRIPCION"},{"av":"AV25TFEstadoDescripcion_Sel","fld":"vTFESTADODESCRIPCION_SEL"},{"av":"AV26TFEstadoActivo_Sel","fld":"vTFESTADOACTIVO_SEL","pic":"9"},{"av":"AV33PaisID","fld":"vPAISID","pic":"ZZZZZZZZ9","hsh":true},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","""{"handler":"E131B2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV12OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV34Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV24TFEstadoDescripcion","fld":"vTFESTADODESCRIPCION"},{"av":"AV25TFEstadoDescripcion_Sel","fld":"vTFESTADODESCRIPCION_SEL"},{"av":"AV26TFEstadoActivo_Sel","fld":"vTFESTADOACTIVO_SEL","pic":"9"},{"av":"AV33PaisID","fld":"vPAISID","pic":"ZZZZZZZZ9","hsh":true},{"av":"Gridpaginationbar_Rowsperpageselectedvalue","ctrl":"GRIDPAGINATIONBAR","prop":"RowsPerPageSelectedValue"}]""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",""","oparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]}""");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","""{"handler":"E141B2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV12OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV34Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV24TFEstadoDescripcion","fld":"vTFESTADODESCRIPCION"},{"av":"AV25TFEstadoDescripcion_Sel","fld":"vTFESTADODESCRIPCION_SEL"},{"av":"AV26TFEstadoActivo_Sel","fld":"vTFESTADOACTIVO_SEL","pic":"9"},{"av":"AV33PaisID","fld":"vPAISID","pic":"ZZZZZZZZ9","hsh":true},{"av":"Ddo_grid_Activeeventkey","ctrl":"DDO_GRID","prop":"ActiveEventKey"},{"av":"Ddo_grid_Selectedvalue_get","ctrl":"DDO_GRID","prop":"SelectedValue_get"},{"av":"Ddo_grid_Selectedcolumn","ctrl":"DDO_GRID","prop":"SelectedColumn"},{"av":"Ddo_grid_Filteredtext_get","ctrl":"DDO_GRID","prop":"FilteredText_get"}]""");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED",""","oparms":[{"av":"AV12OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV24TFEstadoDescripcion","fld":"vTFESTADODESCRIPCION"},{"av":"AV25TFEstadoDescripcion_Sel","fld":"vTFESTADODESCRIPCION_SEL"},{"av":"AV26TFEstadoActivo_Sel","fld":"vTFESTADOACTIVO_SEL","pic":"9"},{"av":"Ddo_grid_Sortedstatus","ctrl":"DDO_GRID","prop":"SortedStatus"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E191B2","iparms":[]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"cmbavGridactions"},{"av":"AV32GridActions","fld":"vGRIDACTIONS","pic":"ZZZ9"}]}""");
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED","""{"handler":"E151B2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV12OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV34Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV24TFEstadoDescripcion","fld":"vTFESTADODESCRIPCION"},{"av":"AV25TFEstadoDescripcion_Sel","fld":"vTFESTADODESCRIPCION_SEL"},{"av":"AV26TFEstadoActivo_Sel","fld":"vTFESTADOACTIVO_SEL","pic":"9"},{"av":"AV33PaisID","fld":"vPAISID","pic":"ZZZZZZZZ9","hsh":true},{"av":"Ddo_gridcolumnsselector_Columnsselectorvalues","ctrl":"DDO_GRIDCOLUMNSSELECTOR","prop":"ColumnsSelectorValues"}]""");
         ...
         setEventMetadata("'DOUSERACTION1'","""{"handler":"E161B2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV12OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV34Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV24TFEstadoDescripcion","fld":"vTFESTADODESCRIPCION"},{"av":"AV25TFEstadoDescripcion_Sel","fld":"vTFESTADODESCRIPCION_SEL"},{"av":"AV26TFEstadoActivo_Sel","fld":"vTFESTADOACTIVO_SEL","pic":"9"},{"av":"AV33PaisID","fld":"vPAISID","pic":"ZZZZZZZZ9","hsh":true},{"av":"A1EstadoID","fld":"ESTADOID","pic":"ZZZZZZZZ9","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         A17PaisDescripcion = "";
         A2EstadoDescripcion = "";
         lV35Estadowwds_1_filterfulltext = "";
         lV36Estadowwds_2_tfestadodescripcion = "";
         AV35Estadowwds_1_filterfulltext = "";
         AV37Estadowwds_3_tfestadodescripcion_sel = "";
         AV36Estadowwds_2_tfestadodescripcion = "";
         H001B2_A3EstadoActivo = new bool[] {false} ;
         H001B2_A2EstadoDescripcion = new string[] {""} ;
         H001B2_A17PaisDescripcion = new string[] {""} ;
         H001B2_A16PaisID = new int[1] ;
         H001B2_A1EstadoID = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.estadoww__default(),
            new Object[][] {
                new Object[] {
               H001B2_A3EstadoActivo, H001B2_A2EstadoDescripcion, H001B2_A17PaisDescripcion, H001B2_A16PaisID, H001B2_A1EstadoID
               }
               , new Object[] {
      ...
      private short AV26TFEstadoActivo_Sel ;
      ...
      private short AV38Estadowwds_4_tfestadoactivo_sel ;
      ...
      private string AV24TFEstadoDescripcion ;
      private string AV25TFEstadoDescripcion_Sel ;
      private string AV31GridAppliedFilters ;
      private string A17PaisDescripcion ;
      private string A2EstadoDescripcion ;
      private string lV35Estadowwds_1_filterfulltext ;
      private string lV36Estadowwds_2_tfestadodescripcion ;
      private string AV35Estadowwds_1_filterfulltext ;
      private string AV37Estadowwds_3_tfestadodescripcion_sel ;
      private string AV36Estadowwds_2_tfestadodescripcion ;
      ...
      private bool[] H001B2_A3EstadoActivo ;
      private string[] H001B2_A2EstadoDescripcion ;
      private string[] H001B2_A17PaisDescripcion ;
      private int[] H001B2_A16PaisID ;
      private int[] H001B2_A1EstadoID ;
   ...
   public class estadoww__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H001B2( IGxContext context ,
                                             string AV35Estadowwds_1_filterfulltext ,
                                             string AV37Estadowwds_3_tfestadodescripcion_sel ,
                                             string AV36Estadowwds_2_tfestadodescripcion ,
                                             short AV38Estadowwds_4_tfestadoactivo_sel ,
                                             ...
                                             bool AV13OrderedDsc )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.`EstadoActivo`, T1.`EstadoDescripcion`, T2.`PaisDescripcion`, T1.`PaisID`, T1.`EstadoID`";
         sFromString = " FROM (`Estado` T1 INNER JOIN `Pais` T2 ON T2.`PaisID` = T1.`PaisID`)";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV35Estadowwds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( T1.`EstadoDescripcion` like CONCAT('%', @lV35Estadowwds_1_filterfulltext)))");
         }
         else
         {
            GXv_int4[0] = 1;
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV37Estadowwds_3_tfestadodescripcion_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV36Estadowwds_2_tfestadodescripcion)) ) )
         {
            AddWhere(sWhereString, "(T1.`EstadoDescripcion` like @lV36Estadowwds_2_tfestadodescripcion)");
         }
         else
         {
            GXv_int4[1] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV37Estadowwds_3_tfestadodescripcion_sel)) && ! ( StringUtil.StrCmp(AV37Estadowwds_3_tfestadodescripcion_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T1.`EstadoDescripcion` = @AV37Estadowwds_3_tfestadodescripcion_sel)");
         }
         else
         {
            GXv_int4[2] = 1;
         }
         if ( StringUtil.StrCmp(AV37Estadowwds_3_tfestadodescripcion_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "((LENGTH(TRIM(T1.`EstadoDescripcion`))=0))");
         }
         if ( AV38Estadowwds_4_tfestadoactivo_sel == 1 )
         {
            AddWhere(sWhereString, "(T1.`EstadoActivo` = 1)");
         }
         if ( AV38Estadowwds_4_tfestadoactivo_sel == 2 )
         {
            AddWhere(sWhereString, "(T1.`EstadoActivo` = 0)");
         }
         if ( ( AV12OrderedBy == 1 ) && ! AV13OrderedDsc )
         {
            sOrderString += " ORDER BY T1.`EstadoDescripcion`";
         }
         else if ( ( AV12OrderedBy == 1 ) && ( AV13OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.`EstadoDescripcion` DESC";
         }
         else if ( ( AV12OrderedBy == 2 ) && ! AV13OrderedDsc )
         {
            sOrderString += " ORDER BY T1.`EstadoActivo`";
         }
         else if ( ( AV12OrderedBy == 2 ) && ( AV13OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.`EstadoActivo` DESC";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY T1.`EstadoID`";
         }
                                             ...
                                             bool AV13OrderedDsc )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM (`Estado` T1 INNER JOIN `Pais` T2 ON T2.`PaisID` = T1.`PaisID`)";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV35Estadowwds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( T1.`EstadoDescripcion` like CONCAT('%', @lV35Estadowwds_1_filterfulltext)))");
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H001B2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (string)dynConstraints[4] , (bool)dynConstraints[5] , (short)dynConstraints[6] , (bool)dynConstraints[7] );
               case 1 :
                     return conditional_H001B3(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (string)dynConstraints[4] , (bool)dynConstraints[5] , (short)dynConstraints[6] , (bool)dynConstraints[7] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV35Estadowwds_1_filterfulltext",GXType.Char,100,0) ,
          new ParDef("@lV36Estadowwds_2_tfestadodescripcion",GXType.Char,80,0) ,
          new ParDef("@AV37Estadowwds_3_tfestadodescripcion_sel",GXType.Char,80,0) ,
