...
namespace GeneXus.Programs {
   public class wpdetallepromocionadminpromocionmodelowc : GXWebComponent
   {
      public wpdetallepromocionadminpromocionmodelowc( )
      {
      ...
      public wpdetallepromocionadminpromocionmodelowc( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         ajax_req_read_hidden_sdt(GetNextPar( ), AV28TFModeloSegmento_Sels);
         sPrefix = GetPar( "sPrefix");
         ...
         gxgrGrid_refresh( subGrid_Rows, AV13OrderedBy, AV14OrderedDsc, AV15FilterFullText, AV7PromocionID, AV19ManageFiltersExecutionStep, AV30Pgmname, AV28TFModeloSegmento_Sels, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV30Pgmname = "WPDetallePromocionAdminPromocionModeloWC";
               WS3O2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "WPDetalle Promocion Admin Promocion Modelo WC", "")) ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "wpdetallepromocionadminpromocionmodelowc.aspx"+UrlEncode(StringUtil.LTrimStr(AV7PromocionID,9,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wpdetallepromocionadminpromocionmodelowc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"vTFMODELOSEGMENTO_SELS", AV28TFModeloSegmento_Sels);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt(sPrefix+"vTFMODELOSEGMENTO_SELS", AV28TFModeloSegmento_Sels);
         }
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFMODELOSEGMENTO_SELSJSON", AV27TFModeloSegmento_SelsJson);
      ...
      {
         return "WPDetallePromocionAdminPromocionModeloWC" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "WPDetalle Promocion Admin Promocion Modelo WC", "") ;
      }
      ...
      protected void WB3O0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "wpdetallepromocionadminpromocionmodelowc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            GxWebStd.gx_single_line_edit( context, edtavFilterfulltext_Internalname, AV15FilterFullText, StringUtil.RTrim( context.localUtil.Format( AV15FilterFullText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,29);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", context.GetMessage( "WWP_Search", ""), edtavFilterfulltext_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavFilterfulltext_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "WorkWithPlus_Web\\WWPFullTextFilter", "start", true, "", "HLP_WPDetallePromocionAdminPromocionModeloWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START3O2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "WPDetalle Promocion Admin Promocion Modelo WC", ""), 0) ;
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wpdetallepromocionadminpromocionmodelowc.aspx")), "wpdetallepromocionadminpromocionmodelowc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wpdetallepromocionadminpromocionmodelowc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       string AV30Pgmname ,
                                       GxSimpleCollection<string> AV28TFModeloSegmento_Sels ,
                                       string sPrefix )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_PROMOCIONMODELOID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A48PromocionModeloID), "ZZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"PROMOCIONMODELOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A48PromocionModeloID), 9, 0, ".", "")));
      }
      ...
      protected int subGridclient_rec_count_fnc( )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              A25ModeloSegmento ,
                                              AV28TFModeloSegmento_Sels ,
                                              AV28TFModeloSegmento_Sels.Count ,
                                              AV13OrderedBy ,
                                              AV14OrderedDsc ,
                                              AV15FilterFullText ,
                                              ...
                                              A41PromocionID } ,
                                              new int[]{
                                              TypeConstants.INT, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.DECIMAL, TypeConstants.INT, TypeConstants.INT
                                              }
         });
         /* Using cursor H003O2 */
         ...
         {
            A41PromocionID = H003O2_A41PromocionID[0];
            AssignAttri(sPrefix, false, "A41PromocionID", StringUtil.LTrimStr( (decimal)(A41PromocionID), 9, 0));
            A49PromocionModeloPrecio = H003O2_A49PromocionModeloPrecio[0];
            A25ModeloSegmento = H003O2_A25ModeloSegmento[0];
            A23ModeloDescripcion = H003O2_A23ModeloDescripcion[0];
            A22ModeloID = H003O2_A22ModeloID[0];
            A48PromocionModeloID = H003O2_A48PromocionModeloID[0];
            A25ModeloSegmento = H003O2_A25ModeloSegmento[0];
            A23ModeloDescripcion = H003O2_A23ModeloDescripcion[0];
            if ( String.IsNullOrEmpty(StringUtil.RTrim( AV15FilterFullText)) || ( ( StringUtil.Like( A23ModeloDescripcion , StringUtil.PadR( "%" + AV15FilterFullText , 101 , "%"),  ' ' ) ) || ( StringUtil.Like( context.GetMessage( "auto", "") , StringUtil.PadR( "%" + StringUtil.Lower( AV15FilterFullText) , 255 , "%"),  ' ' ) && ( StringUtil.StrCmp(A25ModeloSegmento, "AUTO") == 0 ) ) || ( StringUtil.Like( context.GetMessage( "camioneta", "") , StringUtil.PadR( "%" + StringUtil.Lower( AV15FilterFullText) , 255 , "%"),  ' ' ) && ( StringUtil.StrCmp(A25ModeloSegmento, "CAMIONETA") == 0 ) ) || ( StringUtil.Like( context.GetMessage( "camión", "") , StringUtil.PadR( "%" + StringUtil.Lower( AV15FilterFullText) , 255 , "%"),  ' ' ) && ( StringUtil.StrCmp(A25ModeloSegmento, "CAMIÓN") == 0 ) ) || ( StringUtil.Like( context.GetMessage( "agrícola", "") , StringUtil.PadR( "%" + StringUtil.Lower( AV15FilterFullText) , 255 , "%"),  ' ' ) && ( StringUtil.StrCmp(A25ModeloSegmento, "AGRÍCOLA") == 0 ) ) || ( StringUtil.Like( context.GetMessage( "industrial", "") , StringUtil.PadR( "%" + StringUtil.Lower( AV15FilterFullText) , 255 , "%"),  ' ' ) && ( StringUtil.StrCmp(A25ModeloSegmento, "INDUSTRIAL") == 0 ) ) || ( StringUtil.Like( context.GetMessage( "otr", "") , StringUtil.PadR( "%" + StringUtil.Lower( AV15FilterFullText) , 255 , "%"),  ' ' ) && ( StringUtil.StrCmp(A25ModeloSegmento, "OTR") == 0 ) ) || ( StringUtil.Like( StringUtil.Str( A49PromocionModeloPrecio, 10, 2) , StringUtil.PadR( "%" + AV15FilterFullText , 254 , "%"),  ' ' ) ) ) )
            {
      ...
      protected void RF3O2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A41PromocionID = H003O3_A41PromocionID[0];
               AssignAttri(sPrefix, false, "A41PromocionID", StringUtil.LTrimStr( (decimal)(A41PromocionID), 9, 0));
               A49PromocionModeloPrecio = H003O3_A49PromocionModeloPrecio[0];
               A25ModeloSegmento = H003O3_A25ModeloSegmento[0];
               A23ModeloDescripcion = H003O3_A23ModeloDescripcion[0];
               A22ModeloID = H003O3_A22ModeloID[0];
               A48PromocionModeloID = H003O3_A48PromocionModeloID[0];
               A25ModeloSegmento = H003O3_A25ModeloSegmento[0];
               A23ModeloDescripcion = H003O3_A23ModeloDescripcion[0];
               if ( String.IsNullOrEmpty(StringUtil.RTrim( AV15FilterFullText)) || ( ( StringUtil.Like( A23ModeloDescripcion , StringUtil.PadR( "%" + AV15FilterFullText , 101 , "%"),  ' ' ) ) || ( StringUtil.Like( context.GetMessage( "auto", "") , StringUtil.PadR( "%" + StringUtil.Lower( AV15FilterFullText) , 255 , "%"),  ' ' ) && ( StringUtil.StrCmp(A25ModeloSegmento, "AUTO") == 0 ) ) || ( StringUtil.Like( context.GetMessage( "camioneta", "") , StringUtil.PadR( "%" + StringUtil.Lower( AV15FilterFullText) , 255 , "%"),  ' ' ) && ( StringUtil.StrCmp(A25ModeloSegmento, "CAMIONETA") == 0 ) ) || ( StringUtil.Like( context.GetMessage( "camión", "") , StringUtil.PadR( "%" + StringUtil.Lower( AV15FilterFullText) , 255 , "%"),  ' ' ) && ( StringUtil.StrCmp(A25ModeloSegmento, "CAMIÓN") == 0 ) ) || ( StringUtil.Like( context.GetMessage( "agrícola", "") , StringUtil.PadR( "%" + StringUtil.Lower( AV15FilterFullText) , 255 , "%"),  ' ' ) && ( StringUtil.StrCmp(A25ModeloSegmento, "AGRÍCOLA") == 0 ) ) || ( StringUtil.Like( context.GetMessage( "industrial", "") , StringUtil.PadR( "%" + StringUtil.Lower( AV15FilterFullText) , 255 , "%"),  ' ' ) && ( StringUtil.StrCmp(A25ModeloSegmento, "INDUSTRIAL") == 0 ) ) || ( StringUtil.Like( context.GetMessage( "otr", "") , StringUtil.PadR( "%" + StringUtil.Lower( AV15FilterFullText) , 255 , "%"),  ' ' ) && ( StringUtil.StrCmp(A25ModeloSegmento, "OTR") == 0 ) ) || ( StringUtil.Like( StringUtil.Str( A49PromocionModeloPrecio, 10, 2) , StringUtil.PadR( "%" + AV15FilterFullText , 254 , "%"),  ' ' ) ) ) )
               {
      ...
      protected void send_integrity_lvl_hashes3O2( )
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"vPGMNAME", StringUtil.RTrim( AV30Pgmname));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vPGMNAME", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV30Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_PROMOCIONMODELOID"+"_"+sGXsfl_35_idx, GetSecureSignedToken( sPrefix+sGXsfl_35_idx, context.localUtil.Format( (decimal)(A48PromocionModeloID), "ZZZZZZZZ9"), context));
      }
      ...
      protected void E173O2( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_getappliedfiltersdescription(context ).execute(  AV30Pgmname, out  GXt_char2) ;
      ...
      protected void E143O2( )
      {
         ...
         {
            if ( StringUtil.StrCmp(Ddo_grid_Selectedcolumn, "ModeloSegmento") == 0 )
            {
               AV27TFModeloSegmento_SelsJson = Ddo_grid_Selectedvalue_get;
               AssignAttri(sPrefix, false, "AV27TFModeloSegmento_SelsJson", AV27TFModeloSegmento_SelsJson);
               AV28TFModeloSegmento_Sels.FromJSonString(AV27TFModeloSegmento_SelsJson, null);
            }
            subgrid_firstpage( ) ;
         }
         /*  Sending Event outputs  */
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, "AV28TFModeloSegmento_Sels", AV28TFModeloSegmento_Sels);
      }
      ...
      protected void E113O2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("WPDetallePromocionAdminPromocionModeloWCFilters")) + "," + UrlEncode(StringUtil.RTrim(AV30Pgmname+"GridState"));
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Manage#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.managefilters.aspx"+UrlEncode(StringUtil.RTrim("WPDetallePromocionAdminPromocionModeloWCFilters"));
         ...
         else
         {
            ...
            new WorkWithPlus.workwithplus_web.getfilterbyname(context ).execute(  "WPDetallePromocionAdminPromocionModeloWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char2) ;
            ...
            else
            {
               ...
               new WorkWithPlus.workwithplus_web.savegridstate(context ).execute(  AV30Pgmname+"GridState",  AV18ManageFiltersXml) ;
      ...
      protected void E153O2( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wpagregarmodelopromo.aspx"+UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode(StringUtil.LTrimStr(0,1,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV7PromocionID,9,0));
         context.PopUp(formatLink("wpagregarmodelopromo.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey), new Object[] {});
         context.DoAjaxRefreshCmp(sPrefix);
         /*  Sending Event outputs  */
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, "AV17ManageFiltersData", AV17ManageFiltersData);
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, "AV11GridState", AV11GridState);
      ...
      protected void S112( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_managefiltersloadsavedfilters(context ).execute(  "WPDetallePromocionAdminPromocionModeloWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item3) ;
      ...
      protected void S162( )
      {
         ...
         AV15FilterFullText = "";
         AssignAttri(sPrefix, false, "AV15FilterFullText", AV15FilterFullText);
         AV28TFModeloSegmento_Sels = (GxSimpleCollection<string>)(new GxSimpleCollection<string>());
      ...
      protected void S182( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wpagregarmodelopromo.aspx"+UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode(StringUtil.LTrimStr(A48PromocionModeloID,9,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV7PromocionID,9,0));
         context.PopUp(formatLink("wpagregarmodelopromo.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey), new Object[] {});
         context.DoAjaxRefreshCmp(sPrefix);
      }
      ...
      protected void S192( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wpagregarmodelopromo.aspx"+UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode(StringUtil.LTrimStr(A48PromocionModeloID,9,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV7PromocionID,9,0));
         context.PopUp(formatLink("wpagregarmodelopromo.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey), new Object[] {});
         context.DoAjaxRefreshCmp(sPrefix);
      }
      ...
      protected void S132( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV16Session.Get(AV30Pgmname+"GridState"), "") == 0 )
         {
            AV11GridState.FromXml(new WorkWithPlus.workwithplus_web.loadgridstate(context).executeUdp(  AV30Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV11GridState.FromXml(AV16Session.Get(AV30Pgmname+"GridState"), null, "", "");
         }
         AV13OrderedBy = AV11GridState.gxTpr_Orderedby;
         AssignAttri(sPrefix, false, "AV13OrderedBy", StringUtil.LTrimStr( (decimal)(AV13OrderedBy), 4, 0));
         AV14OrderedDsc = AV11GridState.gxTpr_Ordereddsc;
      ...
      protected void S172( )
      {
         ...
         returnInSub = false;
         AV31GXV1 = 1;
         while ( AV31GXV1 <= AV11GridState.gxTpr_Filtervalues.Count )
         {
            AV12GridStateFilterValue = ((WorkWithPlus.workwithplus_web.SdtWWPGridState_FilterValue)AV11GridState.gxTpr_Filtervalues.Item(AV31GXV1));
            if ( StringUtil.StrCmp(AV12GridStateFilterValue.gxTpr_Name, "FILTERFULLTEXT") == 0 )
            {
               AV15FilterFullText = AV12GridStateFilterValue.gxTpr_Value;
               AssignAttri(sPrefix, false, "AV15FilterFullText", AV15FilterFullText);
            }
            else if ( StringUtil.StrCmp(AV12GridStateFilterValue.gxTpr_Name, "TFMODELOSEGMENTO_SEL") == 0 )
            {
               AV27TFModeloSegmento_SelsJson = AV12GridStateFilterValue.gxTpr_Value;
               AssignAttri(sPrefix, false, "AV27TFModeloSegmento_SelsJson", AV27TFModeloSegmento_SelsJson);
               AV28TFModeloSegmento_Sels.FromJSonString(AV27TFModeloSegmento_SelsJson, null);
            }
         ...
         GXt_char2 = "";
         new WorkWithPlus.workwithplus_web.wwp_getfilterval(context ).execute(  (AV28TFModeloSegmento_Sels.Count==0),  AV27TFModeloSegmento_SelsJson, out  GXt_char2) ;
      ...
      protected void S152( )
      {
         ...
         AV29AuxText = ((AV28TFModeloSegmento_Sels.Count==1) ? "["+AV28TFModeloSegmento_Sels.GetString(1)+"]" : context.GetMessage( "WWP_FilterValueDescription_MultipleValues", ""));
         new WorkWithPlus.workwithplus_web.wwp_gridstateaddfiltervalue(context ).execute( ref  AV11GridState,  "TFMODELOSEGMENTO_SEL",  context.GetMessage( "Segmento", ""),  !(AV28TFModeloSegmento_Sels.Count==0),  0,  AV28TFModeloSegmento_Sels.ToJSonString(false),  ((StringUtil.StrCmp(AV29AuxText, "")==0) ? "" : StringUtil.StringReplace( StringUtil.StringReplace( StringUtil.StringReplace( StringUtil.StringReplace( StringUtil.StringReplace( StringUtil.StringReplace( AV29AuxText, "[AUTO]", context.GetMessage( "AUTO", "")), "[CAMIONETA]", context.GetMessage( "CAMIONETA", "")), "[CAMIÓN]", context.GetMessage( "CAMIÓN", "")), "[AGRÍCOLA]", context.GetMessage( "AGRÍCOLA", "")), "[INDUSTRIAL]", context.GetMessage( "INDUSTRIAL", "")), "[OTR]", context.GetMessage( "OTR", ""))),  false,  "",  "") ;
         AV11GridState.gxTpr_Pagesize = StringUtil.Str( (decimal)(subGrid_Rows), 10, 0);
         new WorkWithPlus.workwithplus_web.savegridstate(context ).execute(  AV30Pgmname+"GridState",  AV11GridState.ToXml(false, true, "", "")) ;
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "wpdetallepromocionadminpromocionmodelowc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202651111305584", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wpdetallepromocionadminpromocionmodelowc.js", "?202651111305585", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_352( )
      {
         ...
         edtModeloDescripcion_Internalname = sPrefix+"MODELODESCRIPCION_"+sGXsfl_35_idx;
         cmbModeloSegmento_Internalname = sPrefix+"MODELOSEGMENTO_"+sGXsfl_35_idx;
      ...
      protected void SubsflControlProps_fel_352( )
      {
         ...
         edtModeloDescripcion_Internalname = sPrefix+"MODELODESCRIPCION_"+sGXsfl_35_fel_idx;
         cmbModeloSegmento_Internalname = sPrefix+"MODELOSEGMENTO_"+sGXsfl_35_fel_idx;
      ...
      protected void sendrow_352( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_35_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GXCCtl = "MODELOSEGMENTO_" + sGXsfl_35_idx;
            ...
            AssignProp(sPrefix, false, cmbModeloSegmento_Internalname, "Values", (string)(cmbModeloSegmento.ToJavascriptSource()), !bGXsfl_35_Refreshing);
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      protected void init_default_properties( )
      {
         ...
         cmbModeloSegmento_Internalname = sPrefix+"MODELOSEGMENTO";
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Datalistfixedvalues = "|AUTO:AUTO,CAMIONETA:CAMIONETA,CAMIÓN:CAMIÓN,AGRÍCOLA:AGRÍCOLA,INDUSTRIAL:INDUSTRIAL,OTR:OTR|";
         Ddo_grid_Allowmultipleselection = "|T|";
         Ddo_grid_Datalisttype = "|FixedValues|";
         Ddo_grid_Includedatalist = "|T|";
         Ddo_grid_Includesortasc = "T";
         Ddo_grid_Columnssortvalues = "2|3|1";
         Ddo_grid_Columnids = "2:ModeloDescripcion|3:ModeloSegmento|4:PromocionModeloPrecio";
         Ddo_grid_Gridinternalname = "";
         Gridpaginationbar_Rowsperpagecaption = "WWP_PagingRowsPerPage";
         Gridpaginationbar_Emptygridcaption = "Esta promoción no tiene Modelos asignados";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E123O2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV7PromocionID","fld":"vPROMOCIONID","pic":"ZZZZZZZZ9"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV30Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV28TFModeloSegmento_Sels","fld":"vTFMODELOSEGMENTO_SELS"},{"av":"sPrefix"},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","""{"handler":"E133O2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV7PromocionID","fld":"vPROMOCIONID","pic":"ZZZZZZZZ9"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV30Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV28TFModeloSegmento_Sels","fld":"vTFMODELOSEGMENTO_SELS"},{"av":"sPrefix"},{"av":"Gridpaginationbar_Rowsperpageselectedvalue","ctrl":"GRIDPAGINATIONBAR","prop":"RowsPerPageSelectedValue"}]""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",""","oparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]}""");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","""{"handler":"E143O2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV7PromocionID","fld":"vPROMOCIONID","pic":"ZZZZZZZZ9"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV30Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV28TFModeloSegmento_Sels","fld":"vTFMODELOSEGMENTO_SELS"},{"av":"sPrefix"},{"av":"Ddo_grid_Activeeventkey","ctrl":"DDO_GRID","prop":"ActiveEventKey"},{"av":"Ddo_grid_Selectedvalue_get","ctrl":"DDO_GRID","prop":"SelectedValue_get"},{"av":"Ddo_grid_Selectedcolumn","ctrl":"DDO_GRID","prop":"SelectedColumn"}]""");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED",""","oparms":[{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV27TFModeloSegmento_SelsJson","fld":"vTFMODELOSEGMENTO_SELSJSON"},{"av":"AV28TFModeloSegmento_Sels","fld":"vTFMODELOSEGMENTO_SELS"},{"av":"Ddo_grid_Sortedstatus","ctrl":"DDO_GRID","prop":"SortedStatus"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E183O2","iparms":[]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"cmbavGridactions"},{"av":"AV26GridActions","fld":"vGRIDACTIONS","pic":"ZZZ9"}]}""");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","""{"handler":"E113O2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV7PromocionID","fld":"vPROMOCIONID","pic":"ZZZZZZZZ9"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV30Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV28TFModeloSegmento_Sels","fld":"vTFMODELOSEGMENTO_SELS"},{"av":"sPrefix"},{"av":"Ddo_managefilters_Activeeventkey","ctrl":"DDO_MANAGEFILTERS","prop":"ActiveEventKey"},{"av":"AV11GridState","fld":"vGRIDSTATE"},{"av":"AV27TFModeloSegmento_SelsJson","fld":"vTFMODELOSEGMENTO_SELSJSON"}]""");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED",""","oparms":[{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV11GridState","fld":"vGRIDSTATE"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV28TFModeloSegmento_Sels","fld":"vTFMODELOSEGMENTO_SELS"},{"av":"Ddo_grid_Selectedvalue_set","ctrl":"DDO_GRID","prop":"SelectedValue_set"},{"av":"Ddo_grid_Sortedstatus","ctrl":"DDO_GRID","prop":"SortedStatus"},{"av":"AV27TFModeloSegmento_SelsJson","fld":"vTFMODELOSEGMENTO_SELSJSON"},{"av":"AV23GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV24GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV25GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV17ManageFiltersData","fld":"vMANAGEFILTERSDATA"}]}""");
         setEventMetadata("VGRIDACTIONS.CLICK","""{"handler":"E193O2","iparms":[{"av":"cmbavGridactions"},{"av":"AV26GridActions","fld":"vGRIDACTIONS","pic":"ZZZ9"},{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV7PromocionID","fld":"vPROMOCIONID","pic":"ZZZZZZZZ9"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV30Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV28TFModeloSegmento_Sels","fld":"vTFMODELOSEGMENTO_SELS"},{"av":"sPrefix"},{"av":"A48PromocionModeloID","fld":"PROMOCIONMODELOID","pic":"ZZZZZZZZ9","hsh":true}]""");
         ...
         setEventMetadata("'DOUSERACTION1'","""{"handler":"E153O2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV7PromocionID","fld":"vPROMOCIONID","pic":"ZZZZZZZZ9"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV30Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV28TFModeloSegmento_Sels","fld":"vTFMODELOSEGMENTO_SELS"},{"av":"sPrefix"},{"av":"A48PromocionModeloID","fld":"PROMOCIONMODELOID","pic":"ZZZZZZZZ9","hsh":true}]""");
         ...
         setEventMetadata("VALID_PROMOCIONMODELOPRECIO","""{"handler":"Valid_Promocionmodeloprecio","iparms":[]}""");
      ...
      public override void initialize( )
      {
         ...
         AV15FilterFullText = "";
         AV30Pgmname = "";
         AV28TFModeloSegmento_Sels = new GxSimpleCollection<string>();
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         GXKey = "";
         ...
         GXDecQS = "";
         lV15FilterFullText = "";
         H003O2_A41PromocionID = new int[1] ;
         H003O2_A49PromocionModeloPrecio = new decimal[1] ;
         H003O2_A25ModeloSegmento = new string[] {""} ;
         H003O2_A23ModeloDescripcion = new string[] {""} ;
         H003O2_A22ModeloID = new int[1] ;
         H003O2_A48PromocionModeloID = new int[1] ;
         H003O3_A41PromocionID = new int[1] ;
         H003O3_A49PromocionModeloPrecio = new decimal[1] ;
         H003O3_A25ModeloSegmento = new string[] {""} ;
         H003O3_A23ModeloDescripcion = new string[] {""} ;
         H003O3_A22ModeloID = new int[1] ;
         H003O3_A48PromocionModeloID = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wpdetallepromocionadminpromocionmodelowc__default(),
            new Object[][] {
                new Object[] {
               H003O2_A41PromocionID, H003O2_A49PromocionModeloPrecio, H003O2_A25ModeloSegmento, H003O2_A23ModeloDescripcion, H003O2_A22ModeloID, H003O2_A48PromocionModeloID
               }
               , new Object[] {
               H003O3_A41PromocionID, H003O3_A49PromocionModeloPrecio, H003O3_A25ModeloSegmento, H003O3_A23ModeloDescripcion, H003O3_A22ModeloID, H003O3_A48PromocionModeloID
               }
            }
         );
         AV30Pgmname = "WPDetallePromocionAdminPromocionModeloWC";
      ...
      private int AV28TFModeloSegmento_Sels_Count ;
      ...
      private string AV27TFModeloSegmento_SelsJson ;
      ...
      private GxSimpleCollection<string> AV28TFModeloSegmento_Sels ;
      ...
      private int[] H003O2_A41PromocionID ;
      private decimal[] H003O2_A49PromocionModeloPrecio ;
      private string[] H003O2_A25ModeloSegmento ;
      private string[] H003O2_A23ModeloDescripcion ;
      private int[] H003O2_A22ModeloID ;
      private int[] H003O2_A48PromocionModeloID ;
      private int[] H003O3_A41PromocionID ;
      private decimal[] H003O3_A49PromocionModeloPrecio ;
      private string[] H003O3_A25ModeloSegmento ;
      private string[] H003O3_A23ModeloDescripcion ;
      private int[] H003O3_A22ModeloID ;
      private int[] H003O3_A48PromocionModeloID ;
   ...
   public class wpdetallepromocionadminpromocionmodelowc__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H003O2( IGxContext context ,
                                             string A25ModeloSegmento ,
                                             GxSimpleCollection<string> AV28TFModeloSegmento_Sels ,
                                             int AV28TFModeloSegmento_Sels_Count ,
                                             short AV13OrderedBy ,
                                             bool AV14OrderedDsc ,
                                             string AV15FilterFullText ,
                                             ...
                                             int A41PromocionID )
      {
         ...
         scmdbuf = "SELECT T1.`PromocionID`, T1.`PromocionModeloPrecio`, T2.`ModeloSegmento`, T2.`ModeloDescripcion`, T1.`ModeloID`, T1.`PromocionModeloID` FROM (`PromocionModelo` T1 INNER JOIN `Modelo` T2 ON T2.`ModeloID` = T1.`ModeloID`)";
         AddWhere(sWhereString, "(T1.`PromocionID` = @AV7PromocionID)");
         if ( AV28TFModeloSegmento_Sels_Count > 0 )
         {
            AddWhere(sWhereString, "("+new GxDbmsUtils( new GxSqlServer()).ValueList(AV28TFModeloSegmento_Sels, "T2.`ModeloSegmento` IN (", ")")+")");
         }
         scmdbuf += sWhereString;
         if ( ( AV13OrderedBy == 1 ) && ! AV14OrderedDsc )
         {
            scmdbuf += " ORDER BY T1.`PromocionID`, T1.`PromocionModeloPrecio`";
         }
         else if ( ( AV13OrderedBy == 1 ) && ( AV14OrderedDsc ) )
         {
            scmdbuf += " ORDER BY T1.`PromocionID` DESC, T1.`PromocionModeloPrecio` DESC";
         }
         else if ( ( AV13OrderedBy == 2 ) && ! AV14OrderedDsc )
         {
            scmdbuf += " ORDER BY T1.`PromocionID`, T2.`ModeloDescripcion`";
         }
         else if ( ( AV13OrderedBy == 2 ) && ( AV14OrderedDsc ) )
         {
            scmdbuf += " ORDER BY T1.`PromocionID` DESC, T2.`ModeloDescripcion` DESC";
         }
         else if ( ( AV13OrderedBy == 3 ) && ! AV14OrderedDsc )
         {
            scmdbuf += " ORDER BY T1.`PromocionID`, T2.`ModeloSegmento`";
         }
         else if ( ( AV13OrderedBy == 3 ) && ( AV14OrderedDsc ) )
         {
            scmdbuf += " ORDER BY T1.`PromocionID` DESC, T2.`ModeloSegmento` DESC";
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H003O2(context, (string)dynConstraints[0] , (GxSimpleCollection<string>)dynConstraints[1] , (int)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (decimal)dynConstraints[7] , (int)dynConstraints[8] , (int)dynConstraints[9] );
               case 1 :
                     return conditional_H003O3(context, (string)dynConstraints[0] , (GxSimpleCollection<string>)dynConstraints[1] , (int)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (decimal)dynConstraints[7] , (int)dynConstraints[8] , (int)dynConstraints[9] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H003O2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003O2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H003O3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003O3,11, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
