...
namespace GeneXus.Programs {
   public class wpagregarparticipanteloaddvcombo : GXProcedure
   {
      public wpagregarparticipanteloaddvcombo( )
      {
      ...
      public wpagregarparticipanteloaddvcombo( IGxContext context )
      {
      ...
      protected void S111( )
      {
         ...
         {
            A2EstadoDescripcion = P003Q2_A2EstadoDescripcion[0];
            A16PaisID = P003Q2_A16PaisID[0];
            A1EstadoID = P003Q2_A1EstadoID[0];
      ...
      protected void S121( )
      {
         ...
         {
            A5CiudadDescripcion = P003Q3_A5CiudadDescripcion[0];
            A1EstadoID = P003Q3_A1EstadoID[0];
            A4CiudadID = P003Q3_A4CiudadID[0];
            AV15Combo_DataItem = new WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item(context);
      ...
      public override void initialize( )
      {
         ...
         lV13SearchTxt = "";
         A2EstadoDescripcion = "";
         P003Q2_A2EstadoDescripcion = new string[] {""} ;
         P003Q2_A16PaisID = new int[1] ;
         P003Q2_A1EstadoID = new int[1] ;
         AV15Combo_DataItem = new WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item(context);
         AV14Combo_Data = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item>( context, "Item", "");
         A5CiudadDescripcion = "";
         P003Q3_A5CiudadDescripcion = new string[] {""} ;
         P003Q3_A1EstadoID = new int[1] ;
         P003Q3_A4CiudadID = new int[1] ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wpagregarparticipanteloaddvcombo__default(),
            new Object[][] {
                new Object[] {
               P003Q2_A2EstadoDescripcion, P003Q2_A16PaisID, P003Q2_A1EstadoID
               }
               , new Object[] {
               P003Q3_A5CiudadDescripcion, P003Q3_A1EstadoID, P003Q3_A4CiudadID
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P003Q2_A2EstadoDescripcion ;
      private int[] P003Q2_A16PaisID ;
      private int[] P003Q2_A1EstadoID ;
      ...
      private string[] P003Q3_A5CiudadDescripcion ;
      private int[] P003Q3_A1EstadoID ;
      private int[] P003Q3_A4CiudadID ;
      private string aP4_Combo_DataJson ;
   }

   public class wpagregarparticipanteloaddvcombo__default : DataStoreHelperBase, IDataStoreHelper
   {
      ...
      protected Object[] conditional_P003Q3( IGxContext context ,
                                             string AV13SearchTxt ,
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P003Q2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (int)dynConstraints[2] , (int)dynConstraints[3] );
               case 1 :
                     return conditional_P003Q3(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (int)dynConstraints[2] , (int)dynConstraints[3] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("P003Q3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP003Q3,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
