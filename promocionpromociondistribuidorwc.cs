...
namespace GeneXus.Programs {
   public class promocionpromociondistribuidorwc : GXWebComponent
   {
      public promocionpromociondistribuidorwc( )
      {
      ...
      public promocionpromociondistribuidorwc( IGxContext context )
      {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV27Pgmname = "PromocionPromocionDistribuidorWC";
               WS2F2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "Promocion Promocion Distribuidor WC", "")) ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "promocionpromociondistribuidorwc.aspx"+UrlEncode(StringUtil.LTrimStr(AV7PromocionID,9,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("promocionpromociondistribuidorwc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         return "PromocionPromocionDistribuidorWC" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Promocion Promocion Distribuidor WC", "") ;
      }
      ...
      protected void WB2F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "promocionpromociondistribuidorwc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            GxWebStd.gx_single_line_edit( context, edtavFilterfulltext_Internalname, AV15FilterFullText, StringUtil.RTrim( context.localUtil.Format( AV15FilterFullText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,29);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", context.GetMessage( "WWP_Search", ""), edtavFilterfulltext_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavFilterfulltext_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "WorkWithPlus_Web\\WWPFullTextFilter", "start", true, "", "HLP_PromocionPromocionDistribuidorWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START2F2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "Promocion Promocion Distribuidor WC", ""), 0) ;
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "promocionpromociondistribuidorwc.aspx")), "promocionpromociondistribuidorwc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "promocionpromociondistribuidorwc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void RF2F2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV15FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV15FilterFullText), "%", "");
            /* Using cursor H002F2 */
            pr_default.execute(0, new Object[] {AV7PromocionID, lV15FilterFullText, lV15FilterFullText, GXPagingFrom2, GXPagingTo2});
            nGXsfl_35_idx = 1;
            sGXsfl_35_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_35_idx), 4, 0), 4, "0");
            SubsflControlProps_352( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A41PromocionID = H002F2_A41PromocionID[0];
               AssignAttri(sPrefix, false, "A41PromocionID", StringUtil.LTrimStr( (decimal)(A41PromocionID), 9, 0));
               A10DistribuidorID = H002F2_A10DistribuidorID[0];
               A47PromocionDistribuidorID = H002F2_A47PromocionDistribuidorID[0];
               /* Execute user event: Grid.Load */
               E182F2 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV15FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV15FilterFullText), "%", "");
         /* Using cursor H002F3 */
         pr_default.execute(1, new Object[] {AV7PromocionID, lV15FilterFullText, lV15FilterFullText});
      ...
      protected void E112F2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("PromocionPromocionDistribuidorWCFilters")) + "," + UrlEncode(StringUtil.RTrim(AV27Pgmname+"GridState"));
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Manage#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.managefilters.aspx"+UrlEncode(StringUtil.RTrim("PromocionPromocionDistribuidorWCFilters"));
         ...
         else
         {
            ...
            new WorkWithPlus.workwithplus_web.getfilterbyname(context ).execute(  "PromocionPromocionDistribuidorWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char2) ;
      ...
      protected void E152F2( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "promociondistribuidor.aspx"+UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode(StringUtil.LTrimStr(0,1,0));
         CallWebObject(formatLink("promociondistribuidor.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
      ...
      protected void S112( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_managefiltersloadsavedfilters(context ).execute(  "PromocionPromocionDistribuidorWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item3) ;
      ...
      protected void S182( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "promociondistribuidor.aspx"+UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode(StringUtil.LTrimStr(A47PromocionDistribuidorID,9,0));
         CallWebObject(formatLink("promociondistribuidor.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S192( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "promociondistribuidor.aspx"+UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode(StringUtil.LTrimStr(A47PromocionDistribuidorID,9,0));
         CallWebObject(formatLink("promociondistribuidor.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
         context.wjLocDisableFrm = 1;
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "promocionpromociondistribuidorwc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202651111305433", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("promocionpromociondistribuidorwc.js", "?202651111305434", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "0:PromocionDistribuidorID|1:DistribuidorID";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E182F2","iparms":[]""");
         ...
         setEventMetadata("VGRIDACTIONS.CLICK","""{"handler":"E192F2","iparms":[{"av":"cmbavGridactions"},{"av":"AV26GridActions","fld":"vGRIDACTIONS","pic":"ZZZ9"},{"av":"A47PromocionDistribuidorID","fld":"PROMOCIONDISTRIBUIDORID","pic":"ZZZZZZZZ9"}]""");
         setEventMetadata("VGRIDACTIONS.CLICK",""","oparms":[{"av":"cmbavGridactions"},{"av":"AV26GridActions","fld":"vGRIDACTIONS","pic":"ZZZ9"},{"av":"A47PromocionDistribuidorID","fld":"PROMOCIONDISTRIBUIDORID","pic":"ZZZZZZZZ9"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E152F2","iparms":[{"av":"A47PromocionDistribuidorID","fld":"PROMOCIONDISTRIBUIDORID","pic":"ZZZZZZZZ9"}]""");
         setEventMetadata("'DOINSERT'",""","oparms":[{"av":"A47PromocionDistribuidorID","fld":"PROMOCIONDISTRIBUIDORID","pic":"ZZZZZZZZ9"}]}""");
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         lV15FilterFullText = "";
         H002F2_A41PromocionID = new int[1] ;
         H002F2_A10DistribuidorID = new int[1] ;
         H002F2_A47PromocionDistribuidorID = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.promocionpromociondistribuidorwc__default(),
            new Object[][] {
                new Object[] {
               H002F2_A41PromocionID, H002F2_A10DistribuidorID, H002F2_A47PromocionDistribuidorID
               }
               , new Object[] {
      ...
      private int[] H002F2_A41PromocionID ;
      private int[] H002F2_A10DistribuidorID ;
      private int[] H002F2_A47PromocionDistribuidorID ;
   ...
   public class promocionpromociondistribuidorwc__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H002F2( IGxContext context ,
                                             string AV15FilterFullText ,
                                             int A47PromocionDistribuidorID ,
                                             ...
                                             int A41PromocionID )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " `PromocionID`, `DistribuidorID`, `PromocionDistribuidorID`";
         sFromString = " FROM `PromocionDistribuidor`";
         sOrderString = "";
         AddWhere(sWhereString, "(`PromocionID` = @AV7PromocionID)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV15FilterFullText)) )
         {
            AddWhere(sWhereString, "(( (LPAD(REPLACE(FORMAT(`PromocionDistribuidorID`,0), ',', ''), 9, ' ')) like CONCAT('%', @lV15FilterFullText)) or ( (LPAD(REPLACE(FORMAT(`DistribuidorID`,0), ',', ''), 9, ' ')) like CONCAT('%', @lV15FilterFullText)))");
         }
         else
         {
            GXv_int4[1] = 1;
         ...
         {
            sOrderString += " ORDER BY `PromocionID`, `PromocionDistribuidorID`";
         }
         else if ( ( AV13OrderedBy == 1 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY `PromocionID` DESC, `PromocionDistribuidorID` DESC";
         }
         else if ( ( AV13OrderedBy == 2 ) && ! AV14OrderedDsc )
         {
            sOrderString += " ORDER BY `PromocionID`, `DistribuidorID`";
         }
         else if ( ( AV13OrderedBy == 2 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY `PromocionID` DESC, `DistribuidorID` DESC";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY `PromocionDistribuidorID`";
         }
                                             ...
                                             int A41PromocionID )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM `PromocionDistribuidor`";
         AddWhere(sWhereString, "(`PromocionID` = @AV7PromocionID)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV15FilterFullText)) )
         {
            AddWhere(sWhereString, "(( (LPAD(REPLACE(FORMAT(`PromocionDistribuidorID`,0), ',', ''), 9, ' ')) like CONCAT('%', @lV15FilterFullText)) or ( (LPAD(REPLACE(FORMAT(`DistribuidorID`,0), ',', ''), 9, ' ')) like CONCAT('%', @lV15FilterFullText)))");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H002F2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (int)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (int)dynConstraints[5] , (int)dynConstraints[6] );
               case 1 :
                     return conditional_H002F3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (int)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (int)dynConstraints[5] , (int)dynConstraints[6] );
         }
