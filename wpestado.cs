...
namespace GeneXus.Programs {
   public class wpestado : GXDataArea
   {
      public wpestado( )
      {
      ...
      public wpestado( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV37PaisID = (int)(Math.Round(NumberUtil.Val( GetPar( "PaisID"), "."), 18, MidpointRounding.ToEven));
         ...
         AV28TFEstadoDescripcion = GetPar( "TFEstadoDescripcion");
         AV29TFEstadoDescripcion_Sel = GetPar( "TFEstadoDescripcion_Sel");
         AV30TFEstadoActivo_Sel = (short)(Math.Round(NumberUtil.Val( GetPar( "TFEstadoActivo_Sel"), "."), 18, MidpointRounding.ToEven));
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         {
            GxWebError = 1;
         ...
         gxgrGrid_refresh( subGrid_Rows, AV12OrderedBy, AV13OrderedDsc, AV15FilterFullText, AV37PaisID, AV23ManageFiltersExecutionStep, AV18ColumnsSelector, AV39Pgmname, AV28TFEstadoDescripcion, AV29TFEstadoDescripcion_Sel, AV30TFEstadoActivo_Sel) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "wpestado.aspx"+UrlEncode(StringUtil.LTrimStr(AV37PaisID,9,0));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wpestado.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPAISID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV37PaisID), 9, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vPAISID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV37PaisID), "ZZZZZZZZ9"), context));
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV39Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV39Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "vTFESTADODESCRIPCION", AV28TFEstadoDescripcion);
         GxWebStd.gx_hidden_field( context, "vTFESTADODESCRIPCION_SEL", AV29TFEstadoDescripcion_Sel);
         GxWebStd.gx_hidden_field( context, "vTFESTADOACTIVO_SEL", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV30TFEstadoActivo_Sel), 1, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wpestado.aspx"+UrlEncode(StringUtil.LTrimStr(AV37PaisID,9,0));
         return formatLink("wpestado.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }
      ...
      protected void WB150( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavFilterfulltext_Internalname, AV15FilterFullText, StringUtil.RTrim( context.localUtil.Format( AV15FilterFullText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,28);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", context.GetMessage( "WWP_Search", ""), edtavFilterfulltext_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavFilterfulltext_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "WorkWithPlus_Web\\WWPFullTextFilter", "start", true, "", "HLP_WPEstado.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 18), "VGRIDACTIONS.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 18), "VGRIDACTIONS.CLICK") == 0 ) )
                           {
                              ...
                              AV36GridActions = (short)(Math.Round(NumberUtil.Val( cgiGet( cmbavGridactions_Internalname), "."), 18, MidpointRounding.ToEven));
                              AssignAttri("", false, cmbavGridactions_Internalname, StringUtil.LTrimStr( (decimal)(AV36GridActions), 4, 0));
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 sEvt = StringUtil.Left( sEvt, (short)(StringUtil.Len( sEvt)-1));
      ...
      protected void PA152( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wpestado.aspx")), "wpestado.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wpestado.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV37PaisID = (int)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
                     AssignAttri("", false, "AV37PaisID", StringUtil.LTrimStr( (decimal)(AV37PaisID), 9, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vPAISID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV37PaisID), "ZZZZZZZZ9"), context));
                  }
                  if ( toggleJsOutput )
                  {
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       string AV39Pgmname ,
                                       string AV28TFEstadoDescripcion ,
                                       string AV29TFEstadoDescripcion_Sel ,
                                       short AV30TFEstadoActivo_Sel )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_ESTADOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(A1EstadoID), "ZZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "ESTADOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A1EstadoID), 9, 0, ".", "")));
      }
      ...
      protected void RF152( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 AV40Wpestadods_1_filterfulltext ,
                                                 AV42Wpestadods_3_tfestadodescripcion_sel ,
                                                 AV41Wpestadods_2_tfestadodescripcion ,
                                                 AV43Wpestadods_4_tfestadoactivo_sel ,
                                                 A2EstadoDescripcion ,
                                                 A3EstadoActivo ,
                                                 AV12OrderedBy ,
                                                 AV13OrderedDsc ,
            ...
            lV40Wpestadods_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV40Wpestadods_1_filterfulltext), "%", "");
            lV41Wpestadods_2_tfestadodescripcion = StringUtil.Concat( StringUtil.RTrim( AV41Wpestadods_2_tfestadodescripcion), "%", "");
            /* Using cursor H00152 */
            pr_default.execute(0, new Object[] {AV37PaisID, lV40Wpestadods_1_filterfulltext, lV41Wpestadods_2_tfestadodescripcion, AV42Wpestadods_3_tfestadodescripcion_sel, GXPagingFrom2, GXPagingTo2});
            nGXsfl_37_idx = 1;
            sGXsfl_37_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_37_idx), 4, 0), 4, "0");
            SubsflControlProps_372( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A3EstadoActivo = H00152_A3EstadoActivo[0];
               A2EstadoDescripcion = H00152_A2EstadoDescripcion[0];
               A16PaisID = H00152_A16PaisID[0];
               A1EstadoID = H00152_A1EstadoID[0];
               /* Execute user event: Grid.Load */
               E19152 ();
      ...
      protected void send_integrity_lvl_hashes152( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV39Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV39Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_ESTADOID"+"_"+sGXsfl_37_idx, GetSecureSignedToken( sGXsfl_37_idx, context.localUtil.Format( (decimal)(A1EstadoID), "ZZZZZZZZ9"), context));
      }
      ...
      {
         AV40Wpestadods_1_filterfulltext = AV15FilterFullText;
         AV41Wpestadods_2_tfestadodescripcion = AV28TFEstadoDescripcion;
         AV42Wpestadods_3_tfestadodescripcion_sel = AV29TFEstadoDescripcion_Sel;
         AV43Wpestadods_4_tfestadoactivo_sel = AV30TFEstadoActivo_Sel;
         ...
         lV41Wpestadods_2_tfestadodescripcion = StringUtil.Concat( StringUtil.RTrim( AV41Wpestadods_2_tfestadodescripcion), "%", "");
         /* Using cursor H00153 */
         pr_default.execute(1, new Object[] {AV37PaisID, lV40Wpestadods_1_filterfulltext, lV41Wpestadods_2_tfestadodescripcion, AV42Wpestadods_3_tfestadodescripcion_sel});
      ...
      protected void E17152( )
      {
         /* Start Routine */
         returnInSub = false;
         new obtienenombrepais(context ).execute(  AV37PaisID, out  AV38PaisDescripcion) ;
         subGrid_Rows = 10;
         GxWebStd.gx_hidden_field( context, "GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
         ...
         Form.Caption = context.GetMessage( "Estados del país: ", "")+StringUtil.NewLine( )+StringUtil.Trim( AV38PaisDescripcion);
      ...
      protected void E18152( )
      {
         ...
         if ( StringUtil.StrCmp(AV20Session.Get("WPEstadoColumnsSelector"), "") != 0 )
         {
            AV16ColumnsSelectorXML = AV20Session.Get("WPEstadoColumnsSelector");
         ...
         edtEstadoDescripcion_Visible = (((WorkWithPlus.workwithplus_web.SdtWWPColumnsSelector_Column)AV18ColumnsSelector.gxTpr_Columns.Item(1)).gxTpr_Isvisible ? 1 : 0);
         ...
         chkEstadoActivo.Visible = (((WorkWithPlus.workwithplus_web.SdtWWPColumnsSelector_Column)AV18ColumnsSelector.gxTpr_Columns.Item(2)).gxTpr_Isvisible ? 1 : 0);
         AssignProp("", false, chkEstadoActivo_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(chkEstadoActivo.Visible), 5, 0), !bGXsfl_37_Refreshing);
         ...
         new WorkWithPlus.workwithplus_web.wwp_getappliedfiltersdescription(context ).execute(  AV39Pgmname, out  GXt_char2) ;
      ...
      protected void E14152( )
      {
         ...
         {
            if ( StringUtil.StrCmp(Ddo_grid_Selectedcolumn, "EstadoDescripcion") == 0 )
            {
               AV28TFEstadoDescripcion = Ddo_grid_Filteredtext_get;
               AssignAttri("", false, "AV28TFEstadoDescripcion", AV28TFEstadoDescripcion);
               AV29TFEstadoDescripcion_Sel = Ddo_grid_Selectedvalue_get;
               AssignAttri("", false, "AV29TFEstadoDescripcion_Sel", AV29TFEstadoDescripcion_Sel);
            }
            else if ( StringUtil.StrCmp(Ddo_grid_Selectedcolumn, "EstadoActivo") == 0 )
            {
               AV30TFEstadoActivo_Sel = (short)(Math.Round(NumberUtil.Val( Ddo_grid_Selectedvalue_get, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV30TFEstadoActivo_Sel", StringUtil.Str( (decimal)(AV30TFEstadoActivo_Sel), 1, 0));
            }
            subgrid_firstpage( ) ;
         }
         /*  Sending Event outputs  */
      ...
      private void E19152( )
      {
         ...
         cmbavGridactions.addItem("3", StringUtil.Format( "%1;%2", context.GetMessage( "Ciudades", ""), "fas fa-city", "", "", "", "", "", "", ""), 0);
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 37;
         ...
         /*  Sending Event outputs  */
         cmbavGridactions.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV36GridActions), 4, 0));
      }
      ...
      protected void E15152( )
      {
         ...
         new WorkWithPlus.workwithplus_web.savecolumnsselectorstate(context ).execute(  "WPEstadoColumnsSelector",  (String.IsNullOrEmpty(StringUtil.RTrim( AV16ColumnsSelectorXML)) ? "" : AV18ColumnsSelector.ToXml(false, true, "", ""))) ;
      ...
      protected void E11152( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("WPEstadoFilters")) + "," + UrlEncode(StringUtil.RTrim(AV39Pgmname+"GridState"));
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Manage#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.managefilters.aspx"+UrlEncode(StringUtil.RTrim("WPEstadoFilters"));
         ...
         else
         {
            ...
            new WorkWithPlus.workwithplus_web.getfilterbyname(context ).execute(  "WPEstadoFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char2) ;
      ...
      protected void E16152( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wpagregarestado.aspx"+UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode(StringUtil.LTrimStr(0,1,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV37PaisID,9,0));
         context.PopUp(formatLink("wpagregarestado.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey), new Object[] {});
         context.DoAjaxRefresh();
         /*  Sending Event outputs  */
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV18ColumnsSelector", AV18ColumnsSelector);
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV21ManageFiltersData", AV21ManageFiltersData);
      ...
      protected void S162( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_columnsselector_add(context ).execute( ref  AV18ColumnsSelector,  "EstadoActivo",  "",  "Activo",  true,  "") ;
         GXt_char2 = AV17UserCustomValue;
         new WorkWithPlus.workwithplus_web.loadcolumnsselectorstate(context ).execute(  "WPEstadoColumnsSelector", out  GXt_char2) ;
      ...
      protected void S112( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_managefiltersloadsavedfilters(context ).execute(  "WPEstadoFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item3) ;
      ...
      protected void S172( )
      {
         ...
         AV15FilterFullText = "";
         AssignAttri("", false, "AV15FilterFullText", AV15FilterFullText);
         AV28TFEstadoDescripcion = "";
         AssignAttri("", false, "AV28TFEstadoDescripcion", AV28TFEstadoDescripcion);
         AV29TFEstadoDescripcion_Sel = "";
         AssignAttri("", false, "AV29TFEstadoDescripcion_Sel", AV29TFEstadoDescripcion_Sel);
         AV30TFEstadoActivo_Sel = 0;
         AssignAttri("", false, "AV30TFEstadoActivo_Sel", StringUtil.Str( (decimal)(AV30TFEstadoActivo_Sel), 1, 0));
      ...
      protected void S192( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wpagregarestado.aspx"+UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode(StringUtil.LTrimStr(A1EstadoID,9,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV37PaisID,9,0));
         context.PopUp(formatLink("wpagregarestado.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey), new Object[] {});
         context.DoAjaxRefresh();
      }
      ...
      protected void S202( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wpagregarestado.aspx"+UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode(StringUtil.LTrimStr(A1EstadoID,9,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV37PaisID,9,0));
         context.PopUp(formatLink("wpagregarestado.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey), new Object[] {});
         context.DoAjaxRefresh();
      }
      ...
      protected void S212( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wpciudad.aspx"+UrlEncode(StringUtil.LTrimStr(A1EstadoID,9,0));
         CallWebObject(formatLink("wpciudad.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
      ...
      protected void S132( )
      {
         ...
         {
            AV10GridState.FromXml(new WorkWithPlus.workwithplus_web.loadgridstate(context).executeUdp(  AV39Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV10GridState.FromXml(AV20Session.Get(AV39Pgmname+"GridState"), null, "", "");
         }
         AV12OrderedBy = AV10GridState.gxTpr_Orderedby;
         AssignAttri("", false, "AV12OrderedBy", StringUtil.LTrimStr( (decimal)(AV12OrderedBy), 4, 0));
         AV13OrderedDsc = AV10GridState.gxTpr_Ordereddsc;
      ...
      protected void S182( )
      {
         ...
         {
            AV11GridStateFilterValue = ((WorkWithPlus.workwithplus_web.SdtWWPGridState_FilterValue)AV10GridState.gxTpr_Filtervalues.Item(AV44GXV1));
            ...
            {
               AV28TFEstadoDescripcion = AV11GridStateFilterValue.gxTpr_Value;
               AssignAttri("", false, "AV28TFEstadoDescripcion", AV28TFEstadoDescripcion);
            }
            else if ( StringUtil.StrCmp(AV11GridStateFilterValue.gxTpr_Name, "TFESTADODESCRIPCION_SEL") == 0 )
            {
               AV29TFEstadoDescripcion_Sel = AV11GridStateFilterValue.gxTpr_Value;
               AssignAttri("", false, "AV29TFEstadoDescripcion_Sel", AV29TFEstadoDescripcion_Sel);
            }
            else if ( StringUtil.StrCmp(AV11GridStateFilterValue.gxTpr_Name, "TFESTADOACTIVO_SEL") == 0 )
            {
               AV30TFEstadoActivo_Sel = (short)(Math.Round(NumberUtil.Val( AV11GridStateFilterValue.gxTpr_Value, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV30TFEstadoActivo_Sel", StringUtil.Str( (decimal)(AV30TFEstadoActivo_Sel), 1, 0));
            }
            AV44GXV1 = (int)(AV44GXV1+1);
         }
         GXt_char2 = "";
         new WorkWithPlus.workwithplus_web.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV29TFEstadoDescripcion_Sel)),  AV29TFEstadoDescripcion_Sel, out  GXt_char2) ;
         Ddo_grid_Selectedvalue_set = GXt_char2+"|"+((0==AV30TFEstadoActivo_Sel) ? "" : StringUtil.Str( (decimal)(AV30TFEstadoActivo_Sel), 1, 0));
         ucDdo_grid.SendProperty(context, "", false, Ddo_grid_Internalname, "SelectedValue_set", Ddo_grid_Selectedvalue_set);
         GXt_char2 = "";
         new WorkWithPlus.workwithplus_web.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV28TFEstadoDescripcion)),  AV28TFEstadoDescripcion, out  GXt_char2) ;
      ...
      protected void S152( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_gridstateaddfiltervalueandsel(context ).execute( ref  AV10GridState,  "TFESTADODESCRIPCION",  context.GetMessage( "Estado", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV28TFEstadoDescripcion)),  0,  AV28TFEstadoDescripcion,  AV28TFEstadoDescripcion,  false,  "",  "",  !String.IsNullOrEmpty(StringUtil.RTrim( AV29TFEstadoDescripcion_Sel)),  AV29TFEstadoDescripcion_Sel,  AV29TFEstadoDescripcion_Sel) ;
         new WorkWithPlus.workwithplus_web.wwp_gridstateaddfiltervalue(context ).execute( ref  AV10GridState,  "TFESTADOACTIVO_SEL",  context.GetMessage( "Activo", ""),  !(0==AV30TFEstadoActivo_Sel),  0,  StringUtil.Trim( StringUtil.Str( (decimal)(AV30TFEstadoActivo_Sel), 1, 0)),  ((AV30TFEstadoActivo_Sel==1) ? context.GetMessage( "WWP_TSChecked", "") : context.GetMessage( "WWP_TSUnChecked", "")),  false,  "",  "") ;
         AV10GridState.gxTpr_Pagesize = StringUtil.Str( (decimal)(subGrid_Rows), 10, 0);
         AV10GridState.gxTpr_Currentpage = (short)(subGrid_fnc_Currentpage( ));
         new WorkWithPlus.workwithplus_web.savegridstate(context ).execute(  AV39Pgmname+"GridState",  AV10GridState.ToXml(false, true, "", "")) ;
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV37PaisID = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV37PaisID", StringUtil.LTrimStr( (decimal)(AV37PaisID), 9, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vPAISID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV37PaisID), "ZZZZZZZZ9"), context));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2026511113100", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wpestado.js", "?2026511113101", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_372( )
      {
         ...
         chkEstadoActivo_Internalname = "ESTADOACTIVO_"+sGXsfl_37_idx;
      ...
      protected void SubsflControlProps_fel_372( )
      {
         ...
         chkEstadoActivo_Internalname = "ESTADOACTIVO_"+sGXsfl_37_fel_idx;
      ...
      protected void sendrow_372( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_37_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            GXCCtl = "ESTADOACTIVO_" + sGXsfl_37_idx;
            chkEstadoActivo.Name = GXCCtl;
            chkEstadoActivo.WebTags = "";
            chkEstadoActivo.Caption = "";
            AssignProp("", false, chkEstadoActivo_Internalname, "TitleCaption", chkEstadoActivo.Caption, !bGXsfl_37_Refreshing);
            chkEstadoActivo.CheckedValue = "false";
            A3EstadoActivo = StringUtil.StrToBool( StringUtil.BoolToStr( A3EstadoActivo));
            GridRow.AddColumnProperties("checkbox", 1, isAjaxCallMode( ), new Object[] {(string)chkEstadoActivo_Internalname,StringUtil.BoolToStr( A3EstadoActivo),(string)"",(string)"",chkEstadoActivo.Visible,(short)0,(string)"true",(string)"",(string)StyleString,(string)ClassString,(string)"WWColumn",(string)"",(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            if ( ( cmbavGridactions.ItemCount == 0 ) && isAjaxCallMode( ) )
            {
               ...
               {
                  AV36GridActions = (short)(Math.Round(NumberUtil.Val( cmbavGridactions.getValidValue(StringUtil.Trim( StringUtil.Str( (decimal)(AV36GridActions), 4, 0))), "."), 18, MidpointRounding.ToEven));
                  AssignAttri("", false, cmbavGridactions_Internalname, StringUtil.LTrimStr( (decimal)(AV36GridActions), 4, 0));
               }
            }
            /* ComboBox */
            GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {(GXCombobox)cmbavGridactions,(string)cmbavGridactions_Internalname,StringUtil.Trim( StringUtil.Str( (decimal)(AV36GridActions), 4, 0)),(short)1,(string)cmbavGridactions_Jsonclick,(short)5,"'"+""+"'"+",false,"+"'"+"EVGRIDACTIONS.CLICK."+sGXsfl_37_idx+"'",(string)"int",(string)"",(short)-1,(short)1,(short)0,(short)0,(short)0,(string)"px",(short)0,(string)"px",(string)"",(string)"ConvertToDDO",(string)"WWActionGroupColumn",(string)"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,42);\"",(string)"",(bool)true,(short)0});
            cmbavGridactions.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV36GridActions), 4, 0));
      ...
      protected void StartGridControl37( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+""+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+((chkEstadoActivo.Visible==0) ? "display:none;" : "")+""+"\" "+">") ;
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.BoolToStr( A3EstadoActivo)));
            GridColumn.AddObjectProperty("Visible", StringUtil.LTrim( StringUtil.NToC( (decimal)(chkEstadoActivo.Visible), 5, 0, ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(AV36GridActions), 4, 0, ".", ""))));
            GridContainer.AddColumnProperties(GridColumn);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Datalistproc = "WPEstadoGetFilterData";
         ...
         Ddo_grid_Columnids = "2:EstadoDescripcion|3:EstadoActivo";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV12OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV37PaisID","fld":"vPAISID","pic":"ZZZZZZZZ9","hsh":true},{"av":"AV39Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV28TFEstadoDescripcion","fld":"vTFESTADODESCRIPCION"},{"av":"AV29TFEstadoDescripcion_Sel","fld":"vTFESTADODESCRIPCION_SEL"},{"av":"AV30TFEstadoActivo_Sel","fld":"vTFESTADOACTIVO_SEL","pic":"9"}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtEstadoDescripcion_Visible","ctrl":"ESTADODESCRIPCION","prop":"Visible"},{"av":"chkEstadoActivo.Visible","ctrl":"ESTADOACTIVO","prop":"Visible"},{"av":"AV33GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV34GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV35GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV21ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV10GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E12152","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV12OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV37PaisID","fld":"vPAISID","pic":"ZZZZZZZZ9","hsh":true},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV39Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV28TFEstadoDescripcion","fld":"vTFESTADODESCRIPCION"},{"av":"AV29TFEstadoDescripcion_Sel","fld":"vTFESTADODESCRIPCION_SEL"},{"av":"AV30TFEstadoActivo_Sel","fld":"vTFESTADOACTIVO_SEL","pic":"9"},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","""{"handler":"E13152","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV12OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV37PaisID","fld":"vPAISID","pic":"ZZZZZZZZ9","hsh":true},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV39Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV28TFEstadoDescripcion","fld":"vTFESTADODESCRIPCION"},{"av":"AV29TFEstadoDescripcion_Sel","fld":"vTFESTADODESCRIPCION_SEL"},{"av":"AV30TFEstadoActivo_Sel","fld":"vTFESTADOACTIVO_SEL","pic":"9"},{"av":"Gridpaginationbar_Rowsperpageselectedvalue","ctrl":"GRIDPAGINATIONBAR","prop":"RowsPerPageSelectedValue"}]""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",""","oparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]}""");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","""{"handler":"E14152","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV12OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV37PaisID","fld":"vPAISID","pic":"ZZZZZZZZ9","hsh":true},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV39Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV28TFEstadoDescripcion","fld":"vTFESTADODESCRIPCION"},{"av":"AV29TFEstadoDescripcion_Sel","fld":"vTFESTADODESCRIPCION_SEL"},{"av":"AV30TFEstadoActivo_Sel","fld":"vTFESTADOACTIVO_SEL","pic":"9"},{"av":"Ddo_grid_Activeeventkey","ctrl":"DDO_GRID","prop":"ActiveEventKey"},{"av":"Ddo_grid_Selectedvalue_get","ctrl":"DDO_GRID","prop":"SelectedValue_get"},{"av":"Ddo_grid_Selectedcolumn","ctrl":"DDO_GRID","prop":"SelectedColumn"},{"av":"Ddo_grid_Filteredtext_get","ctrl":"DDO_GRID","prop":"FilteredText_get"}]""");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED",""","oparms":[{"av":"AV12OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV28TFEstadoDescripcion","fld":"vTFESTADODESCRIPCION"},{"av":"AV29TFEstadoDescripcion_Sel","fld":"vTFESTADODESCRIPCION_SEL"},{"av":"AV30TFEstadoActivo_Sel","fld":"vTFESTADOACTIVO_SEL","pic":"9"},{"av":"Ddo_grid_Sortedstatus","ctrl":"DDO_GRID","prop":"SortedStatus"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E19152","iparms":[]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"cmbavGridactions"},{"av":"AV36GridActions","fld":"vGRIDACTIONS","pic":"ZZZ9"}]}""");
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED","""{"handler":"E15152","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV12OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV37PaisID","fld":"vPAISID","pic":"ZZZZZZZZ9","hsh":true},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV39Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV28TFEstadoDescripcion","fld":"vTFESTADODESCRIPCION"},{"av":"AV29TFEstadoDescripcion_Sel","fld":"vTFESTADODESCRIPCION_SEL"},{"av":"AV30TFEstadoActivo_Sel","fld":"vTFESTADOACTIVO_SEL","pic":"9"},{"av":"Ddo_gridcolumnsselector_Columnsselectorvalues","ctrl":"DDO_GRIDCOLUMNSSELECTOR","prop":"ColumnsSelectorValues"}]""");
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED",""","oparms":[{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"edtEstadoDescripcion_Visible","ctrl":"ESTADODESCRIPCION","prop":"Visible"},{"av":"chkEstadoActivo.Visible","ctrl":"ESTADOACTIVO","prop":"Visible"},{"av":"AV33GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV34GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV35GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV21ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV10GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","""{"handler":"E11152","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV12OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV37PaisID","fld":"vPAISID","pic":"ZZZZZZZZ9","hsh":true},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV39Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV28TFEstadoDescripcion","fld":"vTFESTADODESCRIPCION"},{"av":"AV29TFEstadoDescripcion_Sel","fld":"vTFESTADODESCRIPCION_SEL"},{"av":"AV30TFEstadoActivo_Sel","fld":"vTFESTADOACTIVO_SEL","pic":"9"},{"av":"Ddo_managefilters_Activeeventkey","ctrl":"DDO_MANAGEFILTERS","prop":"ActiveEventKey"},{"av":"AV10GridState","fld":"vGRIDSTATE"}]""");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED",""","oparms":[{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV10GridState","fld":"vGRIDSTATE"},{"av":"AV12OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV28TFEstadoDescripcion","fld":"vTFESTADODESCRIPCION"},{"av":"AV29TFEstadoDescripcion_Sel","fld":"vTFESTADODESCRIPCION_SEL"},{"av":"AV30TFEstadoActivo_Sel","fld":"vTFESTADOACTIVO_SEL","pic":"9"},{"av":"Ddo_grid_Selectedvalue_set","ctrl":"DDO_GRID","prop":"SelectedValue_set"},{"av":"Ddo_grid_Filteredtext_set","ctrl":"DDO_GRID","prop":"FilteredText_set"},{"av":"Ddo_grid_Sortedstatus","ctrl":"DDO_GRID","prop":"SortedStatus"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtEstadoDescripcion_Visible","ctrl":"ESTADODESCRIPCION","prop":"Visible"},{"av":"chkEstadoActivo.Visible","ctrl":"ESTADOACTIVO","prop":"Visible"},{"av":"AV33GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV34GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV35GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV21ManageFiltersData","fld":"vMANAGEFILTERSDATA"}]}""");
         setEventMetadata("VGRIDACTIONS.CLICK","""{"handler":"E20152","iparms":[{"av":"cmbavGridactions"},{"av":"AV36GridActions","fld":"vGRIDACTIONS","pic":"ZZZ9"},{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV12OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV37PaisID","fld":"vPAISID","pic":"ZZZZZZZZ9","hsh":true},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV39Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV28TFEstadoDescripcion","fld":"vTFESTADODESCRIPCION"},{"av":"AV29TFEstadoDescripcion_Sel","fld":"vTFESTADODESCRIPCION_SEL"},{"av":"AV30TFEstadoActivo_Sel","fld":"vTFESTADOACTIVO_SEL","pic":"9"},{"av":"A1EstadoID","fld":"ESTADOID","pic":"ZZZZZZZZ9","hsh":true}]""");
         setEventMetadata("VGRIDACTIONS.CLICK",""","oparms":[{"av":"cmbavGridactions"},{"av":"AV36GridActions","fld":"vGRIDACTIONS","pic":"ZZZ9"},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtEstadoDescripcion_Visible","ctrl":"ESTADODESCRIPCION","prop":"Visible"},{"av":"chkEstadoActivo.Visible","ctrl":"ESTADOACTIVO","prop":"Visible"},{"av":"AV33GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV34GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV35GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV21ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV10GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("'DOUSERACTION1'","""{"handler":"E16152","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV12OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV37PaisID","fld":"vPAISID","pic":"ZZZZZZZZ9","hsh":true},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV39Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV28TFEstadoDescripcion","fld":"vTFESTADODESCRIPCION"},{"av":"AV29TFEstadoDescripcion_Sel","fld":"vTFESTADODESCRIPCION_SEL"},{"av":"AV30TFEstadoActivo_Sel","fld":"vTFESTADOACTIVO_SEL","pic":"9"},{"av":"A1EstadoID","fld":"ESTADOID","pic":"ZZZZZZZZ9","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         A2EstadoDescripcion = "";
         GXDecQS = "";
         lV40Wpestadods_1_filterfulltext = "";
         lV41Wpestadods_2_tfestadodescripcion = "";
         AV40Wpestadods_1_filterfulltext = "";
         AV42Wpestadods_3_tfestadodescripcion_sel = "";
         AV41Wpestadods_2_tfestadodescripcion = "";
         H00152_A3EstadoActivo = new bool[] {false} ;
         H00152_A2EstadoDescripcion = new string[] {""} ;
         H00152_A16PaisID = new int[1] ;
         H00152_A1EstadoID = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wpestado__default(),
            new Object[][] {
                new Object[] {
               H00152_A3EstadoActivo, H00152_A2EstadoDescripcion, H00152_A16PaisID, H00152_A1EstadoID
               }
               , new Object[] {
      ...
      private short AV30TFEstadoActivo_Sel ;
      ...
      private short AV43Wpestadods_4_tfestadoactivo_sel ;
      ...
      private int AV37PaisID ;
      private int wcpOAV37PaisID ;
      ...
      private string AV28TFEstadoDescripcion ;
      private string AV29TFEstadoDescripcion_Sel ;
      private string AV35GridAppliedFilters ;
      private string A2EstadoDescripcion ;
      private string lV40Wpestadods_1_filterfulltext ;
      private string lV41Wpestadods_2_tfestadodescripcion ;
      private string AV40Wpestadods_1_filterfulltext ;
      private string AV42Wpestadods_3_tfestadodescripcion_sel ;
      private string AV41Wpestadods_2_tfestadodescripcion ;
      private string AV38PaisDescripcion ;
      ...
      private bool[] H00152_A3EstadoActivo ;
      private string[] H00152_A2EstadoDescripcion ;
      private int[] H00152_A16PaisID ;
      private int[] H00152_A1EstadoID ;
   ...
   public class wpestado__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H00152( IGxContext context ,
                                             string AV40Wpestadods_1_filterfulltext ,
                                             string AV42Wpestadods_3_tfestadodescripcion_sel ,
                                             string AV41Wpestadods_2_tfestadodescripcion ,
                                             short AV43Wpestadods_4_tfestadoactivo_sel ,
                                             ...
                                             int A16PaisID )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " `EstadoActivo`, `EstadoDescripcion`, `PaisID`, `EstadoID`";
         sFromString = " FROM `Estado`";
         sOrderString = "";
         AddWhere(sWhereString, "(`PaisID` = @AV37PaisID)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV40Wpestadods_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( `EstadoDescripcion` like CONCAT('%', @lV40Wpestadods_1_filterfulltext)))");
         }
         else
         {
            GXv_int4[1] = 1;
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV42Wpestadods_3_tfestadodescripcion_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV41Wpestadods_2_tfestadodescripcion)) ) )
         {
            AddWhere(sWhereString, "(`EstadoDescripcion` like @lV41Wpestadods_2_tfestadodescripcion)");
         }
         else
         {
            GXv_int4[2] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV42Wpestadods_3_tfestadodescripcion_sel)) && ! ( StringUtil.StrCmp(AV42Wpestadods_3_tfestadodescripcion_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(`EstadoDescripcion` = @AV42Wpestadods_3_tfestadodescripcion_sel)");
         }
         else
         {
            GXv_int4[3] = 1;
         }
         if ( StringUtil.StrCmp(AV42Wpestadods_3_tfestadodescripcion_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "((LENGTH(TRIM(`EstadoDescripcion`))=0))");
         }
         if ( AV43Wpestadods_4_tfestadoactivo_sel == 1 )
         {
            AddWhere(sWhereString, "(`EstadoActivo` = 1)");
         }
         if ( AV43Wpestadods_4_tfestadoactivo_sel == 2 )
         {
         ...
         {
            sOrderString += " ORDER BY `EstadoDescripcion` DESC";
         }
         else if ( ( AV12OrderedBy == 2 ) && ! AV13OrderedDsc )
         {
            sOrderString += " ORDER BY `EstadoActivo`";
         }
         else if ( ( AV12OrderedBy == 2 ) && ( AV13OrderedDsc ) )
         {
            sOrderString += " ORDER BY `EstadoActivo` DESC";
         }
         else if ( true )
         {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00152(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (string)dynConstraints[4] , (bool)dynConstraints[5] , (short)dynConstraints[6] , (bool)dynConstraints[7] , (int)dynConstraints[8] , (int)dynConstraints[9] );
               case 1 :
                     return conditional_H00153(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (string)dynConstraints[4] , (bool)dynConstraints[5] , (short)dynConstraints[6] , (bool)dynConstraints[7] , (int)dynConstraints[8] , (int)dynConstraints[9] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV37PaisID",GXType.Int32,9,0) ,
          new ParDef("@lV40Wpestadods_1_filterfulltext",GXType.Char,100,0) ,
          new ParDef("@lV41Wpestadods_2_tfestadodescripcion",GXType.Char,80,0) ,
          new ParDef("@AV42Wpestadods_3_tfestadodescripcion_sel",GXType.Char,80,0) ,
