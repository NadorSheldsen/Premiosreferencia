...
namespace GeneXus.Programs {
   public class wpactualizarinfousuarioloaddvcombo : GXProcedure
   {
      public wpactualizarinfousuarioloaddvcombo( )
      {
      ...
      public wpactualizarinfousuarioloaddvcombo( IGxContext context )
      {
      ...
      protected void S111( )
      {
         ...
         {
            A2EstadoDescripcion = P003L2_A2EstadoDescripcion[0];
            A16PaisID = P003L2_A16PaisID[0];
            A1EstadoID = P003L2_A1EstadoID[0];
      ...
      protected void S121( )
      {
         ...
         {
            A5CiudadDescripcion = P003L3_A5CiudadDescripcion[0];
            A1EstadoID = P003L3_A1EstadoID[0];
            A4CiudadID = P003L3_A4CiudadID[0];
            AV15Combo_DataItem = new WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item(context);
      ...
      public override void initialize( )
      {
         ...
         lV13SearchTxt = "";
         A2EstadoDescripcion = "";
         P003L2_A2EstadoDescripcion = new string[] {""} ;
         P003L2_A16PaisID = new int[1] ;
         P003L2_A1EstadoID = new int[1] ;
         AV15Combo_DataItem = new WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item(context);
         AV14Combo_Data = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item>( context, "Item", "");
         A5CiudadDescripcion = "";
         P003L3_A5CiudadDescripcion = new string[] {""} ;
         P003L3_A1EstadoID = new int[1] ;
         P003L3_A4CiudadID = new int[1] ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wpactualizarinfousuarioloaddvcombo__default(),
            new Object[][] {
                new Object[] {
               P003L2_A2EstadoDescripcion, P003L2_A16PaisID, P003L2_A1EstadoID
               }
               , new Object[] {
               P003L3_A5CiudadDescripcion, P003L3_A1EstadoID, P003L3_A4CiudadID
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P003L2_A2EstadoDescripcion ;
      private int[] P003L2_A16PaisID ;
      private int[] P003L2_A1EstadoID ;
      ...
      private string[] P003L3_A5CiudadDescripcion ;
      private int[] P003L3_A1EstadoID ;
      private int[] P003L3_A4CiudadID ;
      private string aP4_Combo_DataJson ;
   }

   public class wpactualizarinfousuarioloaddvcombo__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P003L2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (int)dynConstraints[2] , (int)dynConstraints[3] );
               case 1 :
                     return conditional_P003L3(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (int)dynConstraints[2] , (int)dynConstraints[3] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("P003L3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP003L3,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
