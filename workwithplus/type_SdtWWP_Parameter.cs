...
namespace GeneXus.Programs.workwithplus {
   ...
   [XmlType(TypeName =  "WWP_Parameter" , Namespace = "Premios" )]
   [Serializable]
   public class SdtWWP_Parameter : GxSilentTrnSdt
   {
      ...
      public void Load( string AV34WWPParameterKey )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(string)AV34WWPParameterKey});
         return  ;
      }
   ...
   [DataContract(Name = @"WorkWithPlus\WWP_Parameter", Namespace = "Premios")]
