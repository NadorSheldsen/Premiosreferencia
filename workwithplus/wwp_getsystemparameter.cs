...
namespace GeneXus.Programs.workwithplus {
   public class wwp_getsystemparameter : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A34WWPParameterKey = P00222_A34WWPParameterKey[0];
            A35WWPParameterValue = P00222_A35WWPParameterValue[0];
            AV9WWPParameterValue = A35WWPParameterValue;
      ...
      public override void initialize( )
      {
         ...
         P00222_A34WWPParameterKey = new string[] {""} ;
         P00222_A35WWPParameterValue = new string[] {""} ;
         A34WWPParameterKey = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.workwithplus.wwp_getsystemparameter__default(),
            new Object[][] {
                new Object[] {
               P00222_A34WWPParameterKey, P00222_A35WWPParameterValue
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P00222_A34WWPParameterKey ;
      private string[] P00222_A35WWPParameterValue ;
   ...
   public class wwp_getsystemparameter__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV8WWPParameterKey",GXType.Char,300,0)
          };
          def= new CursorDef[] {
              new CursorDef("P00222", "SELECT `WWPParameterKey`, `WWPParameterValue` FROM `WWP_Parameter` WHERE `WWPParameterKey` = @AV8WWPParameterKey ORDER BY `WWPParameterKey` ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00222,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
