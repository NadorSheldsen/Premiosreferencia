...
namespace GeneXus.Programs.workwithplus {
   public class wwp_editconfformattingvalues : GXWebComponent
   {
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 10), "GRIDS.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AV10GXV1 = (int)(nGXsfl_15_idx+GRIDS_nFirstRecordOnPage);
                              if ( ( AV6ConfFormattingVariables.Count >= AV10GXV1 ) && ( AV10GXV1 > 0 ) )
                              {
                                 AV6ConfFormattingVariables.CurrentItem = ((WorkWithPlus.workwithplus_web.SdtWWPConfFormattingVariable)AV6ConfFormattingVariables.Item(AV10GXV1));
                                 if ( ( ( context.localUtil.CToN( cgiGet( edtavDefaultvalue_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")) < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavDefaultvalue_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")) > Convert.ToDecimal( 9999999999L )) ) )
                                 {
                                    ...
                                    wbErr = true;
                                    AV9DefaultValue = 0;
                                    AssignAttri(sPrefix, false, edtavDefaultvalue_Internalname, StringUtil.LTrimStr( (decimal)(AV9DefaultValue), 10, 0));
                                 }
                                 else
                                 {
                                    AV9DefaultValue = (long)(Math.Round(context.localUtil.CToN( cgiGet( edtavDefaultvalue_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
                                    AssignAttri(sPrefix, false, edtavDefaultvalue_Internalname, StringUtil.LTrimStr( (decimal)(AV9DefaultValue), 10, 0));
                                 }
                              }
                              sEvtType = StringUtil.Right( sEvt, 1);
      ...
      protected void RF0T2( )
      {
         ...
         GridsContainer.AddObjectProperty("Class", "GridNoBorder WorkWith");
      ...
      protected void STRUP0T0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            while ( nGXsfl_15_fel_idx < nRC_GXsfl_15 )
            {
               ...
               AV10GXV1 = (int)(nGXsfl_15_fel_idx+GRIDS_nFirstRecordOnPage);
               if ( ( AV6ConfFormattingVariables.Count >= AV10GXV1 ) && ( AV10GXV1 > 0 ) )
               {
                  AV6ConfFormattingVariables.CurrentItem = ((WorkWithPlus.workwithplus_web.SdtWWPConfFormattingVariable)AV6ConfFormattingVariables.Item(AV10GXV1));
                  if ( ( ( context.localUtil.CToN( cgiGet( edtavDefaultvalue_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")) < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavDefaultvalue_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")) > Convert.ToDecimal( 9999999999L )) ) )
      ...
      protected void E140T2( )
      {
         ...
         if ( 1 == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = UrlEncode(StringUtil.RTrim(AV8link)) + "," + UrlEncode(StringUtil.RTrim(AV8link));
            AV8link = formatLink("workwithplus.wwp_getsystemparameter") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
            AssignAttri(sPrefix, false, "AV8link", AV8link);
         }
      }
      ...
      private void E150T2( )
      {
         ...
         returnInSub = false;
         AV10GXV1 = 1;
         while ( AV10GXV1 <= AV6ConfFormattingVariables.Count )
         {
            AV6ConfFormattingVariables.CurrentItem = ((WorkWithPlus.workwithplus_web.SdtWWPConfFormattingVariable)AV6ConfFormattingVariables.Item(AV10GXV1));
            AV9DefaultValue = (long)(Math.Round(NumberUtil.Val( ((WorkWithPlus.workwithplus_web.SdtWWPConfFormattingVariable)(AV6ConfFormattingVariables.CurrentItem)).gxTpr_Defaultvalue, "."), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, edtavDefaultvalue_Internalname, StringUtil.LTrimStr( (decimal)(AV9DefaultValue), 10, 0));
            /* Load Method */
            if ( wbStart != -1 )
            {
      ...
      {
         AV10GXV1 = (int)(nGXsfl_15_idx+GRIDS_nFirstRecordOnPage);
         if ( ( AV10GXV1 > 0 ) && ( AV6ConfFormattingVariables.Count >= AV10GXV1 ) )
         {
            AV6ConfFormattingVariables.CurrentItem = ((WorkWithPlus.workwithplus_web.SdtWWPConfFormattingVariable)AV6ConfFormattingVariables.Item(AV10GXV1));
         }
         ...
         returnInSub = false;
         AV12GXV3 = 1;
         while ( AV12GXV3 <= AV6ConfFormattingVariables.Count )
         {
            AV5ConfFormattingVariable = ((WorkWithPlus.workwithplus_web.SdtWWPConfFormattingVariable)AV6ConfFormattingVariables.Item(AV12GXV3));
      ...
      protected void E130T2( )
      {
         ...
         while ( nGXsfl_15_fel_idx < nRC_GXsfl_15 )
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.saveuserkeyvalue(context ).execute(  AV7VarProgramName+"."+((WorkWithPlus.workwithplus_web.SdtWWPConfFormattingVariable)(AV6ConfFormattingVariables.CurrentItem)).gxTpr_Name,  StringUtil.Trim( StringUtil.Str( (decimal)(AV9DefaultValue), 10, 0))) ;
            /* End For Each Line */
         }
         if ( nGXsfl_15_fel_idx == 0 )
         {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202510281546162", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/wwp_editconfformattingvalues.js", "?202510281546162", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/GridEmpowerer/GridEmpowererRender.js", "", false, true);
      ...
      protected void sendrow_152( )
      {
         ...
         if ( ( subGrids_Rows * 1 == 0 ) || ( nGXsfl_15_idx <= subGrids_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            ROClassString = "Attribute";
            GridsRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavDefaultvalue_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9DefaultValue), 10, 0, context.GetLanguageProperty( "decimal_point"), "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(AV9DefaultValue), "ZZZZZZZZZ9"))," dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onblur(this,17);\"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavDefaultvalue_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)1,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)10,(short)0,(short)0,(short)15,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
      ...
      protected void StartGridControl15( )
      {
         if ( GridsContainer.GetWrapped() == 1 )
         {
            ...
            sStyleString = "";
            GxWebStd.gx_table_start( context, subGrids_Internalname, subGrids_Internalname, "", "GridNoBorder WorkWith", 0, "", "", 1, 2, sStyleString, "", "", 0);
            /* Subfile titles */
            context.WriteHtmlText( "<tr") ;
         ...
         else
         {
            ...
            GridsColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridsColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9DefaultValue), 10, 0, ".", ""))));
            GridsContainer.AddColumnProperties(GridsColumn);
      ...
      public override void initialize_properties( )
      {
         ...
         edtavConfformattingvariables__description_Enabled = 0;
         subGrids_Class = "GridNoBorder WorkWith";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDS.LOAD","""{"handler":"E150T2","iparms":[{"av":"AV6ConfFormattingVariables","fld":"vCONFFORMATTINGVARIABLES","grid":15},{"av":"nGXsfl_15_idx","ctrl":"GRID","prop":"GridCurrRow","grid":15},{"av":"GRIDS_nFirstRecordOnPage"},{"av":"nRC_GXsfl_15","ctrl":"GRIDS","prop":"GridRC","grid":15}]""");
         setEventMetadata("GRIDS.LOAD",""","oparms":[{"av":"AV9DefaultValue","fld":"vDEFAULTVALUE","pic":"ZZZZZZZZZ9"}]}""");
         setEventMetadata("'DOUSERACTION1'","""{"handler":"E110T1","iparms":[]}""");
         setEventMetadata("'DOUSERACTIONRESET'","""{"handler":"E120T2","iparms":[{"av":"AV6ConfFormattingVariables","fld":"vCONFFORMATTINGVARIABLES","grid":15},{"av":"nGXsfl_15_idx","ctrl":"GRID","prop":"GridCurrRow","grid":15},{"av":"GRIDS_nFirstRecordOnPage"},{"av":"nRC_GXsfl_15","ctrl":"GRIDS","prop":"GridRC","grid":15},{"av":"AV7VarProgramName","fld":"vVARPROGRAMNAME"}]}""");
         setEventMetadata("ENTER","""{"handler":"E130T2","iparms":[{"av":"AV7VarProgramName","fld":"vVARPROGRAMNAME"},{"av":"AV6ConfFormattingVariables","fld":"vCONFFORMATTINGVARIABLES","grid":15},{"av":"nGXsfl_15_idx","ctrl":"GRID","prop":"GridCurrRow","grid":15},{"av":"GRIDS_nFirstRecordOnPage"},{"av":"nRC_GXsfl_15","ctrl":"GRIDS","grid":15,"prop":"GridRC","grid":15},{"av":"AV9DefaultValue","fld":"vDEFAULTVALUE","grid":15,"pic":"ZZZZZZZZZ9"}]}""");
      ...
      {
         AV6ConfFormattingVariables = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWWPConfFormattingVariable>( context, "WWPConfFormattingVariable", "Premios");
