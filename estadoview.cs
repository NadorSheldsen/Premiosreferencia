...
namespace GeneXus.Programs {
   public class estadoview : GXDataArea
   {
      public estadoview( )
      {
      ...
      public estadoview( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "estadoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV9EstadoID,9,0)) + "," + UrlEncode(StringUtil.RTrim(AV7TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("estadoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vESTADOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9EstadoID), 9, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vESTADOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV9EstadoID), "ZZZZZZZZ9"), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "estadoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV9EstadoID,9,0)) + "," + UrlEncode(StringUtil.RTrim(AV7TabCode));
         return formatLink("estadoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }
      ...
      {
         return context.GetMessage( "Estado View", "") ;
      }
      ...
      protected void WB1E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, context.GetMessage( "Ir a Estado", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_EstadoView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, context.GetMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_EstadoView.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCiudad_title_Internalname, context.GetMessage( "Ciudad", ""), "", "", lblCiudad_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_EstadoView.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtableciudad_Internalname, 1, 0, "px", 0, "px", "TableViewTab", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0033"+"", StringUtil.RTrim( WebComp_Ciudadwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
      ...
      protected void START1E2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Estado View", ""), 0) ;
         context.wjLoc = "";
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        else if ( nCmpId == 33 )
                        {
                           ...
                           if ( StringUtil.Len( WebComp_Ciudadwc_Component) != 0 )
                           {
                              WebComp_Ciudadwc.componentprocess("W0033", "", sEvt);
                           }
                           WebComp_Ciudadwc_Component = OldCiudadwc;
                        }
                     }
      ...
      protected void PA1E2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "estadoview.aspx")), "estadoview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "estadoview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV9EstadoID = (int)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
      ...
      protected void E121E2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("estadoww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV12GXLvl9 = 0;
         /* Using cursor H001E2 */
         pr_default.execute(0, new Object[] {AV9EstadoID});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A1EstadoID = H001E2_A1EstadoID[0];
            A2EstadoDescripcion = H001E2_A2EstadoDescripcion[0];
            AV12GXLvl9 = 1;
            Form.Caption = A2EstadoDescripcion;
      ...
      protected void S112( )
      {
         ...
         if ( AV10LoadAllTabs || ( StringUtil.StrCmp(AV11SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV11SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               ...
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0025",(string)"",(int)AV9EstadoID});
         ...
         if ( AV10LoadAllTabs || ( StringUtil.StrCmp(AV11SelectedTabCode, "Ciudad") == 0 ) )
         {
            /* Object Property */
            if ( true )
            {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Ciudadwc_Component), StringUtil.Lower( "EstadoCiudadWC")) != 0 )
            {
               WebComp_Ciudadwc = getWebComponent(GetType(), "GeneXus.Programs", "estadociudadwc", new Object[] {context} );
               WebComp_Ciudadwc.ComponentInit();
               WebComp_Ciudadwc.Name = "EstadoCiudadWC";
               WebComp_Ciudadwc_Component = "EstadoCiudadWC";
            }
            if ( StringUtil.Len( WebComp_Ciudadwc_Component) != 0 )
            {
               WebComp_Ciudadwc.setjustcreated();
               WebComp_Ciudadwc.componentprepare(new Object[] {(string)"W0033",(string)"",(int)AV9EstadoID});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV9EstadoID = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV9EstadoID", StringUtil.LTrimStr( (decimal)(AV9EstadoID), 9, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vESTADOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV9EstadoID), "ZZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025102815462327", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("estadoview.js", "?2025102815462327", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divUnnamedtableciudad_Internalname = "UNNAMEDTABLECIUDAD";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Estado View", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV9EstadoID","fld":"vESTADOID","pic":"ZZZZZZZZ9","hsh":true},{"av":"AV7TabCode","fld":"vTABCODE","hsh":true}]}""");
         setEventMetadata("TABS.TABCHANGED","""{"handler":"E111E2","iparms":[{"av":"Tabs_Activepagecontrolname","ctrl":"TABS","prop":"ActivePageControlName"},{"av":"AV10LoadAllTabs","fld":"vLOADALLTABS"},{"av":"AV11SelectedTabCode","fld":"vSELECTEDTABCODE"},{"av":"AV9EstadoID","fld":"vESTADOID","pic":"ZZZZZZZZ9","hsh":true}]""");
         setEventMetadata("TABS.TABCHANGED",""","oparms":[{"av":"AV11SelectedTabCode","fld":"vSELECTEDTABCODE"},{"av":"AV10LoadAllTabs","fld":"vLOADALLTABS"},{"ctrl":"GENERALWC"},{"ctrl":"CIUDADWC"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         H001E2_A1EstadoID = new int[1] ;
         H001E2_A2EstadoDescripcion = new string[] {""} ;
         A2EstadoDescripcion = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.estadoview__default(),
            new Object[][] {
                new Object[] {
               H001E2_A1EstadoID, H001E2_A2EstadoDescripcion
               }
            }
         );
      ...
      private string divUnnamedtableciudad_Internalname ;
      ...
      private int[] H001E2_A1EstadoID ;
      private string[] H001E2_A2EstadoDescripcion ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class estadoview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H001E2", "SELECT `EstadoID`, `EstadoDescripcion` FROM `Estado` WHERE `EstadoID` = @AV9EstadoID ORDER BY `EstadoID` ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001E2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
