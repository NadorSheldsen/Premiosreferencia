...
namespace GeneXus.Programs {
   public class aloadeventssampleproc : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         AV8event.gxTpr_Id = context.GetMessage( "Sample1", "");
         AV8event.gxTpr_Name = context.GetMessage( "Wimbledon Match", "");
         AV8event.gxTpr_Notes = context.GetMessage( "Wimbledon Match", "");
         AV8event.gxTpr_Link = context.GetMessage( "http://www.genexus.com", "");
         ...
         AV8event.gxTpr_Id = context.GetMessage( "Sample2", "");
         AV8event.gxTpr_Name = context.GetMessage( "NBA Finals", "");
         AV8event.gxTpr_Notes = context.GetMessage( "NBA Finals", "");
         AV8event.gxTpr_Link = context.GetMessage( "http://www.gxtechnical.com", "");
         ...
         AV9events.gxTpr_Items.Add(AV8event, 0);
         AV8event = new SdtSchedulerEvents_event(context);
         AV8event.gxTpr_Id = context.GetMessage( "Sample3", "");
         AV8event.gxTpr_Name = context.GetMessage( "Meeting with clients", "");
         AV8event.gxTpr_Notes = context.GetMessage( "Meeting with clients", "");
         AV8event.gxTpr_Link = context.GetMessage( "http://www.gxtechnical.com/gxsearch", "");
