...
namespace GeneXus.Programs {
   public class aschedulerrequesthandler : GXWebProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         if ( ( StringUtil.StringSearch( AV21queryString, context.GetMessage( "&from=", ""), 1) > 0 ) && ( StringUtil.StringSearch( AV21queryString, context.GetMessage( "&to=", ""), 1) > 0 ) )
         {
            AV10callbackIndex = (short)(StringUtil.StringSearch( AV21queryString, context.GetMessage( "&callback=", ""), 1));
            ...
            AV12fromIndex = (short)(StringUtil.StringSearch( AV21queryString, context.GetMessage( "&from=", ""), 1));
            ...
            AV15toIndex = (short)(StringUtil.StringSearch( AV21queryString, context.GetMessage( "&to=", ""), 1));
         ...
         {
            AV13httpResponse.AppendHeader(context.GetMessage( "Content-Type", ""), context.GetMessage( "text/xml", ""));
         }
