...
namespace GeneXus.Programs {
   public class wpduplicarpromopromociondistribuidorwc : GXWebComponent
   {
      public wpduplicarpromopromociondistribuidorwc( )
      {
      ...
      public wpduplicarpromopromociondistribuidorwc( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV13OrderedBy, AV14OrderedDsc, AV7PromocionID, AV27Pgmname, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV27Pgmname = "WPDuplicarPromoPromocionDistribuidorWC";
               WS432( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "WPDuplicar Promo Promocion Distribuidor WC", "")) ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "wpduplicarpromopromociondistribuidorwc.aspx"+UrlEncode(StringUtil.LTrimStr(AV7PromocionID,9,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wpduplicarpromopromociondistribuidorwc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         return "WPDuplicarPromoPromocionDistribuidorWC" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "WPDuplicar Promo Promocion Distribuidor WC", "") ;
      }
      ...
      protected void WB430( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "wpduplicarpromopromociondistribuidorwc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void START432( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "WPDuplicar Promo Promocion Distribuidor WC", ""), 0) ;
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wpduplicarpromopromociondistribuidorwc.aspx")), "wpduplicarpromopromociondistribuidorwc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wpduplicarpromopromociondistribuidorwc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void RF432( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H00432 */
            pr_default.execute(0, new Object[] {AV7PromocionID, GXPagingFrom2, GXPagingTo2});
            nGXsfl_15_idx = 1;
            sGXsfl_15_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_15_idx), 4, 0), 4, "0");
            SubsflControlProps_152( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A41PromocionID = H00432_A41PromocionID[0];
               AssignAttri(sPrefix, false, "A41PromocionID", StringUtil.LTrimStr( (decimal)(A41PromocionID), 9, 0));
               A11DistribuidorDescripcion = H00432_A11DistribuidorDescripcion[0];
               A10DistribuidorID = H00432_A10DistribuidorID[0];
               A47PromocionDistribuidorID = H00432_A47PromocionDistribuidorID[0];
               A11DistribuidorDescripcion = H00432_A11DistribuidorDescripcion[0];
               /* Execute user event: Grid.Load */
               E16432 ();
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "wpduplicarpromopromociondistribuidorwc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20265111130545", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wpduplicarpromopromociondistribuidorwc.js", "?20265111130545", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         edtPromocionDistribuidorID_Internalname = sPrefix+"PROMOCIONDISTRIBUIDORID_"+sGXsfl_15_idx;
         edtDistribuidorID_Internalname = sPrefix+"DISTRIBUIDORID_"+sGXsfl_15_idx;
         edtDistribuidorDescripcion_Internalname = sPrefix+"DISTRIBUIDORDESCRIPCION_"+sGXsfl_15_idx;
      }

      protected void SubsflControlProps_fel_152( )
      {
         edtPromocionDistribuidorID_Internalname = sPrefix+"PROMOCIONDISTRIBUIDORID_"+sGXsfl_15_fel_idx;
         edtDistribuidorID_Internalname = sPrefix+"DISTRIBUIDORID_"+sGXsfl_15_fel_idx;
         edtDistribuidorDescripcion_Internalname = sPrefix+"DISTRIBUIDORDESCRIPCION_"+sGXsfl_15_fel_idx;
      }
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "0:PromocionDistribuidorID|1:DistribuidorID|2:DistribuidorDescripcion";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"AV7PromocionID","fld":"vPROMOCIONID","pic":"ZZZZZZZZ9"},{"av":"sPrefix"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV27Pgmname","fld":"vPGMNAME","hsh":true}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"AV23GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV24GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV25GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E11432","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV7PromocionID","fld":"vPROMOCIONID","pic":"ZZZZZZZZ9"},{"av":"AV27Pgmname","fld":"vPGMNAME","hsh":true},{"av":"sPrefix"},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","""{"handler":"E12432","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV7PromocionID","fld":"vPROMOCIONID","pic":"ZZZZZZZZ9"},{"av":"AV27Pgmname","fld":"vPGMNAME","hsh":true},{"av":"sPrefix"},{"av":"Gridpaginationbar_Rowsperpageselectedvalue","ctrl":"GRIDPAGINATIONBAR","prop":"RowsPerPageSelectedValue"}]""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",""","oparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]}""");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","""{"handler":"E13432","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV7PromocionID","fld":"vPROMOCIONID","pic":"ZZZZZZZZ9"},{"av":"AV27Pgmname","fld":"vPGMNAME","hsh":true},{"av":"sPrefix"},{"av":"Ddo_grid_Activeeventkey","ctrl":"DDO_GRID","prop":"ActiveEventKey"},{"av":"Ddo_grid_Selectedvalue_get","ctrl":"DDO_GRID","prop":"SelectedValue_get"}]""");
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E16432","iparms":[]}""");
         setEventMetadata("VALID_DISTRIBUIDORID","""{"handler":"Valid_Distribuidorid","iparms":[]}""");
         setEventMetadata("NULL","""{"handler":"Valid_Distribuidordescripcion","iparms":[]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         H00432_A41PromocionID = new int[1] ;
         H00432_A11DistribuidorDescripcion = new string[] {""} ;
         H00432_A10DistribuidorID = new int[1] ;
         H00432_A47PromocionDistribuidorID = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wpduplicarpromopromociondistribuidorwc__default(),
            new Object[][] {
                new Object[] {
               H00432_A41PromocionID, H00432_A11DistribuidorDescripcion, H00432_A10DistribuidorID, H00432_A47PromocionDistribuidorID
               }
               , new Object[] {
      ...
      private int[] H00432_A41PromocionID ;
      private string[] H00432_A11DistribuidorDescripcion ;
      private int[] H00432_A10DistribuidorID ;
      private int[] H00432_A47PromocionDistribuidorID ;
   ...
   public class wpduplicarpromopromociondistribuidorwc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             int A41PromocionID )
      {
         ...
         {
            sOrderString += " ORDER BY T1.`PromocionID`, T1.`PromocionDistribuidorID`";
         }
         else if ( ( AV13OrderedBy == 1 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.`PromocionID` DESC, T1.`PromocionDistribuidorID` DESC";
         }
         else if ( ( AV13OrderedBy == 2 ) && ! AV14OrderedDsc )
         {
            sOrderString += " ORDER BY T1.`PromocionID`, T1.`DistribuidorID`";
         }
         else if ( ( AV13OrderedBy == 2 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.`PromocionID` DESC, T1.`DistribuidorID` DESC";
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00432(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (int)dynConstraints[2] , (int)dynConstraints[3] );
               case 1 :
                     return conditional_H00433(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (int)dynConstraints[2] , (int)dynConstraints[3] );
         }
