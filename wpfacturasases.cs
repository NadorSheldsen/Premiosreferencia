...
namespace GeneXus.Programs {
   public class wpfacturasases : GXDataArea
   {
      public wpfacturasases( )
      {
      ...
      public wpfacturasases( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV258FromDate = context.localUtil.ParseDateParm( GetPar( "FromDate"));
         AV259ToDate = context.localUtil.ParseDateParm( GetPar( "ToDate"));
         ...
         AV234UsuarioID = (int)(Math.Round(NumberUtil.Val( GetPar( "UsuarioID"), "."), 18, MidpointRounding.ToEven));
         A10DistribuidorID = (int)(Math.Round(NumberUtil.Val( GetPar( "DistribuidorID"), "."), 18, MidpointRounding.ToEven));
         ajax_req_read_hidden_sdt(GetNextPar( ), AV103DistribuidorID);
         A40UsuarioRol = GetPar( "UsuarioRol");
         edtavUseraction2_Visible = (int)(Math.Round(NumberUtil.Val( GetNextPar( ), "."), 18, MidpointRounding.ToEven));
         AssignProp("", false, edtavUseraction2_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtavUseraction2_Visible), 5, 0), !bGXsfl_65_Refreshing);
         AV70Estatus = GetPar( "Estatus");
         AV253RegUsuarioID = (int)(Math.Round(NumberUtil.Val( GetPar( "RegUsuarioID"), "."), 18, MidpointRounding.ToEven));
         A11DistribuidorDescripcion = GetPar( "DistribuidorDescripcion");
         AV277UsuarioCorreo = GetPar( "UsuarioCorreo");
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         {
            GxWebError = 1;
         ...
         gxgrGrid_refresh( subGrid_Rows, AV12OrderedBy, AV13OrderedDsc, AV258FromDate, AV259ToDate, AV15FilterFullText, AV23ManageFiltersExecutionStep, AV18ColumnsSelector, AV278Pgmname, AV41TFFacturaFechaRegistro, AV42TFFacturaFechaRegistro_To, AV28TFPromocionDescripcion, AV29TFPromocionDescripcion_Sel, AV34TFFacturaNo, AV35TFFacturaNo_Sel, AV36TFFacturaFechaFactura, AV37TFFacturaFechaFactura_To, AV72TFEstatus, AV73TFEstatusOperator, AV48TFUsuarioNombreCompleto, AV49TFUsuarioNombreCompleto_Sel, AV234UsuarioID, A10DistribuidorID, AV103DistribuidorID, A40UsuarioRol, AV70Estatus, AV253RegUsuarioID, A11DistribuidorDescripcion, AV277UsuarioCorreo) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wpfacturasases.aspx") +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV278Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV278Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "vUSUARIOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV234UsuarioID), 9, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV234UsuarioID), "ZZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vREGUSUARIOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV253RegUsuarioID), 9, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vREGUSUARIOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV253RegUsuarioID), "ZZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vUSUARIOCORREO", AV277UsuarioCorreo);
         GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIOCORREO", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV277UsuarioCorreo, "")), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vFROMDATE", context.localUtil.Format(AV258FromDate, "99/99/99"));
         GxWebStd.gx_hidden_field( context, "GXH_vTODATE", context.localUtil.Format(AV259ToDate, "99/99/99"));
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vDISTRIBUIDORID_DATA", AV270DistribuidorID_Data);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vDISTRIBUIDORID_DATA", AV270DistribuidorID_Data);
         }
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vELEMENTS", AV260Elements);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vELEMENTS", AV260Elements);
         }
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vPARAMETERS", AV261Parameters);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vPARAMETERS", AV261Parameters);
         }
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vITEMCLICKDATA", AV262ItemClickData);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vITEMCLICKDATA", AV262ItemClickData);
         }
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vITEMDOUBLECLICKDATA", AV263ItemDoubleClickData);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vITEMDOUBLECLICKDATA", AV263ItemDoubleClickData);
         }
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vDRAGANDDROPDATA", AV264DragAndDropData);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vDRAGANDDROPDATA", AV264DragAndDropData);
         }
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vFILTERCHANGEDDATA", AV265FilterChangedData);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vFILTERCHANGEDDATA", AV265FilterChangedData);
         }
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vITEMEXPANDDATA", AV266ItemExpandData);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vITEMEXPANDDATA", AV266ItemExpandData);
         }
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vITEMCOLLAPSEDATA", AV267ItemCollapseData);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vITEMCOLLAPSEDATA", AV267ItemCollapseData);
         }
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_hidden_field( context, "vDDO_FACTURAFECHAREGISTROAUXDATETO", context.localUtil.DToC( AV248DDO_FacturaFechaRegistroAuxDateTo, 0, "/"));
         GxWebStd.gx_hidden_field( context, "vDDO_FACTURAFECHAFACTURAAUXDATETO", context.localUtil.DToC( AV250DDO_FacturaFechaFacturaAuxDateTo, 0, "/"));
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vDISTRIBUIDORID", AV103DistribuidorID);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vDISTRIBUIDORID", AV103DistribuidorID);
         }
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vLISTAUSUARIOS", AV274ListaUsuarios);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vLISTAUSUARIOS", AV274ListaUsuarios);
         }
         GxWebStd.gx_hidden_field( context, "vBLOB", AV255Blob);
         GxWebStd.gx_hidden_field( context, "vFACTURAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV257FacturaID), 9, 0, context.GetLanguageProperty( "decimal_point"), "")));
         ...
         GxWebStd.gx_hidden_field( context, "vDDO_FACTURAFECHAREGISTROAUXDATE", context.localUtil.DToC( AV247DDO_FacturaFechaRegistroAuxDate, 0, "/"));
         GxWebStd.gx_hidden_field( context, "vDDO_FACTURAFECHAFACTURAAUXDATE", context.localUtil.DToC( AV249DDO_FacturaFechaFacturaAuxDate, 0, "/"));
      ...
      {
         return formatLink("wpfacturasases.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "WPFacturasAses" ;
      }
      ...
      protected void WB3G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavFromdate_Internalname, context.localUtil.Format(AV258FromDate, "99/99/99"), context.localUtil.Format( AV258FromDate, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'"+context.GetLanguageProperty( "date_fmt")+"',0,"+context.GetLanguageProperty( "time_fmt")+",'"+context.GetLanguageProperty( "code")+"',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'"+context.GetLanguageProperty( "date_fmt")+"',0,"+context.GetLanguageProperty( "time_fmt")+",'"+context.GetLanguageProperty( "code")+"',false,0);"+";gx.evt.onblur(this,17);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFromdate_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavFromdate_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WPFacturasAses.htm");
            GxWebStd.gx_bitmap( context, edtavFromdate_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFromdate_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_WPFacturasAses.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavTodate_Internalname, context.localUtil.Format(AV259ToDate, "99/99/99"), context.localUtil.Format( AV259ToDate, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'"+context.GetLanguageProperty( "date_fmt")+"',0,"+context.GetLanguageProperty( "time_fmt")+",'"+context.GetLanguageProperty( "code")+"',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'"+context.GetLanguageProperty( "date_fmt")+"',0,"+context.GetLanguageProperty( "time_fmt")+",'"+context.GetLanguageProperty( "code")+"',false,0);"+";gx.evt.onblur(this,21);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTodate_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavTodate_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WPFacturasAses.htm");
            GxWebStd.gx_bitmap( context, edtavTodate_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavTodate_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_WPFacturasAses.htm");
            context.WriteHtmlTextNl( "</div>") ;
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_distribuidorid_Internalname, context.GetMessage( "Distribuidores", ""), "", "", lblTextblockcombo_distribuidorid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_WPFacturasAses.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            ...
            ucCombo_distribuidorid.SetProperty("DropDownOptionsData", AV270DistribuidorID_Data);
            ...
            /* User Defined Control */
            ucUtchartdoughnut.SetProperty("Elements", AV260Elements);
            ucUtchartdoughnut.SetProperty("Parameters", AV261Parameters);
            ...
            ucUtchartdoughnut.SetProperty("ItemClickData", AV262ItemClickData);
            ucUtchartdoughnut.SetProperty("ItemDoubleClickData", AV263ItemDoubleClickData);
            ucUtchartdoughnut.SetProperty("DragAndDropData", AV264DragAndDropData);
            ucUtchartdoughnut.SetProperty("FilterChangedData", AV265FilterChangedData);
            ucUtchartdoughnut.SetProperty("ItemExpandData", AV266ItemExpandData);
            ucUtchartdoughnut.SetProperty("ItemCollapseData", AV267ItemCollapseData);
            ucUtchartdoughnut.Render(context, "queryviewer", Utchartdoughnut_Internalname, "UTCHARTDOUGHNUTContainer");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "start", "top", "", "", "div");
            /* User Defined Control */
            ucUtchartcolumnline.SetProperty("Elements", AV260Elements);
            ucUtchartcolumnline.SetProperty("Parameters", AV261Parameters);
            ucUtchartcolumnline.SetProperty("Type", Utchartcolumnline_Type);
            ucUtchartcolumnline.SetProperty("Title", Utchartcolumnline_Title);
            ucUtchartcolumnline.SetProperty("ItemClickData", AV262ItemClickData);
            ucUtchartcolumnline.SetProperty("ItemDoubleClickData", AV263ItemDoubleClickData);
            ucUtchartcolumnline.SetProperty("DragAndDropData", AV264DragAndDropData);
            ucUtchartcolumnline.SetProperty("FilterChangedData", AV265FilterChangedData);
            ucUtchartcolumnline.SetProperty("ItemExpandData", AV266ItemExpandData);
            ucUtchartcolumnline.SetProperty("ItemCollapseData", AV267ItemCollapseData);
            ...
            GxWebStd.gx_single_line_edit( context, edtavFilterfulltext_Internalname, AV15FilterFullText, StringUtil.RTrim( context.localUtil.Format( AV15FilterFullText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,59);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", context.GetMessage( "WWP_Search", ""), edtavFilterfulltext_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavFilterfulltext_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "WorkWithPlus_Web\\WWPFullTextFilter", "start", true, "", "HLP_WPFacturasAses.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 65 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavDdo_facturafechafacturaauxdatetext_Internalname, AV40DDO_FacturaFechaFacturaAuxDateText, StringUtil.RTrim( context.localUtil.Format( AV40DDO_FacturaFechaFacturaAuxDateText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,105);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDdo_facturafechafacturaauxdatetext_Jsonclick, 0, "Attribute", "", "", "", "", 1, 1, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WPFacturasAses.htm");
            /* User Defined Control */
            ucTffacturafechafactura_rangepicker.SetProperty("Start Date", AV249DDO_FacturaFechaFacturaAuxDate);
            ucTffacturafechafactura_rangepicker.SetProperty("End Date", AV250DDO_FacturaFechaFacturaAuxDateTo);
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 15), "VPARTIDAS.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 18), "VUSERACTION4.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 18), "VUSERACTION2.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 18), "VUSERACTION4.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 15), "VPARTIDAS.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 18), "VUSERACTION2.CLICK") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtavUseraction4_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV79UserAction4)) ? AV292Useraction4_GXI : context.convertURL( context.PathToRelativeUrl( AV79UserAction4))), !bGXsfl_65_Refreshing);
                              AssignProp("", false, edtavUseraction4_Internalname, "SrcSet", context.GetImageSrcSet( AV79UserAction4), true);
                              AV83UserAction8 = cgiGet( edtavUseraction8_Internalname);
                              AssignAttri("", false, edtavUseraction8_Internalname, AV83UserAction8);
                              ...
                              AV252PartidasWithTags = cgiGet( edtavPartidaswithtags_Internalname);
                              AssignAttri("", false, edtavPartidaswithtags_Internalname, AV252PartidasWithTags);
                              AV251Partidas = cgiGet( edtavPartidas_Internalname);
                              AssignAttri("", false, edtavPartidas_Internalname, AV251Partidas);
                              ...
                              AV254DistribuidorDescripcion = cgiGet( edtavDistribuidordescripcion_Internalname);
                              AssignAttri("", false, edtavDistribuidordescripcion_Internalname, AV254DistribuidorDescripcion);
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 sEvt = StringUtil.Left( sEvt, (short)(StringUtil.Len( sEvt)-1));
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( context.localUtil.CToT( cgiGet( "GXH_vFROMDATE"), 0) != AV258FromDate )
                                       {
                                          Rfr0gs = true;
                                       }
                                       /* Set Refresh If Todate Changed */
                                       if ( context.localUtil.CToT( cgiGet( "GXH_vTODATE"), 0) != AV259ToDate )
                                       {
                                          Rfr0gs = true;
                                       }
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       short AV12OrderedBy ,
                                       bool AV13OrderedDsc ,
                                       DateTime AV258FromDate ,
                                       DateTime AV259ToDate ,
                                       ...
                                       GxSimpleCollection<int> AV103DistribuidorID ,
                                       string A40UsuarioRol ,
                                       string AV70Estatus ,
                                       int AV253RegUsuarioID ,
                                       string A11DistribuidorDescripcion ,
                                       string AV277UsuarioCorreo )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      protected void RF3G2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 A29UsuarioID ,
                                                 AV274ListaUsuarios ,
                                                 AV279Wpfacturasasesds_1_filterfulltext ,
                                                 AV280Wpfacturasasesds_2_tffacturafecharegistro ,
                                                 AV281Wpfacturasasesds_3_tffacturafecharegistro_to ,
                                                 AV283Wpfacturasasesds_5_tfpromociondescripcion_sel ,
                                                 AV282Wpfacturasasesds_4_tfpromociondescripcion ,
                                                 AV285Wpfacturasasesds_7_tffacturano_sel ,
                                                 AV284Wpfacturasasesds_6_tffacturano ,
                                                 AV286Wpfacturasasesds_8_tffacturafechafactura ,
                                                 AV287Wpfacturasasesds_9_tffacturafechafactura_to ,
                                                 AV289Wpfacturasasesds_11_tfestatusoperator ,
                                                 AV291Wpfacturasasesds_13_tfusuarionombrecompleto_sel ,
                                                 AV290Wpfacturasasesds_12_tfusuarionombrecompleto ,
                                                 AV258FromDate ,
                                                 AV259ToDate ,
                                                 AV274ListaUsuarios.Count ,
            ...
            lV279Wpfacturasasesds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV279Wpfacturasasesds_1_filterfulltext), "%", "");
            lV279Wpfacturasasesds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV279Wpfacturasasesds_1_filterfulltext), "%", "");
            lV279Wpfacturasasesds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV279Wpfacturasasesds_1_filterfulltext), "%", "");
            lV282Wpfacturasasesds_4_tfpromociondescripcion = StringUtil.Concat( StringUtil.RTrim( AV282Wpfacturasasesds_4_tfpromociondescripcion), "%", "");
            lV284Wpfacturasasesds_6_tffacturano = StringUtil.PadR( StringUtil.RTrim( AV284Wpfacturasasesds_6_tffacturano), 20, "%");
            lV290Wpfacturasasesds_12_tfusuarionombrecompleto = StringUtil.Concat( StringUtil.RTrim( AV290Wpfacturasasesds_12_tfusuarionombrecompleto), "%", "");
            /* Using cursor H003G2 */
            pr_default.execute(0, new Object[] {lV279Wpfacturasasesds_1_filterfulltext, lV279Wpfacturasasesds_1_filterfulltext, lV279Wpfacturasasesds_1_filterfulltext, AV280Wpfacturasasesds_2_tffacturafecharegistro, AV281Wpfacturasasesds_3_tffacturafecharegistro_to, lV282Wpfacturasasesds_4_tfpromociondescripcion, AV283Wpfacturasasesds_5_tfpromociondescripcion_sel, lV284Wpfacturasasesds_6_tffacturano, AV285Wpfacturasasesds_7_tffacturano_sel, AV286Wpfacturasasesds_8_tffacturafechafactura, AV287Wpfacturasasesds_9_tffacturafechafactura_to, lV290Wpfacturasasesds_12_tfusuarionombrecompleto, AV291Wpfacturasasesds_13_tfusuarionombrecompleto_sel, AV258FromDate, AV259ToDate, GXPagingFrom2, GXPagingTo2});
            nGXsfl_65_idx = 1;
            sGXsfl_65_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_65_idx), 4, 0), 4, "0");
            SubsflControlProps_652( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A41PromocionID = H003G2_A41PromocionID[0];
               A93FacturaCompleta = H003G2_A93FacturaCompleta[0];
               A19MotivoRechazoID = H003G2_A19MotivoRechazoID[0];
               A20MotivoRechazoDescripcion = H003G2_A20MotivoRechazoDescripcion[0];
               A21MotivoRechazoActivo = H003G2_A21MotivoRechazoActivo[0];
               A29UsuarioID = H003G2_A29UsuarioID[0];
               A80FacturaEstatus = H003G2_A80FacturaEstatus[0];
               A73FacturaFechaFactura = H003G2_A73FacturaFechaFactura[0];
               A71FacturaNo = H003G2_A71FacturaNo[0];
               A42PromocionDescripcion = H003G2_A42PromocionDescripcion[0];
               A72FacturaFechaRegistro = H003G2_A72FacturaFechaRegistro[0];
               A69FacturaID = H003G2_A69FacturaID[0];
               A51UsuarioApellido = H003G2_A51UsuarioApellido[0];
               A30UsuarioNombre = H003G2_A30UsuarioNombre[0];
               A42PromocionDescripcion = H003G2_A42PromocionDescripcion[0];
               A20MotivoRechazoDescripcion = H003G2_A20MotivoRechazoDescripcion[0];
               A21MotivoRechazoActivo = H003G2_A21MotivoRechazoActivo[0];
               A51UsuarioApellido = H003G2_A51UsuarioApellido[0];
      ...
      {
         AV279Wpfacturasasesds_1_filterfulltext = AV15FilterFullText;
         AV280Wpfacturasasesds_2_tffacturafecharegistro = AV41TFFacturaFechaRegistro;
         AV281Wpfacturasasesds_3_tffacturafecharegistro_to = AV42TFFacturaFechaRegistro_To;
         AV282Wpfacturasasesds_4_tfpromociondescripcion = AV28TFPromocionDescripcion;
         AV283Wpfacturasasesds_5_tfpromociondescripcion_sel = AV29TFPromocionDescripcion_Sel;
         AV284Wpfacturasasesds_6_tffacturano = AV34TFFacturaNo;
         AV285Wpfacturasasesds_7_tffacturano_sel = AV35TFFacturaNo_Sel;
         AV286Wpfacturasasesds_8_tffacturafechafactura = AV36TFFacturaFechaFactura;
         AV287Wpfacturasasesds_9_tffacturafechafactura_to = AV37TFFacturaFechaFactura_To;
         AV288Wpfacturasasesds_10_tfestatus = AV72TFEstatus;
         AV289Wpfacturasasesds_11_tfestatusoperator = AV73TFEstatusOperator;
         AV290Wpfacturasasesds_12_tfusuarionombrecompleto = AV48TFUsuarioNombreCompleto;
         AV291Wpfacturasasesds_13_tfusuarionombrecompleto_sel = AV49TFUsuarioNombreCompleto_Sel;
         ...
         lV290Wpfacturasasesds_12_tfusuarionombrecompleto = StringUtil.Concat( StringUtil.RTrim( AV290Wpfacturasasesds_12_tfusuarionombrecompleto), "%", "");
         /* Using cursor H003G3 */
         pr_default.execute(1, new Object[] {lV279Wpfacturasasesds_1_filterfulltext, lV279Wpfacturasasesds_1_filterfulltext, lV279Wpfacturasasesds_1_filterfulltext, AV280Wpfacturasasesds_2_tffacturafecharegistro, AV281Wpfacturasasesds_3_tffacturafecharegistro_to, lV282Wpfacturasasesds_4_tfpromociondescripcion, AV283Wpfacturasasesds_5_tfpromociondescripcion_sel, lV284Wpfacturasasesds_6_tffacturano, AV285Wpfacturasasesds_7_tffacturano_sel, AV286Wpfacturasasesds_8_tffacturafechafactura, AV287Wpfacturasasesds_9_tffacturafechafactura_to, lV290Wpfacturasasesds_12_tfusuarionombrecompleto, AV291Wpfacturasasesds_13_tfusuarionombrecompleto_sel, AV258FromDate, AV259ToDate});
      ...
      protected void STRUP3G0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            ajax_req_read_hidden_sdt(cgiGet( "vDISTRIBUIDORID_DATA"), AV270DistribuidorID_Data);
            ajax_req_read_hidden_sdt(cgiGet( "vELEMENTS"), AV260Elements);
            ajax_req_read_hidden_sdt(cgiGet( "vPARAMETERS"), AV261Parameters);
            ajax_req_read_hidden_sdt(cgiGet( "vITEMCLICKDATA"), AV262ItemClickData);
            ajax_req_read_hidden_sdt(cgiGet( "vITEMDOUBLECLICKDATA"), AV263ItemDoubleClickData);
            ajax_req_read_hidden_sdt(cgiGet( "vDRAGANDDROPDATA"), AV264DragAndDropData);
            ajax_req_read_hidden_sdt(cgiGet( "vFILTERCHANGEDDATA"), AV265FilterChangedData);
            ajax_req_read_hidden_sdt(cgiGet( "vITEMEXPANDDATA"), AV266ItemExpandData);
            ajax_req_read_hidden_sdt(cgiGet( "vITEMCOLLAPSEDATA"), AV267ItemCollapseData);
            ...
            ajax_req_read_hidden_sdt(cgiGet( "vDISTRIBUIDORID"), AV103DistribuidorID);
            /* Read saved values. */
            ...
            AV247DDO_FacturaFechaRegistroAuxDate = context.localUtil.CToD( cgiGet( "vDDO_FACTURAFECHAREGISTROAUXDATE"), 0);
            AV248DDO_FacturaFechaRegistroAuxDateTo = context.localUtil.CToD( cgiGet( "vDDO_FACTURAFECHAREGISTROAUXDATETO"), 0);
            AV249DDO_FacturaFechaFacturaAuxDate = context.localUtil.CToD( cgiGet( "vDDO_FACTURAFECHAFACTURAAUXDATE"), 0);
            AV250DDO_FacturaFechaFacturaAuxDateTo = context.localUtil.CToD( cgiGet( "vDDO_FACTURAFECHAFACTURAAUXDATETO"), 0);
            ...
            if ( context.localUtil.VCDate( cgiGet( edtavFromdate_Internalname), (short)(DateTimeUtil.MapDateFormat( context.GetLanguageProperty( "date_fmt")))) == 0 )
            {
               ...
               AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV258FromDate = DateTime.MinValue;
               AssignAttri("", false, "AV258FromDate", context.localUtil.Format(AV258FromDate, "99/99/99"));
            }
            else
            {
               AV258FromDate = context.localUtil.CToD( cgiGet( edtavFromdate_Internalname), DateTimeUtil.MapDateFormat( context.GetLanguageProperty( "date_fmt")));
               AssignAttri("", false, "AV258FromDate", context.localUtil.Format(AV258FromDate, "99/99/99"));
            }
            if ( context.localUtil.VCDate( cgiGet( edtavTodate_Internalname), (short)(DateTimeUtil.MapDateFormat( context.GetLanguageProperty( "date_fmt")))) == 0 )
            {
               ...
               AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV259ToDate = DateTime.MinValue;
               AssignAttri("", false, "AV259ToDate", context.localUtil.Format(AV259ToDate, "99/99/99"));
            }
            else
            {
               AV259ToDate = context.localUtil.CToD( cgiGet( edtavTodate_Internalname), DateTimeUtil.MapDateFormat( context.GetLanguageProperty( "date_fmt")));
               AssignAttri("", false, "AV259ToDate", context.localUtil.Format(AV259ToDate, "99/99/99"));
            }
            ...
            if ( DateTimeUtil.ResetTime ( context.localUtil.CToD( cgiGet( "GXH_vFROMDATE"), DateTimeUtil.MapDateFormat( context.GetLanguageProperty( "date_fmt"))) ) != DateTimeUtil.ResetTime ( AV258FromDate ) )
            {
               GRID_nFirstRecordOnPage = 0;
            }
            if ( DateTimeUtil.ResetTime ( context.localUtil.CToD( cgiGet( "GXH_vTODATE"), DateTimeUtil.MapDateFormat( context.GetLanguageProperty( "date_fmt"))) ) != DateTimeUtil.ResetTime ( AV259ToDate ) )
            {
               GRID_nFirstRecordOnPage = 0;
            }
            if ( StringUtil.StrCmp(cgiGet( "GXH_vFILTERFULLTEXT"), AV15FilterFullText) != 0 )
      ...
      protected void E173G2( )
      {
         ...
         AV234UsuarioID = AV75SDTUsuario.gxTpr_Usuarioid;
         AssignAttri("", false, "AV234UsuarioID", StringUtil.LTrimStr( (decimal)(AV234UsuarioID), 9, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV234UsuarioID), "ZZZZZZZZ9"), context));
         AV277UsuarioCorreo = StringUtil.Lower( StringUtil.Trim( AV75SDTUsuario.gxTpr_Usuariocorreo));
         AssignAttri("", false, "AV277UsuarioCorreo", AV277UsuarioCorreo);
         GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIOCORREO", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV277UsuarioCorreo, "")), context));
         ...
         AV259ToDate = DateTimeUtil.Today( context);
         AssignAttri("", false, "AV259ToDate", context.localUtil.Format(AV259ToDate, "99/99/99"));
         AV258FromDate = DateTimeUtil.AddMth( AV259ToDate, -3);
         AssignAttri("", false, "AV258FromDate", context.localUtil.Format(AV258FromDate, "99/99/99"));
         ...
         Utchartdoughnut_Objectcall = "[ \""+"dp"+"\", \""+StringUtil.JSONEncode( "DPFacturaEstatusFiltrado")+"\", \""+StringUtil.JSONEncode( context.localUtil.Format(AV258FromDate, "99/99/99"))+"\", \""+StringUtil.JSONEncode( context.localUtil.Format(AV259ToDate, "99/99/99"))+"\", \""+StringUtil.JSONEncode( AV274ListaUsuarios.ToJSonString(false))+"\" ]";
         ucUtchartdoughnut.SendProperty(context, "", false, Utchartdoughnut_Internalname, "Object", Utchartdoughnut_Objectcall);
         Utchartcolumnline_Objectcall = "[ \""+"dp"+"\", \""+StringUtil.JSONEncode( "DPGraficaFacturasPorMesFiltrado")+"\", \""+StringUtil.JSONEncode( context.localUtil.Format(AV258FromDate, "99/99/99"))+"\", \""+StringUtil.JSONEncode( context.localUtil.Format(AV259ToDate, "99/99/99"))+"\", \""+StringUtil.JSONEncode( AV274ListaUsuarios.ToJSonString(false))+"\" ]";
      ...
      protected void E183G2( )
      {
         ...
         if ( StringUtil.StrCmp(AV20Session.Get("WPFacturasAsesColumnsSelector"), "") != 0 )
         {
            AV16ColumnsSelectorXML = AV20Session.Get("WPFacturasAsesColumnsSelector");
         ...
         AssignProp("", false, edtavDistribuidordescripcion_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtavDistribuidordescripcion_Visible), 5, 0), !bGXsfl_65_Refreshing);
         ...
         new WorkWithPlus.workwithplus_web.wwp_getappliedfiltersdescription(context ).execute(  AV278Pgmname, out  GXt_char2) ;
         ...
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV274ListaUsuarios", AV274ListaUsuarios);
      ...
      private void E193G2( )
      {
         ...
         AV251Partidas = context.GetMessage( "Partidas", "");
         AssignAttri("", false, edtavPartidas_Internalname, AV251Partidas);
         AV253RegUsuarioID = A29UsuarioID;
         AssignAttri("", false, "AV253RegUsuarioID", StringUtil.LTrimStr( (decimal)(AV253RegUsuarioID), 9, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vREGUSUARIOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV253RegUsuarioID), "ZZZZZZZZ9"), context));
         ...
         AV292Useraction4_GXI = GXDbFile.PathToUrl( context.GetImagePath( "b97efd0f-8d9d-4227-92c4-9cbec8912646", "", context.GetTheme( )), context);
         edtavUseraction4_Tooltiptext = "";
         AV83UserAction8 = "<i class=\"IconoEditarAzul fas fa-magnifying-glass\"></i>";
         AssignAttri("", false, edtavUseraction8_Internalname, AV83UserAction8);
         if ( String.IsNullOrEmpty(StringUtil.RTrim( context.GetCookie( "GX_SESSION_ID"))) )
         {
            gxcookieaux = context.SetCookie( "GX_SESSION_ID", Encrypt64( Crypto.GetEncryptionKey( ), Crypto.GetServerKey( )), "", (DateTime)(DateTime.MinValue), "", (short)(context.GetHttpSecure( )));
         ...
         AssignAttri("", false, edtavUseraction2_Internalname, AV80UserAction2);
         GXt_char2 = AV252PartidasWithTags;
         new WorkWithPlus.workwithplus_web.wwp_encodehtml(context ).execute(  AV251Partidas, out  GXt_char2) ;
         AV252PartidasWithTags = GXt_char2;
         AssignAttri("", false, edtavPartidaswithtags_Internalname, AV252PartidasWithTags);
         AV252PartidasWithTags += "<i class='WWPPopoverIcon FontColorIcon fas fa-angle-down'></i>";
         AssignAttri("", false, edtavPartidaswithtags_Internalname, AV252PartidasWithTags);
      ...
      protected void E153G2( )
      {
         ...
         new WorkWithPlus.workwithplus_web.savecolumnsselectorstate(context ).execute(  "WPFacturasAsesColumnsSelector",  (String.IsNullOrEmpty(StringUtil.RTrim( AV16ColumnsSelectorXML)) ? "" : AV18ColumnsSelector.ToXml(false, true, "", ""))) ;
      ...
      protected void E113G2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("WPFacturasAsesFilters")) + "," + UrlEncode(StringUtil.RTrim(AV278Pgmname+"GridState"));
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Manage#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.managefilters.aspx"+UrlEncode(StringUtil.RTrim("WPFacturasAsesFilters"));
         ...
         else
         {
            ...
            new WorkWithPlus.workwithplus_web.getfilterbyname(context ).execute(  "WPFacturasAsesFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char2) ;
            ...
            else
            {
               ...
               new WorkWithPlus.workwithplus_web.savegridstate(context ).execute(  AV278Pgmname+"GridState",  AV22ManageFiltersXml) ;
      ...
      protected void S182( )
      {
         ...
         new WorkWithPlus.workwithplus_web.loadcolumnsselectorstate(context ).execute(  "WPFacturasAsesColumnsSelector", out  GXt_char2) ;
      ...
      protected void S132( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_managefiltersloadsavedfilters(context ).execute(  "WPFacturasAsesFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item3) ;
      ...
      protected void S152( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV20Session.Get(AV278Pgmname+"GridState"), "") == 0 )
         {
            AV10GridState.FromXml(new WorkWithPlus.workwithplus_web.loadgridstate(context).executeUdp(  AV278Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV10GridState.FromXml(AV20Session.Get(AV278Pgmname+"GridState"), null, "", "");
         }
         AV12OrderedBy = AV10GridState.gxTpr_Orderedby;
         AssignAttri("", false, "AV12OrderedBy", StringUtil.LTrimStr( (decimal)(AV12OrderedBy), 4, 0));
         AV13OrderedDsc = AV10GridState.gxTpr_Ordereddsc;
      ...
      protected void S212( )
      {
         ...
         returnInSub = false;
         AV293GXV1 = 1;
         while ( AV293GXV1 <= AV10GridState.gxTpr_Filtervalues.Count )
         {
            AV11GridStateFilterValue = ((WorkWithPlus.workwithplus_web.SdtWWPGridState_FilterValue)AV10GridState.gxTpr_Filtervalues.Item(AV293GXV1));
      ...
      protected void S172( )
      {
         ...
         new WorkWithPlus.workwithplus_web.savegridstate(context ).execute(  AV278Pgmname+"GridState",  AV10GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void S142( )
      {
         ...
         AV8TrnContext.gxTpr_Callerobject = AV278Pgmname;
      ...
      protected void S122( )
      {
         ...
         {
            A10DistribuidorID = H003G4_A10DistribuidorID[0];
            A11DistribuidorDescripcion = H003G4_A11DistribuidorDescripcion[0];
            AV271Combo_DataItem = new WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item(context);
            AV271Combo_DataItem.gxTpr_Id = StringUtil.Trim( StringUtil.Str( (decimal)(A10DistribuidorID), 9, 0));
            AV271Combo_DataItem.gxTpr_Title = A11DistribuidorDescripcion;
            AV270DistribuidorID_Data.Add(AV271Combo_DataItem, 0);
            pr_default.readNext(2);
         }
         pr_default.close(2);
         Combo_distribuidorid_Selectedvalue_set = AV103DistribuidorID.ToJSonString(false);
      ...
      protected void E213G2( )
      {
         ...
         returnInSub = false;
         AV257FacturaID = A69FacturaID;
         AssignAttri("", false, "AV257FacturaID", StringUtil.LTrimStr( (decimal)(AV257FacturaID), 9, 0));
         ...
         AV256FileURL = context.PathToUrl( AV255Blob);
         Innwewindow_Target = AV256FileURL;
      ...
      protected void E223G2( )
      {
         ...
         returnInSub = false;
         if ( ( StringUtil.StrCmp(AV277UsuarioCorreo, context.GetMessage( "lehr777@hotmail.com", "")) == 0 ) || ( StringUtil.StrCmp(AV277UsuarioCorreo, context.GetMessage( "mercadotecnia@yokohamatire.mx", "")) == 0 ) )
         {
            if ( String.IsNullOrEmpty(StringUtil.RTrim( context.GetCookie( "GX_SESSION_ID"))) )
            {
               gxcookieaux = context.SetCookie( "GX_SESSION_ID", Encrypt64( Crypto.GetEncryptionKey( ), Crypto.GetServerKey( )), "", (DateTime)(DateTime.MinValue), "", (short)(context.GetHttpSecure( )));
      ...
      protected void S192( )
      {
         ...
         returnInSub = false;
         /* Using cursor H003G5 */
         pr_default.execute(3, new Object[] {AV253RegUsuarioID});
         while ( (pr_default.getStatus(3) != 101) )
         {
            A10DistribuidorID = H003G5_A10DistribuidorID[0];
            A29UsuarioID = H003G5_A29UsuarioID[0];
            A11DistribuidorDescripcion = H003G5_A11DistribuidorDescripcion[0];
            A11DistribuidorDescripcion = H003G5_A11DistribuidorDescripcion[0];
            AV254DistribuidorDescripcion = A11DistribuidorDescripcion;
            AssignAttri("", false, edtavDistribuidordescripcion_Internalname, AV254DistribuidorDescripcion);
      ...
      protected void S222( )
      {
         ...
         returnInSub = false;
         /* Using cursor H003G6 */
         pr_default.execute(4, new Object[] {AV257FacturaID});
         while ( (pr_default.getStatus(4) != 101) )
         {
            A69FacturaID = H003G6_A69FacturaID[0];
            A40000FacturaPDF_GXI = H003G6_A40000FacturaPDF_GXI[0];
            A75FacturaPDF = H003G6_A75FacturaPDF[0];
            AV255Blob = A75FacturaPDF;
            AssignAttri("", false, "AV255Blob", AV255Blob);
            /* Exit For each command. Update data (if necessary), close cursors & exit. */
            if (true) break;
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV274ListaUsuarios.Clear();
         AV272DistribuidoresAutorizados.Clear();
         /* Using cursor H003G7 */
         pr_default.execute(5, new Object[] {AV234UsuarioID});
         while ( (pr_default.getStatus(5) != 101) )
         {
            A29UsuarioID = H003G7_A29UsuarioID[0];
            A10DistribuidorID = H003G7_A10DistribuidorID[0];
            AV139Pasa = false;
            AV298GXV2 = 1;
            while ( AV298GXV2 <= AV272DistribuidoresAutorizados.Count )
            {
               AV273DistID = (int)(AV272DistribuidoresAutorizados.GetNumeric(AV298GXV2));
               if ( AV273DistID == A10DistribuidorID )
               {
                  AV139Pasa = true;
                  if (true) break;
               }
               AV298GXV2 = (int)(AV298GXV2+1);
            }
            if ( ! AV139Pasa )
            {
               AV272DistribuidoresAutorizados.Add(A10DistribuidorID, 0);
            }
            pr_default.readNext(5);
         }
         pr_default.close(5);
         if ( AV103DistribuidorID.Count == 0 )
         {
            AV275DistribuidoresFiltrados = AV272DistribuidoresAutorizados;
         }
         else
         {
            AV275DistribuidoresFiltrados.Clear();
            AV299GXV3 = 1;
            while ( AV299GXV3 <= AV103DistribuidorID.Count )
            {
               AV273DistID = (int)(AV103DistribuidorID.GetNumeric(AV299GXV3));
               AV139Pasa = false;
               AV300GXV4 = 1;
               while ( AV300GXV4 <= AV272DistribuidoresAutorizados.Count )
               {
                  AV276DistAut = (int)(AV272DistribuidoresAutorizados.GetNumeric(AV300GXV4));
                  if ( AV273DistID == AV276DistAut )
                  {
                     AV139Pasa = true;
                     if (true) break;
                  }
                  AV300GXV4 = (int)(AV300GXV4+1);
               }
               if ( AV139Pasa )
               {
                  AV275DistribuidoresFiltrados.Add(AV273DistID, 0);
               }
               AV299GXV3 = (int)(AV299GXV3+1);
            }
         }
         pr_default.dynParam(6, new Object[]{ new Object[]{
                                              A10DistribuidorID ,
                                              AV275DistribuidoresFiltrados ,
                                              A40UsuarioRol } ,
                                              new int[]{
                                              TypeConstants.INT
                                              }
         ...
         {
            A10DistribuidorID = H003G8_A10DistribuidorID[0];
            A40UsuarioRol = H003G8_A40UsuarioRol[0];
            A29UsuarioID = H003G8_A29UsuarioID[0];
            A40UsuarioRol = H003G8_A40UsuarioRol[0];
            AV139Pasa = false;
            AV302GXV5 = 1;
            while ( AV302GXV5 <= AV274ListaUsuarios.Count )
            {
               AV238UsuariosListaID = (int)(AV274ListaUsuarios.GetNumeric(AV302GXV5));
               if ( AV238UsuariosListaID == A29UsuarioID )
               {
                  AV139Pasa = true;
                  if (true) break;
               }
               AV302GXV5 = (int)(AV302GXV5+1);
            }
            if ( ! AV139Pasa )
            {
               AV274ListaUsuarios.Add(A29UsuarioID, 0);
            }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202651111311764", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wpfacturasases.js", "?202651111311764", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("QueryViewer/QueryViewerCommon.js", "", false, true);
      ...
      protected void SubsflControlProps_652( )
      {
         ...
         edtavUseraction8_Internalname = "vUSERACTION8_"+sGXsfl_65_idx;
         ...
         edtavDistribuidordescripcion_Internalname = "vDISTRIBUIDORDESCRIPCION_"+sGXsfl_65_idx;
      }
      ...
      protected void SubsflControlProps_fel_652( )
      {
         ...
         edtavUseraction8_Internalname = "vUSERACTION8_"+sGXsfl_65_fel_idx;
         ...
         edtavDistribuidordescripcion_Internalname = "vDISTRIBUIDORDESCRIPCION_"+sGXsfl_65_fel_idx;
      }
      ...
      protected void sendrow_652( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_65_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            AV79UserAction4_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV79UserAction4))&&String.IsNullOrEmpty(StringUtil.RTrim( AV292Useraction4_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV79UserAction4)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV79UserAction4)) ? AV292Useraction4_GXI : context.PathToRelativeUrl( AV79UserAction4));
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavPartidas_Internalname,StringUtil.RTrim( AV251Partidas),(string)"",""+" onchange=\""+""+";gx.evt.onchange(this, event)\" ","'"+""+"'"+",false,"+"'"+"EVPARTIDAS.CLICK."+sGXsfl_65_idx+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavPartidas_Jsonclick,(short)5,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn ColumnSizeLarge ColumnWeightBold ColumnHighlightBackground ColumnLeftDivision",(string)"",(short)0,(int)edtavPartidas_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)40,(short)0,(short)0,(short)65,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      protected void StartGridControl65( )
      {
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( AV83UserAction8)));
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( AV252PartidasWithTags));
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( AV251Partidas)));
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( AV254DistribuidorDescripcion));
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Datalistproc = "WPFacturasAsesGetFilterData";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"AV258FromDate","fld":"vFROMDATE"},{"av":"AV259ToDate","fld":"vTODATE"},{"av":"edtavUseraction2_Visible","ctrl":"vUSERACTION2","prop":"Visible"},{"av":"AV70Estatus","fld":"vESTATUS","hsh":true},{"av":"A11DistribuidorDescripcion","fld":"DISTRIBUIDORDESCRIPCION"},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV12OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV278Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV41TFFacturaFechaRegistro","fld":"vTFFACTURAFECHAREGISTRO"},{"av":"AV42TFFacturaFechaRegistro_To","fld":"vTFFACTURAFECHAREGISTRO_TO"},{"av":"AV28TFPromocionDescripcion","fld":"vTFPROMOCIONDESCRIPCION"},{"av":"AV29TFPromocionDescripcion_Sel","fld":"vTFPROMOCIONDESCRIPCION_SEL"},{"av":"AV34TFFacturaNo","fld":"vTFFACTURANO"},{"av":"AV35TFFacturaNo_Sel","fld":"vTFFACTURANO_SEL"},{"av":"AV36TFFacturaFechaFactura","fld":"vTFFACTURAFECHAFACTURA"},{"av":"AV37TFFacturaFechaFactura_To","fld":"vTFFACTURAFECHAFACTURA_TO"},{"av":"AV72TFEstatus","fld":"vTFESTATUS"},{"av":"AV73TFEstatusOperator","fld":"vTFESTATUSOPERATOR","pic":"ZZZ9"},{"av":"AV48TFUsuarioNombreCompleto","fld":"vTFUSUARIONOMBRECOMPLETO"},{"av":"AV49TFUsuarioNombreCompleto_Sel","fld":"vTFUSUARIONOMBRECOMPLETO_SEL"},{"av":"AV234UsuarioID","fld":"vUSUARIOID","pic":"ZZZZZZZZ9","hsh":true},{"av":"A10DistribuidorID","fld":"DISTRIBUIDORID","pic":"ZZZZZZZZ9"},{"av":"AV103DistribuidorID","fld":"vDISTRIBUIDORID"},{"av":"A40UsuarioRol","fld":"USUARIOROL"},{"av":"AV253RegUsuarioID","fld":"vREGUSUARIOID","pic":"ZZZZZZZZ9","hsh":true},{"av":"AV277UsuarioCorreo","fld":"vUSUARIOCORREO","hsh":true},{"av":"A29UsuarioID","fld":"USUARIOID","pic":"ZZZZZZZZ9","hsh":true}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtFacturaFechaRegistro_Visible","ctrl":"FACTURAFECHAREGISTRO","prop":"Visible"},{"av":"edtPromocionDescripcion_Visible","ctrl":"PROMOCIONDESCRIPCION","prop":"Visible"},{"av":"edtFacturaNo_Visible","ctrl":"FACTURANO","prop":"Visible"},{"av":"edtFacturaFechaFactura_Visible","ctrl":"FACTURAFECHAFACTURA","prop":"Visible"},{"av":"edtavPartidaswithtags_Visible","ctrl":"vPARTIDASWITHTAGS","prop":"Visible"},{"av":"edtavEstatuswithtags_Visible","ctrl":"vESTATUSWITHTAGS","prop":"Visible"},{"av":"edtavDescripcion_Visible","ctrl":"vDESCRIPCION","prop":"Visible"},{"av":"edtUsuarioNombreCompleto_Visible","ctrl":"USUARIONOMBRECOMPLETO","prop":"Visible"},{"av":"edtavDistribuidordescripcion_Visible","ctrl":"vDISTRIBUIDORDESCRIPCION","prop":"Visible"},{"av":"AV62GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV63GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV64GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"edtavUseraction2_Visible","ctrl":"vUSERACTION2","prop":"Visible"},{"av":"AV274ListaUsuarios","fld":"vLISTAUSUARIOS"},{"av":"AV21ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV10GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E123G2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV12OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV258FromDate","fld":"vFROMDATE"},{"av":"AV259ToDate","fld":"vTODATE"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV278Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV41TFFacturaFechaRegistro","fld":"vTFFACTURAFECHAREGISTRO"},{"av":"AV42TFFacturaFechaRegistro_To","fld":"vTFFACTURAFECHAREGISTRO_TO"},{"av":"AV28TFPromocionDescripcion","fld":"vTFPROMOCIONDESCRIPCION"},{"av":"AV29TFPromocionDescripcion_Sel","fld":"vTFPROMOCIONDESCRIPCION_SEL"},{"av":"AV34TFFacturaNo","fld":"vTFFACTURANO"},{"av":"AV35TFFacturaNo_Sel","fld":"vTFFACTURANO_SEL"},{"av":"AV36TFFacturaFechaFactura","fld":"vTFFACTURAFECHAFACTURA"},{"av":"AV37TFFacturaFechaFactura_To","fld":"vTFFACTURAFECHAFACTURA_TO"},{"av":"AV72TFEstatus","fld":"vTFESTATUS"},{"av":"AV73TFEstatusOperator","fld":"vTFESTATUSOPERATOR","pic":"ZZZ9"},{"av":"AV48TFUsuarioNombreCompleto","fld":"vTFUSUARIONOMBRECOMPLETO"},{"av":"AV49TFUsuarioNombreCompleto_Sel","fld":"vTFUSUARIONOMBRECOMPLETO_SEL"},{"av":"AV234UsuarioID","fld":"vUSUARIOID","pic":"ZZZZZZZZ9","hsh":true},{"av":"A10DistribuidorID","fld":"DISTRIBUIDORID","pic":"ZZZZZZZZ9"},{"av":"AV103DistribuidorID","fld":"vDISTRIBUIDORID"},{"av":"A40UsuarioRol","fld":"USUARIOROL"},{"av":"edtavUseraction2_Visible","ctrl":"vUSERACTION2","prop":"Visible"},{"av":"AV70Estatus","fld":"vESTATUS","hsh":true},{"av":"AV253RegUsuarioID","fld":"vREGUSUARIOID","pic":"ZZZZZZZZ9","hsh":true},{"av":"A11DistribuidorDescripcion","fld":"DISTRIBUIDORDESCRIPCION"},{"av":"AV277UsuarioCorreo","fld":"vUSUARIOCORREO","hsh":true},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","""{"handler":"E133G2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV12OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV258FromDate","fld":"vFROMDATE"},{"av":"AV259ToDate","fld":"vTODATE"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV278Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV41TFFacturaFechaRegistro","fld":"vTFFACTURAFECHAREGISTRO"},{"av":"AV42TFFacturaFechaRegistro_To","fld":"vTFFACTURAFECHAREGISTRO_TO"},{"av":"AV28TFPromocionDescripcion","fld":"vTFPROMOCIONDESCRIPCION"},{"av":"AV29TFPromocionDescripcion_Sel","fld":"vTFPROMOCIONDESCRIPCION_SEL"},{"av":"AV34TFFacturaNo","fld":"vTFFACTURANO"},{"av":"AV35TFFacturaNo_Sel","fld":"vTFFACTURANO_SEL"},{"av":"AV36TFFacturaFechaFactura","fld":"vTFFACTURAFECHAFACTURA"},{"av":"AV37TFFacturaFechaFactura_To","fld":"vTFFACTURAFECHAFACTURA_TO"},{"av":"AV72TFEstatus","fld":"vTFESTATUS"},{"av":"AV73TFEstatusOperator","fld":"vTFESTATUSOPERATOR","pic":"ZZZ9"},{"av":"AV48TFUsuarioNombreCompleto","fld":"vTFUSUARIONOMBRECOMPLETO"},{"av":"AV49TFUsuarioNombreCompleto_Sel","fld":"vTFUSUARIONOMBRECOMPLETO_SEL"},{"av":"AV234UsuarioID","fld":"vUSUARIOID","pic":"ZZZZZZZZ9","hsh":true},{"av":"A10DistribuidorID","fld":"DISTRIBUIDORID","pic":"ZZZZZZZZ9"},{"av":"AV103DistribuidorID","fld":"vDISTRIBUIDORID"},{"av":"A40UsuarioRol","fld":"USUARIOROL"},{"av":"edtavUseraction2_Visible","ctrl":"vUSERACTION2","prop":"Visible"},{"av":"AV70Estatus","fld":"vESTATUS","hsh":true},{"av":"AV253RegUsuarioID","fld":"vREGUSUARIOID","pic":"ZZZZZZZZ9","hsh":true},{"av":"A11DistribuidorDescripcion","fld":"DISTRIBUIDORDESCRIPCION"},{"av":"AV277UsuarioCorreo","fld":"vUSUARIOCORREO","hsh":true},{"av":"Gridpaginationbar_Rowsperpageselectedvalue","ctrl":"GRIDPAGINATIONBAR","prop":"RowsPerPageSelectedValue"}]""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",""","oparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]}""");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","""{"handler":"E143G2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV12OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV258FromDate","fld":"vFROMDATE"},{"av":"AV259ToDate","fld":"vTODATE"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV278Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV41TFFacturaFechaRegistro","fld":"vTFFACTURAFECHAREGISTRO"},{"av":"AV42TFFacturaFechaRegistro_To","fld":"vTFFACTURAFECHAREGISTRO_TO"},{"av":"AV28TFPromocionDescripcion","fld":"vTFPROMOCIONDESCRIPCION"},{"av":"AV29TFPromocionDescripcion_Sel","fld":"vTFPROMOCIONDESCRIPCION_SEL"},{"av":"AV34TFFacturaNo","fld":"vTFFACTURANO"},{"av":"AV35TFFacturaNo_Sel","fld":"vTFFACTURANO_SEL"},{"av":"AV36TFFacturaFechaFactura","fld":"vTFFACTURAFECHAFACTURA"},{"av":"AV37TFFacturaFechaFactura_To","fld":"vTFFACTURAFECHAFACTURA_TO"},{"av":"AV72TFEstatus","fld":"vTFESTATUS"},{"av":"AV73TFEstatusOperator","fld":"vTFESTATUSOPERATOR","pic":"ZZZ9"},{"av":"AV48TFUsuarioNombreCompleto","fld":"vTFUSUARIONOMBRECOMPLETO"},{"av":"AV49TFUsuarioNombreCompleto_Sel","fld":"vTFUSUARIONOMBRECOMPLETO_SEL"},{"av":"AV234UsuarioID","fld":"vUSUARIOID","pic":"ZZZZZZZZ9","hsh":true},{"av":"A10DistribuidorID","fld":"DISTRIBUIDORID","pic":"ZZZZZZZZ9"},{"av":"AV103DistribuidorID","fld":"vDISTRIBUIDORID"},{"av":"A40UsuarioRol","fld":"USUARIOROL"},{"av":"edtavUseraction2_Visible","ctrl":"vUSERACTION2","prop":"Visible"},{"av":"AV70Estatus","fld":"vESTATUS","hsh":true},{"av":"AV253RegUsuarioID","fld":"vREGUSUARIOID","pic":"ZZZZZZZZ9","hsh":true},{"av":"A11DistribuidorDescripcion","fld":"DISTRIBUIDORDESCRIPCION"},{"av":"AV277UsuarioCorreo","fld":"vUSUARIOCORREO","hsh":true},{"av":"Ddo_grid_Activeeventkey","ctrl":"DDO_GRID","prop":"ActiveEventKey"},{"av":"Ddo_grid_Selectedvalue_get","ctrl":"DDO_GRID","prop":"SelectedValue_get"},{"av":"Ddo_grid_Filteredtextto_get","ctrl":"DDO_GRID","prop":"FilteredTextTo_get"},{"av":"Ddo_grid_Selectedcolumnfixedfilter","ctrl":"DDO_GRID","prop":"SelectedColumnFixedFilter"},{"av":"Ddo_grid_Filteredtext_get","ctrl":"DDO_GRID","prop":"FilteredText_get"},{"av":"Ddo_grid_Selectedcolumn","ctrl":"DDO_GRID","prop":"SelectedColumn"}]""");
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E193G2","iparms":[{"av":"cmbFacturaEstatus"},{"av":"A80FacturaEstatus","fld":"FACTURAESTATUS","hsh":true},{"av":"A20MotivoRechazoDescripcion","fld":"MOTIVORECHAZODESCRIPCION"},{"av":"A29UsuarioID","fld":"USUARIOID","pic":"ZZZZZZZZ9","hsh":true},{"av":"A69FacturaID","fld":"FACTURAID","pic":"ZZZZZZZZ9","hsh":true},{"av":"AV70Estatus","fld":"vESTATUS","hsh":true},{"av":"AV253RegUsuarioID","fld":"vREGUSUARIOID","pic":"ZZZZZZZZ9","hsh":true},{"av":"A11DistribuidorDescripcion","fld":"DISTRIBUIDORDESCRIPCION"}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"AV81Descripcion","fld":"vDESCRIPCION"},{"av":"AV251Partidas","fld":"vPARTIDAS"},{"av":"AV253RegUsuarioID","fld":"vREGUSUARIOID","pic":"ZZZZZZZZ9","hsh":true},{"av":"AV79UserAction4","fld":"vUSERACTION4"},{"av":"edtavUseraction4_Tooltiptext","ctrl":"vUSERACTION4","prop":"Tooltiptext"},{"av":"AV83UserAction8","fld":"vUSERACTION8"},{"av":"edtavUseraction8_Link","ctrl":"vUSERACTION8","prop":"Link"},{"av":"AV80UserAction2","fld":"vUSERACTION2"},{"av":"AV252PartidasWithTags","fld":"vPARTIDASWITHTAGS"},{"av":"AV71EstatusWithTags","fld":"vESTATUSWITHTAGS"},{"av":"AV254DistribuidorDescripcion","fld":"vDISTRIBUIDORDESCRIPCION"}]}""");
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED","""{"handler":"E153G2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV12OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV258FromDate","fld":"vFROMDATE"},{"av":"AV259ToDate","fld":"vTODATE"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV278Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV41TFFacturaFechaRegistro","fld":"vTFFACTURAFECHAREGISTRO"},{"av":"AV42TFFacturaFechaRegistro_To","fld":"vTFFACTURAFECHAREGISTRO_TO"},{"av":"AV28TFPromocionDescripcion","fld":"vTFPROMOCIONDESCRIPCION"},{"av":"AV29TFPromocionDescripcion_Sel","fld":"vTFPROMOCIONDESCRIPCION_SEL"},{"av":"AV34TFFacturaNo","fld":"vTFFACTURANO"},{"av":"AV35TFFacturaNo_Sel","fld":"vTFFACTURANO_SEL"},{"av":"AV36TFFacturaFechaFactura","fld":"vTFFACTURAFECHAFACTURA"},{"av":"AV37TFFacturaFechaFactura_To","fld":"vTFFACTURAFECHAFACTURA_TO"},{"av":"AV72TFEstatus","fld":"vTFESTATUS"},{"av":"AV73TFEstatusOperator","fld":"vTFESTATUSOPERATOR","pic":"ZZZ9"},{"av":"AV48TFUsuarioNombreCompleto","fld":"vTFUSUARIONOMBRECOMPLETO"},{"av":"AV49TFUsuarioNombreCompleto_Sel","fld":"vTFUSUARIONOMBRECOMPLETO_SEL"},{"av":"AV234UsuarioID","fld":"vUSUARIOID","pic":"ZZZZZZZZ9","hsh":true},{"av":"A10DistribuidorID","fld":"DISTRIBUIDORID","pic":"ZZZZZZZZ9"},{"av":"AV103DistribuidorID","fld":"vDISTRIBUIDORID"},{"av":"A40UsuarioRol","fld":"USUARIOROL"},{"av":"edtavUseraction2_Visible","ctrl":"vUSERACTION2","prop":"Visible"},{"av":"AV70Estatus","fld":"vESTATUS","hsh":true},{"av":"AV253RegUsuarioID","fld":"vREGUSUARIOID","pic":"ZZZZZZZZ9","hsh":true},{"av":"A11DistribuidorDescripcion","fld":"DISTRIBUIDORDESCRIPCION"},{"av":"AV277UsuarioCorreo","fld":"vUSUARIOCORREO","hsh":true},{"av":"Ddo_gridcolumnsselector_Columnsselectorvalues","ctrl":"DDO_GRIDCOLUMNSSELECTOR","prop":"ColumnsSelectorValues"},{"av":"A29UsuarioID","fld":"USUARIOID","pic":"ZZZZZZZZ9","hsh":true}]""");
         ...
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","""{"handler":"E113G2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV12OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV258FromDate","fld":"vFROMDATE"},{"av":"AV259ToDate","fld":"vTODATE"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV278Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV41TFFacturaFechaRegistro","fld":"vTFFACTURAFECHAREGISTRO"},{"av":"AV42TFFacturaFechaRegistro_To","fld":"vTFFACTURAFECHAREGISTRO_TO"},{"av":"AV28TFPromocionDescripcion","fld":"vTFPROMOCIONDESCRIPCION"},{"av":"AV29TFPromocionDescripcion_Sel","fld":"vTFPROMOCIONDESCRIPCION_SEL"},{"av":"AV34TFFacturaNo","fld":"vTFFACTURANO"},{"av":"AV35TFFacturaNo_Sel","fld":"vTFFACTURANO_SEL"},{"av":"AV36TFFacturaFechaFactura","fld":"vTFFACTURAFECHAFACTURA"},{"av":"AV37TFFacturaFechaFactura_To","fld":"vTFFACTURAFECHAFACTURA_TO"},{"av":"AV72TFEstatus","fld":"vTFESTATUS"},{"av":"AV73TFEstatusOperator","fld":"vTFESTATUSOPERATOR","pic":"ZZZ9"},{"av":"AV48TFUsuarioNombreCompleto","fld":"vTFUSUARIONOMBRECOMPLETO"},{"av":"AV49TFUsuarioNombreCompleto_Sel","fld":"vTFUSUARIONOMBRECOMPLETO_SEL"},{"av":"AV234UsuarioID","fld":"vUSUARIOID","pic":"ZZZZZZZZ9","hsh":true},{"av":"A10DistribuidorID","fld":"DISTRIBUIDORID","pic":"ZZZZZZZZ9"},{"av":"AV103DistribuidorID","fld":"vDISTRIBUIDORID"},{"av":"A40UsuarioRol","fld":"USUARIOROL"},{"av":"edtavUseraction2_Visible","ctrl":"vUSERACTION2","prop":"Visible"},{"av":"AV70Estatus","fld":"vESTATUS","hsh":true},{"av":"AV253RegUsuarioID","fld":"vREGUSUARIOID","pic":"ZZZZZZZZ9","hsh":true},{"av":"A11DistribuidorDescripcion","fld":"DISTRIBUIDORDESCRIPCION"},{"av":"AV277UsuarioCorreo","fld":"vUSUARIOCORREO","hsh":true},{"av":"Ddo_managefilters_Activeeventkey","ctrl":"DDO_MANAGEFILTERS","prop":"ActiveEventKey"},{"av":"AV10GridState","fld":"vGRIDSTATE"},{"av":"A29UsuarioID","fld":"USUARIOID","pic":"ZZZZZZZZ9","hsh":true}]""");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED",""","oparms":[{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV10GridState","fld":"vGRIDSTATE"},{"av":"AV12OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV41TFFacturaFechaRegistro","fld":"vTFFACTURAFECHAREGISTRO"},{"av":"AV42TFFacturaFechaRegistro_To","fld":"vTFFACTURAFECHAREGISTRO_TO"},{"av":"AV28TFPromocionDescripcion","fld":"vTFPROMOCIONDESCRIPCION"},{"av":"AV29TFPromocionDescripcion_Sel","fld":"vTFPROMOCIONDESCRIPCION_SEL"},{"av":"AV34TFFacturaNo","fld":"vTFFACTURANO"},{"av":"AV35TFFacturaNo_Sel","fld":"vTFFACTURANO_SEL"},{"av":"AV36TFFacturaFechaFactura","fld":"vTFFACTURAFECHAFACTURA"},{"av":"AV37TFFacturaFechaFactura_To","fld":"vTFFACTURAFECHAFACTURA_TO"},{"av":"AV73TFEstatusOperator","fld":"vTFESTATUSOPERATOR","pic":"ZZZ9"},{"av":"Ddo_grid_Selectedfixedfilter","ctrl":"DDO_GRID","prop":"SelectedFixedFilter"},{"av":"AV48TFUsuarioNombreCompleto","fld":"vTFUSUARIONOMBRECOMPLETO"},{"av":"AV49TFUsuarioNombreCompleto_Sel","fld":"vTFUSUARIONOMBRECOMPLETO_SEL"},{"av":"Ddo_grid_Selectedvalue_set","ctrl":"DDO_GRID","prop":"SelectedValue_set"},{"av":"Ddo_grid_Filteredtext_set","ctrl":"DDO_GRID","prop":"FilteredText_set"},{"av":"Ddo_grid_Filteredtextto_set","ctrl":"DDO_GRID","prop":"FilteredTextTo_set"},{"av":"Ddo_grid_Sortedstatus","ctrl":"DDO_GRID","prop":"SortedStatus"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtFacturaFechaRegistro_Visible","ctrl":"FACTURAFECHAREGISTRO","prop":"Visible"},{"av":"edtPromocionDescripcion_Visible","ctrl":"PROMOCIONDESCRIPCION","prop":"Visible"},{"av":"edtFacturaNo_Visible","ctrl":"FACTURANO","prop":"Visible"},{"av":"edtFacturaFechaFactura_Visible","ctrl":"FACTURAFECHAFACTURA","prop":"Visible"},{"av":"edtavPartidaswithtags_Visible","ctrl":"vPARTIDASWITHTAGS","prop":"Visible"},{"av":"edtavEstatuswithtags_Visible","ctrl":"vESTATUSWITHTAGS","prop":"Visible"},{"av":"edtavDescripcion_Visible","ctrl":"vDESCRIPCION","prop":"Visible"},{"av":"edtUsuarioNombreCompleto_Visible","ctrl":"USUARIONOMBRECOMPLETO","prop":"Visible"},{"av":"edtavDistribuidordescripcion_Visible","ctrl":"vDISTRIBUIDORDESCRIPCION","prop":"Visible"},{"av":"AV62GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV63GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV64GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"edtavUseraction2_Visible","ctrl":"vUSERACTION2","prop":"Visible"},{"av":"AV274ListaUsuarios","fld":"vLISTAUSUARIOS"},{"av":"AV21ManageFiltersData","fld":"vMANAGEFILTERSDATA"}]}""");
         setEventMetadata("'DOUSERACTION99'","""{"handler":"E163G2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV12OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV258FromDate","fld":"vFROMDATE"},{"av":"AV259ToDate","fld":"vTODATE"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV278Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV41TFFacturaFechaRegistro","fld":"vTFFACTURAFECHAREGISTRO"},{"av":"AV42TFFacturaFechaRegistro_To","fld":"vTFFACTURAFECHAREGISTRO_TO"},{"av":"AV28TFPromocionDescripcion","fld":"vTFPROMOCIONDESCRIPCION"},{"av":"AV29TFPromocionDescripcion_Sel","fld":"vTFPROMOCIONDESCRIPCION_SEL"},{"av":"AV34TFFacturaNo","fld":"vTFFACTURANO"},{"av":"AV35TFFacturaNo_Sel","fld":"vTFFACTURANO_SEL"},{"av":"AV36TFFacturaFechaFactura","fld":"vTFFACTURAFECHAFACTURA"},{"av":"AV37TFFacturaFechaFactura_To","fld":"vTFFACTURAFECHAFACTURA_TO"},{"av":"AV72TFEstatus","fld":"vTFESTATUS"},{"av":"AV73TFEstatusOperator","fld":"vTFESTATUSOPERATOR","pic":"ZZZ9"},{"av":"AV48TFUsuarioNombreCompleto","fld":"vTFUSUARIONOMBRECOMPLETO"},{"av":"AV49TFUsuarioNombreCompleto_Sel","fld":"vTFUSUARIONOMBRECOMPLETO_SEL"},{"av":"AV234UsuarioID","fld":"vUSUARIOID","pic":"ZZZZZZZZ9","hsh":true},{"av":"A10DistribuidorID","fld":"DISTRIBUIDORID","pic":"ZZZZZZZZ9"},{"av":"AV103DistribuidorID","fld":"vDISTRIBUIDORID"},{"av":"A40UsuarioRol","fld":"USUARIOROL"},{"av":"edtavUseraction2_Visible","ctrl":"vUSERACTION2","prop":"Visible"},{"av":"AV70Estatus","fld":"vESTATUS","hsh":true},{"av":"AV253RegUsuarioID","fld":"vREGUSUARIOID","pic":"ZZZZZZZZ9","hsh":true},{"av":"A11DistribuidorDescripcion","fld":"DISTRIBUIDORDESCRIPCION"},{"av":"AV277UsuarioCorreo","fld":"vUSUARIOCORREO","hsh":true},{"av":"AV274ListaUsuarios","fld":"vLISTAUSUARIOS"},{"av":"A29UsuarioID","fld":"USUARIOID","pic":"ZZZZZZZZ9","hsh":true}]""");
         setEventMetadata("'DOUSERACTION99'",""","oparms":[{"ctrl":"UTCHARTDOUGHNUT"},{"ctrl":"UTCHARTCOLUMNLINE"},{"av":"AV274ListaUsuarios","fld":"vLISTAUSUARIOS"},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtFacturaFechaRegistro_Visible","ctrl":"FACTURAFECHAREGISTRO","prop":"Visible"},{"av":"edtPromocionDescripcion_Visible","ctrl":"PROMOCIONDESCRIPCION","prop":"Visible"},{"av":"edtFacturaNo_Visible","ctrl":"FACTURANO","prop":"Visible"},{"av":"edtFacturaFechaFactura_Visible","ctrl":"FACTURAFECHAFACTURA","prop":"Visible"},{"av":"edtavPartidaswithtags_Visible","ctrl":"vPARTIDASWITHTAGS","prop":"Visible"},{"av":"edtavEstatuswithtags_Visible","ctrl":"vESTATUSWITHTAGS","prop":"Visible"},{"av":"edtavDescripcion_Visible","ctrl":"vDESCRIPCION","prop":"Visible"},{"av":"edtUsuarioNombreCompleto_Visible","ctrl":"USUARIONOMBRECOMPLETO","prop":"Visible"},{"av":"edtavDistribuidordescripcion_Visible","ctrl":"vDISTRIBUIDORDESCRIPCION","prop":"Visible"},{"av":"AV62GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV63GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV64GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"edtavUseraction2_Visible","ctrl":"vUSERACTION2","prop":"Visible"},{"av":"AV21ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV10GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("VPARTIDAS.CLICK","""{"handler":"E203G2","iparms":[{"av":"A69FacturaID","fld":"FACTURAID","pic":"ZZZZZZZZ9","hsh":true}]""");
         setEventMetadata("VPARTIDAS.CLICK",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("VUSERACTION4.CLICK","""{"handler":"E213G2","iparms":[{"av":"A69FacturaID","fld":"FACTURAID","pic":"ZZZZZZZZ9","hsh":true},{"av":"AV255Blob","fld":"vBLOB"},{"av":"AV257FacturaID","fld":"vFACTURAID","pic":"ZZZZZZZZ9"},{"av":"A75FacturaPDF","fld":"FACTURAPDF"}]""");
         setEventMetadata("VUSERACTION4.CLICK",""","oparms":[{"av":"AV257FacturaID","fld":"vFACTURAID","pic":"ZZZZZZZZ9"},{"av":"Innwewindow_Target","ctrl":"INNWEWINDOW","prop":"Target"},{"av":"AV255Blob","fld":"vBLOB"}]}""");
         setEventMetadata("VUSERACTION2.CLICK","""{"handler":"E223G2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV12OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV258FromDate","fld":"vFROMDATE"},{"av":"AV259ToDate","fld":"vTODATE"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV278Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV41TFFacturaFechaRegistro","fld":"vTFFACTURAFECHAREGISTRO"},{"av":"AV42TFFacturaFechaRegistro_To","fld":"vTFFACTURAFECHAREGISTRO_TO"},{"av":"AV28TFPromocionDescripcion","fld":"vTFPROMOCIONDESCRIPCION"},{"av":"AV29TFPromocionDescripcion_Sel","fld":"vTFPROMOCIONDESCRIPCION_SEL"},{"av":"AV34TFFacturaNo","fld":"vTFFACTURANO"},{"av":"AV35TFFacturaNo_Sel","fld":"vTFFACTURANO_SEL"},{"av":"AV36TFFacturaFechaFactura","fld":"vTFFACTURAFECHAFACTURA"},{"av":"AV37TFFacturaFechaFactura_To","fld":"vTFFACTURAFECHAFACTURA_TO"},{"av":"AV72TFEstatus","fld":"vTFESTATUS"},{"av":"AV73TFEstatusOperator","fld":"vTFESTATUSOPERATOR","pic":"ZZZ9"},{"av":"AV48TFUsuarioNombreCompleto","fld":"vTFUSUARIONOMBRECOMPLETO"},{"av":"AV49TFUsuarioNombreCompleto_Sel","fld":"vTFUSUARIONOMBRECOMPLETO_SEL"},{"av":"AV234UsuarioID","fld":"vUSUARIOID","pic":"ZZZZZZZZ9","hsh":true},{"av":"A10DistribuidorID","fld":"DISTRIBUIDORID","pic":"ZZZZZZZZ9"},{"av":"AV103DistribuidorID","fld":"vDISTRIBUIDORID"},{"av":"A40UsuarioRol","fld":"USUARIOROL"},{"av":"edtavUseraction2_Visible","ctrl":"vUSERACTION2","prop":"Visible"},{"av":"AV70Estatus","fld":"vESTATUS","hsh":true},{"av":"AV253RegUsuarioID","fld":"vREGUSUARIOID","pic":"ZZZZZZZZ9","hsh":true},{"av":"A11DistribuidorDescripcion","fld":"DISTRIBUIDORDESCRIPCION"},{"av":"AV277UsuarioCorreo","fld":"vUSUARIOCORREO","hsh":true},{"av":"A69FacturaID","fld":"FACTURAID","pic":"ZZZZZZZZ9","hsh":true},{"av":"cmbFacturaEstatus"},{"av":"A80FacturaEstatus","fld":"FACTURAESTATUS","hsh":true},{"av":"A29UsuarioID","fld":"USUARIOID","pic":"ZZZZZZZZ9","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         AV48TFUsuarioNombreCompleto = "";
         AV49TFUsuarioNombreCompleto_Sel = "";
         AV103DistribuidorID = new GxSimpleCollection<int>();
         A40UsuarioRol = "";
         AV70Estatus = "";
         ...
         AV270DistribuidorID_Data = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item>( context, "Item", "");
         AV260Elements = new GXBaseCollection<GeneXus.Programs.genexusreporting.SdtQueryViewerElements_Element>( context, "Element", "GeneXus.Reporting");
         AV261Parameters = new GXBaseCollection<GeneXus.Programs.genexusreporting.SdtQueryViewerParameters_Parameter>( context, "Parameter", "GeneXus.Reporting");
         AV262ItemClickData = new GeneXus.Programs.genexusreporting.SdtQueryViewerItemClickData(context);
         AV263ItemDoubleClickData = new GeneXus.Programs.genexusreporting.SdtQueryViewerItemDoubleClickData(context);
         AV264DragAndDropData = new GeneXus.Programs.genexusreporting.SdtQueryViewerDragAndDropData(context);
         AV265FilterChangedData = new GeneXus.Programs.genexusreporting.SdtQueryViewerFilterChangedData(context);
         AV266ItemExpandData = new GeneXus.Programs.genexusreporting.SdtQueryViewerItemExpandData(context);
         AV267ItemCollapseData = new GeneXus.Programs.genexusreporting.SdtQueryViewerItemCollapseData(context);
         ...
         AV248DDO_FacturaFechaRegistroAuxDateTo = DateTime.MinValue;
         AV250DDO_FacturaFechaFacturaAuxDateTo = DateTime.MinValue;
         AV10GridState = new WorkWithPlus.workwithplus_web.SdtWWPGridState(context);
         AV274ListaUsuarios = new GxSimpleCollection<int>();
         AV255Blob = "";
         A75FacturaPDF = "";
         A30UsuarioNombre = "";
         A51UsuarioApellido = "";
         AV247DDO_FacturaFechaRegistroAuxDate = DateTime.MinValue;
         AV249DDO_FacturaFechaFacturaAuxDate = DateTime.MinValue;
         ...
         AV254DistribuidorDescripcion = "";
         lV279Wpfacturasasesds_1_filterfulltext = "";
         lV282Wpfacturasasesds_4_tfpromociondescripcion = "";
         lV284Wpfacturasasesds_6_tffacturano = "";
         lV290Wpfacturasasesds_12_tfusuarionombrecompleto = "";
         AV279Wpfacturasasesds_1_filterfulltext = "";
         AV280Wpfacturasasesds_2_tffacturafecharegistro = DateTime.MinValue;
         AV281Wpfacturasasesds_3_tffacturafecharegistro_to = DateTime.MinValue;
         AV283Wpfacturasasesds_5_tfpromociondescripcion_sel = "";
         AV282Wpfacturasasesds_4_tfpromociondescripcion = "";
         AV285Wpfacturasasesds_7_tffacturano_sel = "";
         AV284Wpfacturasasesds_6_tffacturano = "";
         AV286Wpfacturasasesds_8_tffacturafechafactura = DateTime.MinValue;
         AV287Wpfacturasasesds_9_tffacturafechafactura_to = DateTime.MinValue;
         AV291Wpfacturasasesds_13_tfusuarionombrecompleto_sel = "";
         AV290Wpfacturasasesds_12_tfusuarionombrecompleto = "";
         H003G2_A41PromocionID = new int[1] ;
         H003G2_A93FacturaCompleta = new bool[] {false} ;
         H003G2_A19MotivoRechazoID = new int[1] ;
         H003G2_A20MotivoRechazoDescripcion = new string[] {""} ;
         H003G2_A21MotivoRechazoActivo = new bool[] {false} ;
         H003G2_A29UsuarioID = new int[1] ;
         H003G2_A80FacturaEstatus = new string[] {""} ;
         H003G2_A73FacturaFechaFactura = new DateTime[] {DateTime.MinValue} ;
         H003G2_A71FacturaNo = new string[] {""} ;
         H003G2_A42PromocionDescripcion = new string[] {""} ;
         H003G2_A72FacturaFechaRegistro = new DateTime[] {DateTime.MinValue} ;
         H003G2_A69FacturaID = new int[1] ;
         H003G2_A51UsuarioApellido = new string[] {""} ;
         H003G2_A30UsuarioNombre = new string[] {""} ;
         AV288Wpfacturasasesds_10_tfestatus = "";
         ...
         GXt_char2 = "";
         AV8TrnContext = new WorkWithPlus.workwithplus_commonobjects.SdtWWPTransactionContext(context);
         AV122ListaDistribuidores = new GxSimpleCollection<int>();
         H003G4_A10DistribuidorID = new int[1] ;
         H003G4_A11DistribuidorDescripcion = new string[] {""} ;
         AV271Combo_DataItem = new WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item(context);
         AV256FileURL = "";
         H003G5_A81DistribuidoresUsuarioID = new int[1] ;
         H003G5_A10DistribuidorID = new int[1] ;
         H003G5_A29UsuarioID = new int[1] ;
         H003G5_A11DistribuidorDescripcion = new string[] {""} ;
         H003G6_A69FacturaID = new int[1] ;
         H003G6_A40000FacturaPDF_GXI = new string[] {""} ;
         H003G6_A75FacturaPDF = new string[] {""} ;
         A40000FacturaPDF_GXI = "";
         AV272DistribuidoresAutorizados = new GxSimpleCollection<int>();
         H003G7_A81DistribuidoresUsuarioID = new int[1] ;
         H003G7_A29UsuarioID = new int[1] ;
         H003G7_A10DistribuidorID = new int[1] ;
         AV275DistribuidoresFiltrados = new GxSimpleCollection<int>();
         H003G8_A81DistribuidoresUsuarioID = new int[1] ;
         H003G8_A10DistribuidorID = new int[1] ;
         H003G8_A40UsuarioRol = new string[] {""} ;
         H003G8_A29UsuarioID = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wpfacturasases__default(),
            new Object[][] {
                new Object[] {
               H003G2_A41PromocionID, H003G2_A93FacturaCompleta, H003G2_A19MotivoRechazoID, H003G2_A20MotivoRechazoDescripcion, H003G2_A21MotivoRechazoActivo, H003G2_A29UsuarioID, H003G2_A80FacturaEstatus, H003G2_A73FacturaFechaFactura, H003G2_A71FacturaNo, H003G2_A42PromocionDescripcion,
               H003G2_A72FacturaFechaRegistro, H003G2_A69FacturaID, H003G2_A51UsuarioApellido, H003G2_A30UsuarioNombre
               }
               , new Object[] {
               H003G3_AGRID_nRecordCount
               }
               , new Object[] {
               H003G4_A10DistribuidorID, H003G4_A11DistribuidorDescripcion
               }
               , new Object[] {
               H003G5_A81DistribuidoresUsuarioID, H003G5_A10DistribuidorID, H003G5_A29UsuarioID, H003G5_A11DistribuidorDescripcion
               }
               , new Object[] {
               H003G6_A69FacturaID, H003G6_A40000FacturaPDF_GXI, H003G6_A75FacturaPDF
               }
               , new Object[] {
               H003G7_A81DistribuidoresUsuarioID, H003G7_A29UsuarioID, H003G7_A10DistribuidorID
               }
               , new Object[] {
               H003G8_A81DistribuidoresUsuarioID, H003G8_A10DistribuidorID, H003G8_A40UsuarioRol, H003G8_A29UsuarioID
               }
            }
         );
      ...
      private short AV289Wpfacturasasesds_11_tfestatusoperator ;
      ...
      private int AV234UsuarioID ;
      private int A10DistribuidorID ;
      private int AV253RegUsuarioID ;
      private int AV257FacturaID ;
      ...
      private int AV274ListaUsuarios_Count ;
      ...
      private int AV293GXV1 ;
      private int AV298GXV2 ;
      private int AV273DistID ;
      private int AV299GXV3 ;
      private int AV300GXV4 ;
      private int AV276DistAut ;
      private int AV302GXV5 ;
      private int AV238UsuariosListaID ;
      private int idxLst ;
      ...
      private string AV83UserAction8 ;
      ...
      private string lV284Wpfacturasasesds_6_tffacturano ;
      private string AV285Wpfacturasasesds_7_tffacturano_sel ;
      private string AV284Wpfacturasasesds_6_tffacturano ;
      private string AV288Wpfacturasasesds_10_tfestatus ;
      ...
      private DateTime AV258FromDate ;
      private DateTime AV259ToDate ;
      ...
      private DateTime AV248DDO_FacturaFechaRegistroAuxDateTo ;
      private DateTime AV250DDO_FacturaFechaFacturaAuxDateTo ;
      private DateTime AV247DDO_FacturaFechaRegistroAuxDate ;
      private DateTime AV249DDO_FacturaFechaFacturaAuxDate ;
      private DateTime A72FacturaFechaRegistro ;
      private DateTime A73FacturaFechaFactura ;
      private DateTime AV280Wpfacturasasesds_2_tffacturafecharegistro ;
      private DateTime AV281Wpfacturasasesds_3_tffacturafecharegistro_to ;
      private DateTime AV286Wpfacturasasesds_8_tffacturafechafactura ;
      private DateTime AV287Wpfacturasasesds_9_tffacturafechafactura_to ;
      ...
      private string AV277UsuarioCorreo ;
      ...
      private string AV292Useraction4_GXI ;
      private string A42PromocionDescripcion ;
      private string AV252PartidasWithTags ;
      ...
      private string AV254DistribuidorDescripcion ;
      private string lV279Wpfacturasasesds_1_filterfulltext ;
      private string lV282Wpfacturasasesds_4_tfpromociondescripcion ;
      private string lV290Wpfacturasasesds_12_tfusuarionombrecompleto ;
      private string AV279Wpfacturasasesds_1_filterfulltext ;
      private string AV283Wpfacturasasesds_5_tfpromociondescripcion_sel ;
      private string AV282Wpfacturasasesds_4_tfpromociondescripcion ;
      private string AV291Wpfacturasasesds_13_tfusuarionombrecompleto_sel ;
      private string AV290Wpfacturasasesds_12_tfusuarionombrecompleto ;
      private string AV256FileURL ;
      private string A40000FacturaPDF_GXI ;
      private string AV79UserAction4 ;
      private string A75FacturaPDF ;
      private string AV255Blob ;
      ...
      private GxSimpleCollection<int> AV103DistribuidorID ;
      private WorkWithPlus.workwithplus_web.SdtDVB_SDTDropDownOptionsTitleSettingsIcons AV60DDO_TitleSettingsIcons ;
      private GXBaseCollection<WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item> AV270DistribuidorID_Data ;
      private GXBaseCollection<GeneXus.Programs.genexusreporting.SdtQueryViewerElements_Element> AV260Elements ;
      private GXBaseCollection<GeneXus.Programs.genexusreporting.SdtQueryViewerParameters_Parameter> AV261Parameters ;
      private GeneXus.Programs.genexusreporting.SdtQueryViewerItemClickData AV262ItemClickData ;
      private GeneXus.Programs.genexusreporting.SdtQueryViewerItemDoubleClickData AV263ItemDoubleClickData ;
      private GeneXus.Programs.genexusreporting.SdtQueryViewerDragAndDropData AV264DragAndDropData ;
      private GeneXus.Programs.genexusreporting.SdtQueryViewerFilterChangedData AV265FilterChangedData ;
      private GeneXus.Programs.genexusreporting.SdtQueryViewerItemExpandData AV266ItemExpandData ;
      private GeneXus.Programs.genexusreporting.SdtQueryViewerItemCollapseData AV267ItemCollapseData ;
      ...
      private GxSimpleCollection<int> AV274ListaUsuarios ;
      private IDataStoreProvider pr_default ;
      private int[] H003G2_A41PromocionID ;
      private bool[] H003G2_A93FacturaCompleta ;
      private int[] H003G2_A19MotivoRechazoID ;
      private string[] H003G2_A20MotivoRechazoDescripcion ;
      private bool[] H003G2_A21MotivoRechazoActivo ;
      private int[] H003G2_A29UsuarioID ;
      private string[] H003G2_A80FacturaEstatus ;
      private DateTime[] H003G2_A73FacturaFechaFactura ;
      private string[] H003G2_A71FacturaNo ;
      private string[] H003G2_A42PromocionDescripcion ;
      private DateTime[] H003G2_A72FacturaFechaRegistro ;
      private int[] H003G2_A69FacturaID ;
      private string[] H003G2_A51UsuarioApellido ;
      private string[] H003G2_A30UsuarioNombre ;
      ...
      private GxSimpleCollection<int> AV122ListaDistribuidores ;
      private int[] H003G4_A10DistribuidorID ;
      private string[] H003G4_A11DistribuidorDescripcion ;
      private WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item AV271Combo_DataItem ;
      private int[] H003G5_A81DistribuidoresUsuarioID ;
      private int[] H003G5_A10DistribuidorID ;
      private int[] H003G5_A29UsuarioID ;
      private string[] H003G5_A11DistribuidorDescripcion ;
      private int[] H003G6_A69FacturaID ;
      private string[] H003G6_A40000FacturaPDF_GXI ;
      private string[] H003G6_A75FacturaPDF ;
      private GxSimpleCollection<int> AV272DistribuidoresAutorizados ;
      private int[] H003G7_A81DistribuidoresUsuarioID ;
      private int[] H003G7_A29UsuarioID ;
      private int[] H003G7_A10DistribuidorID ;
      private GxSimpleCollection<int> AV275DistribuidoresFiltrados ;
      private int[] H003G8_A81DistribuidoresUsuarioID ;
      private int[] H003G8_A10DistribuidorID ;
      private string[] H003G8_A40UsuarioRol ;
      private int[] H003G8_A29UsuarioID ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class wpfacturasases__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H003G2( IGxContext context ,
                                             int A29UsuarioID ,
                                             GxSimpleCollection<int> AV274ListaUsuarios ,
                                             string AV279Wpfacturasasesds_1_filterfulltext ,
                                             DateTime AV280Wpfacturasasesds_2_tffacturafecharegistro ,
                                             DateTime AV281Wpfacturasasesds_3_tffacturafecharegistro_to ,
                                             string AV283Wpfacturasasesds_5_tfpromociondescripcion_sel ,
                                             string AV282Wpfacturasasesds_4_tfpromociondescripcion ,
                                             string AV285Wpfacturasasesds_7_tffacturano_sel ,
                                             string AV284Wpfacturasasesds_6_tffacturano ,
                                             DateTime AV286Wpfacturasasesds_8_tffacturafechafactura ,
                                             DateTime AV287Wpfacturasasesds_9_tffacturafechafactura_to ,
                                             short AV289Wpfacturasasesds_11_tfestatusoperator ,
                                             string AV291Wpfacturasasesds_13_tfusuarionombrecompleto_sel ,
                                             string AV290Wpfacturasasesds_12_tfusuarionombrecompleto ,
                                             DateTime AV258FromDate ,
                                             DateTime AV259ToDate ,
                                             int AV274ListaUsuarios_Count ,
                                             ...
                                             bool A93FacturaCompleta )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV279Wpfacturasasesds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( T2.`PromocionDescripcion` like CONCAT('%', @lV279Wpfacturasasesds_1_filterfulltext)) or ( T1.`FacturaNo` like CONCAT('%', @lV279Wpfacturasasesds_1_filterfulltext)) or ( CONCAT(CONCAT(RTRIM(LTRIM(T4.`UsuarioNombre`)), ' '), RTRIM(LTRIM(T4.`UsuarioApellido`))) like CONCAT('%', @lV279Wpfacturasasesds_1_filterfulltext)))");
         }
         else
         {
            GXv_int6[0] = 1;
         ...
         if ( ! (DateTime.MinValue==AV280Wpfacturasasesds_2_tffacturafecharegistro) )
         {
            AddWhere(sWhereString, "(T1.`FacturaFechaRegistro` >= @AV280Wpfacturasasesds_2_tffacturafecharegistro)");
         }
         else
         {
            GXv_int6[3] = 1;
         }
         if ( ! (DateTime.MinValue==AV281Wpfacturasasesds_3_tffacturafecharegistro_to) )
         {
            AddWhere(sWhereString, "(T1.`FacturaFechaRegistro` <= @AV281Wpfacturasasesds_3_tffacturafecharegistro_to)");
         }
         else
         {
            GXv_int6[4] = 1;
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV283Wpfacturasasesds_5_tfpromociondescripcion_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV282Wpfacturasasesds_4_tfpromociondescripcion)) ) )
         {
            AddWhere(sWhereString, "(T2.`PromocionDescripcion` like @lV282Wpfacturasasesds_4_tfpromociondescripcion)");
         }
         else
         {
            GXv_int6[5] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV283Wpfacturasasesds_5_tfpromociondescripcion_sel)) && ! ( StringUtil.StrCmp(AV283Wpfacturasasesds_5_tfpromociondescripcion_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T2.`PromocionDescripcion` = @AV283Wpfacturasasesds_5_tfpromociondescripcion_sel)");
         }
         else
         {
            GXv_int6[6] = 1;
         }
         if ( StringUtil.StrCmp(AV283Wpfacturasasesds_5_tfpromociondescripcion_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "((LENGTH(TRIM(T2.`PromocionDescripcion`))=0))");
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV285Wpfacturasasesds_7_tffacturano_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV284Wpfacturasasesds_6_tffacturano)) ) )
         {
            AddWhere(sWhereString, "(T1.`FacturaNo` like @lV284Wpfacturasasesds_6_tffacturano)");
         }
         else
         {
            GXv_int6[7] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV285Wpfacturasasesds_7_tffacturano_sel)) && ! ( StringUtil.StrCmp(AV285Wpfacturasasesds_7_tffacturano_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T1.`FacturaNo` = @AV285Wpfacturasasesds_7_tffacturano_sel)");
         }
         else
         {
            GXv_int6[8] = 1;
         }
         if ( StringUtil.StrCmp(AV285Wpfacturasasesds_7_tffacturano_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "((LENGTH(TRIM(T1.`FacturaNo`))=0))");
         }
         if ( ! (DateTime.MinValue==AV286Wpfacturasasesds_8_tffacturafechafactura) )
         {
            AddWhere(sWhereString, "(T1.`FacturaFechaFactura` >= @AV286Wpfacturasasesds_8_tffacturafechafactura)");
         }
         else
         {
            GXv_int6[9] = 1;
         }
         if ( ! (DateTime.MinValue==AV287Wpfacturasasesds_9_tffacturafechafactura_to) )
         {
            AddWhere(sWhereString, "(T1.`FacturaFechaFactura` <= @AV287Wpfacturasasesds_9_tffacturafechafactura_to)");
         }
         else
         {
            GXv_int6[10] = 1;
         }
         if ( AV289Wpfacturasasesds_11_tfestatusoperator == 1 )
         {
            AddWhere(sWhereString, "(T1.`FacturaEstatus` = 'En Proceso')");
         }
         if ( AV289Wpfacturasasesds_11_tfestatusoperator == 2 )
         {
            AddWhere(sWhereString, "(T1.`FacturaEstatus` = 'Aprobada')");
         }
         if ( AV289Wpfacturasasesds_11_tfestatusoperator == 3 )
         {
            AddWhere(sWhereString, "(T1.`FacturaEstatus` = 'Rechazada')");
         }
         if ( AV289Wpfacturasasesds_11_tfestatusoperator == 4 )
         {
            AddWhere(sWhereString, "(T1.`FacturaEstatus` = 'Cancelada')");
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV291Wpfacturasasesds_13_tfusuarionombrecompleto_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV290Wpfacturasasesds_12_tfusuarionombrecompleto)) ) )
         {
            AddWhere(sWhereString, "(CONCAT(CONCAT(RTRIM(LTRIM(T4.`UsuarioNombre`)), ' '), RTRIM(LTRIM(T4.`UsuarioApellido`))) like @lV290Wpfacturasasesds_12_tfusuarionombrecompleto)");
         }
         else
         {
            GXv_int6[11] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV291Wpfacturasasesds_13_tfusuarionombrecompleto_sel)) && ! ( StringUtil.StrCmp(AV291Wpfacturasasesds_13_tfusuarionombrecompleto_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(CONCAT(CONCAT(RTRIM(LTRIM(T4.`UsuarioNombre`)), ' '), RTRIM(LTRIM(T4.`UsuarioApellido`))) = @AV291Wpfacturasasesds_13_tfusuarionombrecompleto_sel)");
         }
         else
         {
            GXv_int6[12] = 1;
         }
         if ( StringUtil.StrCmp(AV291Wpfacturasasesds_13_tfusuarionombrecompleto_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "((LENGTH(TRIM(RTRIM(LTRIM(T4.`UsuarioNombre`)) || ' ' || RTRIM(LTRIM(T4.`UsuarioApellido`))))=0))");
         }
         if ( ! (DateTime.MinValue==AV258FromDate) )
         {
            AddWhere(sWhereString, "(T1.`FacturaFechaFactura` >= @AV258FromDate)");
         }
         else
         {
            GXv_int6[13] = 1;
         }
         if ( ! (DateTime.MinValue==AV259ToDate) )
         {
            AddWhere(sWhereString, "(T1.`FacturaFechaFactura` <= @AV259ToDate)");
         }
         else
         {
            GXv_int6[14] = 1;
         }
         if ( AV274ListaUsuarios_Count > 0 )
         {
            AddWhere(sWhereString, "("+new GxDbmsUtils( new GxSqlServer()).ValueList(AV274ListaUsuarios, "T1.`UsuarioID` IN (", ")")+")");
         }
      ...
      protected Object[] conditional_H003G4( IGxContext context ,
                                             int A10DistribuidorID ,
                                             GxSimpleCollection<int> AV122ListaDistribuidores )
      {
         System.Text.StringBuilder sWhereString = new System.Text.StringBuilder();
         string scmdbuf;
         Object[] GXv_Object10 = new Object[2];
         scmdbuf = "SELECT `DistribuidorID`, `DistribuidorDescripcion` FROM `Distribuidor`";
         AddWhere(sWhereString, "("+new GxDbmsUtils( new GxSqlServer()).ValueList(AV122ListaDistribuidores, "`DistribuidorID` IN (", ")")+")");
         scmdbuf += sWhereString;
      ...
      protected Object[] conditional_H003G8( IGxContext context ,
                                             int A10DistribuidorID ,
                                             GxSimpleCollection<int> AV275DistribuidoresFiltrados ,
                                             string A40UsuarioRol )
      {
         System.Text.StringBuilder sWhereString = new System.Text.StringBuilder();
         string scmdbuf;
         Object[] GXv_Object12 = new Object[2];
         scmdbuf = "SELECT T1.`DistribuidoresUsuarioID`, T1.`DistribuidorID`, T2.`UsuarioRol`, T1.`UsuarioID` FROM (`DistribuidoresUsuario` T1 INNER JOIN `Usuario` T2 ON T2.`UsuarioID` = T1.`UsuarioID`)";
         AddWhere(sWhereString, "("+new GxDbmsUtils( new GxSqlServer()).ValueList(AV275DistribuidoresFiltrados, "T1.`DistribuidorID` IN (", ")")+")");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H003G2(context, (int)dynConstraints[0] , (GxSimpleCollection<int>)dynConstraints[1] , (string)dynConstraints[2] , (DateTime)dynConstraints[3] , (DateTime)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (DateTime)dynConstraints[9] , (DateTime)dynConstraints[10] , (short)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (DateTime)dynConstraints[14] , (DateTime)dynConstraints[15] , (int)dynConstraints[16] , (string)dynConstraints[17] , (string)dynConstraints[18] , (string)dynConstraints[19] , (string)dynConstraints[20] , (DateTime)dynConstraints[21] , (DateTime)dynConstraints[22] , (string)dynConstraints[23] , (short)dynConstraints[24] , (bool)dynConstraints[25] , (bool)dynConstraints[26] );
               case 1 :
               ...
               case 2 :
                     return conditional_H003G4(context, (int)dynConstraints[0] , (GxSimpleCollection<int>)dynConstraints[1] );
               case 6 :
                     return conditional_H003G8(context, (int)dynConstraints[0] , (GxSimpleCollection<int>)dynConstraints[1] , (string)dynConstraints[2] );
         }
    ...
    private void cursorDefinitions( )
    {
       ...
       {
          Object[] prmH003G5;
          prmH003G5 = new Object[] {
          new ParDef("@AV253RegUsuarioID",GXType.Int32,9,0)
          };
          Object[] prmH003G6;
          prmH003G6 = new Object[] {
          new ParDef("@AV257FacturaID",GXType.Int32,9,0)
          };
          Object[] prmH003G7;
          prmH003G7 = new Object[] {
          new ParDef("@AV234UsuarioID",GXType.Int32,9,0)
          };
          Object[] prmH003G2;
          prmH003G2 = new Object[] {
          new ParDef("@lV279Wpfacturasasesds_1_filterfulltext",GXType.Char,100,0) ,
          new ParDef("@lV279Wpfacturasasesds_1_filterfulltext",GXType.Char,100,0) ,
          new ParDef("@lV279Wpfacturasasesds_1_filterfulltext",GXType.Char,100,0) ,
          new ParDef("@AV280Wpfacturasasesds_2_tffacturafecharegistro",GXType.Date,8,0) ,
          new ParDef("@AV281Wpfacturasasesds_3_tffacturafecharegistro_to",GXType.Date,8,0) ,
          new ParDef("@lV282Wpfacturasasesds_4_tfpromociondescripcion",GXType.Char,80,0) ,
          new ParDef("@AV283Wpfacturasasesds_5_tfpromociondescripcion_sel",GXType.Char,80,0) ,
          new ParDef("@lV284Wpfacturasasesds_6_tffacturano",GXType.Char,20,0) ,
          new ParDef("@AV285Wpfacturasasesds_7_tffacturano_sel",GXType.Char,20,0) ,
          new ParDef("@AV286Wpfacturasasesds_8_tffacturafechafactura",GXType.Date,8,0) ,
          new ParDef("@AV287Wpfacturasasesds_9_tffacturafechafactura_to",GXType.Date,8,0) ,
          new ParDef("@lV290Wpfacturasasesds_12_tfusuarionombrecompleto",GXType.Char,40,0) ,
          new ParDef("@AV291Wpfacturasasesds_13_tfusuarionombrecompleto_sel",GXType.Char,40,0) ,
          new ParDef("@AV258FromDate",GXType.Date,8,0) ,
          new ParDef("@AV259ToDate",GXType.Date,8,0) ,
          ...
          Object[] prmH003G4;
          prmH003G4 = new Object[] {
          };
          Object[] prmH003G8;
          prmH003G8 = new Object[] {
          };
          def= new CursorDef[] {
             ...
             ,new CursorDef("H003G4", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003G4,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H003G5", "SELECT T1.`DistribuidoresUsuarioID`, T1.`DistribuidorID`, T1.`UsuarioID`, T2.`DistribuidorDescripcion` FROM (`DistribuidoresUsuario` T1 INNER JOIN `Distribuidor` T2 ON T2.`DistribuidorID` = T1.`DistribuidorID`) WHERE T1.`UsuarioID` = @AV253RegUsuarioID ORDER BY T1.`UsuarioID`  LIMIT 1",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003G5,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H003G6", "SELECT `FacturaID`, `FacturaPDF_GXI`, `FacturaPDF` FROM `Factura` WHERE `FacturaID` = @AV257FacturaID ORDER BY `FacturaID`  LIMIT 1",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003G6,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H003G7", "SELECT `DistribuidoresUsuarioID`, `UsuarioID`, `DistribuidorID` FROM `DistribuidoresUsuario` WHERE `UsuarioID` = @AV234UsuarioID ORDER BY `UsuarioID` ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003G7,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H003G8", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003G8,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
