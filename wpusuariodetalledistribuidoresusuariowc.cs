...
namespace GeneXus.Programs {
   public class wpusuariodetalledistribuidoresusuariowc : GXWebComponent
   {
      public wpusuariodetalledistribuidoresusuariowc( )
      {
      ...
      public wpusuariodetalledistribuidoresusuariowc( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV13OrderedBy, AV14OrderedDsc, AV15FilterFullText, AV7UsuarioID, AV19ManageFiltersExecutionStep, AV33Pgmname, A29UsuarioID, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV33Pgmname = "WPUsuarioDetalleDistribuidoresUsuarioWC";
               WS342( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "WPUsuario Detalle Distribuidores Usuario WC", "")) ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "wpusuariodetalledistribuidoresusuariowc.aspx"+UrlEncode(StringUtil.LTrimStr(AV7UsuarioID,9,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wpusuariodetalledistribuidoresusuariowc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", sPrefix+"hsh"+"WPUsuarioDetalleDistribuidoresUsuarioWC");
         forbiddenHiddens.Add("UsuarioID", context.localUtil.Format( (decimal)(A29UsuarioID), "ZZZZZZZZ9"));
         GxWebStd.gx_hidden_field( context, sPrefix+"hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("wpusuariodetalledistribuidoresusuariowc:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      {
         return "WPUsuarioDetalleDistribuidoresUsuarioWC" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "WPUsuario Detalle Distribuidores Usuario WC", "") ;
      }
      ...
      protected void WB340( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "wpusuariodetalledistribuidoresusuariowc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            GxWebStd.gx_single_line_edit( context, edtavFilterfulltext_Internalname, AV15FilterFullText, StringUtil.RTrim( context.localUtil.Format( AV15FilterFullText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,29);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", context.GetMessage( "WWP_Search", ""), edtavFilterfulltext_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavFilterfulltext_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "WorkWithPlus_Web\\WWPFullTextFilter", "start", true, "", "HLP_WPUsuarioDetalleDistribuidoresUsuarioWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 35 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtUsuarioID_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A29UsuarioID), 9, 0, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A29UsuarioID), "ZZZZZZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtUsuarioID_Jsonclick, 0, "Attribute", "", "", "", "", edtUsuarioID_Visible, 0, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 0, -1, 0, true, "ID", "end", false, "", "HLP_WPUsuarioDetalleDistribuidoresUsuarioWC.htm");
            /* User Defined Control */
      ...
      protected void START342( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "WPUsuario Detalle Distribuidores Usuario WC", ""), 0) ;
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wpusuariodetalledistribuidoresusuariowc.aspx")), "wpusuariodetalledistribuidoresusuariowc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wpusuariodetalledistribuidoresusuariowc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_DISTRIBUIDORESUSUARIOID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A81DistribuidoresUsuarioID), "ZZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"DISTRIBUIDORESUSUARIOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A81DistribuidoresUsuarioID), 9, 0, ".", "")));
      }
      ...
      protected void RF342( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV15FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV15FilterFullText), "%", "");
            /* Using cursor H00342 */
            pr_default.execute(0, new Object[] {AV7UsuarioID, lV15FilterFullText, lV15FilterFullText, GXPagingFrom2, GXPagingTo2});
            nGXsfl_35_idx = 1;
            sGXsfl_35_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_35_idx), 4, 0), 4, "0");
            SubsflControlProps_352( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A29UsuarioID = H00342_A29UsuarioID[0];
               AssignAttri(sPrefix, false, "A29UsuarioID", StringUtil.LTrimStr( (decimal)(A29UsuarioID), 9, 0));
               GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_USUARIOID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A29UsuarioID), "ZZZZZZZZ9"), context));
               A12DistribuidorRFC = H00342_A12DistribuidorRFC[0];
               A11DistribuidorDescripcion = H00342_A11DistribuidorDescripcion[0];
               A40UsuarioRol = H00342_A40UsuarioRol[0];
               A10DistribuidorID = H00342_A10DistribuidorID[0];
               A81DistribuidoresUsuarioID = H00342_A81DistribuidoresUsuarioID[0];
               A40UsuarioRol = H00342_A40UsuarioRol[0];
               A12DistribuidorRFC = H00342_A12DistribuidorRFC[0];
               A11DistribuidorDescripcion = H00342_A11DistribuidorDescripcion[0];
               /* Execute user event: Grid.Load */
      ...
      protected void send_integrity_lvl_hashes342( )
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"vPGMNAME", StringUtil.RTrim( AV33Pgmname));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vPGMNAME", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV33Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_DISTRIBUIDORESUSUARIOID"+"_"+sGXsfl_35_idx, GetSecureSignedToken( sPrefix+sGXsfl_35_idx, context.localUtil.Format( (decimal)(A81DistribuidoresUsuarioID), "ZZZZZZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV15FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV15FilterFullText), "%", "");
         /* Using cursor H00343 */
         pr_default.execute(1, new Object[] {AV7UsuarioID, lV15FilterFullText, lV15FilterFullText});
      ...
      protected void STRUP340( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            {
               GXUtil.WriteLogError("wpusuariodetalledistribuidoresusuariowc:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
               context.HttpContext.Response.StatusCode = 403;
               context.WriteHtmlText( "<title>403 Forbidden</title>") ;
               context.WriteHtmlText( "<h1>403 Forbidden</h1>") ;
      ...
      protected void E16342( )
      {
         ...
         returnInSub = false;
         /* Using cursor H00344 */
         pr_default.execute(2, new Object[] {AV7UsuarioID});
         while ( (pr_default.getStatus(2) != 101) )
         {
            A29UsuarioID = H00344_A29UsuarioID[0];
            AssignAttri(sPrefix, false, "A29UsuarioID", StringUtil.LTrimStr( (decimal)(A29UsuarioID), 9, 0));
            GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_USUARIOID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A29UsuarioID), "ZZZZZZZZ9"), context));
            A40UsuarioRol = H00344_A40UsuarioRol[0];
            AV27UsuarioRol = A40UsuarioRol;
         ...
         pr_default.close(2);
         if ( ( StringUtil.StrCmp(AV27UsuarioRol, "Administrador Yokohama") == 0 ) || ( StringUtil.StrCmp(AV27UsuarioRol, "Super Administrador") == 0 ) )
         {
            ...
            bttBtnuseraction1_Enabled = 0;
            AssignProp(sPrefix, false, bttBtnuseraction1_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(bttBtnuseraction1_Enabled), 5, 0), true);
         }
         else
         {
            if ( StringUtil.StrCmp(AV27UsuarioRol, "Participante") == 0 )
            {
               AV28Count = 0;
               /* Optimized group. */
               /* Using cursor H00345 */
               pr_default.execute(3, new Object[] {AV7UsuarioID});
               cV28Count = H00345_AV28Count[0];
               pr_default.close(3);
               AV28Count = (short)(AV28Count+cV28Count*1);
               /* End optimized group. */
               if ( AV28Count > 0 )
               {
                  bttBtnuseraction1_Visible = 0;
            ...
            else if ( StringUtil.StrCmp(AV27UsuarioRol, "Asesor") == 0 )
            {
      ...
      protected void E17342( )
      {
         ...
         returnInSub = false;
         /* Using cursor H00346 */
         pr_default.execute(4, new Object[] {AV7UsuarioID});
         while ( (pr_default.getStatus(4) != 101) )
         {
            A29UsuarioID = H00346_A29UsuarioID[0];
            AssignAttri(sPrefix, false, "A29UsuarioID", StringUtil.LTrimStr( (decimal)(A29UsuarioID), 9, 0));
            GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_USUARIOID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A29UsuarioID), "ZZZZZZZZ9"), context));
            A40UsuarioRol = H00346_A40UsuarioRol[0];
            AV27UsuarioRol = A40UsuarioRol;
            /* Exit For each command. Update data (if necessary), close cursors & exit. */
            if (true) break;
            /* Exiting from a For First loop. */
         ...
         else
         {
            if ( StringUtil.StrCmp(AV27UsuarioRol, "Participante") == 0 )
            {
               ...
               /* Optimized group. */
               /* Using cursor H00347 */
               pr_default.execute(5, new Object[] {AV7UsuarioID});
               cV28Count = H00347_AV28Count[0];
               pr_default.close(5);
               AV28Count = (short)(AV28Count+cV28Count*1);
               /* End optimized group. */
               if ( AV28Count > 0 )
      ...
      protected void E11342( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("WPUsuarioDetalleDistribuidoresUsuarioWCFilters")) + "," + UrlEncode(StringUtil.RTrim(AV33Pgmname+"GridState"));
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Manage#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.managefilters.aspx"+UrlEncode(StringUtil.RTrim("WPUsuarioDetalleDistribuidoresUsuarioWCFilters"));
         ...
         else
         {
            ...
            new WorkWithPlus.workwithplus_web.getfilterbyname(context ).execute(  "WPUsuarioDetalleDistribuidoresUsuarioWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char2) ;
            ...
            else
            {
               ...
               new WorkWithPlus.workwithplus_web.savegridstate(context ).execute(  AV33Pgmname+"GridState",  AV18ManageFiltersXml) ;
      ...
      protected void E15342( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wpasignardistribuidorusuario.aspx"+UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode(StringUtil.LTrimStr(0,1,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV7UsuarioID,9,0));
      ...
      protected void S112( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_managefiltersloadsavedfilters(context ).execute(  "WPUsuarioDetalleDistribuidoresUsuarioWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item3) ;
      ...
      protected void S182( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wpasignardistribuidorusuario.aspx"+UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode(StringUtil.LTrimStr(A81DistribuidoresUsuarioID,9,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV7UsuarioID,9,0));
         context.PopUp(formatLink("wpasignardistribuidorusuario.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey), new Object[] {});
         context.DoAjaxRefreshCmp(sPrefix);
      }
      ...
      protected void S192( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wpasignardistribuidorusuario.aspx"+UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode(StringUtil.LTrimStr(A81DistribuidoresUsuarioID,9,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV7UsuarioID,9,0));
         context.PopUp(formatLink("wpasignardistribuidorusuario.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey), new Object[] {});
         context.DoAjaxRefreshCmp(sPrefix);
      }
      ...
      protected void S132( )
      {
         ...
         {
            AV11GridState.FromXml(new WorkWithPlus.workwithplus_web.loadgridstate(context).executeUdp(  AV33Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV11GridState.FromXml(AV16Session.Get(AV33Pgmname+"GridState"), null, "", "");
         }
         AV13OrderedBy = AV11GridState.gxTpr_Orderedby;
         AssignAttri(sPrefix, false, "AV13OrderedBy", StringUtil.LTrimStr( (decimal)(AV13OrderedBy), 4, 0));
         AV14OrderedDsc = AV11GridState.gxTpr_Ordereddsc;
      ...
      protected void S172( )
      {
         ...
         {
            AV12GridStateFilterValue = ((WorkWithPlus.workwithplus_web.SdtWWPGridState_FilterValue)AV11GridState.gxTpr_Filtervalues.Item(AV34GXV1));
      ...
      protected void S152( )
      {
         ...
         new WorkWithPlus.workwithplus_web.savegridstate(context ).execute(  AV33Pgmname+"GridState",  AV11GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void S122( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "DistribuidoresUsuario";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "wpusuariodetalledistribuidoresusuariowc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20265111130595", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wpusuariodetalledistribuidoresusuariowc.js", "?20265111130595", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         edtDistribuidoresUsuarioID_Internalname = sPrefix+"DISTRIBUIDORESUSUARIOID_"+sGXsfl_35_idx;
         edtDistribuidorID_Internalname = sPrefix+"DISTRIBUIDORID_"+sGXsfl_35_idx;
         cmbUsuarioRol_Internalname = sPrefix+"USUARIOROL_"+sGXsfl_35_idx;
         edtDistribuidorDescripcion_Internalname = sPrefix+"DISTRIBUIDORDESCRIPCION_"+sGXsfl_35_idx;
         edtDistribuidorRFC_Internalname = sPrefix+"DISTRIBUIDORRFC_"+sGXsfl_35_idx;
         cmbavGridactions_Internalname = sPrefix+"vGRIDACTIONS_"+sGXsfl_35_idx;
      }

      protected void SubsflControlProps_fel_352( )
      {
         edtDistribuidoresUsuarioID_Internalname = sPrefix+"DISTRIBUIDORESUSUARIOID_"+sGXsfl_35_fel_idx;
         edtDistribuidorID_Internalname = sPrefix+"DISTRIBUIDORID_"+sGXsfl_35_fel_idx;
         cmbUsuarioRol_Internalname = sPrefix+"USUARIOROL_"+sGXsfl_35_fel_idx;
         edtDistribuidorDescripcion_Internalname = sPrefix+"DISTRIBUIDORDESCRIPCION_"+sGXsfl_35_fel_idx;
         edtDistribuidorRFC_Internalname = sPrefix+"DISTRIBUIDORRFC_"+sGXsfl_35_fel_idx;
      ...
      protected void sendrow_352( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_35_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtDistribuidoresUsuarioID_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A81DistribuidoresUsuarioID), 9, 0, context.GetLanguageProperty( "decimal_point"), "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A81DistribuidoresUsuarioID), "ZZZZZZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtDistribuidoresUsuarioID_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)9,(short)0,(short)0,(short)35,(short)0,(short)-1,(short)0,(bool)true,(string)"ID",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+"display:none;"+"\">") ;
            ...
            AssignProp(sPrefix, false, cmbUsuarioRol_Internalname, "Values", (string)(cmbUsuarioRol.ToJavascriptSource()), !bGXsfl_35_Refreshing);
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtDistribuidorRFC_Internalname,StringUtil.RTrim( A12DistribuidorRFC),(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtDistribuidorRFC_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)13,(short)0,(short)0,(short)35,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      protected void init_default_properties( )
      {
         ...
         edtDistribuidoresUsuarioID_Internalname = sPrefix+"DISTRIBUIDORESUSUARIOID";
         ...
         edtDistribuidorRFC_Internalname = sPrefix+"DISTRIBUIDORRFC";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"sPrefix"},{"av":"AV7UsuarioID","fld":"vUSUARIOID","pic":"ZZZZZZZZ9"},{"av":"cmbUsuarioRol"},{"av":"A40UsuarioRol","fld":"USUARIOROL"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV33Pgmname","fld":"vPGMNAME","hsh":true},{"av":"A29UsuarioID","fld":"USUARIOID","pic":"ZZZZZZZZ9","hsh":true}]""");
         setEventMetadata("REFRESH",""","oparms":[{"ctrl":"BTNUSERACTION1","prop":"Visible"},{"ctrl":"BTNUSERACTION1","prop":"Enabled"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV23GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV24GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV25GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV17ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV11GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E12342","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV7UsuarioID","fld":"vUSUARIOID","pic":"ZZZZZZZZ9"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV33Pgmname","fld":"vPGMNAME","hsh":true},{"av":"A29UsuarioID","fld":"USUARIOID","pic":"ZZZZZZZZ9","hsh":true},{"av":"sPrefix"},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","""{"handler":"E13342","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV7UsuarioID","fld":"vUSUARIOID","pic":"ZZZZZZZZ9"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV33Pgmname","fld":"vPGMNAME","hsh":true},{"av":"A29UsuarioID","fld":"USUARIOID","pic":"ZZZZZZZZ9","hsh":true},{"av":"sPrefix"},{"av":"Gridpaginationbar_Rowsperpageselectedvalue","ctrl":"GRIDPAGINATIONBAR","prop":"RowsPerPageSelectedValue"}]""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",""","oparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]}""");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","""{"handler":"E14342","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV7UsuarioID","fld":"vUSUARIOID","pic":"ZZZZZZZZ9"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV33Pgmname","fld":"vPGMNAME","hsh":true},{"av":"A29UsuarioID","fld":"USUARIOID","pic":"ZZZZZZZZ9","hsh":true},{"av":"sPrefix"},{"av":"Ddo_grid_Activeeventkey","ctrl":"DDO_GRID","prop":"ActiveEventKey"},{"av":"Ddo_grid_Selectedvalue_get","ctrl":"DDO_GRID","prop":"SelectedValue_get"}]""");
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E18342","iparms":[]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"cmbavGridactions"},{"av":"AV26GridActions","fld":"vGRIDACTIONS","pic":"ZZZ9"}]}""");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","""{"handler":"E11342","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV7UsuarioID","fld":"vUSUARIOID","pic":"ZZZZZZZZ9"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV33Pgmname","fld":"vPGMNAME","hsh":true},{"av":"A29UsuarioID","fld":"USUARIOID","pic":"ZZZZZZZZ9","hsh":true},{"av":"sPrefix"},{"av":"Ddo_managefilters_Activeeventkey","ctrl":"DDO_MANAGEFILTERS","prop":"ActiveEventKey"},{"av":"AV11GridState","fld":"vGRIDSTATE"},{"av":"cmbUsuarioRol"},{"av":"A40UsuarioRol","fld":"USUARIOROL"}]""");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED",""","oparms":[{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV11GridState","fld":"vGRIDSTATE"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"Ddo_grid_Sortedstatus","ctrl":"DDO_GRID","prop":"SortedStatus"},{"ctrl":"BTNUSERACTION1","prop":"Visible"},{"ctrl":"BTNUSERACTION1","prop":"Enabled"},{"av":"AV23GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV24GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV25GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV17ManageFiltersData","fld":"vMANAGEFILTERSDATA"}]}""");
         setEventMetadata("VGRIDACTIONS.CLICK","""{"handler":"E19342","iparms":[{"av":"cmbavGridactions"},{"av":"AV26GridActions","fld":"vGRIDACTIONS","pic":"ZZZ9"},{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV7UsuarioID","fld":"vUSUARIOID","pic":"ZZZZZZZZ9"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV33Pgmname","fld":"vPGMNAME","hsh":true},{"av":"A29UsuarioID","fld":"USUARIOID","pic":"ZZZZZZZZ9","hsh":true},{"av":"sPrefix"},{"av":"A81DistribuidoresUsuarioID","fld":"DISTRIBUIDORESUSUARIOID","pic":"ZZZZZZZZ9","hsh":true},{"av":"cmbUsuarioRol"},{"av":"A40UsuarioRol","fld":"USUARIOROL"}]""");
         setEventMetadata("VGRIDACTIONS.CLICK",""","oparms":[{"av":"cmbavGridactions"},{"av":"AV26GridActions","fld":"vGRIDACTIONS","pic":"ZZZ9"},{"ctrl":"BTNUSERACTION1","prop":"Visible"},{"ctrl":"BTNUSERACTION1","prop":"Enabled"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV23GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV24GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV25GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV17ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV11GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("'DOUSERACTION1'","""{"handler":"E15342","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV7UsuarioID","fld":"vUSUARIOID","pic":"ZZZZZZZZ9"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV33Pgmname","fld":"vPGMNAME","hsh":true},{"av":"A29UsuarioID","fld":"USUARIOID","pic":"ZZZZZZZZ9","hsh":true},{"av":"sPrefix"},{"av":"cmbUsuarioRol"},{"av":"A40UsuarioRol","fld":"USUARIOROL"}]""");
         setEventMetadata("'DOUSERACTION1'",""","oparms":[{"ctrl":"BTNUSERACTION1","prop":"Visible"},{"ctrl":"BTNUSERACTION1","prop":"Enabled"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV23GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV24GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV25GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV17ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV11GridState","fld":"vGRIDSTATE"}]}""");
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         lV15FilterFullText = "";
         H00342_A29UsuarioID = new int[1] ;
         H00342_A12DistribuidorRFC = new string[] {""} ;
         H00342_A11DistribuidorDescripcion = new string[] {""} ;
         H00342_A40UsuarioRol = new string[] {""} ;
         H00342_A10DistribuidorID = new int[1] ;
         H00342_A81DistribuidoresUsuarioID = new int[1] ;
         H00343_AGRID_nRecordCount = new long[1] ;
         hsh = "";
         H00344_A29UsuarioID = new int[1] ;
         H00344_A40UsuarioRol = new string[] {""} ;
         AV27UsuarioRol = "";
         H00345_AV28Count = new short[1] ;
         GXt_SdtDVB_SDTDropDownOptionsTitleSettingsIcons1 = new WorkWithPlus.workwithplus_web.SdtDVB_SDTDropDownOptionsTitleSettingsIcons(context);
         H00346_A29UsuarioID = new int[1] ;
         H00346_A40UsuarioRol = new string[] {""} ;
         H00347_AV28Count = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wpusuariodetalledistribuidoresusuariowc__default(),
            new Object[][] {
                new Object[] {
               H00342_A29UsuarioID, H00342_A12DistribuidorRFC, H00342_A11DistribuidorDescripcion, H00342_A40UsuarioRol, H00342_A10DistribuidorID, H00342_A81DistribuidoresUsuarioID
               }
               , new Object[] {
               H00343_AGRID_nRecordCount
               }
               , new Object[] {
               H00344_A29UsuarioID, H00344_A40UsuarioRol
               }
               , new Object[] {
               H00345_AV28Count
               }
               , new Object[] {
               H00346_A29UsuarioID, H00346_A40UsuarioRol
               }
               , new Object[] {
               H00347_AV28Count
               }
      ...
      private short AV28Count ;
      private short cV28Count ;
      ...
      private int[] H00342_A29UsuarioID ;
      private string[] H00342_A12DistribuidorRFC ;
      private string[] H00342_A11DistribuidorDescripcion ;
      private string[] H00342_A40UsuarioRol ;
      private int[] H00342_A10DistribuidorID ;
      private int[] H00342_A81DistribuidoresUsuarioID ;
      private long[] H00343_AGRID_nRecordCount ;
      private int[] H00344_A29UsuarioID ;
      private string[] H00344_A40UsuarioRol ;
      private short[] H00345_AV28Count ;
      private WorkWithPlus.workwithplus_web.SdtDVB_SDTDropDownOptionsTitleSettingsIcons GXt_SdtDVB_SDTDropDownOptionsTitleSettingsIcons1 ;
      private int[] H00346_A29UsuarioID ;
      private string[] H00346_A40UsuarioRol ;
      private short[] H00347_AV28Count ;
   ...
   public class wpusuariodetalledistribuidoresusuariowc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             int A29UsuarioID )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.`UsuarioID`, T3.`DistribuidorRFC`, T3.`DistribuidorDescripcion`, T2.`UsuarioRol`, T1.`DistribuidorID`, T1.`DistribuidoresUsuarioID`";
         sFromString = " FROM ((`DistribuidoresUsuario` T1 INNER JOIN `Usuario` T2 ON T2.`UsuarioID` = T1.`UsuarioID`) INNER JOIN `Distribuidor` T3 ON T3.`DistribuidorID` = T1.`DistribuidorID`)";
         sOrderString = "";
         AddWhere(sWhereString, "(T1.`UsuarioID` = @AV7UsuarioID)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV15FilterFullText)) )
         {
            AddWhere(sWhereString, "(( T3.`DistribuidorDescripcion` like CONCAT('%', @lV15FilterFullText)) or ( T3.`DistribuidorRFC` like CONCAT('%', @lV15FilterFullText)))");
         }
         else
         {
            GXv_int4[1] = 1;
         ...
         {
            sOrderString += " ORDER BY T1.`UsuarioID`, T3.`DistribuidorDescripcion`";
         }
         else if ( ( AV13OrderedBy == 2 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.`UsuarioID` DESC, T3.`DistribuidorDescripcion` DESC";
         }
         else if ( ( AV13OrderedBy == 3 ) && ! AV14OrderedDsc )
         {
            sOrderString += " ORDER BY T1.`UsuarioID`, T3.`DistribuidorRFC`";
         }
         else if ( ( AV13OrderedBy == 3 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.`UsuarioID` DESC, T3.`DistribuidorRFC` DESC";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY T1.`DistribuidoresUsuarioID`";
                                             ...
                                             int A29UsuarioID )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ((`DistribuidoresUsuario` T1 INNER JOIN `Usuario` T3 ON T3.`UsuarioID` = T1.`UsuarioID`) INNER JOIN `Distribuidor` T2 ON T2.`DistribuidorID` = T1.`DistribuidorID`)";
         AddWhere(sWhereString, "(T1.`UsuarioID` = @AV7UsuarioID)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV15FilterFullText)) )
         {
            AddWhere(sWhereString, "(( T2.`DistribuidorDescripcion` like CONCAT('%', @lV15FilterFullText)) or ( T2.`DistribuidorRFC` like CONCAT('%', @lV15FilterFullText)))");
         }
         else
         {
            GXv_int6[1] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00342(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (int)dynConstraints[5] , (int)dynConstraints[6] );
               case 1 :
                     return conditional_H00343(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (int)dynConstraints[5] , (int)dynConstraints[6] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmH00346;
          prmH00346 = new Object[] {
          new ParDef("@AV7UsuarioID",GXType.Int32,9,0)
          };
          Object[] prmH00347;
          prmH00347 = new Object[] {
          new ParDef("@AV7UsuarioID",GXType.Int32,9,0)
          };
          Object[] prmH00342;
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("H00344", "SELECT `UsuarioID`, `UsuarioRol` FROM `Usuario` WHERE `UsuarioID` = @AV7UsuarioID ORDER BY `UsuarioID`  LIMIT 1",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00344,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("H00345", "SELECT COUNT(*) FROM `DistribuidoresUsuario` WHERE `UsuarioID` = @AV7UsuarioID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00345,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00346", "SELECT `UsuarioID`, `UsuarioRol` FROM `Usuario` WHERE `UsuarioID` = @AV7UsuarioID ORDER BY `UsuarioID`  LIMIT 1",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00346,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("H00347", "SELECT COUNT(*) FROM `DistribuidoresUsuario` WHERE `UsuarioID` = @AV7UsuarioID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00347,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
