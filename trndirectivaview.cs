...
namespace GeneXus.Programs {
   public class trndirectivaview : GXDataArea
   {
      public trndirectivaview( )
      {
      ...
      public trndirectivaview( IGxContext context )
      {
      ...
      public void execute( string aP0_TrnDirectivaTitle ,
                           string aP1_TabCode )
      {
         this.AV9TrnDirectivaTitle = aP0_TrnDirectivaTitle;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "TrnDirectivaTitle");
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "trndirectivaview.aspx"+UrlEncode(StringUtil.RTrim(AV9TrnDirectivaTitle)) + "," + UrlEncode(StringUtil.RTrim(AV7TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trndirectivaview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vTRNDIRECTIVATITLE", AV9TrnDirectivaTitle);
         GxWebStd.gx_hidden_field( context, "gxhash_vTRNDIRECTIVATITLE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV9TrnDirectivaTitle, "")), context));
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
      }
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "trndirectivaview.aspx"+UrlEncode(StringUtil.RTrim(AV9TrnDirectivaTitle)) + "," + UrlEncode(StringUtil.RTrim(AV7TabCode));
         return formatLink("trndirectivaview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "TrnDirectivaView" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Trn Directiva View", "") ;
      }
      ...
      protected void WB4V0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, context.GetMessage( "Ir a Directivas", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_TrnDirectivaView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTrndirectivageneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
      ...
      protected void START4V2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Trn Directiva View", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void PA4V2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "trndirectivaview.aspx")), "trndirectivaview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "trndirectivaview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV9TrnDirectivaTitle = gxfirstwebparm;
                     AssignAttri("", false, "AV9TrnDirectivaTitle", AV9TrnDirectivaTitle);
                     GxWebStd.gx_hidden_field( context, "gxhash_vTRNDIRECTIVATITLE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV9TrnDirectivaTitle, "")), context));
      ...
      protected void E114V2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("trndirectivaww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV13GXLvl9 = 0;
         /* Using cursor H004V2 */
         pr_default.execute(0, new Object[] {AV9TrnDirectivaTitle});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A89TrnDirectivaTitle = H004V2_A89TrnDirectivaTitle[0];
            AV13GXLvl9 = 1;
            Form.Caption = A89TrnDirectivaTitle;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "TrnDirectivaGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "trndirectivageneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "TrnDirectivaGeneral";
            WebComp_Webcomponent_general_Component = "TrnDirectivaGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(string)AV9TrnDirectivaTitle});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV9TrnDirectivaTitle = (string)getParm(obj,0);
         AssignAttri("", false, "AV9TrnDirectivaTitle", AV9TrnDirectivaTitle);
         GxWebStd.gx_hidden_field( context, "gxhash_vTRNDIRECTIVATITLE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV9TrnDirectivaTitle, "")), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20265111131796", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trndirectivaview.js", "?20265111131796", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divTrndirectivageneral_cell_Internalname = "TRNDIRECTIVAGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Trn Directiva View", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV9TrnDirectivaTitle","fld":"vTRNDIRECTIVATITLE","hsh":true}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         H004V2_A89TrnDirectivaTitle = new string[] {""} ;
         A89TrnDirectivaTitle = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trndirectivaview__default(),
            new Object[][] {
                new Object[] {
               H004V2_A89TrnDirectivaTitle
               }
            }
         );
      ...
      private string divTrndirectivageneral_cell_Internalname ;
      ...
      private string AV9TrnDirectivaTitle ;
      private string wcpOAV9TrnDirectivaTitle ;
      ...
      private string[] H004V2_A89TrnDirectivaTitle ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class trndirectivaview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV9TrnDirectivaTitle",GXType.Char,100,0)
          };
          def= new CursorDef[] {
              new CursorDef("H004V2", "SELECT `TrnDirectivaTitle` FROM `TrnDirectiva` WHERE `TrnDirectivaTitle` = @AV9TrnDirectivaTitle ORDER BY `TrnDirectivaTitle` ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004V2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
