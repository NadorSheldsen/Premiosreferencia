...
namespace GeneXus.Programs {
   public class wpavisomensaje : GXDataArea
   {
      public wpavisomensaje( )
      {
      ...
      public wpavisomensaje( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wpavisomensaje.aspx") +"\">") ;
      ...
      {
         return formatLink("wpavisomensaje.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "WPAvisoMensaje" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "WPAviso Mensaje", "") ;
      }
      ...
      protected void WB540( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock1_Internalname, lblTextblock1_Caption, "", "", lblTextblock1_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 2, "HLP_WPAvisoMensaje.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnenter_Internalname, "", context.GetMessage( "GX_BtnEnter", ""), bttBtnenter_Jsonclick, 5, context.GetMessage( "GX_BtnEnter", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_WPAvisoMensaje.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavFocustrap_Internalname, StringUtil.RTrim( AV5FocusTrap), StringUtil.RTrim( context.localUtil.Format( AV5FocusTrap, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,33);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFocustrap_Jsonclick, 0, "Attribute", "", "", "", "", edtavFocustrap_Visible, 1, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WPAvisoMensaje.htm");
            /* Multiple line edit */
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavDescription_Internalname, AV6Description, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,34);\"", 0, edtavDescription_Visible, 1, 0, 80, "chr", 10, "row", 0, StyleString, ClassString, "", "", "2097152", -1, 0, "", "", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "", "HLP_WPAvisoMensaje.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START542( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "WPAviso Mensaje", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void STRUP540( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV5FocusTrap = cgiGet( edtavFocustrap_Internalname);
            AssignAttri("", false, "AV5FocusTrap", AV5FocusTrap);
      ...
      protected void E11542( )
      {
         ...
         new obtienedescdirectiva(context ).execute(  context.GetMessage( "MENSAJEANUNCIO", ""), out  AV18MENSAJEANUNCIO) ;
         lblTextblock1_Caption = AV18MENSAJEANUNCIO;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20265111131988", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wpavisomensaje.js", "?20265111131988", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "WPAviso Mensaje", "");
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","""{"handler":"E12542","iparms":[]}""");
         return  ;
      }
      ...
      private bool AV14Aviso ;
      private string AV6Description ;
      private string AV18MENSAJEANUNCIO ;
