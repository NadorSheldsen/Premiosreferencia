...
namespace GeneXus.Programs {
   public class promocionpromocionmodelowc : GXWebComponent
   {
      public promocionpromocionmodelowc( )
      {
      ...
      public promocionpromocionmodelowc( IGxContext context )
      {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV27Pgmname = "PromocionPromocionModeloWC";
               WS2G2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "Promocion Promocion Modelo WC", "")) ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "promocionpromocionmodelowc.aspx"+UrlEncode(StringUtil.LTrimStr(AV7PromocionID,9,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("promocionpromocionmodelowc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         return "PromocionPromocionModeloWC" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Promocion Promocion Modelo WC", "") ;
      }
      ...
      protected void WB2G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "promocionpromocionmodelowc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            GxWebStd.gx_single_line_edit( context, edtavFilterfulltext_Internalname, AV15FilterFullText, StringUtil.RTrim( context.localUtil.Format( AV15FilterFullText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,29);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", context.GetMessage( "WWP_Search", ""), edtavFilterfulltext_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavFilterfulltext_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "WorkWithPlus_Web\\WWPFullTextFilter", "start", true, "", "HLP_PromocionPromocionModeloWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START2G2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "Promocion Promocion Modelo WC", ""), 0) ;
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "promocionpromocionmodelowc.aspx")), "promocionpromocionmodelowc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "promocionpromocionmodelowc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void RF2G2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 A41PromocionID } ,
                                                 new int[]{
                                                 TypeConstants.INT, TypeConstants.INT, TypeConstants.DECIMAL, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.INT, TypeConstants.INT
                                                 }
            });
            ...
            lV15FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV15FilterFullText), "%", "");
            /* Using cursor H002G2 */
            pr_default.execute(0, new Object[] {AV7PromocionID, lV15FilterFullText, lV15FilterFullText, lV15FilterFullText, GXPagingFrom2, GXPagingTo2});
            nGXsfl_35_idx = 1;
            sGXsfl_35_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_35_idx), 4, 0), 4, "0");
            SubsflControlProps_352( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A41PromocionID = H002G2_A41PromocionID[0];
               AssignAttri(sPrefix, false, "A41PromocionID", StringUtil.LTrimStr( (decimal)(A41PromocionID), 9, 0));
               A49PromocionModeloPrecio = H002G2_A49PromocionModeloPrecio[0];
               A22ModeloID = H002G2_A22ModeloID[0];
               A48PromocionModeloID = H002G2_A48PromocionModeloID[0];
               /* Execute user event: Grid.Load */
               E182G2 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV15FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV15FilterFullText), "%", "");
         /* Using cursor H002G3 */
         pr_default.execute(1, new Object[] {AV7PromocionID, lV15FilterFullText, lV15FilterFullText, lV15FilterFullText});
      ...
      protected void E112G2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("PromocionPromocionModeloWCFilters")) + "," + UrlEncode(StringUtil.RTrim(AV27Pgmname+"GridState"));
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Manage#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.managefilters.aspx"+UrlEncode(StringUtil.RTrim("PromocionPromocionModeloWCFilters"));
         ...
         else
         {
            ...
            new WorkWithPlus.workwithplus_web.getfilterbyname(context ).execute(  "PromocionPromocionModeloWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char2) ;
      ...
      protected void E152G2( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "promocionmodelo.aspx"+UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode(StringUtil.LTrimStr(0,1,0));
         CallWebObject(formatLink("promocionmodelo.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
      ...
      protected void S112( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_managefiltersloadsavedfilters(context ).execute(  "PromocionPromocionModeloWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item3) ;
      ...
      protected void S182( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "promocionmodelo.aspx"+UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode(StringUtil.LTrimStr(A48PromocionModeloID,9,0));
         CallWebObject(formatLink("promocionmodelo.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S192( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "promocionmodelo.aspx"+UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode(StringUtil.LTrimStr(A48PromocionModeloID,9,0));
         CallWebObject(formatLink("promocionmodelo.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S122( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "PromocionModelo";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "promocionpromocionmodelowc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202651111305523", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("promocionpromocionmodelowc.js", "?202651111305523", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         edtPromocionModeloID_Internalname = sPrefix+"PROMOCIONMODELOID_"+sGXsfl_35_idx;
         edtModeloID_Internalname = sPrefix+"MODELOID_"+sGXsfl_35_idx;
         edtPromocionModeloPrecio_Internalname = sPrefix+"PROMOCIONMODELOPRECIO_"+sGXsfl_35_idx;
         cmbavGridactions_Internalname = sPrefix+"vGRIDACTIONS_"+sGXsfl_35_idx;
      }

      protected void SubsflControlProps_fel_352( )
      {
         edtPromocionModeloID_Internalname = sPrefix+"PROMOCIONMODELOID_"+sGXsfl_35_fel_idx;
         edtModeloID_Internalname = sPrefix+"MODELOID_"+sGXsfl_35_fel_idx;
         edtPromocionModeloPrecio_Internalname = sPrefix+"PROMOCIONMODELOPRECIO_"+sGXsfl_35_fel_idx;
      ...
      protected void sendrow_352( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_35_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtPromocionModeloID_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A48PromocionModeloID), 9, 0, context.GetLanguageProperty( "decimal_point"), "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A48PromocionModeloID), "ZZZZZZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtPromocionModeloID_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)9,(short)0,(short)0,(short)35,(short)0,(short)-1,(short)0,(bool)true,(string)"ID",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtPromocionModeloPrecio_Internalname,StringUtil.LTrim( StringUtil.NToC( A49PromocionModeloPrecio, 14, 2, context.GetLanguageProperty( "decimal_point"), "")),StringUtil.LTrim( context.localUtil.Format( A49PromocionModeloPrecio, "$ Z,ZZZ,ZZ9.99")),(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtPromocionModeloPrecio_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)14,(short)0,(short)0,(short)35,(short)0,(short)-1,(short)0,(bool)true,(string)"Precio",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl35( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"end"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( context.GetMessage( "Comisión", "")) ;
            context.WriteHtmlTextNl( "</th>") ;
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A48PromocionModeloID), 9, 0, ".", ""))));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A22ModeloID), 9, 0, ".", ""))));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( A49PromocionModeloPrecio, 14, 2, ".", ""))));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void init_default_properties( )
      {
         ...
         edtPromocionModeloID_Internalname = sPrefix+"PROMOCIONMODELOID";
         edtModeloID_Internalname = sPrefix+"MODELOID";
         edtPromocionModeloPrecio_Internalname = sPrefix+"PROMOCIONMODELOPRECIO";
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "0:PromocionModeloID|1:ModeloID|2:PromocionModeloPrecio";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E182G2","iparms":[]""");
         ...
         setEventMetadata("VGRIDACTIONS.CLICK","""{"handler":"E192G2","iparms":[{"av":"cmbavGridactions"},{"av":"AV26GridActions","fld":"vGRIDACTIONS","pic":"ZZZ9"},{"av":"A48PromocionModeloID","fld":"PROMOCIONMODELOID","pic":"ZZZZZZZZ9"}]""");
         setEventMetadata("VGRIDACTIONS.CLICK",""","oparms":[{"av":"cmbavGridactions"},{"av":"AV26GridActions","fld":"vGRIDACTIONS","pic":"ZZZ9"},{"av":"A48PromocionModeloID","fld":"PROMOCIONMODELOID","pic":"ZZZZZZZZ9"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E152G2","iparms":[{"av":"A48PromocionModeloID","fld":"PROMOCIONMODELOID","pic":"ZZZZZZZZ9"}]""");
         setEventMetadata("'DOINSERT'",""","oparms":[{"av":"A48PromocionModeloID","fld":"PROMOCIONMODELOID","pic":"ZZZZZZZZ9"}]}""");
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         lV15FilterFullText = "";
         H002G2_A41PromocionID = new int[1] ;
         H002G2_A49PromocionModeloPrecio = new decimal[1] ;
         H002G2_A22ModeloID = new int[1] ;
         H002G2_A48PromocionModeloID = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.promocionpromocionmodelowc__default(),
            new Object[][] {
                new Object[] {
               H002G2_A41PromocionID, H002G2_A49PromocionModeloPrecio, H002G2_A22ModeloID, H002G2_A48PromocionModeloID
               }
               , new Object[] {
      ...
      private int[] H002G2_A41PromocionID ;
      private decimal[] H002G2_A49PromocionModeloPrecio ;
      private int[] H002G2_A22ModeloID ;
      private int[] H002G2_A48PromocionModeloID ;
   ...
   public class promocionpromocionmodelowc__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H002G2( IGxContext context ,
                                             string AV15FilterFullText ,
                                             int A48PromocionModeloID ,
                                             int A22ModeloID ,
                                             ...
                                             int A41PromocionID )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " `PromocionID`, `PromocionModeloPrecio`, `ModeloID`, `PromocionModeloID`";
         sFromString = " FROM `PromocionModelo`";
         sOrderString = "";
         AddWhere(sWhereString, "(`PromocionID` = @AV7PromocionID)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV15FilterFullText)) )
         {
            AddWhere(sWhereString, "(( (LPAD(REPLACE(FORMAT(`PromocionModeloID`,0), ',', ''), 9, ' ')) like CONCAT('%', @lV15FilterFullText)) or ( (LPAD(REPLACE(FORMAT(`ModeloID`,0), ',', ''), 9, ' ')) like CONCAT('%', @lV15FilterFullText)) or ( (LPAD(REPLACE(FORMAT(`PromocionModeloPrecio`,2), ',', ''), 10, ' ')) like CONCAT('%', @lV15FilterFullText)))");
         }
         else
         {
            GXv_int4[1] = 1;
         ...
         {
            sOrderString += " ORDER BY `PromocionID`, `PromocionModeloPrecio`";
         }
         else if ( ( AV13OrderedBy == 1 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY `PromocionID` DESC, `PromocionModeloPrecio` DESC";
         }
         else if ( ( AV13OrderedBy == 2 ) && ! AV14OrderedDsc )
         {
            sOrderString += " ORDER BY `PromocionID`, `PromocionModeloID`";
         }
         else if ( ( AV13OrderedBy == 2 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY `PromocionID` DESC, `PromocionModeloID` DESC";
         }
         else if ( ( AV13OrderedBy == 3 ) && ! AV14OrderedDsc )
         {
            sOrderString += " ORDER BY `PromocionID`, `ModeloID`";
         }
         else if ( ( AV13OrderedBy == 3 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY `PromocionID` DESC, `ModeloID` DESC";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY `PromocionModeloID`";
         }
                                             ...
                                             int A41PromocionID )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM `PromocionModelo`";
         AddWhere(sWhereString, "(`PromocionID` = @AV7PromocionID)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV15FilterFullText)) )
         {
            AddWhere(sWhereString, "(( (LPAD(REPLACE(FORMAT(`PromocionModeloID`,0), ',', ''), 9, ' ')) like CONCAT('%', @lV15FilterFullText)) or ( (LPAD(REPLACE(FORMAT(`ModeloID`,0), ',', ''), 9, ' ')) like CONCAT('%', @lV15FilterFullText)) or ( (LPAD(REPLACE(FORMAT(`PromocionModeloPrecio`,2), ',', ''), 10, ' ')) like CONCAT('%', @lV15FilterFullText)))");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H002G2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (int)dynConstraints[2] , (decimal)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] , (int)dynConstraints[6] , (int)dynConstraints[7] );
               case 1 :
                     return conditional_H002G3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (int)dynConstraints[2] , (decimal)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] , (int)dynConstraints[6] , (int)dynConstraints[7] );
         }
