   ...
   public class savefilteras : GXDataArea
   {
      ...
      protected void wb_table2_5_0M2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table3_8_0M2( true) ;
         }
         else
         {
            wb_table3_8_0M2( false) ;
         }
         return  ;
      }

      protected void wb_table3_8_0M2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
      ...
      protected void wb_table3_8_0M2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_8_0M2e( true) ;
         }
         else
         {
            wb_table3_8_0M2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025102815462257", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/savefilteras.js", "?2025102815462257", false, true);
         context.AddJavascriptSource("DVelop/DVMessage/pnotify.custom.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVMessage/DVMessageRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","""{"handler":"E120M2","iparms":[{"av":"AV8FilterName","fld":"vFILTERNAME"},{"av":"AV20CheckRequiredFieldsResult","fld":"vCHECKREQUIREDFIELDSRESULT"},{"av":"AV15UserKey","fld":"vUSERKEY","hsh":true},{"av":"AV5GridStateKey","fld":"vGRIDSTATEKEY","hsh":true}]""");
