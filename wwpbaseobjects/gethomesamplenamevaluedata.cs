...
namespace GeneXus.Programs.wwpbaseobjects {
   public class gethomesamplenamevaluedata : GXWebProcedure
   {
      public override void webExecute( )
      {
         ...
         initialize();
         Gxm3rootcol = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtHomeSampleNameValueData_HomeSampleNameValueDataItem>( context, "HomeSampleNameValueDataItem", "Premios") ;
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( GXSoapHTTPRequest.Method), "get") == 0 )
         {
            if ( StringUtil.StrCmp(StringUtil.Lower( GXSoapHTTPRequest.QueryString), "wsdl") == 0 )
            {
               ...
               GXSoapXMLWriter.WriteAttribute("targetNamespace", "Premios");
               GXSoapXMLWriter.WriteAttribute("xmlns:wsdlns", "Premios");
               ...
               GXSoapXMLWriter.WriteAttribute("xmlns:tns", "Premios");
               ...
               GXSoapXMLWriter.WriteAttribute("soapAction", "Premiosaction/"+"wwpbaseobjects.AGETHOMESAMPLENAMEVALUEDATA.Execute");
         ...
         if ( ( StringUtil.StringSearch( currMethod+"&", "Execute&", 1) > 0 ) || ( currSoapErr != 0 ) )
         {
            ...
            GXSoapXMLWriter.WriteAttribute("xmlns", "Premios");
            if ( currSoapErr == 0 )
            {
               if ( Gxm3rootcol != null )
               {
                  Gxm3rootcol.writexmlcollection(GXSoapXMLWriter, "ReturnValue", "Premios", "HomeSampleNameValueDataItem", "Premios");
               }
            }
            else
            {
      ...
      {
         this.Gxm3rootcol = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtHomeSampleNameValueData_HomeSampleNameValueDataItem>( context, "HomeSampleNameValueDataItem", "Premios") ;
         initialize();
         ExecuteImpl();
      ...
      public override void initialize( )
      {
         ...
         currSoapErrmsg = "";
         currMethod = "";
         AV5HomeSampleData = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtHomeSampleData_HomeSampleDataItem>( context, "HomeSampleDataItem", "Premios");
         GXt_objcol_SdtHomeSampleData_HomeSampleDataItem1 = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtHomeSampleData_HomeSampleDataItem>( context, "HomeSampleDataItem", "Premios");
