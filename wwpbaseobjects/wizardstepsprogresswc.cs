...
namespace GeneXus.Programs.wwpbaseobjects {
   public class wizardstepsprogresswc : GXWebComponent
   {
      ...
      {
         this.AV8WebSessionKey = aP0_WebSessionKey;
         this.AV10WizardSteps = aP1_WizardSteps;
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV8WebSessionKey = GetPar( "WebSessionKey");
                  AssignAttri(sPrefix, false, "AV8WebSessionKey", AV8WebSessionKey);
                  ajax_req_read_hidden_sdt(GetNextPar( ), AV10WizardSteps);
                  AV6CurrentStep = GetPar( "CurrentStep");
                  AssignAttri(sPrefix, false, "AV6CurrentStep", AV6CurrentStep);
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(string)AV8WebSessionKey,(GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem>)AV10WizardSteps,(string)AV6CurrentStep});
                  componentstart();
      ...
      {
         AV9StepNumber = (short)(Math.Round(NumberUtil.Val( GetPar( "StepNumber"), "."), 18, MidpointRounding.ToEven));
         ...
         gxgrGridwizardsteps_refresh( AV9StepNumber, AV7SelectedStepNumber, sPrefix) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               ...
               GXEncryptionTmp = "wwpbaseobjects.wizardstepsprogresswc.aspx"+UrlEncode(StringUtil.RTrim(AV8WebSessionKey)) + "," + UrlEncode(StringUtil.RTrim(AV6CurrentStep));
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"vSTEPNUMBER", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9StepNumber), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8WebSessionKey", wcpOAV8WebSessionKey);
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6CurrentStep", wcpOAV6CurrentStep);
         GxWebStd.gx_hidden_field( context, sPrefix+"vSTEPNUMBER", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9StepNumber), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vSTEPNUMBER", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(AV9StepNumber), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vSELECTEDSTEPNUMBER", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7SelectedStepNumber), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vSELECTEDSTEPNUMBER", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(AV7SelectedStepNumber), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vWEBSESSIONKEY", AV8WebSessionKey);
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"vWIZARDSTEPS", AV10WizardSteps);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt(sPrefix+"vWIZARDSTEPS", AV10WizardSteps);
         }
      ...
      protected void STRUP0S0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV8WebSessionKey = cgiGet( sPrefix+"wcpOAV8WebSessionKey");
      ...
      protected void E110S2( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vSELECTEDSTEPNUMBER", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(AV7SelectedStepNumber), "ZZZ9"), context));
         AV11GXV1 = 1;
         while ( AV11GXV1 <= AV10WizardSteps.Count )
         {
            AV5WizardStep = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV10WizardSteps.Item(AV11GXV1));
         ...
         AV9StepNumber = 1;
         AssignAttri(sPrefix, false, "AV9StepNumber", StringUtil.LTrimStr( (decimal)(AV9StepNumber), 4, 0));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vSTEPNUMBER", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(AV9StepNumber), "ZZZ9"), context));
      }
      ...
      private void E120S2( )
      {
         ...
         returnInSub = false;
         AV12GXV2 = 1;
         while ( AV12GXV2 <= AV10WizardSteps.Count )
         {
            AV10WizardSteps.CurrentItem = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV10WizardSteps.Item(AV12GXV2));
            if ( AV9StepNumber < AV7SelectedStepNumber )
            {
            ...
            else if ( AV9StepNumber == AV7SelectedStepNumber )
            {
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8WebSessionKey = (string)getParm(obj,0);
         AssignAttri(sPrefix, false, "AV8WebSessionKey", AV8WebSessionKey);
         AV10WizardSteps = (GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem>)getParm(obj,1);
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV8WebSessionKey = (string)((string)getParm(obj,0));
         sCtrlAV10WizardSteps = (string)((string)getParm(obj,1));
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         {
            AV8WebSessionKey = (string)getParm(obj,2);
            AssignAttri(sPrefix, false, "AV8WebSessionKey", AV8WebSessionKey);
            AV10WizardSteps = (GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem>)getParm(obj,3);
            AV6CurrentStep = (string)getParm(obj,4);
            AssignAttri(sPrefix, false, "AV6CurrentStep", AV6CurrentStep);
         }
         wcpOAV8WebSessionKey = cgiGet( sPrefix+"wcpOAV8WebSessionKey");
         wcpOAV6CurrentStep = cgiGet( sPrefix+"wcpOAV6CurrentStep");
         if ( ! GetJustCreated( ) && ( ( StringUtil.StrCmp(AV8WebSessionKey, wcpOAV8WebSessionKey) != 0 ) || ( StringUtil.StrCmp(AV6CurrentStep, wcpOAV6CurrentStep) != 0 ) ) )
         {
            setjustcreated();
         }
         wcpOAV8WebSessionKey = AV8WebSessionKey;
      ...
      protected void WCParametersGet( )
      {
         ...
         sCtrlAV8WebSessionKey = cgiGet( sPrefix+"AV8WebSessionKey_CTRL");
         if ( StringUtil.Len( sCtrlAV8WebSessionKey) > 0 )
         {
            AV8WebSessionKey = cgiGet( sCtrlAV8WebSessionKey);
            AssignAttri(sPrefix, false, "AV8WebSessionKey", AV8WebSessionKey);
         }
         else
         {
            AV8WebSessionKey = cgiGet( sPrefix+"AV8WebSessionKey_PARM");
         }
         sCtrlAV10WizardSteps = cgiGet( sPrefix+"AV10WizardSteps_CTRL");
         if ( StringUtil.Len( sCtrlAV10WizardSteps) > 0 )
         {
            AV10WizardSteps = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem>();
         }
         else
         {
            ajax_req_read_hidden_sdt(cgiGet( sPrefix+"AV10WizardSteps_PARM"), AV10WizardSteps);
         }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV8WebSessionKey_PARM", AV8WebSessionKey);
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV8WebSessionKey)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV8WebSessionKey_CTRL", StringUtil.RTrim( sCtrlAV8WebSessionKey));
         }
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"AV10WizardSteps_PARM", AV10WizardSteps);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt(sPrefix+"AV10WizardSteps_PARM", AV10WizardSteps);
         }
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV10WizardSteps)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV10WizardSteps_CTRL", StringUtil.RTrim( sCtrlAV10WizardSteps));
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025102815461590", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/wizardstepsprogresswc.js", "?2025102815461590", false, true);
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRIDWIZARDSTEPS_nFirstRecordOnPage"},{"av":"GRIDWIZARDSTEPS_nEOF"},{"av":"sPrefix"},{"av":"AV9StepNumber","fld":"vSTEPNUMBER","pic":"ZZZ9","hsh":true},{"av":"AV7SelectedStepNumber","fld":"vSELECTEDSTEPNUMBER","pic":"ZZZ9","hsh":true}]}""");
         setEventMetadata("GRIDWIZARDSTEPS.LOAD","""{"handler":"E120S2","iparms":[{"av":"AV9StepNumber","fld":"vSTEPNUMBER","pic":"ZZZ9","hsh":true},{"av":"AV7SelectedStepNumber","fld":"vSELECTEDSTEPNUMBER","pic":"ZZZ9","hsh":true}]""");
         setEventMetadata("GRIDWIZARDSTEPS.LOAD",""","oparms":[{"av":"divUnnamedtablefsgridwizardsteps_Class","ctrl":"UNNAMEDTABLEFSGRIDWIZARDSTEPS","prop":"Class"},{"av":"AV9StepNumber","fld":"vSTEPNUMBER","pic":"ZZZ9","hsh":true}]}""");
         return  ;
      }
      ...
      {
         AV10WizardSteps = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem>( context, "WizardStepsItem", "Premios");
         wcpOAV8WebSessionKey = "";
         wcpOAV6CurrentStep = "";
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         sPrefix = "";
         ...
         sCtrlAV8WebSessionKey = "";
         sCtrlAV10WizardSteps = "";
         sCtrlAV6CurrentStep = "";
      ...
      private string sCtrlAV8WebSessionKey ;
      private string sCtrlAV10WizardSteps ;
      ...
      private string AV8WebSessionKey ;
      private string AV6CurrentStep ;
      private string wcpOAV8WebSessionKey ;
      ...
      private GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem> AV10WizardSteps ;
