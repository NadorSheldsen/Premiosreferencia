...
namespace GeneXus.Programs.wwpbaseobjects {
   public class wizardstepsunderlinewc : GXWebComponent
   {
      ...
      {
         this.AV19WebSessionKey = aP0_WebSessionKey;
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV19WebSessionKey = GetPar( "WebSessionKey");
                  AssignAttri(sPrefix, false, "AV19WebSessionKey", AV19WebSessionKey);
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(string)AV19WebSessionKey,(GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem>)AV18WizardSteps,(string)AV6CurrentStep});
                  componentstart();
      ...
      protected void gxgrGridwizardsteps_refresh_invoke( )
      {
         ...
         gxgrGridwizardsteps_refresh( AV21WizardStepsAux, AV16StepRealNumber, AV15StepNumber, AV13SelectedStepNumber, AV22WizardStepsCount, AV6CurrentStep, AV7FirstIsDummy, AV8LastIsDummy, AV18WizardSteps, AV11PenultimateIsDummy, sPrefix) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               ...
               GXEncryptionTmp = "wwpbaseobjects.wizardstepsunderlinewc.aspx"+UrlEncode(StringUtil.RTrim(AV19WebSessionKey)) + "," + UrlEncode(StringUtil.RTrim(AV6CurrentStep));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV19WebSessionKey", wcpOAV19WebSessionKey);
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vPENULTIMATEISDUMMY", AV11PenultimateIsDummy);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vPENULTIMATEISDUMMY", GetSecureSignedToken( sPrefix, AV11PenultimateIsDummy, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vWEBSESSIONKEY", AV19WebSessionKey);
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 20), "GRIDWIZARDSTEPS.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 22), "TBLCONTAINERSTEP.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AV24WizardStepTitle = cgiGet( edtavWizardsteptitle_Internalname);
                              AssignAttri(sPrefix, false, edtavWizardsteptitle_Internalname, AV24WizardStepTitle);
      ...
      protected void gxgrGridwizardsteps_refresh( GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem> AV21WizardStepsAux ,
      ...
      protected void STRUP0Q0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV19WebSessionKey = cgiGet( sPrefix+"wcpOAV19WebSessionKey");
      ...
      protected void E120Q2( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vSELECTEDSTEPNUMBER", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(AV13SelectedStepNumber), "ZZZ9"), context));
         AV26GXV1 = 1;
         while ( AV26GXV1 <= AV18WizardSteps.Count )
         {
            AV5WizardStep = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV18WizardSteps.Item(AV26GXV1));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vSTEPREALNUMBER", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(AV16StepRealNumber), "ZZZ9"), context));
         AV21WizardStepsAux = (GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem>)(AV18WizardSteps.Clone());
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vLASTISDUMMY", GetSecureSignedToken( sPrefix, AV8LastIsDummy, context));
         if ( AV21WizardStepsAux.Count > AV9MaxStepsToShow )
         {
            if ( AV13SelectedStepNumber > AV21WizardStepsAux.Count )
            {
               AV13SelectedStepNumber = 1;
               AssignAttri(sPrefix, false, "AV13SelectedStepNumber", StringUtil.LTrimStr( (decimal)(AV13SelectedStepNumber), 4, 0));
               GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vSELECTEDSTEPNUMBER", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(AV13SelectedStepNumber), "ZZZ9"), context));
            ...
            if ( ( AV13SelectedStepNumber + 3 - AV9MaxStepsToShow /  ( decimal )( 2 ) > Convert.ToDecimal( 0 )) )
            {
               ...
               if ( AV14StartIndex + ( AV9MaxStepsToShow - 2 ) > AV21WizardStepsAux.Count + 1 )
               {
                  AV14StartIndex = (short)(AV21WizardStepsAux.Count-(AV9MaxStepsToShow-2)+1);
               }
            }
            if ( AV14StartIndex > 3 )
            {
            ...
            if ( AV21WizardStepsAux.Count > AV9MaxStepsToShow )
            {
               ...
               while ( AV21WizardStepsAux.Count > AV9MaxStepsToShow )
               {
                  AV21WizardStepsAux.RemoveItem(AV21WizardStepsAux.Count-2);
               }
            }
         }
         AV22WizardStepsCount = (short)(AV21WizardStepsAux.Count);
         AssignAttri(sPrefix, false, "AV22WizardStepsCount", StringUtil.LTrimStr( (decimal)(AV22WizardStepsCount), 4, 0));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vWIZARDSTEPSCOUNT", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(AV22WizardStepsCount), "ZZZ9"), context));
         if ( AV21WizardStepsAux.Count > AV10MaxStepsToShowInXS )
         {
            AV23WizardStepsItem = new WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem(context);
            AV23WizardStepsItem.gxTpr_Title = "DummiesXS_Test";
            AV23WizardStepsItem.gxTpr_Code = "FirstDummyXS";
            AV21WizardStepsAux.Add(AV23WizardStepsItem, 2);
            AV23WizardStepsItem = new WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem(context);
            AV23WizardStepsItem.gxTpr_Title = "DummiesXS_Test";
            AV23WizardStepsItem.gxTpr_Code = "LastDummyXS";
            AV21WizardStepsAux.Add(AV23WizardStepsItem, AV21WizardStepsAux.Count-1);
         }
         AV15StepNumber = 1;
      ...
      private void E130Q2( )
      {
         ...
         returnInSub = false;
         AV27GXV2 = 1;
         while ( AV27GXV2 <= AV21WizardStepsAux.Count )
         {
            AV5WizardStep = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV21WizardStepsAux.Item(AV27GXV2));
            AV24WizardStepTitle = AV5WizardStep.gxTpr_Title;
            AssignAttri(sPrefix, false, edtavWizardsteptitle_Internalname, AV24WizardStepTitle);
            ...
            if ( ( AV13SelectedStepNumber != AV15StepNumber ) && ( StringUtil.StrCmp(AV5WizardStep.gxTpr_Code, "FirstDummyXS") != 0 ) && ( StringUtil.StrCmp(AV5WizardStep.gxTpr_Code, "LastDummyXS") != 0 ) && ( AV15StepNumber > 1 ) && ( AV15StepNumber < AV22WizardStepsCount ) )
            {
               ...
               if ( ( AV13SelectedStepNumber > 3 ) && ( AV15StepNumber > 1 ) && ( AV13SelectedStepNumber < AV22WizardStepsCount - 2 ) )
               {
                  divTblcontainerstep_Class = divTblcontainerstep_Class+" hidden-xs";
                  AssignProp(sPrefix, false, divTblcontainerstep_Internalname, "Class", divTblcontainerstep_Class, !bGXsfl_9_Refreshing);
               }
               if ( ( AV13SelectedStepNumber >= AV22WizardStepsCount - 2 ) && ( AV15StepNumber < AV22WizardStepsCount - 2 ) )
               {
                  divTblcontainerstep_Class = divTblcontainerstep_Class+" hidden-xs";
                  AssignProp(sPrefix, false, divTblcontainerstep_Internalname, "Class", divTblcontainerstep_Class, !bGXsfl_9_Refreshing);
               }
            ...
            if ( ! StringUtil.Contains( AV5WizardStep.gxTpr_Code, "DummyXS") )
            {
               ...
               else if ( ( AV15StepNumber == AV22WizardStepsCount ) && AV8LastIsDummy )
               {
                  lblStepnumber_Caption = StringUtil.Trim( StringUtil.Str( (decimal)(AV18WizardSteps.Count), 9, 0));
               }
               else if ( ( AV15StepNumber == AV22WizardStepsCount - 1 ) && AV11PenultimateIsDummy )
               {
            ...
            else
            {
               ...
               AssignProp(sPrefix, false, divTblcontainerstep_Internalname, "Class", divTblcontainerstep_Class, !bGXsfl_9_Refreshing);
               if ( ( ( AV13SelectedStepNumber <= 3 ) && ( StringUtil.StrCmp(AV5WizardStep.gxTpr_Code, "FirstDummyXS") == 0 ) ) || ( ( AV13SelectedStepNumber >= AV22WizardStepsCount - 2 ) && ( StringUtil.StrCmp(AV5WizardStep.gxTpr_Code, "LastDummyXS") == 0 ) ) )
               {
      ...
      protected void E110Q2( )
      {
         ...
         if ( AV25AllowClick )
         {
            AV20ClickedIndex = (short)(Math.Round(NumberUtil.Val( lblStepnumber_Caption, "."), 18, MidpointRounding.ToEven));
            if ( ( AV20ClickedIndex > 0 ) && ( AV20ClickedIndex <= AV18WizardSteps.Count ) )
            {
               this.executeExternalObjectMethod(sPrefix, false, "GlobalEvents", "Wizard_ChangeStep", new Object[] {(string)AV19WebSessionKey,(short)AV20ClickedIndex,((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)(AV21WizardStepsAux.CurrentItem)).gxTpr_Code}, true);
            }
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV19WebSessionKey = (string)getParm(obj,0);
         AssignAttri(sPrefix, false, "AV19WebSessionKey", AV19WebSessionKey);
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV19WebSessionKey = (string)((string)getParm(obj,0));
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         {
            AV19WebSessionKey = (string)getParm(obj,2);
            AssignAttri(sPrefix, false, "AV19WebSessionKey", AV19WebSessionKey);
         ...
         wcpOAV19WebSessionKey = cgiGet( sPrefix+"wcpOAV19WebSessionKey");
         wcpOAV6CurrentStep = cgiGet( sPrefix+"wcpOAV6CurrentStep");
         if ( ! GetJustCreated( ) && ( ( StringUtil.StrCmp(AV19WebSessionKey, wcpOAV19WebSessionKey) != 0 ) || ( StringUtil.StrCmp(AV6CurrentStep, wcpOAV6CurrentStep) != 0 ) ) )
         {
            setjustcreated();
         }
         wcpOAV19WebSessionKey = AV19WebSessionKey;
      ...
      protected void WCParametersGet( )
      {
         ...
         sCtrlAV19WebSessionKey = cgiGet( sPrefix+"AV19WebSessionKey_CTRL");
         if ( StringUtil.Len( sCtrlAV19WebSessionKey) > 0 )
         {
            AV19WebSessionKey = cgiGet( sCtrlAV19WebSessionKey);
            AssignAttri(sPrefix, false, "AV19WebSessionKey", AV19WebSessionKey);
         }
         else
         {
            AV19WebSessionKey = cgiGet( sPrefix+"AV19WebSessionKey_PARM");
         }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV19WebSessionKey_PARM", AV19WebSessionKey);
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV19WebSessionKey)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV19WebSessionKey_CTRL", StringUtil.RTrim( sCtrlAV19WebSessionKey));
         }
         if ( context.isAjaxRequest( ) )
         {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202651111304977", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/wizardstepsunderlinewc.js", "?202651111304977", false, true);
         }
      ...
      protected void StartGridControl9( )
      {
         ...
         else
         {
            ...
            GridwizardstepsContainer.AddColumnProperties(GridwizardstepsColumn);
            GridwizardstepsColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridwizardstepsColumn.AddObjectProperty("Value", GXUtil.ValueEncode( AV24WizardStepTitle));
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRIDWIZARDSTEPS_nFirstRecordOnPage"},{"av":"GRIDWIZARDSTEPS_nEOF"},{"av":"chkavAllowclick.Visible","ctrl":"vALLOWCLICK","prop":"Visible"},{"av":"AV6CurrentStep","fld":"vCURRENTSTEP"},{"av":"AV18WizardSteps","fld":"vWIZARDSTEPS"},{"av":"sPrefix"},{"av":"AV21WizardStepsAux","fld":"vWIZARDSTEPSAUX","hsh":true},{"av":"AV16StepRealNumber","fld":"vSTEPREALNUMBER","pic":"ZZZ9","hsh":true},{"av":"AV15StepNumber","fld":"vSTEPNUMBER","pic":"ZZZ9","hsh":true},{"av":"AV13SelectedStepNumber","fld":"vSELECTEDSTEPNUMBER","pic":"ZZZ9","hsh":true},{"av":"AV22WizardStepsCount","fld":"vWIZARDSTEPSCOUNT","pic":"ZZZ9","hsh":true},{"av":"AV7FirstIsDummy","fld":"vFIRSTISDUMMY","hsh":true},{"av":"AV8LastIsDummy","fld":"vLASTISDUMMY","hsh":true},{"av":"AV11PenultimateIsDummy","fld":"vPENULTIMATEISDUMMY","hsh":true}]}""");
         setEventMetadata("GRIDWIZARDSTEPS.LOAD","""{"handler":"E130Q2","iparms":[{"av":"AV21WizardStepsAux","fld":"vWIZARDSTEPSAUX","hsh":true},{"av":"AV16StepRealNumber","fld":"vSTEPREALNUMBER","pic":"ZZZ9","hsh":true},{"av":"AV15StepNumber","fld":"vSTEPNUMBER","pic":"ZZZ9","hsh":true},{"av":"AV13SelectedStepNumber","fld":"vSELECTEDSTEPNUMBER","pic":"ZZZ9","hsh":true},{"av":"AV22WizardStepsCount","fld":"vWIZARDSTEPSCOUNT","pic":"ZZZ9","hsh":true},{"av":"AV6CurrentStep","fld":"vCURRENTSTEP"},{"av":"AV7FirstIsDummy","fld":"vFIRSTISDUMMY","hsh":true},{"av":"AV8LastIsDummy","fld":"vLASTISDUMMY","hsh":true},{"av":"AV18WizardSteps","fld":"vWIZARDSTEPS"},{"av":"AV11PenultimateIsDummy","fld":"vPENULTIMATEISDUMMY","hsh":true}]""");
         setEventMetadata("GRIDWIZARDSTEPS.LOAD",""","oparms":[{"av":"AV24WizardStepTitle","fld":"vWIZARDSTEPTITLE"},{"av":"lblStepnumber_Caption","ctrl":"STEPNUMBER","prop":"Caption"},{"av":"divTblcontainerstep_Class","ctrl":"TBLCONTAINERSTEP","prop":"Class"},{"av":"divTablestepitem_Class","ctrl":"TABLESTEPITEM","prop":"Class"},{"av":"divTablestepitem_Visible","ctrl":"TABLESTEPITEM","prop":"Visible"},{"av":"divUnnamedtablefsgridwizardsteps_Class","ctrl":"UNNAMEDTABLEFSGRIDWIZARDSTEPS","prop":"Class"},{"av":"AV25AllowClick","fld":"vALLOWCLICK"},{"av":"divTblcontainerstep_Visible","ctrl":"TBLCONTAINERSTEP","prop":"Visible"},{"av":"AV16StepRealNumber","fld":"vSTEPREALNUMBER","pic":"ZZZ9","hsh":true},{"av":"AV15StepNumber","fld":"vSTEPNUMBER","pic":"ZZZ9","hsh":true},{"av":"lblStepnumber_Visible","ctrl":"STEPNUMBER","prop":"Visible"}]}""");
         setEventMetadata("TBLCONTAINERSTEP.CLICK","""{"handler":"E110Q2","iparms":[{"av":"AV25AllowClick","fld":"vALLOWCLICK"},{"av":"lblStepnumber_Caption","ctrl":"STEPNUMBER","prop":"Caption"},{"av":"AV18WizardSteps","fld":"vWIZARDSTEPS"},{"av":"AV19WebSessionKey","fld":"vWEBSESSIONKEY"},{"av":"AV21WizardStepsAux","fld":"vWIZARDSTEPSAUX","hsh":true}]}""");
      ...
      {
         AV18WizardSteps = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem>( context, "WizardStepsItem", "Premios");
         wcpOAV19WebSessionKey = "";
         wcpOAV6CurrentStep = "";
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         sPrefix = "";
      ...
      private short AV20ClickedIndex ;
      ...
      private string sCtrlAV19WebSessionKey ;
      ...
      private string AV19WebSessionKey ;
      private string AV6CurrentStep ;
      private string wcpOAV19WebSessionKey ;
      private string wcpOAV6CurrentStep ;
      private string AV24WizardStepTitle ;
      ...
      private WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem AV23WizardStepsItem ;
