...
namespace GeneXus.Programs.wwpbaseobjects {
   public class wwp_masterpageruntimesettings : GXWebComponent
   {
      ...
      private void E170X2( )
      {
         ...
         S112 ();
         if (returnInSub) return;
         lblColorsquare_Caption = StringUtil.Format( AV9ColorItemDefinition, AV8ColorItemClass, "rgb(0,0,0)", "", "", "", "", "", "", "");
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 12;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202510281546166", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/wwp_masterpageruntimesettings.js", "?202510281546166", false, true);
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("FSCOLOR.LOAD","""{"handler":"E170X2","iparms":[{"av":"AV8ColorItemClass","fld":"vCOLORITEMCLASS","hsh":true},{"av":"AV5WWP_DesignSystemSettings","fld":"vWWP_DESIGNSYSTEMSETTINGS"},{"av":"AV10ColorName","fld":"vCOLORNAME"}]""");
         ...
         setEventMetadata("TABLECOLORITEM.CLICK","""{"handler":"E150X2","iparms":[{"av":"FSCOLOR_nFirstRecordOnPage"},{"av":"FSCOLOR_nEOF"},{"av":"AV5WWP_DesignSystemSettings","fld":"vWWP_DESIGNSYSTEMSETTINGS"},{"av":"edtavColorname_Visible","ctrl":"vCOLORNAME","prop":"Visible"},{"av":"AV8ColorItemClass","fld":"vCOLORITEMCLASS","hsh":true},{"av":"AV10ColorName","fld":"vCOLORNAME"},{"av":"radavBackstyle"},{"av":"AV6BackStyle","fld":"vBACKSTYLE"},{"av":"sPrefix"}]""");
         ...
         setEventMetadata("FONTSIZESMALL.CLICK","""{"handler":"E110X2","iparms":[{"av":"AV11FontSizeSelected","fld":"vFONTSIZESELECTED"},{"av":"AV5WWP_DesignSystemSettings","fld":"vWWP_DESIGNSYSTEMSETTINGS"}]""");
         ...
         setEventMetadata("FONTSIZEMEDIUM.CLICK","""{"handler":"E120X2","iparms":[{"av":"AV11FontSizeSelected","fld":"vFONTSIZESELECTED"},{"av":"AV5WWP_DesignSystemSettings","fld":"vWWP_DESIGNSYSTEMSETTINGS"}]""");
         ...
         setEventMetadata("FONTSIZELARGE.CLICK","""{"handler":"E130X2","iparms":[{"av":"AV11FontSizeSelected","fld":"vFONTSIZESELECTED"},{"av":"AV5WWP_DesignSystemSettings","fld":"vWWP_DESIGNSYSTEMSETTINGS"}]""");
         ...
         setEventMetadata("VBACKSTYLE.CONTROLVALUECHANGED","""{"handler":"E140X2","iparms":[{"av":"radavBackstyle"},{"av":"AV6BackStyle","fld":"vBACKSTYLE"}]""");
