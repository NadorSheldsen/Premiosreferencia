...
namespace GeneXus.Programs.wwpbaseobjects {
   public class wizardstepslinewc : GXWebComponent
   {
      ...
      {
         this.AV9WebSessionKey = aP0_WebSessionKey;
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV9WebSessionKey = GetPar( "WebSessionKey");
                  AssignAttri(sPrefix, false, "AV9WebSessionKey", AV9WebSessionKey);
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(string)AV9WebSessionKey,(GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem>)AV10WizardSteps,(string)AV6CurrentStep});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               ...
               GXEncryptionTmp = "wwpbaseobjects.wizardstepslinewc.aspx"+UrlEncode(StringUtil.RTrim(AV9WebSessionKey)) + "," + UrlEncode(StringUtil.RTrim(AV6CurrentStep));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV9WebSessionKey", wcpOAV9WebSessionKey);
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6CurrentStep", wcpOAV6CurrentStep);
         GxWebStd.gx_hidden_field( context, sPrefix+"vSTEPNUMBER", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8StepNumber), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vSTEPNUMBER", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(AV8StepNumber), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vSELECTEDSTEPNUMBER", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7SelectedStepNumber), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vSELECTEDSTEPNUMBER", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(AV7SelectedStepNumber), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vWEBSESSIONKEY", AV9WebSessionKey);
         if ( context.isAjaxRequest( ) )
         {
      ...
      protected void STRUP0R0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV9WebSessionKey = cgiGet( sPrefix+"wcpOAV9WebSessionKey");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV9WebSessionKey = (string)getParm(obj,0);
         AssignAttri(sPrefix, false, "AV9WebSessionKey", AV9WebSessionKey);
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV9WebSessionKey = (string)((string)getParm(obj,0));
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         {
            AV9WebSessionKey = (string)getParm(obj,2);
            AssignAttri(sPrefix, false, "AV9WebSessionKey", AV9WebSessionKey);
         ...
         wcpOAV9WebSessionKey = cgiGet( sPrefix+"wcpOAV9WebSessionKey");
         wcpOAV6CurrentStep = cgiGet( sPrefix+"wcpOAV6CurrentStep");
         if ( ! GetJustCreated( ) && ( ( StringUtil.StrCmp(AV9WebSessionKey, wcpOAV9WebSessionKey) != 0 ) || ( StringUtil.StrCmp(AV6CurrentStep, wcpOAV6CurrentStep) != 0 ) ) )
         {
            setjustcreated();
         }
         wcpOAV9WebSessionKey = AV9WebSessionKey;
      ...
      protected void WCParametersGet( )
      {
         ...
         sCtrlAV9WebSessionKey = cgiGet( sPrefix+"AV9WebSessionKey_CTRL");
         if ( StringUtil.Len( sCtrlAV9WebSessionKey) > 0 )
         {
            AV9WebSessionKey = cgiGet( sCtrlAV9WebSessionKey);
            AssignAttri(sPrefix, false, "AV9WebSessionKey", AV9WebSessionKey);
         }
         else
         {
            AV9WebSessionKey = cgiGet( sPrefix+"AV9WebSessionKey_PARM");
         }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV9WebSessionKey_PARM", AV9WebSessionKey);
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV9WebSessionKey)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV9WebSessionKey_CTRL", StringUtil.RTrim( sCtrlAV9WebSessionKey));
         }
         if ( context.isAjaxRequest( ) )
         {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025102815461591", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/wizardstepslinewc.js", "?2025102815461591", false, true);
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDWIZARDSTEPS.LOAD","""{"handler":"E120R2","iparms":[{"av":"AV8StepNumber","fld":"vSTEPNUMBER","pic":"ZZZ9","hsh":true},{"av":"AV7SelectedStepNumber","fld":"vSELECTEDSTEPNUMBER","pic":"ZZZ9","hsh":true}]""");
      ...
      private string sCtrlAV9WebSessionKey ;
      ...
      private string AV9WebSessionKey ;
      private string AV6CurrentStep ;
      private string wcpOAV9WebSessionKey ;
