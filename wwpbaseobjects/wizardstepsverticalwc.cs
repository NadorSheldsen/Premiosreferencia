...
namespace GeneXus.Programs.wwpbaseobjects {
   public class wizardstepsverticalwc : GXWebComponent
   {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(string)AV20WebSessionKey,(GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem>)AV19WizardSteps,(string)AV6CurrentStep});
                  componentstart();
      ...
      protected void gxgrGridwizardsteps_refresh_invoke( )
      {
         ...
         AV6CurrentStep = GetPar( "CurrentStep");
         ajax_req_read_hidden_sdt(GetNextPar( ), AV22WizardStepsAux);
         sPrefix = GetPar( "sPrefix");
         ...
         gxgrGridwizardsteps_refresh( AV19WizardSteps, AV16StepNumber, AV14SelectedStepNumber, AV6CurrentStep, AV22WizardStepsAux, sPrefix) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               ...
               GXEncryptionTmp = "wwpbaseobjects.wizardstepsverticalwc.aspx"+UrlEncode(StringUtil.RTrim(AV20WebSessionKey)) + "," + UrlEncode(StringUtil.RTrim(AV6CurrentStep));
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"vWIZARDSTEPSAUX", AV22WizardStepsAux);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt(sPrefix+"vWIZARDSTEPSAUX", AV22WizardStepsAux);
         }
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vWIZARDSTEPSAUX", GetSecureSignedToken( sPrefix, AV22WizardStepsAux, context));
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
      }
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 20), "GRIDWIZARDSTEPS.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 22), "TBLCONTAINERSTEP.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AV25WizardStepTitle = cgiGet( edtavWizardsteptitle_Internalname);
                              AssignAttri(sPrefix, false, edtavWizardsteptitle_Internalname, AV25WizardStepTitle);
                              AV8AllowClick = StringUtil.StrToBool( cgiGet( chkavAllowclick_Internalname));
                              AssignAttri(sPrefix, false, chkavAllowclick_Internalname, AV8AllowClick);
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 sEvt = StringUtil.Left( sEvt, (short)(StringUtil.Len( sEvt)-1));
      ...
      protected void gxgrGridwizardsteps_refresh( GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem> AV19WizardSteps ,
                                                  short AV16StepNumber ,
                                                  short AV14SelectedStepNumber ,
                                                  string AV6CurrentStep ,
                                                  GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem> AV22WizardStepsAux ,
                                                  string sPrefix )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      protected void E120P2( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vSELECTEDSTEPNUMBER", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(AV14SelectedStepNumber), "ZZZ9"), context));
         AV26GXV1 = 1;
         while ( AV26GXV1 <= AV19WizardSteps.Count )
         {
            AV5WizardStep = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV19WizardSteps.Item(AV26GXV1));
      ...
      private void E130P2( )
      {
         ...
         returnInSub = false;
         AV27GXV2 = 1;
         while ( AV27GXV2 <= AV19WizardSteps.Count )
         {
            AV5WizardStep = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV19WizardSteps.Item(AV27GXV2));
            AV25WizardStepTitle = AV5WizardStep.gxTpr_Title;
            AssignAttri(sPrefix, false, edtavWizardsteptitle_Internalname, AV25WizardStepTitle);
            lblStepnumber_Caption = context.localUtil.Format( (decimal)(AV16StepNumber), "ZZZ9");
            ...
            AV8AllowClick = (bool)(AV5WizardStep.gxTpr_Allowclick&&(StringUtil.StrCmp(AV5WizardStep.gxTpr_Code, AV6CurrentStep)!=0));
            AssignAttri(sPrefix, false, chkavAllowclick_Internalname, AV8AllowClick);
      ...
      protected void E110P2( )
      {
         ...
         if ( AV8AllowClick )
         {
            AV21ClickedIndex = (short)(Math.Round(NumberUtil.Val( lblStepnumber_Caption, "."), 18, MidpointRounding.ToEven));
            if ( ( AV21ClickedIndex > 0 ) && ( AV21ClickedIndex <= AV19WizardSteps.Count ) )
            {
               this.executeExternalObjectMethod(sPrefix, false, "GlobalEvents", "Wizard_ChangeStep", new Object[] {(string)AV20WebSessionKey,(short)AV21ClickedIndex,((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)(AV22WizardStepsAux.CurrentItem)).gxTpr_Code}, true);
            }
         }
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         wcpOAV20WebSessionKey = cgiGet( sPrefix+"wcpOAV20WebSessionKey");
         wcpOAV6CurrentStep = cgiGet( sPrefix+"wcpOAV6CurrentStep");
         if ( ! GetJustCreated( ) && ( ( StringUtil.StrCmp(AV20WebSessionKey, wcpOAV20WebSessionKey) != 0 ) || ( StringUtil.StrCmp(AV6CurrentStep, wcpOAV6CurrentStep) != 0 ) ) )
         {
            setjustcreated();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20265111130481", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/wizardstepsverticalwc.js", "?20265111130481", false, true);
         }
      ...
      protected void sendrow_92( )
      {
         ...
         GridwizardstepsRow.AddColumnProperties("checkbox", 1, isAjaxCallMode( ), new Object[] {(string)chkavAllowclick_Internalname,StringUtil.BoolToStr( AV8AllowClick),(string)"",context.GetMessage( "Allow Click", ""),chkavAllowclick.Visible,(short)0,(string)"true",(string)"",(string)StyleString,(string)ClassString,(string)"",(string)"",(string)""});
         GridwizardstepsColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
         GridwizardstepsRow.AddRenderProperties(GridwizardstepsColumn);
         GridwizardstepsRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
         GridwizardstepsColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void StartGridControl9( )
      {
         ...
         else
         {
            ...
            GridwizardstepsContainer.AddColumnProperties(GridwizardstepsColumn);
            GridwizardstepsColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridwizardstepsColumn.AddObjectProperty("Value", GXUtil.ValueEncode( AV25WizardStepTitle));
            ...
            GridwizardstepsContainer.AddColumnProperties(GridwizardstepsColumn);
            GridwizardstepsColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridwizardstepsColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.BoolToStr( AV8AllowClick)));
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRIDWIZARDSTEPS_nFirstRecordOnPage"},{"av":"GRIDWIZARDSTEPS_nEOF"},{"av":"chkavAllowclick.Visible","ctrl":"vALLOWCLICK","prop":"Visible"},{"av":"AV19WizardSteps","fld":"vWIZARDSTEPS"},{"av":"AV6CurrentStep","fld":"vCURRENTSTEP"},{"av":"sPrefix"},{"av":"AV16StepNumber","fld":"vSTEPNUMBER","pic":"ZZZ9","hsh":true},{"av":"AV14SelectedStepNumber","fld":"vSELECTEDSTEPNUMBER","pic":"ZZZ9","hsh":true},{"av":"AV22WizardStepsAux","fld":"vWIZARDSTEPSAUX","hsh":true}]}""");
         setEventMetadata("GRIDWIZARDSTEPS.LOAD","""{"handler":"E130P2","iparms":[{"av":"AV19WizardSteps","fld":"vWIZARDSTEPS"},{"av":"AV16StepNumber","fld":"vSTEPNUMBER","pic":"ZZZ9","hsh":true},{"av":"AV14SelectedStepNumber","fld":"vSELECTEDSTEPNUMBER","pic":"ZZZ9","hsh":true},{"av":"AV6CurrentStep","fld":"vCURRENTSTEP"}]""");
         setEventMetadata("GRIDWIZARDSTEPS.LOAD",""","oparms":[{"av":"AV25WizardStepTitle","fld":"vWIZARDSTEPTITLE"},{"av":"lblStepnumber_Caption","ctrl":"STEPNUMBER","prop":"Caption"},{"av":"divUnnamedtablefsgridwizardsteps_Class","ctrl":"UNNAMEDTABLEFSGRIDWIZARDSTEPS","prop":"Class"},{"av":"AV8AllowClick","fld":"vALLOWCLICK"},{"av":"divTblcontainerstep_Class","ctrl":"TBLCONTAINERSTEP","prop":"Class"},{"av":"AV16StepNumber","fld":"vSTEPNUMBER","pic":"ZZZ9","hsh":true}]}""");
         setEventMetadata("TBLCONTAINERSTEP.CLICK","""{"handler":"E110P2","iparms":[{"av":"AV8AllowClick","fld":"vALLOWCLICK"},{"av":"lblStepnumber_Caption","ctrl":"STEPNUMBER","prop":"Caption"},{"av":"AV19WizardSteps","fld":"vWIZARDSTEPS"},{"av":"AV20WebSessionKey","fld":"vWEBSESSIONKEY"},{"av":"AV22WizardStepsAux","fld":"vWIZARDSTEPSAUX","hsh":true}]}""");
      ...
      public override void initialize( )
      {
         ...
         gxfirstwebparm_bkp = "";
         sPrefix = "";
         AV22WizardStepsAux = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem>( context, "WizardStepsItem", "Premios");
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         GXKey = "";
      ...
      private short AV21ClickedIndex ;
      ...
      private string AV25WizardStepTitle ;
      ...
      private GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem> AV22WizardStepsAux ;
