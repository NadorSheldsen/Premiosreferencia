...
namespace GeneXus.Programs.wwpbaseobjects {
   public class wizardstepsarrowwc : GXWebComponent
   {
                           ...
                           string aP2_SelectedStep )
      {
         ...
         this.AV20WizardSteps = aP1_WizardSteps;
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  ajax_req_read_hidden_sdt(GetNextPar( ), AV20WizardSteps);
                  AV11SelectedStep = GetPar( "SelectedStep");
                  AssignAttri(sPrefix, false, "AV11SelectedStep", AV11SelectedStep);
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(string)AV12WebSessionKey,(GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem>)AV20WizardSteps,(string)AV11SelectedStep});
                  componentstart();
      ...
      protected void gxgrGridwizardsteps_refresh_invoke( )
      {
         ...
         ajax_req_read_hidden_sdt(GetNextPar( ), AV21WizardStepsAux);
         AV11SelectedStep = GetPar( "SelectedStep");
         ...
         gxgrGridwizardsteps_refresh( AV17StepRealNumber, AV21WizardStepsAux, AV11SelectedStep, AV9PreviousSelected, AV16StepNumber, AV5FirstIsDummy, AV6LastIsDummy, AV20WizardSteps, AV10SecondIsDummy, AV8PenultimateIsDummy, sPrefix) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               ...
               GXEncryptionTmp = "wwpbaseobjects.wizardstepsarrowwc.aspx"+UrlEncode(StringUtil.RTrim(AV12WebSessionKey)) + "," + UrlEncode(StringUtil.RTrim(AV11SelectedStep));
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"vWIZARDSTEPSAUX", AV21WizardStepsAux);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt(sPrefix+"vWIZARDSTEPSAUX", AV21WizardStepsAux);
         }
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vWIZARDSTEPSAUX", GetSecureSignedToken( sPrefix, AV21WizardStepsAux, context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"Wizardstepsaux", AV21WizardStepsAux);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt(sPrefix+"Wizardstepsaux", AV21WizardStepsAux);
         }
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_Wizardstepsaux", GetSecureSignedToken( sPrefix, AV21WizardStepsAux, context));
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"vWIZARDSTEPS", AV20WizardSteps);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt(sPrefix+"vWIZARDSTEPS", AV20WizardSteps);
         }
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vSECONDISDUMMY", AV10SecondIsDummy);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vSECONDISDUMMY", GetSecureSignedToken( sPrefix, AV10SecondIsDummy, context));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vPENULTIMATEISDUMMY", AV8PenultimateIsDummy);
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 20), "GRIDWIZARDSTEPS.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 22), "TBLCONTAINERSTEP.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AV22GXV1 = nGXsfl_5_idx;
                              if ( ( AV21WizardStepsAux.Count >= AV22GXV1 ) && ( AV22GXV1 > 0 ) )
                              {
                                 AV21WizardStepsAux.CurrentItem = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV21WizardStepsAux.Item(AV22GXV1));
                              }
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
      ...
      protected void gxgrGridwizardsteps_refresh( short AV17StepRealNumber ,
                                                  GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem> AV21WizardStepsAux ,
                                                  string AV11SelectedStep ,
                                                  bool AV9PreviousSelected ,
                                                  short AV16StepNumber ,
                                                  bool AV5FirstIsDummy ,
                                                  bool AV6LastIsDummy ,
                                                  GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem> AV20WizardSteps ,
      ...
      protected void STRUP0J0( )
      {
         ...
         {
            /* Read saved SDTs. */
            ajax_req_read_hidden_sdt(cgiGet( sPrefix+"Wizardstepsaux"), AV21WizardStepsAux);
            ajax_req_read_hidden_sdt(cgiGet( sPrefix+"vWIZARDSTEPSAUX"), AV21WizardStepsAux);
            /* Read saved values. */
      ...
      protected void E120J2( )
      {
         ...
         returnInSub = false;
         AV7MaxStepsToShow = 8;
         AV21WizardStepsAux = (GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem>)(AV20WizardSteps.Clone());
         gx_BV5 = true;
         AV16StepNumber = 1;
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vLASTISDUMMY", GetSecureSignedToken( sPrefix, AV6LastIsDummy, context));
         if ( AV21WizardStepsAux.Count > AV7MaxStepsToShow )
         {
            AV7MaxStepsToShow = (short)(AV7MaxStepsToShow-1);
            AV14SelectedStepIndex = 1;
            AV24GXV3 = 1;
            while ( AV24GXV3 <= AV21WizardStepsAux.Count )
            {
               AV19WizardStep = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV21WizardStepsAux.Item(AV24GXV3));
               if ( StringUtil.StrCmp(AV19WizardStep.gxTpr_Code, AV11SelectedStep) == 0 )
               {
                  if (true) break;
               }
               AV14SelectedStepIndex = (short)(AV14SelectedStepIndex+1);
               AV24GXV3 = (int)(AV24GXV3+1);
            }
            if ( AV14SelectedStepIndex > AV21WizardStepsAux.Count )
            {
               AV14SelectedStepIndex = 1;
            }
            AV15StartIndex = 1;
            if ( (Convert.ToDecimal( AV14SelectedStepIndex + 1 ) > ( AV7MaxStepsToShow ) /  ( decimal )( 2 ) ) )
            {
               AV15StartIndex = (short)(AV14SelectedStepIndex+1-(AV7MaxStepsToShow)/ (decimal)(2));
               if ( AV15StartIndex + AV7MaxStepsToShow > AV21WizardStepsAux.Count + 1 )
               {
                  AV15StartIndex = (short)(AV21WizardStepsAux.Count+1-AV7MaxStepsToShow);
               }
            }
            ...
            if ( AV15StartIndex > 1 )
            {
               ...
               if ( AV15StartIndex > 2 )
               {
                  ...
                  GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vSECONDISDUMMY", GetSecureSignedToken( sPrefix, AV10SecondIsDummy, context));
                  AV7MaxStepsToShow = (short)(AV7MaxStepsToShow+1);
                  ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV21WizardStepsAux.Item(2)).gxTpr_Title = "...";
                  ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV21WizardStepsAux.Item(2)).gxTpr_Allowclick = false;
                  while ( AV15StartIndex > 3 )
                  {
                     AV21WizardStepsAux.RemoveItem(3);
                     gx_BV5 = true;
            ...
            if ( AV21WizardStepsAux.Count > AV7MaxStepsToShow )
            {
               ...
               AssignAttri(sPrefix, false, "AV6LastIsDummy", AV6LastIsDummy);
               GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vLASTISDUMMY", GetSecureSignedToken( sPrefix, AV6LastIsDummy, context));
               if ( AV21WizardStepsAux.Count > AV7MaxStepsToShow + 1 )
               {
                  AV8PenultimateIsDummy = true;
                  AssignAttri(sPrefix, false, "AV8PenultimateIsDummy", AV8PenultimateIsDummy);
                  GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vPENULTIMATEISDUMMY", GetSecureSignedToken( sPrefix, AV8PenultimateIsDummy, context));
                  ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV21WizardStepsAux.Item(AV21WizardStepsAux.Count-1)).gxTpr_Title = "...";
                  ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV21WizardStepsAux.Item(AV21WizardStepsAux.Count-1)).gxTpr_Allowclick = false;
                  while ( AV21WizardStepsAux.Count > AV7MaxStepsToShow + 2 )
                  {
                     AV21WizardStepsAux.RemoveItem(AV21WizardStepsAux.Count-2);
                     gx_BV5 = true;
                  }
               }
            }
      ...
      private void E130J2( )
      {
         ...
         returnInSub = false;
         AV22GXV1 = 1;
         while ( AV22GXV1 <= AV21WizardStepsAux.Count )
         {
            AV21WizardStepsAux.CurrentItem = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV21WizardStepsAux.Item(AV22GXV1));
            AV18TableContainerStepClass = "TableContainerStep";
            lblStepnumber_Caption = context.localUtil.Format( (decimal)(AV17StepRealNumber), "ZZZ9");
            if ( StringUtil.StrCmp(((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)(AV21WizardStepsAux.CurrentItem)).gxTpr_Code, AV11SelectedStep) == 0 )
            {
               ...
               AV18TableContainerStepClass = "TableContainerStepSelected";
            ...
            if ( AV16StepNumber == 1 )
            {
               ...
               AV18TableContainerStepClass += " " + "TableContainerStepFirst";
            }
            else
            {
               if ( AV16StepNumber == AV21WizardStepsAux.Count )
               {
                  AV18TableContainerStepClass += " " + "TableContainerStepLast";
               }
               imgStepimg_Visible = 1;
            }
            if ( ! ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)(AV21WizardStepsAux.CurrentItem)).gxTpr_Allowclick || ( StringUtil.StrCmp(((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)(AV21WizardStepsAux.CurrentItem)).gxTpr_Code, AV11SelectedStep) == 0 ) )
            {
               AV18TableContainerStepClass += " CursorDefault";
            }
            tblTblcontainerstep_Class = AV18TableContainerStepClass;
            ...
            if ( ( AV16StepNumber == 1 ) && AV5FirstIsDummy )
            {
               lblStepnumber_Caption = StringUtil.Trim( StringUtil.Str( (decimal)(AV16StepNumber), 4, 0));
               edtavWizardstepsaux__title_Visible = 0;
            }
            else if ( ( AV16StepNumber == AV21WizardStepsAux.Count ) && AV6LastIsDummy )
            {
               lblStepnumber_Caption = StringUtil.Trim( StringUtil.Str( (decimal)(AV20WizardSteps.Count), 9, 0));
               edtavWizardstepsaux__title_Visible = 0;
            }
            else if ( ( ( AV16StepNumber == 2 ) && AV10SecondIsDummy ) || ( ( AV16StepNumber == AV21WizardStepsAux.Count - 1 ) && AV8PenultimateIsDummy ) )
            {
      ...
      {
         AV22GXV1 = nGXsfl_5_idx;
         if ( ( AV22GXV1 > 0 ) && ( AV21WizardStepsAux.Count >= AV22GXV1 ) )
         {
            AV21WizardStepsAux.CurrentItem = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV21WizardStepsAux.Item(AV22GXV1));
         }
         /* Tblcontainerstep_Click Routine */
         returnInSub = false;
         if ( ( StringUtil.StrCmp(((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)(AV21WizardStepsAux.CurrentItem)).gxTpr_Code, AV11SelectedStep) != 0 ) && ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)(AV21WizardStepsAux.CurrentItem)).gxTpr_Allowclick )
         {
            AV13ClickedIndex = 1;
            AV25GXV4 = 1;
            while ( AV25GXV4 <= AV20WizardSteps.Count )
            {
               AV19WizardStep = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV20WizardSteps.Item(AV25GXV4));
               if ( StringUtil.StrCmp(AV19WizardStep.gxTpr_Code, ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)(AV21WizardStepsAux.CurrentItem)).gxTpr_Code) == 0 )
               {
                  if (true) break;
               }
               AV13ClickedIndex = (short)(AV13ClickedIndex+1);
               AV25GXV4 = (int)(AV25GXV4+1);
            }
            if ( AV13ClickedIndex <= AV20WizardSteps.Count )
            {
               this.executeExternalObjectMethod(sPrefix, false, "GlobalEvents", "Wizard_ChangeStep", new Object[] {(string)AV12WebSessionKey,(short)AV13ClickedIndex,((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)(AV21WizardStepsAux.CurrentItem)).gxTpr_Code}, true);
            }
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         AssignAttri(sPrefix, false, "AV12WebSessionKey", AV12WebSessionKey);
         AV20WizardSteps = (GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem>)getParm(obj,1);
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV20WizardSteps = (string)((string)getParm(obj,1));
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         else
         {
            ...
            AssignAttri(sPrefix, false, "AV12WebSessionKey", AV12WebSessionKey);
            AV20WizardSteps = (GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem>)getParm(obj,3);
            AV11SelectedStep = (string)getParm(obj,4);
            AssignAttri(sPrefix, false, "AV11SelectedStep", AV11SelectedStep);
         }
         wcpOAV12WebSessionKey = cgiGet( sPrefix+"wcpOAV12WebSessionKey");
         wcpOAV11SelectedStep = cgiGet( sPrefix+"wcpOAV11SelectedStep");
         if ( ! GetJustCreated( ) && ( ( StringUtil.StrCmp(AV12WebSessionKey, wcpOAV12WebSessionKey) != 0 ) || ( StringUtil.StrCmp(AV11SelectedStep, wcpOAV11SelectedStep) != 0 ) ) )
         {
            setjustcreated();
         }
      ...
      protected void WCParametersGet( )
      {
         ...
         sCtrlAV20WizardSteps = cgiGet( sPrefix+"AV20WizardSteps_CTRL");
         if ( StringUtil.Len( sCtrlAV20WizardSteps) > 0 )
         {
            AV20WizardSteps = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem>();
         }
         else
         {
            ajax_req_read_hidden_sdt(cgiGet( sPrefix+"AV20WizardSteps_PARM"), AV20WizardSteps);
         }
      ...
      protected void WCParametersSet( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"AV20WizardSteps_PARM", AV20WizardSteps);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt(sPrefix+"AV20WizardSteps_PARM", AV20WizardSteps);
         }
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV20WizardSteps)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV20WizardSteps_CTRL", StringUtil.RTrim( sCtrlAV20WizardSteps));
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202651111304944", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/wizardstepsarrowwc.js", "?202651111304944", false, true);
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRIDWIZARDSTEPS_nFirstRecordOnPage"},{"av":"GRIDWIZARDSTEPS_nEOF"},{"av":"AV11SelectedStep","fld":"vSELECTEDSTEP"},{"av":"AV20WizardSteps","fld":"vWIZARDSTEPS"},{"av":"sPrefix"},{"av":"AV21WizardStepsAux","fld":"vWIZARDSTEPSAUX","grid":5,"hsh":true},{"av":"nGXsfl_5_idx","ctrl":"GRID","prop":"GridCurrRow","grid":5},{"av":"nRC_GXsfl_5","ctrl":"GRIDWIZARDSTEPS","prop":"GridRC","grid":5},{"av":"AV17StepRealNumber","fld":"vSTEPREALNUMBER","pic":"ZZZ9","hsh":true},{"av":"AV9PreviousSelected","fld":"vPREVIOUSSELECTED","hsh":true},{"av":"AV16StepNumber","fld":"vSTEPNUMBER","pic":"ZZZ9","hsh":true},{"av":"AV5FirstIsDummy","fld":"vFIRSTISDUMMY","hsh":true},{"av":"AV6LastIsDummy","fld":"vLASTISDUMMY","hsh":true},{"av":"AV10SecondIsDummy","fld":"vSECONDISDUMMY","hsh":true},{"av":"AV8PenultimateIsDummy","fld":"vPENULTIMATEISDUMMY","hsh":true}]}""");
         setEventMetadata("GRIDWIZARDSTEPS.LOAD","""{"handler":"E130J2","iparms":[{"av":"AV17StepRealNumber","fld":"vSTEPREALNUMBER","pic":"ZZZ9","hsh":true},{"av":"AV21WizardStepsAux","fld":"vWIZARDSTEPSAUX","grid":5,"hsh":true},{"av":"nGXsfl_5_idx","ctrl":"GRID","prop":"GridCurrRow","grid":5},{"av":"GRIDWIZARDSTEPS_nFirstRecordOnPage"},{"av":"nRC_GXsfl_5","ctrl":"GRIDWIZARDSTEPS","prop":"GridRC","grid":5},{"av":"AV11SelectedStep","fld":"vSELECTEDSTEP"},{"av":"AV9PreviousSelected","fld":"vPREVIOUSSELECTED","hsh":true},{"av":"AV16StepNumber","fld":"vSTEPNUMBER","pic":"ZZZ9","hsh":true},{"av":"AV5FirstIsDummy","fld":"vFIRSTISDUMMY","hsh":true},{"av":"AV6LastIsDummy","fld":"vLASTISDUMMY","hsh":true},{"av":"AV20WizardSteps","fld":"vWIZARDSTEPS"},{"av":"AV10SecondIsDummy","fld":"vSECONDISDUMMY","hsh":true},{"av":"AV8PenultimateIsDummy","fld":"vPENULTIMATEISDUMMY","hsh":true}]""");
         setEventMetadata("GRIDWIZARDSTEPS.LOAD",""","oparms":[{"av":"lblStepnumber_Caption","ctrl":"STEPNUMBER","prop":"Caption"},{"ctrl":"WIZARDSTEPSAUX__TITLE","prop":"Class"},{"av":"imgStepimg_Class","ctrl":"STEPIMG","prop":"Class"},{"av":"lblStepnumber_Class","ctrl":"STEPNUMBER","prop":"Class"},{"av":"divTblstep_Class","ctrl":"TBLSTEP","prop":"Class"},{"av":"AV9PreviousSelected","fld":"vPREVIOUSSELECTED","hsh":true},{"av":"imgStepimg_Visible","ctrl":"STEPIMG","prop":"Visible"},{"av":"tblTblcontainerstep_Class","ctrl":"TBLCONTAINERSTEP","prop":"Class"},{"av":"divTblstep_Visible","ctrl":"TBLSTEP","prop":"Visible"},{"av":"lblStepnumber_Visible","ctrl":"STEPNUMBER","prop":"Visible"},{"ctrl":"WIZARDSTEPSAUX__TITLE","prop":"Visible"},{"av":"AV17StepRealNumber","fld":"vSTEPREALNUMBER","pic":"ZZZ9","hsh":true},{"av":"AV16StepNumber","fld":"vSTEPNUMBER","pic":"ZZZ9","hsh":true}]}""");
         setEventMetadata("TBLCONTAINERSTEP.CLICK","""{"handler":"E110J2","iparms":[{"av":"AV11SelectedStep","fld":"vSELECTEDSTEP"},{"av":"AV21WizardStepsAux","fld":"vWIZARDSTEPSAUX","grid":5,"hsh":true},{"av":"nGXsfl_5_idx","ctrl":"GRID","prop":"GridCurrRow","grid":5},{"av":"GRIDWIZARDSTEPS_nFirstRecordOnPage"},{"av":"nRC_GXsfl_5","ctrl":"GRIDWIZARDSTEPS","prop":"GridRC","grid":5},{"av":"AV20WizardSteps","fld":"vWIZARDSTEPS"},{"av":"AV12WebSessionKey","fld":"vWEBSESSIONKEY"}]}""");
      ...
      {
         AV20WizardSteps = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem>( context, "WizardStepsItem", "Premios");
         wcpOAV12WebSessionKey = "";
         wcpOAV11SelectedStep = "";
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         sPrefix = "";
         AV21WizardStepsAux = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem>( context, "WizardStepsItem", "Premios");
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         GXKey = "";
         ...
         sEvtType = "";
         GXDecQS = "";
         AV19WizardStep = new WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem(context);
         AV18TableContainerStepClass = "";
         imgStepimg_gximage = "";
         GridwizardstepsRow = new GXWebRow();
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         sCtrlAV12WebSessionKey = "";
         sCtrlAV20WizardSteps = "";
      ...
      private short AV14SelectedStepIndex ;
      private short AV15StartIndex ;
      private short AV13ClickedIndex ;
      ...
      private string sCtrlAV20WizardSteps ;
      ...
      private string AV18TableContainerStepClass ;
      ...
      private GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem> AV20WizardSteps ;
      private GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem> AV21WizardStepsAux ;
      private WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem AV19WizardStep ;
