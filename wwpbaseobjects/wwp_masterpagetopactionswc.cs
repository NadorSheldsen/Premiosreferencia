...
namespace GeneXus.Programs.wwpbaseobjects {
   public class wwp_masterpagetopactionswc : GXWebComponent
   {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            if ( ( GxWebError == 0 ) && ! isAjaxCallMode( ) )
            {
               ...
               AssignProp(sPrefix, false, edtavEmail_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavEmail_Enabled), 5, 0), true);
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"vUSUARIOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV11UsuarioID), 9, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vUSUARIOID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(AV11UsuarioID), "ZZZZZZZZ9"), context));
      ...
      protected void WB0W0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divUserinformation_Internalname, 1, 0, "px", 0, "px", "ddoMenuUserInfo", "start", "top", " "+"data-gx-flex"+" ", "flex-direction:column;", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "UserInfoNameCell", "start", "top", "", "flex-grow:1;", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavUsername_Internalname, context.GetMessage( "User Name", ""), "gx-form-item UserInfoNameLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 12,'" + sPrefix + "',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavUsername_Internalname, AV6UserName, StringUtil.RTrim( context.localUtil.Format( AV6UserName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,12);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavUsername_Jsonclick, 0, "UserInfoName", "", "", "", "", 1, edtavUsername_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, false, "", "start", true, "", "HLP_WWPBaseObjects/WWP_MasterPageTopActionsWC.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavEmail_Internalname, context.GetMessage( "Email", ""), "gx-form-item UserInfoRoleLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 15,'" + sPrefix + "',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavEmail_Internalname, AV10Email, StringUtil.RTrim( context.localUtil.Format( AV10Email, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,15);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavEmail_Jsonclick, 0, "UserInfoRole", "", "", "", "", 1, edtavEmail_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, 0, false, "", "start", true, "", "HLP_WWPBaseObjects/WWP_MasterPageTopActionsWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "UserInfoRoleCell", "start", "top", "", "flex-grow:1;", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavRolesdescriptions_Internalname, context.GetMessage( "Roles Descriptions", ""), "gx-form-item UserInfoRoleLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 18,'" + sPrefix + "',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavRolesdescriptions_Internalname, AV7RolesDescriptions, StringUtil.RTrim( context.localUtil.Format( AV7RolesDescriptions, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavRolesdescriptions_Jsonclick, 0, "UserInfoRole", "", "", "", "", 1, edtavRolesdescriptions_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, false, "", "start", true, "", "HLP_WWPBaseObjects/WWP_MasterPageTopActionsWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void E110W2( )
      {
         /* Start Routine */
         returnInSub = false;
         AV12UsuarioJSON = AV8WebSession.Get("Usuario");
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV12UsuarioJSON)) )
         {
         ...
         AV13SDTUsuario = new SdtSDTUsuario(context);
         AV13SDTUsuario.FromJSonString(AV12UsuarioJSON, null);
         AV7RolesDescriptions = AV13SDTUsuario.gxTpr_Usuariorol;
         AssignAttri(sPrefix, false, "AV7RolesDescriptions", AV7RolesDescriptions);
         AV11UsuarioID = AV13SDTUsuario.gxTpr_Usuarioid;
         AssignAttri(sPrefix, false, "AV11UsuarioID", StringUtil.LTrimStr( (decimal)(AV11UsuarioID), 9, 0));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vUSUARIOID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(AV11UsuarioID), "ZZZZZZZZ9"), context));
         AV6UserName = AV13SDTUsuario.gxTpr_Usuarionombre;
         AssignAttri(sPrefix, false, "AV6UserName", AV6UserName);
         AV10Email = AV13SDTUsuario.gxTpr_Usuariocorreo;
         AssignAttri(sPrefix, false, "AV10Email", AV10Email);
      }
      ...
      protected void E120W2( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wpcambiarpass.aspx"+UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode(StringUtil.LTrimStr(AV11UsuarioID,9,0));
         context.PopUp(formatLink("wpcambiarpass.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey), new Object[] {});
      }
      ...
      protected void E130W2( )
      {
         /* 'DoLogout' Routine */
         returnInSub = false;
         AV8WebSession.Remove("Usuario");
         AV8WebSession.Remove("UsuarioID");
         AV8WebSession.Remove("AuthOK");
         AV8WebSession.Remove("AuthPending");
         AV8WebSession.Remove("EsPassGenerica");
         AV8WebSession.Destroy();
         AV15Next = formatLink("login.aspx") ;
         AV16JS = "javascript:window.top.location.href='" + StringUtil.StringReplace( StringUtil.Trim( AV15Next), "'", "\\\\'") + "';";
         CallWebObject(formatLink(AV16JS) );
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202651111304987", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/wwp_masterpagetopactionswc.js", "?202651111304987", false, true);
            context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
            context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV11UsuarioID","fld":"vUSUARIOID","pic":"ZZZZZZZZ9","hsh":true}]}""");
         setEventMetadata("'DOACTIONCHANGEPASSWORD'","""{"handler":"E120W2","iparms":[{"av":"AV11UsuarioID","fld":"vUSUARIOID","pic":"ZZZZZZZZ9","hsh":true}]}""");
         setEventMetadata("'DOLOGOUT'","""{"handler":"E130W2","iparms":[]}""");
      ...
      private string AV12UsuarioJSON ;
      private string AV16JS ;
      private string AV6UserName ;
      private string AV10Email ;
      private string AV7RolesDescriptions ;
      private string AV15Next ;
      ...
      private SdtSDTUsuario AV13SDTUsuario ;
