...
namespace GeneXus.Programs {
   public class wpfacturawizard : GXDataArea
   {
      public wpfacturawizard( )
      {
      ...
      public wpfacturawizard( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "wpfacturawizard.aspx"+UrlEncode(StringUtil.RTrim(AV8PreviousStep)) + "," + UrlEncode(StringUtil.RTrim(AV9CurrentStep)) + "," + UrlEncode(StringUtil.BoolToStr(AV7GoingBack));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wpfacturawizard.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wpfacturawizard.aspx"+UrlEncode(StringUtil.RTrim(AV8PreviousStep)) + "," + UrlEncode(StringUtil.RTrim(AV9CurrentStep)) + "," + UrlEncode(StringUtil.BoolToStr(AV7GoingBack));
         return formatLink("wpfacturawizard.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "WPFacturaWizard" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Agregar una factura", "") ;
      }
      ...
      protected void START2T2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Agregar una factura", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void PA2T2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wpfacturawizard.aspx")), "wpfacturawizard.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wpfacturawizard.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
      ...
      protected void E112T2( )
      {
         ...
         AV11WizardSteps.Add(new WorkWithPlus.workwithplus_web.wwp_wizardgetstep(context).executeUdp(  "SelecPromo",  context.GetMessage( "Seleccionar promoción", ""),  context.GetMessage( "Seleccionar promoción", ""),  false), 0);
         AV11WizardSteps.Add(new WorkWithPlus.workwithplus_web.wwp_wizardgetstep(context).executeUdp(  "SelecMedidas",  context.GetMessage( "Seleccionar Medidas", ""),  context.GetMessage( "Seleccionar Medidas", ""),  false), 0);
         AV11WizardSteps.Add(new WorkWithPlus.workwithplus_web.wwp_wizardgetstep(context).executeUdp(  "Resumen",  context.GetMessage( "Resumen", ""),  context.GetMessage( "Resumen", ""),  false), 0);
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV9CurrentStep)) )
         {
            AV10CurrentStepAux = "SelecPromo";
         ...
         if ( StringUtil.Len( WebComp_Steptitles_Component) != 0 )
         {
            ...
            WebComp_Steptitles.componentprepare(new Object[] {(string)"W0009",(string)"",(string)AV16Pgmname+"_Data",(GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem>)AV11WizardSteps,(string)AV10CurrentStepAux});
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV10CurrentStepAux, "SelecPromo") == 0 )
         {
            /* Object Property */
            if ( true )
            {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Wizardstepwc_Component), StringUtil.Lower( "WPFacturaWizardSelecPromo")) != 0 )
            {
               WebComp_Wizardstepwc = getWebComponent(GetType(), "GeneXus.Programs", "wpfacturawizardselecpromo", new Object[] {context} );
               WebComp_Wizardstepwc.ComponentInit();
               WebComp_Wizardstepwc.Name = "WPFacturaWizardSelecPromo";
               WebComp_Wizardstepwc_Component = "WPFacturaWizardSelecPromo";
            }
            if ( StringUtil.Len( WebComp_Wizardstepwc_Component) != 0 )
            {
         ...
         else if ( StringUtil.StrCmp(AV10CurrentStepAux, "SelecMedidas") == 0 )
         {
            /* Object Property */
            if ( true )
            {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Wizardstepwc_Component), StringUtil.Lower( "WPFacturaWizardSelecMedidas")) != 0 )
            {
               WebComp_Wizardstepwc = getWebComponent(GetType(), "GeneXus.Programs", "wpfacturawizardselecmedidas", new Object[] {context} );
               WebComp_Wizardstepwc.ComponentInit();
               WebComp_Wizardstepwc.Name = "WPFacturaWizardSelecMedidas";
               WebComp_Wizardstepwc_Component = "WPFacturaWizardSelecMedidas";
            }
            if ( StringUtil.Len( WebComp_Wizardstepwc_Component) != 0 )
            {
               WebComp_Wizardstepwc.setjustcreated();
         ...
         else if ( StringUtil.StrCmp(AV10CurrentStepAux, "Resumen") == 0 )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Wizardstepwc_Component), StringUtil.Lower( "WPFacturaWizardResumen")) != 0 )
            {
               WebComp_Wizardstepwc = getWebComponent(GetType(), "GeneXus.Programs", "wpfacturawizardresumen", new Object[] {context} );
               WebComp_Wizardstepwc.ComponentInit();
               WebComp_Wizardstepwc.Name = "WPFacturaWizardResumen";
               WebComp_Wizardstepwc_Component = "WPFacturaWizardResumen";
            }
            if ( StringUtil.Len( WebComp_Wizardstepwc_Component) != 0 )
            {
               WebComp_Wizardstepwc.setjustcreated();
      ...
      protected void E122T2( )
      {
         ...
         {
            AV12WizardStep = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV11WizardSteps.Item(AV17GXV1));
      ...
      protected void wb_table1_6_2T2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWizardstepdescription_Internalname, lblWizardstepdescription_Caption, "", "", lblWizardstepdescription_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "WizardStepDescription", 0, "", 1, 1, 0, 0, "HLP_WPFacturaWizard.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025102815462520", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wpfacturawizard.js", "?2025102815462520", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Agregar una factura", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
