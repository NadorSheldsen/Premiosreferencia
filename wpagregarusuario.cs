...
namespace GeneXus.Programs {
   public class wpagregarusuario : GXDataArea
   {
      public wpagregarusuario( )
      {
      ...
      public wpagregarusuario( IGxContext context )
      {
                           ...
                           int aP1_UsuarioID )
      {
         ...
         this.AV12UsuarioID = aP1_UsuarioID;
         ExecuteImpl();
      }
      ...
      protected override void createObjects( )
      {
         ...
         cmbavRoladmin = new GXCombobox();
         cmbavRolasesor = new GXCombobox();
      }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "wpagregarusuario.aspx"+UrlEncode(StringUtil.RTrim(AV8TrnMode)) + "," + UrlEncode(StringUtil.LTrimStr(AV12UsuarioID,9,0));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wpagregarusuario.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vUSUARIOCORREO", AV37UsuarioCorreo);
         GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIOCORREO", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV37UsuarioCorreo, "")), context));
         GxWebStd.gx_hidden_field( context, "vUSUARIOROL", StringUtil.RTrim( AV32UsuarioRol));
         GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIOROL", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV32UsuarioRol, "")), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vUSUARIO_PUESTOID_DATA", AV18Usuario_PuestoID_Data);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vUSUARIO_PUESTOID_DATA", AV18Usuario_PuestoID_Data);
         }
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vPAISID_DATA", AV25PaisID_Data);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vPAISID_DATA", AV25PaisID_Data);
         }
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vESTADOID_DATA", AV26EstadoID_Data);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vESTADOID_DATA", AV26EstadoID_Data);
         }
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vUSUARIO_CIUDADID_DATA", AV22Usuario_CiudadID_Data);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vUSUARIO_CIUDADID_DATA", AV22Usuario_CiudadID_Data);
         }
         GxWebStd.gx_hidden_field( context, "vTRNMODE", StringUtil.RTrim( AV8TrnMode));
         GxWebStd.gx_hidden_field( context, "gxhash_vTRNMODE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV8TrnMode, "")), context));
         GxWebStd.gx_hidden_field( context, "vUSUARIOCORREO", AV37UsuarioCorreo);
         ...
         GxWebStd.gx_hidden_field( context, "COMBO_USUARIO_PUESTOID_Enabled", StringUtil.BoolToStr( Combo_usuario_puestoid_Enabled));
         ...
         GxWebStd.gx_hidden_field( context, "COMBO_ESTADOID_Enabled", StringUtil.BoolToStr( Combo_estadoid_Enabled));
         ...
         GxWebStd.gx_hidden_field( context, "COMBO_USUARIO_CIUDADID_Enabled", StringUtil.BoolToStr( Combo_usuario_ciudadid_Enabled));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wpagregarusuario.aspx"+UrlEncode(StringUtil.RTrim(AV8TrnMode)) + "," + UrlEncode(StringUtil.LTrimStr(AV12UsuarioID,9,0));
         return formatLink("wpagregarusuario.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "WPAgregarUsuario" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "WPAgregar Usuario", "") ;
      }
      ...
      protected void WB0Z0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavUsuario_usuariocorreo_Internalname, AV5Usuario.gxTpr_Usuariocorreo, StringUtil.RTrim( context.localUtil.Format( AV5Usuario.gxTpr_Usuariocorreo, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,31);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavUsuario_usuariocorreo_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavUsuario_usuariocorreo_Enabled, 1, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, 0, true, "", "start", true, "", "HLP_WPAgregarUsuario.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavUsuario_usuariocelular_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV5Usuario.gxTpr_Usuariocelular), 10, 0, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV5Usuario.gxTpr_Usuariocelular), "ZZZZZZZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onblur(this,44);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavUsuario_usuariocelular_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavUsuario_usuariocelular_Enabled, 1, "text", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WPAgregarUsuario.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_usuario_puestoid_Internalname, context.GetMessage( "Puesto", ""), "", "", lblTextblockcombo_usuario_puestoid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_WPAgregarUsuario.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            ucCombo_usuario_puestoid.SetProperty("DropDownOptionsTitleSettingsIcons", AV19DDO_TitleSettingsIcons);
            ucCombo_usuario_puestoid.SetProperty("DropDownOptionsData", AV18Usuario_PuestoID_Data);
            ...
            GxWebStd.gx_single_line_edit( context, edtavPass_Internalname, StringUtil.RTrim( AV14Pass), StringUtil.RTrim( context.localUtil.Format( AV14Pass, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,57);\""+" "+"data-gx-password-reveal"+" "+"idenableshowpasswordhint=\"True\""+" ", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavPass_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavPass_Enabled, 1, "text", "", 40, "chr", 1, "row", 40, -1, 0, 0, 0, 0, -1, true, "", "start", true, "", "HLP_WPAgregarUsuario.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavPass2_Internalname, StringUtil.RTrim( AV15Pass2), StringUtil.RTrim( context.localUtil.Format( AV15Pass2, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,61);\""+" "+"data-gx-password-reveal"+" "+"idenableshowpasswordhint=\"True\""+" ", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavPass2_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavPass2_Enabled, 1, "text", "", 40, "chr", 1, "row", 40, -1, 0, 0, 0, 0, -1, true, "", "start", true, "", "HLP_WPAgregarUsuario.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock1_Internalname, " ", "", "", lblTextblock1_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPAgregarUsuario.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavUsuario_usuariorazonsocialasociado_Internalname, AV5Usuario.gxTpr_Usuariorazonsocialasociado, StringUtil.RTrim( context.localUtil.Format( AV5Usuario.gxTpr_Usuariorazonsocialasociado, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,77);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavUsuario_usuariorazonsocialasociado_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavUsuario_usuariorazonsocialasociado_Enabled, 1, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WPAgregarUsuario.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-3 MergeLabelCell", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_paisid_Internalname, context.GetMessage( "País", ""), "", "", lblTextblockcombo_paisid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_WPAgregarUsuario.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "start", "top", "", "", "div");
            /* User Defined Control */
            ...
            ucCombo_paisid.SetProperty("DropDownOptionsTitleSettingsIcons", AV19DDO_TitleSettingsIcons);
            ucCombo_paisid.SetProperty("DropDownOptionsData", AV25PaisID_Data);
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-3 MergeLabelCell", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_estadoid_Internalname, context.GetMessage( "Estado", ""), "", "", lblTextblockcombo_estadoid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_WPAgregarUsuario.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "start", "top", "", "", "div");
            /* User Defined Control */
            ...
            ucCombo_estadoid.SetProperty("DropDownOptionsTitleSettingsIcons", AV19DDO_TitleSettingsIcons);
            ucCombo_estadoid.SetProperty("DropDownOptionsData", AV26EstadoID_Data);
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-3 MergeLabelCell", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_usuario_ciudadid_Internalname, context.GetMessage( "Ciudad", ""), "", "", lblTextblockcombo_usuario_ciudadid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_WPAgregarUsuario.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "start", "top", "", "", "div");
            /* User Defined Control */
            ...
            ucCombo_usuario_ciudadid.SetProperty("DropDownOptionsTitleSettingsIcons", AV19DDO_TitleSettingsIcons);
            ucCombo_usuario_ciudadid.SetProperty("DropDownOptionsData", AV22Usuario_CiudadID_Data);
            ...
            GxWebStd.gx_single_line_edit( context, edtavUsuario_usuariodelegacion_Internalname, StringUtil.RTrim( AV5Usuario.gxTpr_Usuariodelegacion), StringUtil.RTrim( context.localUtil.Format( AV5Usuario.gxTpr_Usuariodelegacion, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,133);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavUsuario_usuariodelegacion_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavUsuario_usuariodelegacion_Enabled, 1, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WPAgregarUsuario.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavUsuario_usuariocp_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV5Usuario.gxTpr_Usuariocp), 5, 0, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV5Usuario.gxTpr_Usuariocp), "ZZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onblur(this,137);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavUsuario_usuariocp_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavUsuario_usuariocp_Enabled, 1, "text", "1", 5, "chr", 1, "row", 5, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WPAgregarUsuario.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavUsuario_usuariozona, cmbavUsuario_usuariozona_Internalname, StringUtil.RTrim( AV5Usuario.gxTpr_Usuariozona), 1, cmbavUsuario_usuariozona_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "char", "", 1, cmbavUsuario_usuariozona.Enabled, 1, 0, 0, "em", 0, "", "", "AttributeFL", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,142);\"", "", true, 0, "HLP_WPAgregarUsuario.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavUsuario_usuariotelefonosucursal_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV5Usuario.gxTpr_Usuariotelefonosucursal), 10, 0, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV5Usuario.gxTpr_Usuariotelefonosucursal), "ZZZZZZZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onblur(this,146);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavUsuario_usuariotelefonosucursal_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavUsuario_usuariotelefonosucursal_Enabled, 1, "text", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WPAgregarUsuario.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavUsuario_usuarioproducto, cmbavUsuario_usuarioproducto_Internalname, StringUtil.RTrim( AV5Usuario.gxTpr_Usuarioproducto), 1, cmbavUsuario_usuarioproducto_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, cmbavUsuario_usuarioproducto.Enabled, 1, 0, 0, "em", 0, "", "", "AttributeFL", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,151);\"", "", true, 0, "HLP_WPAgregarUsuario.htm");
            ...
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divUsuario_usuariorol_cell_Internalname, 1, 0, "px", 0, "px", divUsuario_usuariorol_cell_Class, "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", cmbavUsuario_usuariorol.Visible, 0, "px", 0, "px", "form-group gx-form-group", "start", "top", ""+" data-gx-for=\""+cmbavUsuario_usuariorol_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavUsuario_usuariorol, cmbavUsuario_usuariorol_Internalname, StringUtil.RTrim( AV5Usuario.gxTpr_Usuariorol), 1, cmbavUsuario_usuariorol_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "char", "", cmbavUsuario_usuariorol.Visible, cmbavUsuario_usuariorol.Enabled, 1, 0, 0, "em", 0, "", "", "AttributeFL", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,164);\"", "", true, 0, "HLP_WPAgregarUsuario.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divRoladmin_cell_Internalname, 1, 0, "px", 0, "px", divRoladmin_cell_Class, "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", cmbavRoladmin.Visible, 0, "px", 0, "px", "form-group gx-form-group", "start", "top", ""+" data-gx-for=\""+cmbavRoladmin_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, cmbavRoladmin_Internalname, context.GetMessage( "Rol", ""), "col-sm-3 AttributeFLLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 169,'',false,'',0)\"";
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavRoladmin, cmbavRoladmin_Internalname, StringUtil.RTrim( AV30RolAdmin), 1, cmbavRoladmin_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "char", "", cmbavRoladmin.Visible, cmbavRoladmin.Enabled, 1, 0, 0, "em", 0, "", "", "AttributeFL", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,169);\"", "", true, 0, "HLP_WPAgregarUsuario.htm");
            cmbavRoladmin.CurrentValue = StringUtil.RTrim( AV30RolAdmin);
            AssignProp("", false, cmbavRoladmin_Internalname, "Values", (string)(cmbavRoladmin.ToJavascriptSource()), true);
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divRolasesor_cell_Internalname, 1, 0, "px", 0, "px", divRolasesor_cell_Class, "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", cmbavRolasesor.Visible, 0, "px", 0, "px", "form-group gx-form-group", "start", "top", ""+" data-gx-for=\""+cmbavRolasesor_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, cmbavRolasesor_Internalname, context.GetMessage( "Rol", ""), "col-sm-3 AttributeFLLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 173,'',false,'',0)\"";
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavRolasesor, cmbavRolasesor_Internalname, StringUtil.RTrim( AV31RolAsesor), 1, cmbavRolasesor_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "char", "", cmbavRolasesor.Visible, cmbavRolasesor.Enabled, 1, 0, 0, "em", 0, "", "", "AttributeFL", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,173);\"", "", true, 0, "HLP_WPAgregarUsuario.htm");
            cmbavRolasesor.CurrentValue = StringUtil.RTrim( AV31RolAsesor);
            AssignProp("", false, cmbavRolasesor_Internalname, "Values", (string)(cmbavRolasesor.ToJavascriptSource()), true);
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnenter_Internalname, "", context.GetMessage( "GX_BtnEnter", ""), bttBtnenter_Jsonclick, 5, context.GetMessage( "GX_BtnEnter", ""), "", StyleString, ClassString, bttBtnenter_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_WPAgregarUsuario.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtncancel_Internalname, "", context.GetMessage( "GX_BtnCancel", ""), bttBtncancel_Jsonclick, 1, context.GetMessage( "GX_BtnCancel", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_WPAgregarUsuario.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavPaisid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV23PaisID), 9, 0, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV23PaisID), "ZZZZZZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onblur(this,184);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavPaisid_Jsonclick, 0, "Attribute", "", "", "", "", edtavPaisid_Visible, 1, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WPAgregarUsuario.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 185,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavEstadoid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV24EstadoID), 9, 0, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV24EstadoID), "ZZZZZZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onblur(this,185);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavEstadoid_Jsonclick, 0, "Attribute", "", "", "", "", edtavEstadoid_Visible, 1, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WPAgregarUsuario.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 186,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavUsuario_usuarioid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV5Usuario.gxTpr_Usuarioid), 9, 0, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV5Usuario.gxTpr_Usuarioid), "ZZZZZZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onblur(this,186);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavUsuario_usuarioid_Jsonclick, 0, "Attribute", "", "", "", "", edtavUsuario_usuarioid_Visible, 1, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WPAgregarUsuario.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START0Z2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "WPAgregar Usuario", ""), 0) ;
         context.wjLoc = "";
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                        {
                           ...
                           else if ( StringUtil.StrCmp(sEvt, "VROLADMIN.CONTROLVALUECHANGED") == 0 )
                           {
                              context.wbHandled = 1;
                              dynload_actions( ) ;
                              E190Z2 ();
                           }
                           else if ( StringUtil.StrCmp(sEvt, "VROLASESOR.CONTROLVALUECHANGED") == 0 )
                           {
                              context.wbHandled = 1;
                              dynload_actions( ) ;
                              E200Z2 ();
      ...
      protected void PA0Z2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wpagregarusuario.aspx")), "wpagregarusuario.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wpagregarusuario.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
                  {
                     ...
                     {
                        AV12UsuarioID = (int)(Math.Round(NumberUtil.Val( GetPar( "UsuarioID"), "."), 18, MidpointRounding.ToEven));
      ...
      protected void fix_multi_value_controls( )
      {
         ...
         if ( cmbavRoladmin.ItemCount > 0 )
         {
            AV30RolAdmin = cmbavRoladmin.getValidValue(AV30RolAdmin);
            AssignAttri("", false, "AV30RolAdmin", AV30RolAdmin);
         }
         if ( context.isAjaxRequest( ) )
         {
            cmbavRoladmin.CurrentValue = StringUtil.RTrim( AV30RolAdmin);
            AssignProp("", false, cmbavRoladmin_Internalname, "Values", cmbavRoladmin.ToJavascriptSource(), true);
         }
         if ( cmbavRolasesor.ItemCount > 0 )
         {
            AV31RolAsesor = cmbavRolasesor.getValidValue(AV31RolAsesor);
            AssignAttri("", false, "AV31RolAsesor", AV31RolAsesor);
         }
         if ( context.isAjaxRequest( ) )
         {
            cmbavRolasesor.CurrentValue = StringUtil.RTrim( AV31RolAsesor);
            AssignProp("", false, cmbavRolasesor_Internalname, "Values", cmbavRolasesor.ToJavascriptSource(), true);
         }
      }
      ...
      protected void STRUP0Z0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            ajax_req_read_hidden_sdt(cgiGet( "vUSUARIO_PUESTOID_DATA"), AV18Usuario_PuestoID_Data);
            ajax_req_read_hidden_sdt(cgiGet( "vPAISID_DATA"), AV25PaisID_Data);
            ajax_req_read_hidden_sdt(cgiGet( "vESTADOID_DATA"), AV26EstadoID_Data);
            ajax_req_read_hidden_sdt(cgiGet( "vUSUARIO_CIUDADID_DATA"), AV22Usuario_CiudadID_Data);
            /* Read saved values. */
            ...
            Combo_usuario_puestoid_Enabled = StringUtil.StrToBool( cgiGet( "COMBO_USUARIO_PUESTOID_Enabled"));
            ...
            Combo_estadoid_Enabled = StringUtil.StrToBool( cgiGet( "COMBO_ESTADOID_Enabled"));
            ...
            Combo_usuario_ciudadid_Enabled = StringUtil.StrToBool( cgiGet( "COMBO_USUARIO_CIUDADID_Enabled"));
            ...
            AV14Pass = cgiGet( edtavPass_Internalname);
            AssignAttri("", false, "AV14Pass", AV14Pass);
            AV15Pass2 = cgiGet( edtavPass2_Internalname);
            AssignAttri("", false, "AV15Pass2", AV15Pass2);
            ...
            cmbavRoladmin.CurrentValue = cgiGet( cmbavRoladmin_Internalname);
            AV30RolAdmin = cgiGet( cmbavRoladmin_Internalname);
            AssignAttri("", false, "AV30RolAdmin", AV30RolAdmin);
            cmbavRolasesor.CurrentValue = cgiGet( cmbavRolasesor_Internalname);
            AV31RolAsesor = cgiGet( cmbavRolasesor_Internalname);
            AssignAttri("", false, "AV31RolAsesor", AV31RolAsesor);
            if ( ( ( context.localUtil.CToN( cgiGet( edtavPaisid_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")) < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavPaisid_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")) > Convert.ToDecimal( 999999999 )) ) )
            {
               ...
               wbErr = true;
               AV23PaisID = 0;
               AssignAttri("", false, "AV23PaisID", StringUtil.LTrimStr( (decimal)(AV23PaisID), 9, 0));
            }
            else
            {
               AV23PaisID = (int)(Math.Round(context.localUtil.CToN( cgiGet( edtavPaisid_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV23PaisID", StringUtil.LTrimStr( (decimal)(AV23PaisID), 9, 0));
            }
            if ( ( ( context.localUtil.CToN( cgiGet( edtavEstadoid_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")) < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavEstadoid_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")) > Convert.ToDecimal( 999999999 )) ) )
            {
               ...
               wbErr = true;
               AV24EstadoID = 0;
               AssignAttri("", false, "AV24EstadoID", StringUtil.LTrimStr( (decimal)(AV24EstadoID), 9, 0));
            }
            else
            {
               AV24EstadoID = (int)(Math.Round(context.localUtil.CToN( cgiGet( edtavEstadoid_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV24EstadoID", StringUtil.LTrimStr( (decimal)(AV24EstadoID), 9, 0));
            }
      ...
      protected void E150Z2( )
      {
         /* Start Routine */
         returnInSub = false;
         AV34UsuarioJSON = AV35WebSession.Get(context.GetMessage( "Usuario", ""));
         AV33SDTUsuario.FromJSonString(AV34UsuarioJSON, null);
         AV32UsuarioRol = AV33SDTUsuario.gxTpr_Usuariorol;
         AssignAttri("", false, "AV32UsuarioRol", AV32UsuarioRol);
         GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIOROL", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV32UsuarioRol, "")), context));
         AV9LoadSuccess = true;
         if ( ( ( StringUtil.StrCmp(AV8TrnMode, "DSP") == 0 ) ) || ( ( StringUtil.StrCmp(AV8TrnMode, "INS") == 0 ) ) || ( ( StringUtil.StrCmp(AV8TrnMode, "UPD") == 0 ) ) || ( ( StringUtil.StrCmp(AV8TrnMode, "DLT") == 0 ) ) )
         {
            if ( StringUtil.StrCmp(AV8TrnMode, "INS") != 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(AV8TrnMode, "DSP") == 0 ) || ( StringUtil.StrCmp(AV8TrnMode, "DLT") == 0 ) )
               {
                  ...
                  cmbavRoladmin.Enabled = 0;
                  AssignProp("", false, cmbavRoladmin_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(cmbavRoladmin.Enabled), 5, 0), true);
                  cmbavRolasesor.Enabled = 0;
                  AssignProp("", false, cmbavRolasesor_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(cmbavRolasesor.Enabled), 5, 0), true);
                  ...
                  Combo_estadoid_Enabled = false;
                  ucCombo_estadoid.SendProperty(context, "", false, Combo_estadoid_Internalname, "Enabled", StringUtil.BoolToStr( Combo_estadoid_Enabled));
                  Combo_usuario_ciudadid_Enabled = false;
                  ucCombo_usuario_ciudadid.SendProperty(context, "", false, Combo_usuario_ciudadid_Internalname, "Enabled", StringUtil.BoolToStr( Combo_usuario_ciudadid_Enabled));
                  ...
                  Combo_usuario_puestoid_Enabled = false;
                  ucCombo_usuario_puestoid.SendProperty(context, "", false, Combo_usuario_puestoid_Internalname, "Enabled", StringUtil.BoolToStr( Combo_usuario_puestoid_Enabled));
                  edtavPass_Enabled = 0;
                  AssignProp("", false, edtavPass_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavPass_Enabled), 5, 0), true);
                  edtavPass2_Enabled = 0;
                  AssignProp("", false, edtavPass2_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavPass2_Enabled), 5, 0), true);
               }
            }
         }
         else
         ...
         if ( StringUtil.StrCmp(AV8TrnMode, "INS") != 0 )
         {
            AV14Pass = Decrypt64( AV5Usuario.gxTpr_Usuariopass, AV5Usuario.gxTpr_Usuariokey);
            AssignAttri("", false, "AV14Pass", AV14Pass);
            AV15Pass2 = Decrypt64( AV5Usuario.gxTpr_Usuariopass, AV5Usuario.gxTpr_Usuariokey);
            AssignAttri("", false, "AV15Pass2", AV15Pass2);
            /* Using cursor H000Z2 */
            pr_default.execute(0, new Object[] {AV5Usuario.gxTpr_Ciudadid});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A4CiudadID = H000Z2_A4CiudadID[0];
               A1EstadoID = H000Z2_A1EstadoID[0];
               AV24EstadoID = A1EstadoID;
               AssignAttri("", false, "AV24EstadoID", StringUtil.LTrimStr( (decimal)(AV24EstadoID), 9, 0));
            ...
            pr_default.close(0);
            /* Using cursor H000Z3 */
            pr_default.execute(1, new Object[] {AV24EstadoID});
            while ( (pr_default.getStatus(1) != 101) )
            {
               A1EstadoID = H000Z3_A1EstadoID[0];
               A16PaisID = H000Z3_A16PaisID[0];
               AV23PaisID = A16PaisID;
               AssignAttri("", false, "AV23PaisID", StringUtil.LTrimStr( (decimal)(AV23PaisID), 9, 0));
               /* Exit For each command. Update data (if necessary), close cursors & exit. */
               if (true) break;
               /* Exiting from a For First loop. */
            ...
            pr_default.close(1);
            AV28Cond_EstadoID = AV24EstadoID;
            AssignAttri("", false, "AV28Cond_EstadoID", StringUtil.LTrimStr( (decimal)(AV28Cond_EstadoID), 9, 0));
            AV27Cond_PaisID = AV23PaisID;
            AssignAttri("", false, "AV27Cond_PaisID", StringUtil.LTrimStr( (decimal)(AV27Cond_PaisID), 9, 0));
            /* Execute user subroutine: 'LLENAROLES' */
            S172 ();
            if (returnInSub) return;
            AV37UsuarioCorreo = AV5Usuario.gxTpr_Usuariocorreo;
            AssignAttri("", false, "AV37UsuarioCorreo", AV37UsuarioCorreo);
            GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIOCORREO", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV37UsuarioCorreo, "")), context));
         }
         /* Execute user subroutine: 'LOADCOMBOPAISID' */
         S132 ();
      ...
      protected void E130Z2( )
      {
         ...
         AV28Cond_EstadoID = AV24EstadoID;
         AssignAttri("", false, "AV28Cond_EstadoID", StringUtil.LTrimStr( (decimal)(AV28Cond_EstadoID), 9, 0));
         AV24EstadoID = (int)(Math.Round(NumberUtil.Val( Combo_estadoid_Selectedvalue_get, "."), 18, MidpointRounding.ToEven));
         AssignAttri("", false, "AV24EstadoID", StringUtil.LTrimStr( (decimal)(AV24EstadoID), 9, 0));
         if ( AV28Cond_EstadoID != AV24EstadoID )
         {
      ...
      protected void E120Z2( )
      {
         ...
         AV27Cond_PaisID = AV23PaisID;
         AssignAttri("", false, "AV27Cond_PaisID", StringUtil.LTrimStr( (decimal)(AV27Cond_PaisID), 9, 0));
         AV23PaisID = (int)(Math.Round(NumberUtil.Val( Combo_paisid_Selectedvalue_get, "."), 18, MidpointRounding.ToEven));
         AssignAttri("", false, "AV23PaisID", StringUtil.LTrimStr( (decimal)(AV23PaisID), 9, 0));
         if ( AV27Cond_PaisID != AV23PaisID )
         {
            AV24EstadoID = 0;
            AssignAttri("", false, "AV24EstadoID", StringUtil.LTrimStr( (decimal)(AV24EstadoID), 9, 0));
      ...
      protected void E170Z2( )
      {
         ...
         returnInSub = false;
         AV36Pasa = false;
         if ( StringUtil.StrCmp(AV14Pass, AV15Pass2) == 0 )
         {
            if ( StringUtil.StrCmp(AV5Usuario.gxTpr_Usuariocorreo, AV37UsuarioCorreo) != 0 )
            {
               /* Execute user subroutine: 'VERIFICACORREOUNICO' */
               S192 ();
               if (returnInSub) return;
            }
            else
            ...
            if ( AV36Pasa )
            {
               AV13UsuarioKey = Crypto.GetEncryptionKey( );
               AV5Usuario.gxTpr_Usuariopass = Encrypt64( AV15Pass2, AV13UsuarioKey);
               AV5Usuario.gxTpr_Usuariokey = AV13UsuarioKey;
               AV5Usuario.gxTpr_Usuariofecharegistro = DateTimeUtil.Today( context);
            ...
            {
               GX_msglist.addItem(context.GetMessage( "Error, el correo ingresado ya ha sido utilizado", ""));
               GX_FocusControl = edtavUsuario_usuariocorreo_Internalname;
               AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
      ...
      protected void S202( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV14Pass)) )
         {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV15Pass2)) )
         {
         ...
         if ( ( ( StringUtil.StrCmp(AV32UsuarioRol, "Super Administrador") == 0 ) ) && String.IsNullOrEmpty(StringUtil.RTrim( AV5Usuario.gxTpr_Usuariorol)) )
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "Rol", ""), "", "", "", "", "", "", "", ""),  "error",  cmbavUsuario_usuariorol_Internalname,  "true",  ""));
            AV10CheckRequiredFieldsResult = false;
            AssignAttri("", false, "AV10CheckRequiredFieldsResult", AV10CheckRequiredFieldsResult);
         }
         if ( ( ( StringUtil.StrCmp(AV32UsuarioRol, "Administrador Yokohama") == 0 ) ) && String.IsNullOrEmpty(StringUtil.RTrim( AV30RolAdmin)) )
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "Rol", ""), "", "", "", "", "", "", "", ""),  "error",  cmbavRoladmin_Internalname,  "true",  ""));
            AV10CheckRequiredFieldsResult = false;
            AssignAttri("", false, "AV10CheckRequiredFieldsResult", AV10CheckRequiredFieldsResult);
         }
         if ( ( ( StringUtil.StrCmp(AV32UsuarioRol, "Asesor") == 0 ) ) && String.IsNullOrEmpty(StringUtil.RTrim( AV31RolAsesor)) )
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "Rol", ""), "", "", "", "", "", "", "", ""),  "error",  cmbavRolasesor_Internalname,  "true",  ""));
            AV10CheckRequiredFieldsResult = false;
            AssignAttri("", false, "AV10CheckRequiredFieldsResult", AV10CheckRequiredFieldsResult);
         }
      }
      ...
      protected void S162( )
      {
         ...
         returnInSub = false;
         if ( ! ( ( StringUtil.StrCmp(AV32UsuarioRol, "Super Administrador") == 0 ) ) )
         {
            ...
            divUsuario_usuariorol_cell_Class = "Invisible";
            AssignProp("", false, divUsuario_usuariorol_cell_Internalname, "Class", divUsuario_usuariorol_cell_Class, true);
         }
         else
         {
            cmbavUsuario_usuariorol.Visible = 1;
            AssignProp("", false, cmbavUsuario_usuariorol_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(cmbavUsuario_usuariorol.Visible), 5, 0), true);
            divUsuario_usuariorol_cell_Class = "col-xs-12 col-sm-6 DataContentCellFL RequiredDataContentCellFL";
            AssignProp("", false, divUsuario_usuariorol_cell_Internalname, "Class", divUsuario_usuariorol_cell_Class, true);
         }
         if ( ! ( ( StringUtil.StrCmp(AV32UsuarioRol, "Administrador Yokohama") == 0 ) ) )
         {
            cmbavRoladmin.Visible = 0;
            AssignProp("", false, cmbavRoladmin_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(cmbavRoladmin.Visible), 5, 0), true);
            divRoladmin_cell_Class = "Invisible";
            AssignProp("", false, divRoladmin_cell_Internalname, "Class", divRoladmin_cell_Class, true);
         }
         else
         {
            cmbavRoladmin.Visible = 1;
            AssignProp("", false, cmbavRoladmin_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(cmbavRoladmin.Visible), 5, 0), true);
            divRoladmin_cell_Class = "col-xs-12 col-sm-6 DataContentCellFL RequiredDataContentCellFL";
            AssignProp("", false, divRoladmin_cell_Internalname, "Class", divRoladmin_cell_Class, true);
         }
         if ( ! ( ( StringUtil.StrCmp(AV32UsuarioRol, "Asesor") == 0 ) ) )
         {
            cmbavRolasesor.Visible = 0;
            AssignProp("", false, cmbavRolasesor_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(cmbavRolasesor.Visible), 5, 0), true);
            divRolasesor_cell_Class = "Invisible";
            AssignProp("", false, divRolasesor_cell_Internalname, "Class", divRolasesor_cell_Class, true);
         }
         else
         {
            cmbavRolasesor.Visible = 1;
            AssignProp("", false, cmbavRolasesor_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(cmbavRolasesor.Visible), 5, 0), true);
            divRolasesor_cell_Class = "col-xs-12 col-sm-6 DataContentCellFL RequiredDataContentCellFL";
            AssignProp("", false, divRolasesor_cell_Internalname, "Class", divRolasesor_cell_Class, true);
         }
      }
      ...
      protected void S152( )
      {
         ...
         AV61GXLvl348 = 0;
         /* Using cursor H000Z4 */
         pr_default.execute(2, new Object[] {AV5Usuario.gxTpr_Ciudadid, AV28Cond_EstadoID});
         while ( (pr_default.getStatus(2) != 101) )
         {
            A1EstadoID = H000Z4_A1EstadoID[0];
            A4CiudadID = H000Z4_A4CiudadID[0];
            A5CiudadDescripcion = H000Z4_A5CiudadDescripcion[0];
            AV61GXLvl348 = 1;
      ...
      protected void S142( )
      {
         ...
         AV62GXLvl369 = 0;
         /* Using cursor H000Z5 */
         pr_default.execute(3, new Object[] {AV24EstadoID, AV27Cond_PaisID});
         while ( (pr_default.getStatus(3) != 101) )
         {
            A16PaisID = H000Z5_A16PaisID[0];
            A1EstadoID = H000Z5_A1EstadoID[0];
            A2EstadoDescripcion = H000Z5_A2EstadoDescripcion[0];
            AV62GXLvl369 = 1;
         ...
         Combo_estadoid_Selectedvalue_set = ((0==AV24EstadoID) ? "" : StringUtil.Trim( StringUtil.Str( (decimal)(AV24EstadoID), 9, 0)));
         ucCombo_estadoid.SendProperty(context, "", false, Combo_estadoid_Internalname, "SelectedValue_set", Combo_estadoid_Selectedvalue_set);
      }
      ...
      protected void S132( )
      {
         ...
         {
            A16PaisID = H000Z6_A16PaisID[0];
            A17PaisDescripcion = H000Z6_A17PaisDescripcion[0];
            AV17Combo_DataItem = new WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item(context);
            AV17Combo_DataItem.gxTpr_Id = StringUtil.Trim( StringUtil.Str( (decimal)(A16PaisID), 9, 0));
            AV17Combo_DataItem.gxTpr_Title = A17PaisDescripcion;
            AV25PaisID_Data.Add(AV17Combo_DataItem, 0);
            pr_default.readNext(4);
         }
         pr_default.close(4);
         Combo_paisid_Selectedvalue_set = ((0==AV23PaisID) ? "" : StringUtil.Trim( StringUtil.Str( (decimal)(AV23PaisID), 9, 0)));
      ...
      protected void S122( )
      {
         ...
         {
            A15PuestoActivo = H000Z7_A15PuestoActivo[0];
            A13PuestoID = H000Z7_A13PuestoID[0];
            A14PuestoDescripcion = H000Z7_A14PuestoDescripcion[0];
            AV17Combo_DataItem = new WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item(context);
            AV17Combo_DataItem.gxTpr_Id = StringUtil.Trim( StringUtil.Str( (decimal)(A13PuestoID), 9, 0));
            AV17Combo_DataItem.gxTpr_Title = A14PuestoDescripcion;
            AV18Usuario_PuestoID_Data.Add(AV17Combo_DataItem, 0);
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV65GXV22 = 1;
         while ( AV65GXV22 <= AV7Messages.Count )
         {
            AV6Message = ((GeneXus.Utils.SdtMessages_Message)AV7Messages.Item(AV65GXV22));
            GX_msglist.addItem(AV6Message.gxTpr_Description);
            AV65GXV22 = (int)(AV65GXV22+1);
         }
      }
      ...
      protected void S212( )
      {
         /* 'AFTER_TRN' Routine */
         returnInSub = false;
         context.CommitDataStores("wpagregarusuario",pr_default);
         context.setWebReturnParms(new Object[] {});
         context.setWebReturnParmsMetadata(new Object[] {});
         context.wjLocDisableFrm = 1;
         context.nUserReturn = 1;
      ...
      {
         /* Roladmin_Controlvaluechanged Routine */
         returnInSub = false;
         if ( StringUtil.StrCmp(AV30RolAdmin, "Administrador Yokohama") == 0 )
         {
            AV5Usuario.gxTpr_Usuariorol = "Administrador Yokohama";
         }
         else if ( StringUtil.StrCmp(AV30RolAdmin, "Asesor") == 0 )
         {
            AV5Usuario.gxTpr_Usuariorol = "Asesor";
         }
         else if ( StringUtil.StrCmp(AV30RolAdmin, "Participante") == 0 )
         {
            AV5Usuario.gxTpr_Usuariorol = "Participante";
         }
         else
         {
            AV5Usuario.gxTpr_Usuariorol = "";
         }
         /*  Sending Event outputs  */
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV5Usuario", AV5Usuario);
      }
      ...
      {
         /* Rolasesor_Controlvaluechanged Routine */
         returnInSub = false;
         if ( StringUtil.StrCmp(AV31RolAsesor, "Participante") == 0 )
         {
            AV5Usuario.gxTpr_Usuariorol = "Participante";
         }
         else
      ...
      protected void S172( )
      {
         ...
         if ( StringUtil.StrCmp(AV32UsuarioRol, "Administrador Yokohama") == 0 )
         {
            if ( StringUtil.StrCmp(AV5Usuario.gxTpr_Usuariorol, "Administrador Yokohama") == 0 )
            {
               AV30RolAdmin = "Administrador Yokohama";
               AssignAttri("", false, "AV30RolAdmin", AV30RolAdmin);
            }
            else if ( StringUtil.StrCmp(AV5Usuario.gxTpr_Usuariorol, "Asesor") == 0 )
            {
               AV30RolAdmin = "Asesor";
               AssignAttri("", false, "AV30RolAdmin", AV30RolAdmin);
            }
            else if ( StringUtil.StrCmp(AV5Usuario.gxTpr_Usuariorol, "Participante") == 0 )
            {
               AV30RolAdmin = "Participante";
               AssignAttri("", false, "AV30RolAdmin", AV30RolAdmin);
            }
         }
         else if ( StringUtil.StrCmp(AV32UsuarioRol, "Asesor") == 0 )
         {
            if ( StringUtil.StrCmp(AV5Usuario.gxTpr_Usuariorol, "Participante") == 0 )
            {
               AV31RolAsesor = "Participante";
               AssignAttri("", false, "AV31RolAsesor", AV31RolAsesor);
            }
         }
      }
      ...
      protected void S192( )
      {
         /* 'VERIFICACORREOUNICO' Routine */
         returnInSub = false;
         AV66GXLvl495 = 0;
         /* Using cursor H000Z8 */
         pr_default.execute(6, new Object[] {AV5Usuario.gxTpr_Usuariocorreo});
         while ( (pr_default.getStatus(6) != 101) )
         {
            A31UsuarioCorreo = H000Z8_A31UsuarioCorreo[0];
            AV66GXLvl495 = 1;
            AV36Pasa = false;
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         AssignAttri("", false, "AV8TrnMode", AV8TrnMode);
         GxWebStd.gx_hidden_field( context, "gxhash_vTRNMODE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV8TrnMode, "")), context));
         AV12UsuarioID = Convert.ToInt32(getParm(obj,1));
         AssignAttri("", false, "AV12UsuarioID", StringUtil.LTrimStr( (decimal)(AV12UsuarioID), 9, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12UsuarioID), "ZZZZZZZZ9"), context));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20265111131393", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wpagregarusuario.js", "?20265111131393", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void init_web_controls( )
      {
         ...
         cmbavRoladmin.Name = "vROLADMIN";
         cmbavRoladmin.WebTags = "";
         cmbavRoladmin.addItem("", context.GetMessage( "GX_EmptyItemText", ""), 0);
         cmbavRoladmin.addItem("Administrador Yokohama", context.GetMessage( "Administrador Yokohama", ""), 0);
         cmbavRoladmin.addItem("Asesor", context.GetMessage( "Asesor", ""), 0);
         cmbavRoladmin.addItem("Participante", context.GetMessage( "Participante", ""), 0);
         if ( cmbavRoladmin.ItemCount > 0 )
         {
            AV30RolAdmin = cmbavRoladmin.getValidValue(AV30RolAdmin);
            AssignAttri("", false, "AV30RolAdmin", AV30RolAdmin);
         }
         cmbavRolasesor.Name = "vROLASESOR";
         cmbavRolasesor.WebTags = "";
         cmbavRolasesor.addItem("", context.GetMessage( "GX_EmptyItemText", ""), 0);
         cmbavRolasesor.addItem("Participante", context.GetMessage( "Participante", ""), 0);
         if ( cmbavRolasesor.ItemCount > 0 )
         {
            AV31RolAsesor = cmbavRolasesor.getValidValue(AV31RolAsesor);
            AssignAttri("", false, "AV31RolAsesor", AV31RolAsesor);
      ...
      protected void init_default_properties( )
      {
         ...
         divUsuario_usuariorol_cell_Internalname = "USUARIO_USUARIOROL_CELL";
         cmbavRoladmin_Internalname = "vROLADMIN";
         divRoladmin_cell_Internalname = "ROLADMIN_CELL";
         cmbavRolasesor_Internalname = "vROLASESOR";
         divRolasesor_cell_Internalname = "ROLASESOR_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         cmbavRolasesor_Jsonclick = "";
         cmbavRolasesor.Enabled = 1;
         cmbavRolasesor.Visible = 1;
         divRolasesor_cell_Class = "col-xs-12 col-sm-6";
         cmbavRoladmin_Jsonclick = "";
         cmbavRoladmin.Enabled = 1;
         cmbavRoladmin.Visible = 1;
         divRoladmin_cell_Class = "col-xs-12 col-sm-6";
         cmbavUsuario_usuariorol_Jsonclick = "";
         cmbavUsuario_usuariorol.Enabled = 1;
         cmbavUsuario_usuariorol.Visible = 1;
         divUsuario_usuariorol_cell_Class = "col-xs-12 col-sm-6";
         ...
         Combo_usuario_ciudadid_Datalistproc = "WPAgregarUsuarioLoadDVCombo";
         Combo_usuario_ciudadid_Enabled = Convert.ToBoolean( -1);
         Combo_usuario_ciudadid_Cls = "ExtendedCombo AttributeFL";
         Combo_estadoid_Datalistprocparametersprefix = "";
         Combo_estadoid_Datalistproc = "WPAgregarUsuarioLoadDVCombo";
         Combo_estadoid_Enabled = Convert.ToBoolean( -1);
         ...
         Combo_usuario_puestoid_Enabled = Convert.ToBoolean( -1);
         Combo_usuario_puestoid_Cls = "ExtendedCombo AttributeFL";
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
         Form.Backcolor = (int)(0xFFFFFF);
         Form.Caption = context.GetMessage( "WPAgregar Usuario", "");
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV8TrnMode","fld":"vTRNMODE","hsh":true},{"av":"AV37UsuarioCorreo","fld":"vUSUARIOCORREO","hsh":true},{"av":"AV32UsuarioRol","fld":"vUSUARIOROL","hsh":true},{"av":"AV12UsuarioID","fld":"vUSUARIOID","pic":"ZZZZZZZZ9","hsh":true}]""");
         setEventMetadata("REFRESH",""","oparms":[{"ctrl":"BTNENTER","prop":"Visible"}]}""");
         setEventMetadata("COMBO_USUARIO_CIUDADID.ONOPTIONCLICKED","""{"handler":"E140Z2","iparms":[{"av":"Combo_usuario_ciudadid_Selectedvalue_get","ctrl":"COMBO_USUARIO_CIUDADID","prop":"SelectedValue_get"},{"av":"AV5Usuario","fld":"vUSUARIO"}]""");
         setEventMetadata("COMBO_USUARIO_CIUDADID.ONOPTIONCLICKED",""","oparms":[{"av":"AV5Usuario","fld":"vUSUARIO"}]}""");
         setEventMetadata("COMBO_ESTADOID.ONOPTIONCLICKED","""{"handler":"E130Z2","iparms":[{"av":"AV24EstadoID","fld":"vESTADOID","pic":"ZZZZZZZZ9"},{"av":"Combo_estadoid_Selectedvalue_get","ctrl":"COMBO_ESTADOID","prop":"SelectedValue_get"},{"av":"AV5Usuario","fld":"vUSUARIO"}]""");
         setEventMetadata("COMBO_ESTADOID.ONOPTIONCLICKED",""","oparms":[{"av":"AV28Cond_EstadoID","fld":"vCOND_ESTADOID","pic":"ZZZZZZZZ9"},{"av":"AV24EstadoID","fld":"vESTADOID","pic":"ZZZZZZZZ9"},{"av":"AV5Usuario","fld":"vUSUARIO"},{"av":"Combo_usuario_ciudadid_Selectedvalue_set","ctrl":"COMBO_USUARIO_CIUDADID","prop":"SelectedValue_set"},{"av":"Combo_usuario_ciudadid_Selectedtext_set","ctrl":"COMBO_USUARIO_CIUDADID","prop":"SelectedText_set"}]}""");
         setEventMetadata("COMBO_PAISID.ONOPTIONCLICKED","""{"handler":"E120Z2","iparms":[{"av":"AV23PaisID","fld":"vPAISID","pic":"ZZZZZZZZ9"},{"av":"Combo_paisid_Selectedvalue_get","ctrl":"COMBO_PAISID","prop":"SelectedValue_get"}]""");
         setEventMetadata("COMBO_PAISID.ONOPTIONCLICKED",""","oparms":[{"av":"AV27Cond_PaisID","fld":"vCOND_PAISID","pic":"ZZZZZZZZ9"},{"av":"AV23PaisID","fld":"vPAISID","pic":"ZZZZZZZZ9"},{"av":"AV24EstadoID","fld":"vESTADOID","pic":"ZZZZZZZZ9"},{"av":"Combo_estadoid_Selectedvalue_set","ctrl":"COMBO_ESTADOID","prop":"SelectedValue_set"},{"av":"Combo_estadoid_Selectedtext_set","ctrl":"COMBO_ESTADOID","prop":"SelectedText_set"}]}""");
         setEventMetadata("COMBO_USUARIO_PUESTOID.ONOPTIONCLICKED","""{"handler":"E110Z2","iparms":[{"av":"Combo_usuario_puestoid_Selectedvalue_get","ctrl":"COMBO_USUARIO_PUESTOID","prop":"SelectedValue_get"},{"av":"AV5Usuario","fld":"vUSUARIO"}]""");
         setEventMetadata("COMBO_USUARIO_PUESTOID.ONOPTIONCLICKED",""","oparms":[{"av":"AV5Usuario","fld":"vUSUARIO"}]}""");
         setEventMetadata("ENTER","""{"handler":"E170Z2","iparms":[{"av":"AV14Pass","fld":"vPASS"},{"av":"AV15Pass2","fld":"vPASS2"},{"av":"AV5Usuario","fld":"vUSUARIO"},{"av":"AV37UsuarioCorreo","fld":"vUSUARIOCORREO","hsh":true},{"av":"AV8TrnMode","fld":"vTRNMODE","hsh":true},{"av":"AV10CheckRequiredFieldsResult","fld":"vCHECKREQUIREDFIELDSRESULT"},{"av":"A31UsuarioCorreo","fld":"USUARIOCORREO"},{"av":"Combo_usuario_puestoid_Ddointernalname","ctrl":"COMBO_USUARIO_PUESTOID","prop":"DDOInternalName"},{"av":"AV23PaisID","fld":"vPAISID","pic":"ZZZZZZZZ9"},{"av":"Combo_paisid_Ddointernalname","ctrl":"COMBO_PAISID","prop":"DDOInternalName"},{"av":"AV24EstadoID","fld":"vESTADOID","pic":"ZZZZZZZZ9"},{"av":"Combo_estadoid_Ddointernalname","ctrl":"COMBO_ESTADOID","prop":"DDOInternalName"},{"av":"Combo_usuario_ciudadid_Ddointernalname","ctrl":"COMBO_USUARIO_CIUDADID","prop":"DDOInternalName"},{"av":"AV32UsuarioRol","fld":"vUSUARIOROL","hsh":true},{"av":"cmbavRoladmin"},{"av":"AV30RolAdmin","fld":"vROLADMIN"},{"av":"cmbavRolasesor"},{"av":"AV31RolAsesor","fld":"vROLASESOR"},{"av":"AV7Messages","fld":"vMESSAGES"}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"AV5Usuario","fld":"vUSUARIO"},{"av":"AV7Messages","fld":"vMESSAGES"},{"av":"AV10CheckRequiredFieldsResult","fld":"vCHECKREQUIREDFIELDSRESULT"}]}""");
         setEventMetadata("VROLADMIN.CONTROLVALUECHANGED","""{"handler":"E190Z2","iparms":[{"av":"cmbavRoladmin"},{"av":"AV30RolAdmin","fld":"vROLADMIN"},{"av":"AV5Usuario","fld":"vUSUARIO"}]""");
         setEventMetadata("VROLADMIN.CONTROLVALUECHANGED",""","oparms":[{"av":"AV5Usuario","fld":"vUSUARIO"}]}""");
         setEventMetadata("VROLASESOR.CONTROLVALUECHANGED","""{"handler":"E200Z2","iparms":[{"av":"cmbavRolasesor"},{"av":"AV31RolAsesor","fld":"vROLASESOR"},{"av":"AV5Usuario","fld":"vUSUARIO"}]""");
         setEventMetadata("VROLASESOR.CONTROLVALUECHANGED",""","oparms":[{"av":"AV5Usuario","fld":"vUSUARIO"}]}""");
         ...
         setEventMetadata("VALIDV_ROLADMIN","""{"handler":"Validv_Roladmin","iparms":[]}""");
         setEventMetadata("VALIDV_ROLASESOR","""{"handler":"Validv_Rolasesor","iparms":[]}""");
      ...
      public override void initialize( )
      {
         ...
         AV18Usuario_PuestoID_Data = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item>( context, "Item", "");
         AV25PaisID_Data = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item>( context, "Item", "");
         AV26EstadoID_Data = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item>( context, "Item", "");
         AV22Usuario_CiudadID_Data = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item>( context, "Item", "");
         A31UsuarioCorreo = "";
         ...
         AV33SDTUsuario = new SdtSDTUsuario(context);
         GXt_SdtDVB_SDTDropDownOptionsTitleSettingsIcons1 = new WorkWithPlus.workwithplus_web.SdtDVB_SDTDropDownOptionsTitleSettingsIcons(context);
         H000Z2_A4CiudadID = new int[1] ;
         H000Z2_A1EstadoID = new int[1] ;
         H000Z3_A1EstadoID = new int[1] ;
         H000Z3_A16PaisID = new int[1] ;
         AV13UsuarioKey = "";
         H000Z4_A1EstadoID = new int[1] ;
         H000Z4_A4CiudadID = new int[1] ;
         H000Z4_A5CiudadDescripcion = new string[] {""} ;
         A5CiudadDescripcion = "";
         H000Z5_A16PaisID = new int[1] ;
         H000Z5_A1EstadoID = new int[1] ;
         H000Z5_A2EstadoDescripcion = new string[] {""} ;
         A2EstadoDescripcion = "";
         H000Z6_A16PaisID = new int[1] ;
         H000Z6_A17PaisDescripcion = new string[] {""} ;
         A17PaisDescripcion = "";
         AV17Combo_DataItem = new WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item(context);
         H000Z7_A15PuestoActivo = new bool[] {false} ;
         H000Z7_A13PuestoID = new int[1] ;
         H000Z7_A14PuestoDescripcion = new string[] {""} ;
         A14PuestoDescripcion = "";
         AV6Message = new GeneXus.Utils.SdtMessages_Message(context);
         H000Z8_A29UsuarioID = new int[1] ;
         H000Z8_A31UsuarioCorreo = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wpagregarusuario__default(),
            new Object[][] {
                new Object[] {
               H000Z2_A4CiudadID, H000Z2_A1EstadoID
               }
               , new Object[] {
               H000Z3_A1EstadoID, H000Z3_A16PaisID
               }
               , new Object[] {
               H000Z4_A1EstadoID, H000Z4_A4CiudadID, H000Z4_A5CiudadDescripcion
               }
               , new Object[] {
               H000Z5_A16PaisID, H000Z5_A1EstadoID, H000Z5_A2EstadoDescripcion
               }
               , new Object[] {
               H000Z6_A16PaisID, H000Z6_A17PaisDescripcion
               }
               , new Object[] {
               H000Z7_A15PuestoActivo, H000Z7_A13PuestoID, H000Z7_A14PuestoDescripcion
               }
               , new Object[] {
               H000Z8_A29UsuarioID, H000Z8_A31UsuarioCorreo
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short AV61GXLvl348 ;
      private short AV62GXLvl369 ;
      private short AV66GXLvl495 ;
      ...
      private int AV23PaisID ;
      private int edtavPaisid_Visible ;
      private int AV24EstadoID ;
      ...
      private int AV28Cond_EstadoID ;
      private int AV27Cond_PaisID ;
      private int A13PuestoID ;
      private int AV65GXV22 ;
      private int idxLst ;
      ...
      private string divUsuario_usuariorol_cell_Internalname ;
      private string divUsuario_usuariorol_cell_Class ;
      private string cmbavUsuario_usuariorol_Internalname ;
      private string cmbavUsuario_usuariorol_Jsonclick ;
      private string divRoladmin_cell_Internalname ;
      private string divRoladmin_cell_Class ;
      private string cmbavRoladmin_Internalname ;
      private string AV30RolAdmin ;
      private string cmbavRoladmin_Jsonclick ;
      private string divRolasesor_cell_Internalname ;
      private string divRolasesor_cell_Class ;
      private string cmbavRolasesor_Internalname ;
      private string AV31RolAsesor ;
      private string cmbavRolasesor_Jsonclick ;
      ...
      private bool Combo_usuario_puestoid_Enabled ;
      ...
      private bool Combo_estadoid_Enabled ;
      private bool Combo_usuario_ciudadid_Enabled ;
      ...
      private bool AV36Pasa ;
      private bool A15PuestoActivo ;
      private string AV34UsuarioJSON ;
      private string AV37UsuarioCorreo ;
      private string A31UsuarioCorreo ;
      private string AV13UsuarioKey ;
      ...
      private GXCombobox cmbavRoladmin ;
      private GXCombobox cmbavRolasesor ;
      ...
      private GXBaseCollection<WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item> AV18Usuario_PuestoID_Data ;
      private GXBaseCollection<WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item> AV25PaisID_Data ;
      private GXBaseCollection<WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item> AV26EstadoID_Data ;
      private GXBaseCollection<WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item> AV22Usuario_CiudadID_Data ;
      private GXBaseCollection<GeneXus.Utils.SdtMessages_Message> AV7Messages ;
      private SdtSDTUsuario AV33SDTUsuario ;
      private WorkWithPlus.workwithplus_web.SdtDVB_SDTDropDownOptionsTitleSettingsIcons GXt_SdtDVB_SDTDropDownOptionsTitleSettingsIcons1 ;
      private IDataStoreProvider pr_default ;
      private int[] H000Z2_A4CiudadID ;
      private int[] H000Z2_A1EstadoID ;
      private int[] H000Z3_A1EstadoID ;
      private int[] H000Z3_A16PaisID ;
      private int[] H000Z4_A1EstadoID ;
      private int[] H000Z4_A4CiudadID ;
      private string[] H000Z4_A5CiudadDescripcion ;
      private int[] H000Z5_A16PaisID ;
      private int[] H000Z5_A1EstadoID ;
      private string[] H000Z5_A2EstadoDescripcion ;
      private int[] H000Z6_A16PaisID ;
      private string[] H000Z6_A17PaisDescripcion ;
      private WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item AV17Combo_DataItem ;
      private bool[] H000Z7_A15PuestoActivo ;
      private int[] H000Z7_A13PuestoID ;
      private string[] H000Z7_A14PuestoDescripcion ;
      private GeneXus.Utils.SdtMessages_Message AV6Message ;
      private int[] H000Z8_A29UsuarioID ;
      private string[] H000Z8_A31UsuarioCorreo ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class wpagregarusuario__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV24EstadoID",GXType.Int32,9,0)
          };
          Object[] prmH000Z4;
          prmH000Z4 = new Object[] {
          new ParDef("@AV5Usuario__Ciudadid",GXType.Int32,9,0) ,
          new ParDef("@AV28Cond_EstadoID",GXType.Int32,9,0)
          };
          Object[] prmH000Z5;
          prmH000Z5 = new Object[] {
          new ParDef("@AV24EstadoID",GXType.Int32,9,0) ,
          new ParDef("@AV27Cond_PaisID",GXType.Int32,9,0)
          };
          Object[] prmH000Z6;
          prmH000Z6 = new Object[] {
          };
          Object[] prmH000Z7;
          prmH000Z7 = new Object[] {
          };
          Object[] prmH000Z8;
          prmH000Z8 = new Object[] {
          new ParDef("@AV5Usuario__Usuariocorreo",GXType.Char,100,0)
          };
          def= new CursorDef[] {
              new CursorDef("H000Z2", "SELECT `CiudadID`, `EstadoID` FROM `Ciudad` WHERE `CiudadID` = @AV5Usuario__Ciudadid ORDER BY `CiudadID`  LIMIT 1",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000Z2,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("H000Z3", "SELECT `EstadoID`, `PaisID` FROM `Estado` WHERE `EstadoID` = @AV24EstadoID ORDER BY `EstadoID`  LIMIT 1",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000Z3,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("H000Z4", "SELECT `EstadoID`, `CiudadID`, `CiudadDescripcion` FROM `Ciudad` WHERE (`CiudadID` = @AV5Usuario__Ciudadid) AND (`EstadoID` = @AV28Cond_EstadoID) ORDER BY `CiudadID`  LIMIT 1",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000Z4,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("H000Z5", "SELECT `PaisID`, `EstadoID`, `EstadoDescripcion` FROM `Estado` WHERE (`EstadoID` = @AV24EstadoID) AND (`PaisID` = @AV27Cond_PaisID) ORDER BY `EstadoID`  LIMIT 1",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000Z5,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("H000Z6", "SELECT `PaisID`, `PaisDescripcion` FROM `Pais` ORDER BY `PaisDescripcion` ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000Z6,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H000Z7", "SELECT `PuestoActivo`, `PuestoID`, `PuestoDescripcion` FROM `Puesto` WHERE `PuestoActivo` = 1 ORDER BY `PuestoDescripcion` ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000Z7,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H000Z8", "SELECT `UsuarioID`, `UsuarioCorreo` FROM `Usuario` WHERE `UsuarioCorreo` = @AV5Usuario__Usuariocorreo ORDER BY `UsuarioID` ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000Z8,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
