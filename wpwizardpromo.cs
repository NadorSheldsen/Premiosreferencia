...
namespace GeneXus.Programs {
   public class wpwizardpromo : GXDataArea
   {
      public wpwizardpromo( )
      {
      ...
      public wpwizardpromo( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "wpwizardpromo.aspx"+UrlEncode(StringUtil.RTrim(AV8PreviousStep)) + "," + UrlEncode(StringUtil.RTrim(AV9CurrentStep)) + "," + UrlEncode(StringUtil.BoolToStr(AV7GoingBack));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wpwizardpromo.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wpwizardpromo.aspx"+UrlEncode(StringUtil.RTrim(AV8PreviousStep)) + "," + UrlEncode(StringUtil.RTrim(AV9CurrentStep)) + "," + UrlEncode(StringUtil.BoolToStr(AV7GoingBack));
         return formatLink("wpwizardpromo.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "WPWizardPromo" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Agregar promoción", "") ;
      }
      ...
      protected void WB1T0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_6_1T2( true) ;
         }
         else
         {
            wb_table1_6_1T2( false) ;
         }
         return  ;
      }

      protected void wb_table1_6_1T2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START1T2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Agregar promoción", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void PA1T2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wpwizardpromo.aspx")), "wpwizardpromo.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wpwizardpromo.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
      ...
      protected void E111T2( )
      {
         ...
         returnInSub = false;
         AV16Pasa = true;
         AV11WizardSteps = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem>( context, "WizardStepsItem", "Premios");
         AV11WizardSteps.Add(new WorkWithPlus.workwithplus_web.wwp_wizardgetstep(context).executeUdp(  "InfoGeneral",  context.GetMessage( "Datos generales", ""),  context.GetMessage( "Ingresa la información para generar la promoción", ""),  false), 0);
         AV11WizardSteps.Add(new WorkWithPlus.workwithplus_web.wwp_wizardgetstep(context).executeUdp(  "Segmentos",  context.GetMessage( "Segmentos", ""),  context.GetMessage( "Selecciona los segmentos de la promoción", ""),  false), 0);
         AV11WizardSteps.Add(new WorkWithPlus.workwithplus_web.wwp_wizardgetstep(context).executeUdp(  "Modelos",  context.GetMessage( "Modelos", ""),  context.GetMessage( "Selecciona los diseños que entran en la promo y agrega la comisión", ""),  false), 0);
         AV11WizardSteps.Add(new WorkWithPlus.workwithplus_web.wwp_wizardgetstep(context).executeUdp(  "Resumen",  context.GetMessage( "Resumen", ""),  context.GetMessage( "Resumen de la promoción", ""),  false), 0);
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV9CurrentStep)) )
         {
            AV10CurrentStepAux = "InfoGeneral";
            AssignAttri("", false, "AV10CurrentStepAux", AV10CurrentStepAux);
            GxWebStd.gx_hidden_field( context, "gxhash_vCURRENTSTEPAUX", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV10CurrentStepAux, "")), context));
            AV5WebSession.Remove(AV17Pgmname+"_Data");
         }
         else
         {
         ...
         if ( StringUtil.Len( WebComp_Steptitles_Component) != 0 )
         {
            ...
            WebComp_Steptitles.componentprepare(new Object[] {(string)"W0009",(string)"",(string)AV17Pgmname+"_Data",(GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem>)AV11WizardSteps,(string)AV10CurrentStepAux});
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV10CurrentStepAux, "InfoGeneral") == 0 )
         {
            /* Object Property */
            if ( true )
            {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Wizardstepwc_Component), StringUtil.Lower( "WPWizardPromoInfoGeneral")) != 0 )
            {
               WebComp_Wizardstepwc = getWebComponent(GetType(), "GeneXus.Programs", "wpwizardpromoinfogeneral", new Object[] {context} );
               WebComp_Wizardstepwc.ComponentInit();
               WebComp_Wizardstepwc.Name = "WPWizardPromoInfoGeneral";
               WebComp_Wizardstepwc_Component = "WPWizardPromoInfoGeneral";
            }
            if ( StringUtil.Len( WebComp_Wizardstepwc_Component) != 0 )
            {
               WebComp_Wizardstepwc.setjustcreated();
               WebComp_Wizardstepwc.componentprepare(new Object[] {(string)"W0015",(string)"",(string)AV17Pgmname+"_Data",(string)AV8PreviousStep,(bool)AV7GoingBack});
         ...
         else if ( StringUtil.StrCmp(AV10CurrentStepAux, "Segmentos") == 0 )
         {
            /* Object Property */
            if ( true )
            {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Wizardstepwc_Component), StringUtil.Lower( "WPWizardPromoSegmentos")) != 0 )
            {
               WebComp_Wizardstepwc = getWebComponent(GetType(), "GeneXus.Programs", "wpwizardpromosegmentos", new Object[] {context} );
               WebComp_Wizardstepwc.ComponentInit();
               WebComp_Wizardstepwc.Name = "WPWizardPromoSegmentos";
               WebComp_Wizardstepwc_Component = "WPWizardPromoSegmentos";
            }
            if ( StringUtil.Len( WebComp_Wizardstepwc_Component) != 0 )
            {
               WebComp_Wizardstepwc.setjustcreated();
         ...
         else if ( StringUtil.StrCmp(AV10CurrentStepAux, "Modelos") == 0 )
         {
            /* Object Property */
            if ( true )
            {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Wizardstepwc_Component), StringUtil.Lower( "WPWizardPromoModelos")) != 0 )
            {
               WebComp_Wizardstepwc = getWebComponent(GetType(), "GeneXus.Programs", "wpwizardpromomodelos", new Object[] {context} );
               WebComp_Wizardstepwc.ComponentInit();
               WebComp_Wizardstepwc.Name = "WPWizardPromoModelos";
               WebComp_Wizardstepwc_Component = "WPWizardPromoModelos";
            }
            if ( StringUtil.Len( WebComp_Wizardstepwc_Component) != 0 )
            {
               WebComp_Wizardstepwc.setjustcreated();
         ...
         else if ( StringUtil.StrCmp(AV10CurrentStepAux, "Resumen") == 0 )
         {
            /* Object Property */
            if ( true )
            {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Wizardstepwc_Component), StringUtil.Lower( "WPWizardPromoResumen")) != 0 )
            {
               WebComp_Wizardstepwc = getWebComponent(GetType(), "GeneXus.Programs", "wpwizardpromoresumen", new Object[] {context} );
               WebComp_Wizardstepwc.ComponentInit();
               WebComp_Wizardstepwc.Name = "WPWizardPromoResumen";
               WebComp_Wizardstepwc_Component = "WPWizardPromoResumen";
            }
            if ( StringUtil.Len( WebComp_Wizardstepwc_Component) != 0 )
            {
               WebComp_Wizardstepwc.setjustcreated();
      ...
      protected void E121T2( )
      {
         ...
         AV13StepNumber = 1;
         AV18GXV1 = 1;
         while ( AV18GXV1 <= AV11WizardSteps.Count )
         {
            AV12WizardStep = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV11WizardSteps.Item(AV18GXV1));
            if ( StringUtil.StrCmp(AV12WizardStep.gxTpr_Code, AV10CurrentStepAux) == 0 )
            {
               ...
               {
                  lblWizardstepdescription_Caption = StringUtil.Format( context.GetMessage( "Step %1/%2 :: %3", ""), StringUtil.Trim( StringUtil.Str( (decimal)(AV13StepNumber), 2, 0)), StringUtil.Trim( StringUtil.Str( (decimal)(AV11WizardSteps.Count), 9, 0)), AV12WizardStep.gxTpr_Description, "", "", "", "", "", "");
                  AssignProp("", false, lblWizardstepdescription_Internalname, "Caption", lblWizardstepdescription_Caption, true);
               }
            }
            else
      ...
      protected void wb_table1_6_1T2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWizardstepdescription_Internalname, lblWizardstepdescription_Caption, "", "", lblWizardstepdescription_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "WizardStepDescription", 0, "", 1, 1, 0, 0, "HLP_WPWizardPromo.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            ...
            wb_table1_6_1T2e( true) ;
         }
         else
         {
            wb_table1_6_1T2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025102815462431", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wpwizardpromo.js", "?2025102815462432", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         lblWizardstepdescription_Caption = context.GetMessage( "Descripción del paso", "");
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
         Form.Backcolor = (int)(0xFFFFFF);
         Form.Caption = context.GetMessage( "Agregar promoción", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV11WizardSteps","fld":"vWIZARDSTEPS","hsh":true},{"av":"AV10CurrentStepAux","fld":"vCURRENTSTEPAUX","hsh":true},{"av":"AV8PreviousStep","fld":"vPREVIOUSSTEP","hsh":true},{"av":"AV9CurrentStep","fld":"vCURRENTSTEP","hsh":true},{"av":"AV7GoingBack","fld":"vGOINGBACK","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         AV12WizardStep = new WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem(context);
         sStyleString = "";
      ...
      private GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem> AV11WizardSteps ;
      private WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem AV12WizardStep ;
