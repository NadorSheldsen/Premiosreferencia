...
namespace GeneXus.Programs {
   public class wcpartidasfacturapopover : GXWebComponent
   {
      public wcpartidasfacturapopover( )
      {
      ...
      public wcpartidasfacturapopover( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "WCPartidas Factura Popover", "")) ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               ...
               GXEncryptionTmp = "wcpartidasfacturapopover.aspx"+UrlEncode(StringUtil.LTrimStr(AV42FacturaID,9,0));
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wcpartidasfacturapopover.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         return "WCPartidasFacturaPopover" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "WCPartidas Factura Popover", "") ;
      }
      ...
      protected void WB4D0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "wcpartidasfacturapopover.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            ...
            GxWebStd.gx_single_line_edit( context, edtavTitle_Internalname, AV46Title, StringUtil.RTrim( context.localUtil.Format( AV46Title, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTitle_Jsonclick, 0, "SimpleCardAttributeTitle", "", "", "", "", 1, edtavTitle_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WCPartidasFacturaPopover.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START4D2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "WCPartidas Factura Popover", ""), 0) ;
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wcpartidasfacturapopover.aspx")), "wcpartidasfacturapopover.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wcpartidasfacturapopover.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void RF4D2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A79FacturaMedidaPrecio = H004D2_A79FacturaMedidaPrecio[0];
               A78FacturaMedidaCantidad = H004D2_A78FacturaMedidaCantidad[0];
               A74MedidaRin = H004D2_A74MedidaRin[0];
               A28MedidaDescripcion = H004D2_A28MedidaDescripcion[0];
               A23ModeloDescripcion = H004D2_A23ModeloDescripcion[0];
               A22ModeloID = H004D2_A22ModeloID[0];
               A26MedidaID = H004D2_A26MedidaID[0];
               A41PromocionID = H004D2_A41PromocionID[0];
               A69FacturaID = H004D2_A69FacturaID[0];
               A77FacturaMedidaID = H004D2_A77FacturaMedidaID[0];
               A74MedidaRin = H004D2_A74MedidaRin[0];
               A28MedidaDescripcion = H004D2_A28MedidaDescripcion[0];
               A22ModeloID = H004D2_A22ModeloID[0];
               A23ModeloDescripcion = H004D2_A23ModeloDescripcion[0];
      ...
      private void E154D2( )
      {
         ...
         {
            A41PromocionID = H004D4_A41PromocionID[0];
            A22ModeloID = H004D4_A22ModeloID[0];
            A49PromocionModeloPrecio = H004D4_A49PromocionModeloPrecio[0];
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "wcpartidasfacturapopover", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202651111305096", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wcpartidasfacturapopover.js", "?202651111305096", false, true);
            context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
            context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E154D2","iparms":[{"av":"A22ModeloID","fld":"MODELOID","pic":"ZZZZZZZZ9"},{"av":"A41PromocionID","fld":"PROMOCIONID","pic":"ZZZZZZZZ9"},{"av":"A49PromocionModeloPrecio","fld":"PROMOCIONMODELOPRECIO","pic":"$ Z,ZZZ,ZZ9.99"},{"av":"A78FacturaMedidaCantidad","fld":"FACTURAMEDIDACANTIDAD","pic":"ZZZ9"}]""");
      ...
      public override void initialize( )
      {
         ...
         A74MedidaRin = "";
         GXDecQS = "";
         H004D2_A79FacturaMedidaPrecio = new decimal[1] ;
         H004D2_A78FacturaMedidaCantidad = new short[1] ;
         H004D2_A74MedidaRin = new string[] {""} ;
         H004D2_A28MedidaDescripcion = new string[] {""} ;
         H004D2_A23ModeloDescripcion = new string[] {""} ;
         H004D2_A22ModeloID = new int[1] ;
         H004D2_A26MedidaID = new int[1] ;
         H004D2_A41PromocionID = new int[1] ;
         H004D2_A69FacturaID = new int[1] ;
         H004D2_A77FacturaMedidaID = new int[1] ;
         H004D3_AGRID_nRecordCount = new long[1] ;
         H004D4_A48PromocionModeloID = new int[1] ;
         H004D4_A41PromocionID = new int[1] ;
         H004D4_A22ModeloID = new int[1] ;
         H004D4_A49PromocionModeloPrecio = new decimal[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wcpartidasfacturapopover__default(),
            new Object[][] {
                new Object[] {
               H004D2_A79FacturaMedidaPrecio, H004D2_A78FacturaMedidaCantidad, H004D2_A74MedidaRin, H004D2_A28MedidaDescripcion, H004D2_A23ModeloDescripcion, H004D2_A22ModeloID, H004D2_A26MedidaID, H004D2_A41PromocionID, H004D2_A69FacturaID, H004D2_A77FacturaMedidaID
               }
               , new Object[] {
               H004D3_AGRID_nRecordCount
               }
               , new Object[] {
               H004D4_A48PromocionModeloID, H004D4_A41PromocionID, H004D4_A22ModeloID, H004D4_A49PromocionModeloPrecio
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private decimal[] H004D2_A79FacturaMedidaPrecio ;
      private short[] H004D2_A78FacturaMedidaCantidad ;
      private string[] H004D2_A74MedidaRin ;
      private string[] H004D2_A28MedidaDescripcion ;
      private string[] H004D2_A23ModeloDescripcion ;
      private int[] H004D2_A22ModeloID ;
      private int[] H004D2_A26MedidaID ;
      private int[] H004D2_A41PromocionID ;
      private int[] H004D2_A69FacturaID ;
      private int[] H004D2_A77FacturaMedidaID ;
      private long[] H004D3_AGRID_nRecordCount ;
      private int[] H004D4_A48PromocionModeloID ;
      private int[] H004D4_A41PromocionID ;
      private int[] H004D4_A22ModeloID ;
      private decimal[] H004D4_A49PromocionModeloPrecio ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class wcpartidasfacturapopover__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H004D2", "SELECT T1.`FacturaMedidaPrecio`, T1.`FacturaMedidaCantidad`, T2.`MedidaRin`, T2.`MedidaDescripcion`, T3.`ModeloDescripcion`, T2.`ModeloID`, T1.`MedidaID`, T4.`PromocionID`, T1.`FacturaID`, T1.`FacturaMedidaID` FROM (((`FacturaMedida` T1 INNER JOIN `Medida` T2 ON T2.`MedidaID` = T1.`MedidaID`) INNER JOIN `Modelo` T3 ON T3.`ModeloID` = T2.`ModeloID`) INNER JOIN `Factura` T4 ON T4.`FacturaID` = T1.`FacturaID`) WHERE T1.`FacturaID` = @AV42FacturaID ORDER BY T1.`FacturaID`  LIMIT @GXPagingFrom2, @GXPagingTo2",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004D2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H004D3", "SELECT COUNT(*) FROM (((`FacturaMedida` T1 INNER JOIN `Medida` T3 ON T3.`MedidaID` = T1.`MedidaID`) INNER JOIN `Modelo` T4 ON T4.`ModeloID` = T3.`ModeloID`) INNER JOIN `Factura` T2 ON T2.`FacturaID` = T1.`FacturaID`) WHERE T1.`FacturaID` = @AV42FacturaID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004D3,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H004D4", "SELECT `PromocionModeloID`, `PromocionID`, `ModeloID`, `PromocionModeloPrecio` FROM `PromocionModelo` WHERE (`ModeloID` = @ModeloID) AND (`PromocionID` = @PromocionID) ORDER BY `PromocionModeloID`  LIMIT 1",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004D4,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
