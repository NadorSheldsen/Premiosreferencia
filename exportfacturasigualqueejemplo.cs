...
namespace GeneXus.Programs {
   public class exportfacturasigualqueejemplo : GXProcedure
   {
      public exportfacturasigualqueejemplo( )
      {
      ...
      public exportfacturasigualqueejemplo( IGxContext context )
      {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         ClassLoader.Execute("aexportfacturasigualqueejemplo","GeneXus.Programs","aexportfacturasigualqueejemplo", new Object[] {context }, "execute", args);
