...
namespace GeneXus.Programs {
   public class wpduplicarpromopromocionmodelowc : GXWebComponent
   {
      public wpduplicarpromopromocionmodelowc( )
      {
      ...
      public wpduplicarpromopromocionmodelowc( IGxContext context )
      {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV27Pgmname = "WPDuplicarPromoPromocionModeloWC";
               WS442( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "WPDuplicar Promo Promocion Modelo WC", "")) ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "wpduplicarpromopromocionmodelowc.aspx"+UrlEncode(StringUtil.LTrimStr(AV7PromocionID,9,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wpduplicarpromopromocionmodelowc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         return "WPDuplicarPromoPromocionModeloWC" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "WPDuplicar Promo Promocion Modelo WC", "") ;
      }
      ...
      protected void WB440( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "wpduplicarpromopromocionmodelowc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void START442( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "WPDuplicar Promo Promocion Modelo WC", ""), 0) ;
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wpduplicarpromopromocionmodelowc.aspx")), "wpduplicarpromopromocionmodelowc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wpduplicarpromopromocionmodelowc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void RF442( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A41PromocionID = H00442_A41PromocionID[0];
               AssignAttri(sPrefix, false, "A41PromocionID", StringUtil.LTrimStr( (decimal)(A41PromocionID), 9, 0));
               A49PromocionModeloPrecio = H00442_A49PromocionModeloPrecio[0];
               A25ModeloSegmento = H00442_A25ModeloSegmento[0];
               A23ModeloDescripcion = H00442_A23ModeloDescripcion[0];
               A22ModeloID = H00442_A22ModeloID[0];
               A48PromocionModeloID = H00442_A48PromocionModeloID[0];
               A25ModeloSegmento = H00442_A25ModeloSegmento[0];
               A23ModeloDescripcion = H00442_A23ModeloDescripcion[0];
               /* Execute user event: Grid.Load */
               E16442 ();
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "wpduplicarpromopromocionmodelowc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202651111305495", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wpduplicarpromopromocionmodelowc.js", "?202651111305495", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         edtPromocionModeloID_Internalname = sPrefix+"PROMOCIONMODELOID_"+sGXsfl_15_idx;
         ...
         cmbModeloSegmento_Internalname = sPrefix+"MODELOSEGMENTO_"+sGXsfl_15_idx;
         edtPromocionModeloPrecio_Internalname = sPrefix+"PROMOCIONMODELOPRECIO_"+sGXsfl_15_idx;
      }

      protected void SubsflControlProps_fel_152( )
      {
         edtPromocionModeloID_Internalname = sPrefix+"PROMOCIONMODELOID_"+sGXsfl_15_fel_idx;
         ...
         cmbModeloSegmento_Internalname = sPrefix+"MODELOSEGMENTO_"+sGXsfl_15_fel_idx;
         edtPromocionModeloPrecio_Internalname = sPrefix+"PROMOCIONMODELOPRECIO_"+sGXsfl_15_fel_idx;
      }
      ...
      protected void sendrow_152( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_15_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GXCCtl = "MODELOSEGMENTO_" + sGXsfl_15_idx;
            ...
            AssignProp(sPrefix, false, cmbModeloSegmento_Internalname, "Values", (string)(cmbModeloSegmento.ToJavascriptSource()), !bGXsfl_15_Refreshing);
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E16442","iparms":[]}""");
         setEventMetadata("VALID_MODELOID","""{"handler":"Valid_Modeloid","iparms":[]}""");
         setEventMetadata("NULL","""{"handler":"Valid_Promocionmodeloprecio","iparms":[]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         A25ModeloSegmento = "";
         GXDecQS = "";
         H00442_A41PromocionID = new int[1] ;
         H00442_A49PromocionModeloPrecio = new decimal[1] ;
         H00442_A25ModeloSegmento = new string[] {""} ;
         H00442_A23ModeloDescripcion = new string[] {""} ;
         H00442_A22ModeloID = new int[1] ;
         H00442_A48PromocionModeloID = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wpduplicarpromopromocionmodelowc__default(),
            new Object[][] {
                new Object[] {
               H00442_A41PromocionID, H00442_A49PromocionModeloPrecio, H00442_A25ModeloSegmento, H00442_A23ModeloDescripcion, H00442_A22ModeloID, H00442_A48PromocionModeloID
               }
               , new Object[] {
      ...
      private int[] H00442_A41PromocionID ;
      private decimal[] H00442_A49PromocionModeloPrecio ;
      private string[] H00442_A25ModeloSegmento ;
      private string[] H00442_A23ModeloDescripcion ;
      private int[] H00442_A22ModeloID ;
      private int[] H00442_A48PromocionModeloID ;
   ...
   public class wpduplicarpromopromocionmodelowc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             int A41PromocionID )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.`PromocionID`, T1.`PromocionModeloPrecio`, T2.`ModeloSegmento`, T2.`ModeloDescripcion`, T1.`ModeloID`, T1.`PromocionModeloID`";
         ...
         {
            sOrderString += " ORDER BY T1.`PromocionID`, T2.`ModeloDescripcion`";
         }
         else if ( ( AV13OrderedBy == 1 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.`PromocionID` DESC, T2.`ModeloDescripcion` DESC";
         }
         else if ( ( AV13OrderedBy == 2 ) && ! AV14OrderedDsc )
         {
            sOrderString += " ORDER BY T1.`PromocionID`, T2.`ModeloSegmento`";
         }
         else if ( ( AV13OrderedBy == 2 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.`PromocionID` DESC, T2.`ModeloSegmento` DESC";
         }
         else if ( ( AV13OrderedBy == 3 ) && ! AV14OrderedDsc )
         {
            sOrderString += " ORDER BY T1.`PromocionID`, T1.`PromocionModeloPrecio`";
         }
         else if ( ( AV13OrderedBy == 3 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.`PromocionID` DESC, T1.`PromocionModeloPrecio` DESC";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY T1.`PromocionModeloID`";
         }
                                             ...
                                             int A41PromocionID )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM (`PromocionModelo` T1 INNER JOIN `Modelo` T2 ON T2.`ModeloID` = T1.`ModeloID`)";
         AddWhere(sWhereString, "(T1.`PromocionID` = @AV7PromocionID)");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00442(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (int)dynConstraints[2] , (int)dynConstraints[3] );
               case 1 :
                     return conditional_H00443(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (int)dynConstraints[2] , (int)dynConstraints[3] );
         }
