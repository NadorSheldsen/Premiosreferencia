...
namespace GeneXus.Programs {
   public class paisview : GXDataArea
   {
      public paisview( )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "paisview.aspx"+UrlEncode(StringUtil.LTrimStr(AV9PaisID,9,0)) + "," + UrlEncode(StringUtil.RTrim(AV7TabCode));
      ...
      {
         GxWebStd.gx_hidden_field( context, "vPAISID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9PaisID), 9, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vPAISID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV9PaisID), "ZZZZZZZZ9"), context));
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         if ( ! ( WebComp_Estadowc == null ) )
         {
            WebComp_Estadowc.componentjscripts();
         }
      ...
      {
         return context.GetMessage( "Pais View", "") ;
      }
      ...
      protected void WB190( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, context.GetMessage( "Ir a Pais", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_PaisView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, context.GetMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_PaisView.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblEstado_title_Internalname, context.GetMessage( "Estado", ""), "", "", lblEstado_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_PaisView.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            context.WriteHtmlText( "Estado") ;
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+"TABSContainer"+"panel2"+"\" style=\"display:none;\">") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtableestado_Internalname, 1, 0, "px", 0, "px", "TableViewTab", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0033"+"", StringUtil.RTrim( WebComp_Estadowc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpW0033"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.Len( WebComp_Estadowc_Component) != 0 )
               {
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldEstadowc), StringUtil.Lower( WebComp_Estadowc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0033"+"");
                  }
                  WebComp_Estadowc.componentdraw();
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldEstadowc), StringUtil.Lower( WebComp_Estadowc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspEndCmp();
                  }
      ...
      protected void START192( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Pais View", ""), 0) ;
         context.wjLoc = "";
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldEstadowc = cgiGet( "W0033");
                           if ( ( StringUtil.Len( OldEstadowc) == 0 ) || ( StringUtil.StrCmp(OldEstadowc, WebComp_Estadowc_Component) != 0 ) )
                           {
                              WebComp_Estadowc = getWebComponent(GetType(), "GeneXus.Programs", OldEstadowc, new Object[] {context} );
                              WebComp_Estadowc.ComponentInit();
                              WebComp_Estadowc.Name = "OldEstadowc";
                              WebComp_Estadowc_Component = OldEstadowc;
                           }
                           if ( StringUtil.Len( WebComp_Estadowc_Component) != 0 )
                           {
                              WebComp_Estadowc.componentprocess("W0033", "", sEvt);
                           }
                           WebComp_Estadowc_Component = OldEstadowc;
                        }
                     }
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV9PaisID = (int)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
                     AssignAttri("", false, "AV9PaisID", StringUtil.LTrimStr( (decimal)(AV9PaisID), 9, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vPAISID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV9PaisID), "ZZZZZZZZ9"), context));
      ...
      protected void RF192( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            if ( 1 != 0 )
            {
               if ( StringUtil.Len( WebComp_Estadowc_Component) != 0 )
               {
                  WebComp_Estadowc.componentstart();
               }
            }
         }
      ...
      protected void E12192( )
      {
         ...
         AV12GXLvl9 = 0;
         /* Using cursor H00192 */
         pr_default.execute(0, new Object[] {AV9PaisID});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A16PaisID = H00192_A16PaisID[0];
            A17PaisDescripcion = H00192_A17PaisDescripcion[0];
            AV12GXLvl9 = 1;
            Form.Caption = A17PaisDescripcion;
      ...
      protected void S112( )
      {
         ...
         if ( AV10LoadAllTabs || ( StringUtil.StrCmp(AV11SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV11SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               ...
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0025",(string)"",(int)AV9PaisID});
         ...
         if ( AV10LoadAllTabs || ( StringUtil.StrCmp(AV11SelectedTabCode, "Estado") == 0 ) )
         {
            /* Object Property */
            if ( true )
            {
               bDynCreated_Estadowc = true;
            }
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Estadowc_Component), StringUtil.Lower( "PaisEstadoWC")) != 0 )
            {
               WebComp_Estadowc = getWebComponent(GetType(), "GeneXus.Programs", "paisestadowc", new Object[] {context} );
               WebComp_Estadowc.ComponentInit();
               WebComp_Estadowc.Name = "PaisEstadoWC";
               WebComp_Estadowc_Component = "PaisEstadoWC";
            }
            if ( StringUtil.Len( WebComp_Estadowc_Component) != 0 )
            {
               WebComp_Estadowc.setjustcreated();
               WebComp_Estadowc.componentprepare(new Object[] {(string)"W0033",(string)"",(int)AV9PaisID});
               WebComp_Estadowc.componentbind(new Object[] {(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Estadowc )
            {
               context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0033"+"");
               WebComp_Estadowc.componentdraw();
               context.httpAjaxContext.ajax_rspEndCmp();
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV9PaisID = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV9PaisID", StringUtil.LTrimStr( (decimal)(AV9PaisID), 9, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vPAISID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV9PaisID), "ZZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         if ( ! ( WebComp_Estadowc == null ) )
         {
            if ( StringUtil.Len( WebComp_Estadowc_Component) != 0 )
            {
               WebComp_Estadowc.componentthemes();
            }
         }
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025102815462298", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("paisview.js", "?2025102815462298", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         lblEstado_title_Internalname = "ESTADO_TITLE";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Pais View", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV9PaisID","fld":"vPAISID","pic":"ZZZZZZZZ9","hsh":true},{"av":"AV7TabCode","fld":"vTABCODE","hsh":true}]}""");
         setEventMetadata("TABS.TABCHANGED","""{"handler":"E11192","iparms":[{"av":"Tabs_Activepagecontrolname","ctrl":"TABS","prop":"ActivePageControlName"},{"av":"AV10LoadAllTabs","fld":"vLOADALLTABS"},{"av":"AV11SelectedTabCode","fld":"vSELECTEDTABCODE"},{"av":"AV9PaisID","fld":"vPAISID","pic":"ZZZZZZZZ9","hsh":true}]""");
         setEventMetadata("TABS.TABCHANGED",""","oparms":[{"av":"AV11SelectedTabCode","fld":"vSELECTEDTABCODE"},{"av":"AV10LoadAllTabs","fld":"vLOADALLTABS"},{"ctrl":"GENERALWC"},{"ctrl":"ESTADOWC"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         OldGeneralwc = "";
         lblEstado_title_Jsonclick = "";
         WebComp_Estadowc_Component = "";
         OldEstadowc = "";
         sEvt = "";
         EvtGridId = "";
         EvtRowId = "";
         ...
         H00192_A16PaisID = new int[1] ;
         H00192_A17PaisDescripcion = new string[] {""} ;
         A17PaisDescripcion = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.paisview__default(),
            new Object[][] {
                new Object[] {
               H00192_A16PaisID, H00192_A17PaisDescripcion
               }
            }
         );
         WebComp_Generalwc = new GeneXus.Http.GXNullWebComponent();
         WebComp_Estadowc = new GeneXus.Http.GXNullWebComponent();
         /* GeneXus formulas. */
      }
      ...
      private int AV9PaisID ;
      private int wcpOAV9PaisID ;
      ...
      private string lblEstado_title_Internalname ;
      private string lblEstado_title_Jsonclick ;
      private string divUnnamedtableestado_Internalname ;
      private string WebComp_Estadowc_Component ;
      private string OldEstadowc ;
      private string sEvt ;
      ...
      private bool bDynCreated_Estadowc ;
      private string A17PaisDescripcion ;
      private GXWebComponent WebComp_Generalwc ;
      private GXWebComponent WebComp_Estadowc ;
      private GXUserControl ucTabs ;
      private GXWebForm Form ;
      private IGxDataStore dsDefault ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
      private IDataStoreProvider pr_default ;
      private int[] H00192_A16PaisID ;
      private string[] H00192_A17PaisDescripcion ;
   ...
   public class paisview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV9PaisID",GXType.Int32,9,0)
          };
          def= new CursorDef[] {
              new CursorDef("H00192", "SELECT `PaisID`, `PaisDescripcion` FROM `Pais` WHERE `PaisID` = @AV9PaisID ORDER BY `PaisID` ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00192,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
