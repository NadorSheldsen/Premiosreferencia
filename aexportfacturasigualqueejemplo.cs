...
namespace GeneXus.Programs {
   public class aexportfacturasigualqueejemplo : GXProcedure
   {
      public static int Main( string[] args )
      {
         return new aexportfacturasigualqueejemplo().MainImpl(args); ;
      }
      ...
      public aexportfacturasigualqueejemplo( )
      {
      ...
      public aexportfacturasigualqueejemplo( IGxContext context )
      {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         AV11FileName = GXt_char1 + "Reporte.xlsx";
         ...
         AV9ExcelDocument.get_Cells(AV8CellRow, 14, 1, 1).Text = context.GetMessage( "GÉNERO", "");
         AV9ExcelDocument.get_Cells(AV8CellRow, 15, 1, 1).Text = context.GetMessage( "MODELO", "");
         AV9ExcelDocument.get_Cells(AV8CellRow, 16, 1, 1).Text = context.GetMessage( "MEDIDA", "");
         AV9ExcelDocument.get_Cells(AV8CellRow, 17, 1, 1).Text = context.GetMessage( "CÓDIGO", "");
         AV9ExcelDocument.get_Cells(AV8CellRow, 18, 1, 1).Text = context.GetMessage( "RIN", "");
         AV9ExcelDocument.get_Cells(AV8CellRow, 19, 1, 1).Text = context.GetMessage( "CANTIDAD", "");
         AV9ExcelDocument.get_Cells(AV8CellRow, 20, 1, 1).Text = context.GetMessage( "BONO UNITARIO", "");
         AV9ExcelDocument.get_Cells(AV8CellRow, 21, 1, 1).Text = context.GetMessage( "BONO TOTAL", "");
         AV9ExcelDocument.get_Cells(AV8CellRow, 22, 1, 1).Text = context.GetMessage( "PRECIO UNITARIO", "");
         AV32i = 1;
         while ( AV32i <= 22 )
         {
         ...
         AV43ColorEnProceso = GXUtil.RGB( 247, 155, 16);
         AV42ColorAprobada = GXUtil.RGB( 0, 167, 90);
         AV45Colorrechazada = (decimal)(GXUtil.RGB( 221, 75, 57));
         AV44ColorCancelada = GXUtil.RGB( 62, 140, 186);
         AV23Consecutivo = 0;
         ...
         {
            A19MotivoRechazoID = P004C2_A19MotivoRechazoID[0];
            A4CiudadID = P004C2_A4CiudadID[0];
            n4CiudadID = P004C2_n4CiudadID[0];
            A1EstadoID = P004C2_A1EstadoID[0];
            A26MedidaID = P004C2_A26MedidaID[0];
            A93FacturaCompleta = P004C2_A93FacturaCompleta[0];
            A71FacturaNo = P004C2_A71FacturaNo[0];
            A41PromocionID = P004C2_A41PromocionID[0];
            A80FacturaEstatus = P004C2_A80FacturaEstatus[0];
            A29UsuarioID = P004C2_A29UsuarioID[0];
            A73FacturaFechaFactura = P004C2_A73FacturaFechaFactura[0];
            A22ModeloID = P004C2_A22ModeloID[0];
            A78FacturaMedidaCantidad = P004C2_A78FacturaMedidaCantidad[0];
            A69FacturaID = P004C2_A69FacturaID[0];
            A72FacturaFechaRegistro = P004C2_A72FacturaFechaRegistro[0];
            A42PromocionDescripcion = P004C2_A42PromocionDescripcion[0];
            A20MotivoRechazoDescripcion = P004C2_A20MotivoRechazoDescripcion[0];
            A63UsuarioZona = P004C2_A63UsuarioZona[0];
            A2EstadoDescripcion = P004C2_A2EstadoDescripcion[0];
            A5CiudadDescripcion = P004C2_A5CiudadDescripcion[0];
            A53UsuarioGenero = P004C2_A53UsuarioGenero[0];
            A23ModeloDescripcion = P004C2_A23ModeloDescripcion[0];
            A28MedidaDescripcion = P004C2_A28MedidaDescripcion[0];
            A27MedidaCodigo = P004C2_A27MedidaCodigo[0];
            A74MedidaRin = P004C2_A74MedidaRin[0];
            A79FacturaMedidaPrecio = P004C2_A79FacturaMedidaPrecio[0];
            A51UsuarioApellido = P004C2_A51UsuarioApellido[0];
            A30UsuarioNombre = P004C2_A30UsuarioNombre[0];
            A77FacturaMedidaID = P004C2_A77FacturaMedidaID[0];
            A22ModeloID = P004C2_A22ModeloID[0];
            A28MedidaDescripcion = P004C2_A28MedidaDescripcion[0];
            A27MedidaCodigo = P004C2_A27MedidaCodigo[0];
            A74MedidaRin = P004C2_A74MedidaRin[0];
            ...
            {
               A10DistribuidorID = P004C3_A10DistribuidorID[0];
               A29UsuarioID = P004C3_A29UsuarioID[0];
               A11DistribuidorDescripcion = P004C3_A11DistribuidorDescripcion[0];
               A81DistribuidoresUsuarioID = P004C3_A81DistribuidoresUsuarioID[0];
               A11DistribuidorDescripcion = P004C3_A11DistribuidorDescripcion[0];
            ...
            {
               A22ModeloID = P004C4_A22ModeloID[0];
               A41PromocionID = P004C4_A41PromocionID[0];
               A49PromocionModeloPrecio = P004C4_A49PromocionModeloPrecio[0];
               A48PromocionModeloID = P004C4_A48PromocionModeloID[0];
            ...
            {
               AV9ExcelDocument.get_Cells(AV8CellRow, 7, 1, 1).Color = AV43ColorEnProceso;
            }
            ...
            {
               AV9ExcelDocument.get_Cells(AV8CellRow, 7, 1, 1).Color = (int)(Math.Round(AV45Colorrechazada, 18, MidpointRounding.ToEven));
               AV9ExcelDocument.get_Cells(AV8CellRow, 8, 1, 1).Color = (int)(Math.Round(AV45Colorrechazada, 18, MidpointRounding.ToEven));
            }
            else if ( StringUtil.StrCmp(A80FacturaEstatus, "Cancelada") == 0 )
            {
               AV9ExcelDocument.get_Cells(AV8CellRow, 7, 1, 1).Color = AV44ColorCancelada;
            }
            ...
            AV9ExcelDocument.get_Cells(AV8CellRow, 14, 1, 1).Text = A53UsuarioGenero;
            AV9ExcelDocument.get_Cells(AV8CellRow, 15, 1, 1).Text = A23ModeloDescripcion;
            AV9ExcelDocument.get_Cells(AV8CellRow, 16, 1, 1).Text = A28MedidaDescripcion;
            AV9ExcelDocument.get_Cells(AV8CellRow, 17, 1, 1).Text = A27MedidaCodigo;
            AV9ExcelDocument.get_Cells(AV8CellRow, 18, 1, 1).Text = A74MedidaRin;
            AV9ExcelDocument.get_Cells(AV8CellRow, 19, 1, 1).Number = A78FacturaMedidaCantidad;
            AV9ExcelDocument.get_Cells(AV8CellRow, 20, 1, 1).Number = (double)(AV17BonoUnitario);
            AV9ExcelDocument.get_Cells(AV8CellRow, 21, 1, 1).Number = (double)(AV18BonoTotal);
            AV9ExcelDocument.get_Cells(AV8CellRow, 22, 1, 1).Number = (double)(A79FacturaMedidaPrecio);
         ...
         AV12Session.Set(context.GetMessage( "WWPExportFileName", ""), "Reporte.xlsx");
      ...
      public override void initialize( )
      {
         ...
         A80FacturaEstatus = "";
         A71FacturaNo = "";
         P004C2_A19MotivoRechazoID = new int[1] ;
         P004C2_A4CiudadID = new int[1] ;
         P004C2_n4CiudadID = new bool[] {false} ;
         P004C2_A1EstadoID = new int[1] ;
         P004C2_A26MedidaID = new int[1] ;
         P004C2_A93FacturaCompleta = new bool[] {false} ;
         P004C2_A71FacturaNo = new string[] {""} ;
         P004C2_A41PromocionID = new int[1] ;
         P004C2_A80FacturaEstatus = new string[] {""} ;
         P004C2_A29UsuarioID = new int[1] ;
         P004C2_A73FacturaFechaFactura = new DateTime[] {DateTime.MinValue} ;
         P004C2_A22ModeloID = new int[1] ;
         P004C2_A78FacturaMedidaCantidad = new short[1] ;
         P004C2_A69FacturaID = new int[1] ;
         P004C2_A72FacturaFechaRegistro = new DateTime[] {DateTime.MinValue} ;
         P004C2_A42PromocionDescripcion = new string[] {""} ;
         P004C2_A20MotivoRechazoDescripcion = new string[] {""} ;
         P004C2_A63UsuarioZona = new string[] {""} ;
         P004C2_A2EstadoDescripcion = new string[] {""} ;
         P004C2_A5CiudadDescripcion = new string[] {""} ;
         P004C2_A53UsuarioGenero = new string[] {""} ;
         P004C2_A23ModeloDescripcion = new string[] {""} ;
         P004C2_A28MedidaDescripcion = new string[] {""} ;
         P004C2_A27MedidaCodigo = new string[] {""} ;
         P004C2_A74MedidaRin = new string[] {""} ;
         P004C2_A79FacturaMedidaPrecio = new decimal[1] ;
         P004C2_A51UsuarioApellido = new string[] {""} ;
         P004C2_A30UsuarioNombre = new string[] {""} ;
         P004C2_A77FacturaMedidaID = new int[1] ;
         ...
         AV15DistribuidorDescripcion = "";
         P004C3_A10DistribuidorID = new int[1] ;
         P004C3_A29UsuarioID = new int[1] ;
         P004C3_A11DistribuidorDescripcion = new string[] {""} ;
         P004C3_A81DistribuidoresUsuarioID = new int[1] ;
         A11DistribuidorDescripcion = "";
         P004C4_A22ModeloID = new int[1] ;
         P004C4_A41PromocionID = new int[1] ;
         P004C4_A49PromocionModeloPrecio = new decimal[1] ;
         P004C4_A48PromocionModeloID = new int[1] ;
         GXt_dtime2 = (DateTime)(DateTime.MinValue);
         AV12Session = context.GetSession();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.aexportfacturasigualqueejemplo__default(),
            new Object[][] {
                new Object[] {
               P004C2_A19MotivoRechazoID, P004C2_A4CiudadID, P004C2_n4CiudadID, P004C2_A1EstadoID, P004C2_A26MedidaID, P004C2_A93FacturaCompleta, P004C2_A71FacturaNo, P004C2_A41PromocionID, P004C2_A80FacturaEstatus, P004C2_A29UsuarioID,
               P004C2_A73FacturaFechaFactura, P004C2_A22ModeloID, P004C2_A78FacturaMedidaCantidad, P004C2_A69FacturaID, P004C2_A72FacturaFechaRegistro, P004C2_A42PromocionDescripcion, P004C2_A20MotivoRechazoDescripcion, P004C2_A63UsuarioZona, P004C2_A2EstadoDescripcion, P004C2_A5CiudadDescripcion,
               P004C2_A53UsuarioGenero, P004C2_A23ModeloDescripcion, P004C2_A28MedidaDescripcion, P004C2_A27MedidaCodigo, P004C2_A74MedidaRin, P004C2_A79FacturaMedidaPrecio, P004C2_A51UsuarioApellido, P004C2_A30UsuarioNombre, P004C2_A77FacturaMedidaID
               }
               , new Object[] {
               P004C3_A10DistribuidorID, P004C3_A29UsuarioID, P004C3_A11DistribuidorDescripcion, P004C3_A81DistribuidoresUsuarioID
               }
               , new Object[] {
               P004C4_A22ModeloID, P004C4_A41PromocionID, P004C4_A49PromocionModeloPrecio, P004C4_A48PromocionModeloID
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private int AV43ColorEnProceso ;
      private int AV42ColorAprobada ;
      private int AV44ColorCancelada ;
      ...
      private decimal AV45Colorrechazada ;
      ...
      private int[] P004C2_A19MotivoRechazoID ;
      private int[] P004C2_A4CiudadID ;
      private bool[] P004C2_n4CiudadID ;
      private int[] P004C2_A1EstadoID ;
      private int[] P004C2_A26MedidaID ;
      private bool[] P004C2_A93FacturaCompleta ;
      private string[] P004C2_A71FacturaNo ;
      private int[] P004C2_A41PromocionID ;
      private string[] P004C2_A80FacturaEstatus ;
      private int[] P004C2_A29UsuarioID ;
      private DateTime[] P004C2_A73FacturaFechaFactura ;
      private int[] P004C2_A22ModeloID ;
      private short[] P004C2_A78FacturaMedidaCantidad ;
      private int[] P004C2_A69FacturaID ;
      private DateTime[] P004C2_A72FacturaFechaRegistro ;
      private string[] P004C2_A42PromocionDescripcion ;
      private string[] P004C2_A20MotivoRechazoDescripcion ;
      private string[] P004C2_A63UsuarioZona ;
      private string[] P004C2_A2EstadoDescripcion ;
      private string[] P004C2_A5CiudadDescripcion ;
      private string[] P004C2_A53UsuarioGenero ;
      private string[] P004C2_A23ModeloDescripcion ;
      private string[] P004C2_A28MedidaDescripcion ;
      private string[] P004C2_A27MedidaCodigo ;
      private string[] P004C2_A74MedidaRin ;
      private decimal[] P004C2_A79FacturaMedidaPrecio ;
      private string[] P004C2_A51UsuarioApellido ;
      private string[] P004C2_A30UsuarioNombre ;
      private int[] P004C2_A77FacturaMedidaID ;
      private int[] P004C3_A10DistribuidorID ;
      private int[] P004C3_A29UsuarioID ;
      private string[] P004C3_A11DistribuidorDescripcion ;
      private int[] P004C3_A81DistribuidoresUsuarioID ;
      private int[] P004C4_A22ModeloID ;
      private int[] P004C4_A41PromocionID ;
      private decimal[] P004C4_A49PromocionModeloPrecio ;
      private int[] P004C4_A48PromocionModeloID ;
      private string aP6_ExcelFilename ;
   }

   public class aexportfacturasigualqueejemplo__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P004C2(context, (int)dynConstraints[0] , (GxSimpleCollection<int>)dynConstraints[1] , (int)dynConstraints[2] , (GxSimpleCollection<int>)dynConstraints[3] , (DateTime)dynConstraints[4] , (DateTime)dynConstraints[5] , (int)dynConstraints[6] , (string)dynConstraints[7] , (int)dynConstraints[8] , (string)dynConstraints[9] , (DateTime)dynConstraints[10] , (string)dynConstraints[11] , (string)dynConstraints[12] , (bool)dynConstraints[13] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("P004C3", "SELECT T1.`DistribuidorID`, T1.`UsuarioID`, T2.`DistribuidorDescripcion`, T1.`DistribuidoresUsuarioID` FROM (`DistribuidoresUsuario` T1 INNER JOIN `Distribuidor` T2 ON T2.`DistribuidorID` = T1.`DistribuidorID`) WHERE T1.`UsuarioID` = @AV40TempUsuarioID ORDER BY T1.`UsuarioID`  LIMIT 1",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP004C3,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P004C4", "SELECT `ModeloID`, `PromocionID`, `PromocionModeloPrecio`, `PromocionModeloID` FROM `PromocionModelo` WHERE `PromocionID` = @AV37TempPromocionID and `ModeloID` = @AV38TempModeloID ORDER BY `PromocionID`, `ModeloID`  LIMIT 1",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP004C4,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
